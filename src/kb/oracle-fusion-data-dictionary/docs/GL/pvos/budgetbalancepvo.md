---
id: DOC-GL-PVO-BudgetBalancePVO
doc_type: system-doc
title: "BudgetBalancePVO — PVO General Ledger"
...
View Object para extração BICC de dados de Budget Balance. Acessa as tabelas: GL_BUDGET_BALANCES.

**Caminho:** `FscmTopModelAM.FinGlInquiryBalancesAM.BudgetBalancePVO`
...
- [[gl_budget_balances|GL_BUDGET_BALANCES]] — 44 atributos (6 PKs, 44 BICC)
