...
id: DOC-HCM-334
doc_type: system-doc
title: "HWM_TCD_MAPPING_SETS_TL — Conjuntos de Mapeamento de Time Card (Traduções)"
...
Tabela de traduções dos conjuntos de mapeamento de cartão de ponto em múltiplos idiomas.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | TCD_MAPPING_SETS_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | — | 🟢 95% |
...
FROM   HWM_TCD_MAPPING_SETS_TL t
...
- [Oracle Docs — HWM_TCD_MAPPING_SETS_TL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tcd_mapping_sets_tl.html)
