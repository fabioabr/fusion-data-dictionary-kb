...
id: DOC-HCM-325
doc_type: system-doc
title: "HWM_TCATS_VL — Categorias de Cartão de Ponto (View Consolidada)"
...
Visão consolidada que combina dados base e traduções das categorias de cartão de ponto para consulta simplificada.
...
- [Oracle Docs — HWM_TCATS_VL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tcats_vl.html)
