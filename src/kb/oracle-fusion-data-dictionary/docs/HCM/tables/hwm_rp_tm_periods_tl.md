...
id: DOC-HCM-309
doc_type: system-doc
title: "HWM_RP_TM_PERIODS_TL — Períodos de Tempo para Relatórios (Traduções)"
...
Tabela de traduções dos períodos de tempo para relatórios, armazenando nomes e descrições em múltiplos idiomas conforme configuração do tenant.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | RP_TM_PERIODS_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | — | 🟢 95% |
...
- [Oracle Docs — HWM_RP_TM_PERIODS_TL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_rp_tm_periods_tl.html)
