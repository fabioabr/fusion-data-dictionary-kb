...
id: DOC-HCM-320
doc_type: system-doc
title: "HWM_RULE_TMPLT_INPUTS_TL — Entradas de Templates de Regras (Traduções)"
...
Tabela de traduções das entradas de templates de regras, contendo labels e descrições dos inputs em múltiplos idiomas.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | RULE_TMPLT_INPUTS_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | — | 🟢 95% |
...
FROM   HWM_RULE_TMPLT_INPUTS_TL t
...
|------------------|-----------------|------|
| IN_NAME_DESCRIPTION | RuleTemplateInputTLPEOInNameDescription | ✅ |
| LANGUAGE | RuleTemplateInputTLPEOLanguage | — |
| RULE_TMPLT_INPUT_ID | RuleTemplateInputTLPEORuleTmpltInputId | — |
| USER_DEFINED_IN_NAME | RuleTemplateInputTLPEOUserDefinedInName | ✅ |

---

## 📚 Referências

- [Oracle Docs — HWM_RULE_TMPLT_INPUTS_TL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_rule_tmplt_inputs_tl.html)
