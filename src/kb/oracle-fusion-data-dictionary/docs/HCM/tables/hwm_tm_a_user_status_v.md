...
id: DOC-HCM-368
doc_type: system-doc
title: "HWM_TM_A_USER_STATUS_V — Status do Usuário para Aprovação (View)"
...
View que exibe o status de aprovação de registros de tempo na perspectiva do usuário/trabalhador, mostrando o estado atual de suas submissões.
...
- [Oracle Docs — HWM_TM_A_USER_STATUS_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tm_a_user_status_v.html)
