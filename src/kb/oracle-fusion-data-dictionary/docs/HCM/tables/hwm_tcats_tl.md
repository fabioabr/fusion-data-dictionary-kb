...
id: DOC-HCM-324
doc_type: system-doc
title: "HWM_TCATS_TL — Categorias de Cartão de Ponto (Traduções)"
...
Tabela de traduções das categorias de cartão de ponto, armazenando nomes e descrições em múltiplos idiomas.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | TCATS_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | — | 🟢 95% |
...
- [Oracle Docs — HWM_TCATS_TL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tcats_tl.html)
