...
id: DOC-HCM-266
doc_type: system-doc
title: "HRT_RELATION_CONFIG_TL — Configuracao de Relacionamentos — Traducoes"
...
aliases:
  ...
  - hrt_relation_config_tl
  - hrt-relation-config-tl
  - relation-config-tl
  - configuracao-relacionamentos-traducoes
...
Tabela de traducoes que armazena textos em multiplos idiomas para cada registro definido em [[hrt_relation_config_b]].
...
|---|--------|------|-------|-----------|-----------|-----|-----------|
| 1 | RELATION_CONFIG_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | [[hrt_relation_config_b]] | 🟢 100% |
| 2 | LANGUAGE | VARCHAR2(4) | NOT NULL | PK | Codigo do idioma | — | 🟢 100% |
| 3 | SOURCE_LANG | VARCHAR2(4) | NOT NULL | Controle | Idioma de origem | — | 🟢 100% |
| 4 | RELATION_NAME | VARCHAR2(240) | NOT NULL | Dados | Nome/texto traduzido | — | 🟢 100% |
...
- [[hrt_relation_config_b]] — via `RELATION_CONFIG_ID` (registro base da configuracao de relacao)
...
```sql
SELECT tl.RELATION_NAME, tl.DESCRIPTION
FROM   HRT_RELATION_CONFIG_TL tl
WHERE  tl.RELATION_CONFIG_ID = :p_id
...
- Sufixo `_TL` indica tabela de traducao — PK composta por (RELATION_CONFIG_ID, LANGUAGE).
- JOIN com [[hrt_relation_config_b]] para dados completos.
