...
id: DOC-HCM-323
doc_type: system-doc
title: "HWM_TCATS_B — Categorias de Cartão de Ponto (Base)"
...
Tabela base que define as categorias de cartão de ponto (time card categories), utilizadas para classificar registros de tempo em diferentes tipos.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | TCATS_ID | NUMBER(18) | NOT NULL | PK | Identificador único do registro | — | 🟢 95% |
...
- [[hwm_tcat_expr_results_b]] — via `TCAT_ID` (resultados de expressão)
...
- [Oracle Docs — HWM_TCATS_B](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tcats_b.html)
