...
id: DOC-HCM-359
doc_type: system-doc
title: "HWM_TM_ATRB_FLD_MSTR_REF_VL — Referência Mestre de Campos de Atributos (View Consolidada)"
...
Visão consolidada que combina dados base e traduções das referências mestre de campos de atributos.
...
FROM   HWM_TM_ATRB_FLD_MSTR_REF_VL t
...
- [Oracle Docs — HWM_TM_ATRB_FLD_MSTR_REF_VL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tm_atrb_fld_mstr_ref_vl.html)
