...
id: DOC-HCM-331
doc_type: system-doc
title: "HWM_TCD_MAPPINGS_TL — Mapeamentos de Time Card (Traduções)"
...
Tabela de traduções dos mapeamentos de cartão de ponto, contendo labels e descrições em múltiplos idiomas.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | TCD_MAPPINGS_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | — | 🟢 95% |
...
### [[tcdmappingdetailpvo|TcdMappingDetailPVO]] (GL · BICC: 2/4)

| Coluna da Tabela | Atributo do PVO | BICC |
|------------------|-----------------|------|
| DESCRIPTION | TcdMappingTLPEODescription | ✅ |
| LANGUAGE | TcdMappingTLPEOLanguage | — |
| NAME | TcdMappingTLPEOName | ✅ |
| TCD_MAPPING_ID | TcdMappingTLPEOTcdMappingId | — |

### [[tcdmappingpvo|TcdMappingPVO]] (GL · BICC: 2/4)
...
- [Oracle Docs — HWM_TCD_MAPPINGS_TL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tcd_mappings_tl.html)
