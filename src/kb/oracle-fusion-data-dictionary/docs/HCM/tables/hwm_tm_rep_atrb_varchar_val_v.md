...
id: DOC-HCM-390
doc_type: system-doc
title: "HWM_TM_REP_ATRB_VARCHAR_VAL_V — View de Valores Texto de Atributos Reportados"
...
View que apresenta os **valores do tipo Texto** (VARCHAR) dos atributos de entradas reportadas de tempo. Facilita a consulta de atributos com valores texto sem necessidade de conversão.
...
- **Consulta de atributos texto:** acesso direto a valores texto de entradas reportadas.
- **Relatórios:** facilita extração de atributos texto sem conversão de tipo.
...
| 4 | VARCHAR_VALUE | VARCHAR2(240) | NULL | Dados | Valor texto do atributo | — | 🟡 60% |
...
- [[hwm_tm_rep_atrbs]] — via `REP_ATRB_ID` (atributo de reporte do valor texto)
...
### Consultar valores texto de atributos reportados
```sql
SELECT v.ATTRIBUTE_NAME, v.VARCHAR_VALUE, v.REP_ENTRY_ID
FROM   HWM_TM_REP_ATRB_VARCHAR_VAL_V v
...
- Retorna apenas atributos com valores do tipo texto.
...
- [Oracle Docs — HWM_TM_REP_ATRB_VARCHAR_VAL_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwmtmrepatrbvarcharvalv.html)
...
### [[attributevarcharvaluepvo|AttributeVarcharValuePVO]] (HCM · BICC: 6/28)
