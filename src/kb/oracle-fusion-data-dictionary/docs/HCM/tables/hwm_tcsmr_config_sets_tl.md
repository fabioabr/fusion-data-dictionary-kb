...
id: DOC-HCM-341
doc_type: system-doc
title: "HWM_TCSMR_CONFIG_SETS_TL — Conjuntos de Configuração de Resumo (Traduções)"
...
Tabela de traduções dos conjuntos de configuração de resumo de cartão de ponto em múltiplos idiomas.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | TCSMR_CONFIG_SETS_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | — | 🟢 95% |
...
FROM   HWM_TCSMR_CONFIG_SETS_TL t
...
- [Oracle Docs — HWM_TCSMR_CONFIG_SETS_TL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tcsmr_config_sets_tl.html)
