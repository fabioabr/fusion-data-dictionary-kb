...
id: DOC-HCM-170
doc_type: system-doc
title: "HRG_GOAL_PLANS_TL — Traduções de Planos de Metas"
...
Tabela de **traduções** de planos de metas (base). Padrão Oracle MLS.
...
|---|--------|------|-------|-----------|-----------|-----|-----------|
| 1 | GOAL_PLAN_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador | [[hrg_goal_plans_b]] | 🟢 95% |
...
- [[hrg_goal_plans_b]] — via `GOAL_PLAN_ID` (registro base do cadastro)
...
FROM   HRG_GOAL_PLANS_TL tl
WHERE  tl.GOAL_PLAN_ID = :p_id AND tl.LANGUAGE = USERENV('LANG');
```
...
- Chave primária composta: `GOAL_PLAN_ID` + `LANGUAGE`.
