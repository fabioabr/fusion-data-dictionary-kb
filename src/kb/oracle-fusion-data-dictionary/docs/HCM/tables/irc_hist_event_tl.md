...
id: DOC-HCM-490
doc_type: system-doc
title: "IRC_HIST_EVENT_TL — Eventos Historicos (Traducoes)"
...
Traducoes dos eventos historicos. Tabela `_TL`.
...
- **Internacionalizacao:** Descricoes de eventos traduzidas.
---
...
|---|--------|------|-------|-----------|-----------|-----|-----------|
| 1 | HIST_EVENT_ID | NUMBER(18) | NOT NULL | PK/FK | Evento base | IRC_HIST_EVENT_B | 🟢 90% |
| 2 | LANGUAGE | VARCHAR2(4) | NOT NULL | PK | Idioma | — | 🟢 95% |
| 3 | SOURCE_LANG | VARCHAR2(4) | NOT NULL | Controle | Idioma de origem | — | 🟢 90% |
| 4 | EVENT_DESCRIPTION | VARCHAR2(2000) | NULL | Dados | Descricao traduzida | — | 🟡 75% |
...
- [[irc_hist_event_b]] — via `HIST_EVENT_ID` (registro base do evento historico)
...
```sql
SELECT tl.EVENT_DESCRIPTION FROM IRC_HIST_EVENT_TL tl WHERE tl.LANGUAGE = 'PT';
```
...
- Chave composta: HIST_EVENT_ID + LANGUAGE.
---
