...
id: DOC-HCM-301
doc_type: system-doc
title: "HWM_GRPS_VL — Grupos de Workforce (View Consolidada)"
...
Visão consolidada que combina dados base e traduções dos grupos de workforce management, reunindo informações de agrupamento de trabalhadores para fins de planejamento e gestão de força de trabalho.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | GRPS_ID | NUMBER(18) | NOT NULL | PK | Identificador único do registro | — | 🟢 95% |
...
- [[hwm_grp_type]] — via `GRP_TYPE_CODE` (tipo de grupo de trabalho)

### Tabelas-filha (FK de saída)
- [[hwm_grp_criteria]] — via `GRP_ID` (critérios de grupo)
- [[hwm_grp_members_f]] — via `GRP_ID` (membros do grupo)
...
- [Oracle Docs — HWM_GRPS_VL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_grps_vl.html)
