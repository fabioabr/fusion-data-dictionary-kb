...
- [[per_all_assignments_m]] — via `ASSIGNMENT_ID` (vÃ­nculo do registro de ausÃªncia)
- [[per_absence_attendances]] — via `ABSENCE_ATTENDANCE_ID` (ausÃªncia registrada no vÃ­nculo)
