...
id: DOC-HCM-322
doc_type: system-doc
title: "HWM_RULE_TMPLT_USAGES_TL — Usos de Templates de Regras (Traduções)"
...
Tabela de traduções dos usos de templates de regras, armazenando descrições dos contextos de uso em múltiplos idiomas.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | RULE_TMPLT_USAGES_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | — | 🟢 95% |
...
FROM   HWM_RULE_TMPLT_USAGES_TL t
...
- [Oracle Docs — HWM_RULE_TMPLT_USAGES_TL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_rule_tmplt_usages_tl.html)
