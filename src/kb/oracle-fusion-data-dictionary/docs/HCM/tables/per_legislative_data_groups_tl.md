...
id: DOC-HCM-674
doc_type: system-doc
title: "PER_LEGISLATIVE_DATA_GROUPS_TL — Grupos de Dados Legislativos (Traduções)"
...
aliases:
  ...
  - per_legislative_data_groups_tl
  - per-legislative-data-groups-tl
  - grupos-de-dados-legislativos-(traduções)
...
Armazena as **traduções** dos nomes dos grupos de dados legislativos em múltiplos idiomas.
...
- **Internacionalização** — exibe nomes de LDGs no idioma do usuário.
...
|---|--------|------|-------|-----------|-----------|-----|-----------|
| 1 | LEGISLATIVE_DATA_GROUP_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do LDG | PER_LEGISLATIVE_DATA_GROUPS | 🟢 95% |
...
| 4 | NAME | VARCHAR2(240) | NOT NULL | Tradução | Nome traduzido do LDG | — | 🟢 90% |
...
- [[per_legislative_data_groups]] — via `LEGISLATIVE_DATA_GROUP_ID` (tabela base do grupo de dados legislativos)
...
### LDGs em português
```sql
SELECT tl.LEGISLATIVE_DATA_GROUP_ID, tl.NAME
FROM   PER_LEGISLATIVE_DATA_GROUPS_TL tl
