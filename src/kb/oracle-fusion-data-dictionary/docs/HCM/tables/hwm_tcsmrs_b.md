...
id: DOC-HCM-336
doc_type: system-doc
title: "HWM_TCSMRS_B — Resumos de Cartão de Ponto (Base)"
...
Tabela base que armazena os resumos consolidados de cartões de ponto (time card summaries), agregando informações de horas por período e trabalhador.
...
- [Oracle Docs — HWM_TCSMRS_B](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tcsmrs_b.html)
