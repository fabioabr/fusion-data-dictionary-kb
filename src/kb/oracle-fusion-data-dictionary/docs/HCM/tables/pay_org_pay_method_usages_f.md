...
- [[pay_org_pay_methods_f]] --- via `ORG_PAYMENT_METHOD_ID` (m̩todo de pagamento organizacional utilizado)
- [[pay_all_payrolls_f]] --- via `PAYROLL_ID` (folha de pagamento que usa o m̩todo)
