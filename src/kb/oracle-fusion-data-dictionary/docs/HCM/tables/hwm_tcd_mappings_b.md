...
id: DOC-HCM-330
doc_type: system-doc
title: "HWM_TCD_MAPPINGS_B — Mapeamentos de Time Card (Base)"
...
Tabela base que define os mapeamentos de campos do cartão de ponto para sistemas de destino, especificando como os dados são transformados durante a exportação.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | TCD_MAPPINGS_ID | NUMBER(18) | NOT NULL | PK | Identificador único do registro | — | 🟢 95% |
...
- [[hwm_tcd_mapping_dtls]] — via `MAPPING_ID` (detalhes do mapeamento de tempo)
...
- [Oracle Docs — HWM_TCD_MAPPINGS_B](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tcd_mappings_b.html)
