...
id: DOC-HCM-221
doc_type: system-doc
title: "HRT_BI_CRITICALITY_ITEMS_V — Itens de Criticidade — BI View"
...
View de BI com classificação de **criticidade** de colaboradores.
...
- **Talent Analytics:** Nível de criticidade.
- **Retenção:** Risco e impacto de perda.
...
|---|--------|------|-------|-----------|-----------|-----|-----------|
| 1 | CRITICALITY_ITEM_ID | NUMBER(18) | NOT NULL | PK | Identificador único | — | 🟢 90% |
| 2 | PERSON_ID | NUMBER(18) | NOT NULL | FK | Colaborador | [[per_all_people_f]] | 🟢 90% |
| 3 | CRITICALITY_LEVEL | VARCHAR2(30) | NULL | Classificação | Nível de criticidade | — | 🟡 70% |
| 4 | RISK_OF_LOSS | VARCHAR2(30) | NULL | Classificação | Risco de perda | — | 🟡 65% |
| 5 | IMPACT_OF_LOSS | VARCHAR2(30) | NULL | Classificação | Impacto da perda | — | 🟡 65% |
| 6 | ASSESSMENT_DATE | DATE | NULL | Data | Data da avaliação | — | 🟡 75% |
...
- [[per_all_people_f]] — via `PERSON_ID` (criticidade do colaborador)
...
```sql
SELECT * FROM HRT_BI_CRITICALITY_ITEMS_V WHERE PERSON_ID = :p_person_id;
```
...
### [[criticalityprofileitempvo|CriticalityProfileItemPVO]] (HCM · BICC: 14/95)
