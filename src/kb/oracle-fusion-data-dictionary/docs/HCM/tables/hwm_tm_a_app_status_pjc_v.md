...
id: DOC-HCM-364
doc_type: system-doc
title: "HWM_TM_A_APP_STATUS_PJC_V — Status de Aprovação para Project Costing (View)"
...
View que exibe o status de aprovação de registros de tempo destinados ao módulo de Project Costing, indicando se estão prontos para transferência.
...
FROM   HWM_TM_A_APP_STATUS_PJC_V t
...
|------------------|-----------------|------|
| STATUS_ID | TimeEntryPjcAppStatusId | — |
| STATUS_VALUE | TimeEntryPjcAppStatusValue | ✅ |

### [[historicrptabstimeentrypvo|HistoricRptAbsTimeEntryPVO]] (HCM · BICC: 1/2)

| Coluna da Tabela | Atributo do PVO | BICC |
|------------------|-----------------|------|
| STATUS_ID | TmAtomicPjcApprovalStatusPEOStatusId | — |
| STATUS_VALUE | TmAtomicPjcApprovalStatusPEOStatusValue | ✅ |
...
- [Oracle Docs — HWM_TM_A_APP_STATUS_PJC_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tm_a_app_status_pjc_v.html)
