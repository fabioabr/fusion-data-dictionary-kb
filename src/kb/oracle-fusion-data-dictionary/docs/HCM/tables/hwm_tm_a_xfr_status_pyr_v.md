...
id: DOC-HCM-370
doc_type: system-doc
title: "HWM_TM_A_XFR_STATUS_PYR_V — Status de Transferência para Payroll — Aprovação (View)"
...
View que monitora o status de transferência de registros de tempo aprovados para o módulo de Payroll, rastreando o progresso da integração com folha de pagamento.
...
FROM   HWM_TM_A_XFR_STATUS_PYR_V t
...
- [Oracle Docs — HWM_TM_A_XFR_STATUS_PYR_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tm_a_xfr_status_pyr_v.html)
