...
id: DOC-HCM-220
doc_type: system-doc
title: "HRT_BI_COMPETENCY_ITEMS_V — Itens de Competências — BI View"
...
View de BI com **competências** avaliadas do perfil de talento.
...
- **Talent Analytics:** Competências e proficiência.
- **Perfil de talento:** Níveis de proficiência.
...
|---|--------|------|-------|-----------|-----------|-----|-----------|
| 1 | COMPETENCY_ITEM_ID | NUMBER(18) | NOT NULL | PK | Identificador único | — | 🟢 90% |
| 2 | PERSON_ID | NUMBER(18) | NOT NULL | FK | Colaborador | [[per_all_people_f]] | 🟢 90% |
| 3 | COMPETENCY_NAME | VARCHAR2(240) | NULL | Descrição | Nome da competência | — | 🟡 70% |
| 4 | PROFICIENCY_LEVEL | VARCHAR2(30) | NULL | Classificação | Nível de proficiência | — | 🟡 70% |
| 5 | ASSESSMENT_DATE | DATE | NULL | Data | Data da avaliação | — | 🟡 75% |
| 6 | COMPETENCY_TYPE | VARCHAR2(30) | NULL | Classificação | Tipo (CORE, FUNCTIONAL, LEADERSHIP) | — | 🟡 70% |
...
- [[per_all_people_f]] — via `PERSON_ID` (competencias do colaborador)
...
```sql
SELECT * FROM HRT_BI_COMPETENCY_ITEMS_V WHERE PERSON_ID = :p_person_id;
```
...
### [[competencypvo|CompetencyPVO]] (HCM · BICC: 33/101)
...
| ITEM_NUMBER_1 | ItemNumber1_Modl | — |
| ITEM_NUMBER_10 | ItemNumber10 | — |
| ITEM_NUMBER_2 | ItemNumber2 | ✅ |
| ITEM_NUMBER_2 | ItemNumber2_Modl | — |
