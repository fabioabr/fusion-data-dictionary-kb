...
id: DOC-HCM-252
doc_type: system-doc
title: "HRT_PROFILE_TYPES_TL — Tipos de Perfil de Talento — Traducoes"
...
aliases:
  ...
  - hrt_profile_types_tl
  - hrt-profile-types-tl
  - profile-types-translations
  - tipos-perfil-traducoes
...
Tabela de traducoes que armazena textos em multiplos idiomas para cada registro definido em [[hrt_profile_types_b]].
...
|---|--------|------|-------|-----------|-----------|-----|-----------|
| 1 | PROFILE_TYPE_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | [[hrt_profile_types_b]] | 🟢 100% |
| 2 | LANGUAGE | VARCHAR2(4) | NOT NULL | PK | Codigo do idioma | — | 🟢 100% |
| 3 | SOURCE_LANG | VARCHAR2(4) | NOT NULL | Controle | Idioma de origem | — | 🟢 100% |
| 4 | PROFILE_TYPE_NAME | VARCHAR2(240) | NOT NULL | Dados | Nome/texto traduzido | — | 🟢 100% |
...
- [[hrt_profile_types_b]] — via `PROFILE_TYPE_ID` (registro base do tipo de perfil)
...
```sql
SELECT tl.PROFILE_TYPE_NAME, tl.DESCRIPTION
FROM   HRT_PROFILE_TYPES_TL tl
WHERE  tl.PROFILE_TYPE_ID = :p_id
...
- Sufixo `_TL` indica tabela de traducao — PK composta por (PROFILE_TYPE_ID, LANGUAGE).
- JOIN com [[hrt_profile_types_b]] para dados completos.
