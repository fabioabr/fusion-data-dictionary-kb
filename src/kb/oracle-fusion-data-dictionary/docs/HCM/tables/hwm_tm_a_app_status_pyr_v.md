...
id: DOC-HCM-365
doc_type: system-doc
title: "HWM_TM_A_APP_STATUS_PYR_V — Status de Aprovação para Payroll (View)"
...
View que exibe o status de aprovação de registros de tempo destinados ao módulo de Payroll, controlando o fluxo de aprovação para processamento de folha.
...
FROM   HWM_TM_A_APP_STATUS_PYR_V t
...
- [Oracle Docs — HWM_TM_A_APP_STATUS_PYR_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tm_a_app_status_pyr_v.html)
