...
id: DOC-HCM-354
doc_type: system-doc
title: "HWM_TM_ATRB_FLDS_B — Campos de Atributos de Time Management (Base)"
...
Tabela base que define os campos de atributos configuráveis para o módulo de Time Management, permitindo personalização da interface e dos dados capturados.
...
- [[hwm_tm_atrb_fld_set_cmps]] — via `ATRB_FLD_ID` (composicoes de conjunto de campos de atributo)
...
- [Oracle Docs — HWM_TM_ATRB_FLDS_B](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tm_atrb_flds_b.html)
