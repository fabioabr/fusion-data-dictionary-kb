...
id: DOC-HCM-372
doc_type: system-doc
title: "HWM_TM_D_TM_UI_STATUS_V — Status de UI de Time Management — Detalhes (View)"
...
View que exibe o status detalhado dos registros de tempo na perspectiva da interface do usuário, incluindo estados visuais e ações disponíveis.
...
FROM   HWM_TM_D_TM_UI_STATUS_V t
...
- [Oracle Docs — HWM_TM_D_TM_UI_STATUS_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tm_d_tm_ui_status_v.html)
