...
- [[pay_dir_cards_f]] --- via `DIR_CARD_DEFINITION_ID` (cart̵es criados a partir desta defini̤̣o)
- [[pay_dir_card_comp_defs_f]] --- via `DIR_CARD_DEFINITION_ID` (defini̵̤es de componentes do carṭo)
