...
id: DOC-HCM-671
doc_type: system-doc
title: "PER_JOB_FAMILY_F_TL — Famílias de Cargos (Traduções)"
...
Armazena as **traduções** dos nomes das famílias de cargos em múltiplos idiomas.
...
- **Internacionalização** — exibe famílias no idioma do usuário.
...
|---|--------|------|-------|-----------|-----------|-----|-----------|
| 1 | JOB_FAMILY_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador da família | PER_JOB_FAMILY_F | 🟢 95% |
...
| 4 | JOB_FAMILY_NAME | VARCHAR2(240) | NOT NULL | Tradução | Nome traduzido da família | — | 🟢 90% |
...
### Famílias de cargos em português
```sql
SELECT tl.JOB_FAMILY_ID, tl.JOB_FAMILY_NAME
FROM   PER_JOB_FAMILY_F_TL tl
