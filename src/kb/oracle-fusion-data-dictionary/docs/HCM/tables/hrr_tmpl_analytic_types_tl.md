...
id: DOC-HCM-211
doc_type: system-doc
title: "HRR_TMPL_ANALYTIC_TYPES_TL — Traduções de Tipos Analíticos"
...
Tabela de **traduções** de tipos analíticos de template (base). Padrão Oracle MLS.
...
|---|--------|------|-------|-----------|-----------|-----|-----------|
| 1 | ANALYTIC_TYPE_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador | [[hrr_tmpl_analytic_types_b]] | 🟢 95% |
...
- [[hrr_tmpl_analytic_types_b]] — via `ANALYTIC_TYPE_ID` (registro base do cadastro)
...
FROM   HRR_TMPL_ANALYTIC_TYPES_TL tl
WHERE  tl.ANALYTIC_TYPE_ID = :p_id AND tl.LANGUAGE = USERENV('LANG');
```
...
- Chave primária composta: `ANALYTIC_TYPE_ID` + `LANGUAGE`.
