...
id: DOC-HCM-350
doc_type: system-doc
title: "HWM_TE_VERSION_STATUS_V — Status de Versão de Entrada de Tempo (View)"
...
View que exibe o status atual de cada versão de entrada de tempo, incluindo estados do ciclo de vida (criação, submissão, aprovação).
...
FROM   HWM_TE_VERSION_STATUS_V t
...
- [Oracle Docs — HWM_TE_VERSION_STATUS_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_te_version_status_v.html)
