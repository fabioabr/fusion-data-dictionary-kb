---
id: DOC-HCM-PVO-ProjectExpenditureOrganizationPVO
doc_type: system-doc
title: "ProjectExpenditureOrganizationPVO — PVO Human Capital Management"
...
Disponibiliza organizações classificadas para despesas de projeto, com dados de unidades organizacionais e sets de referência. Suporta alocação de custos por organização.

**Caminho:** `FscmTopModelAM.OrganizationAM.ProjectExpenditureOrganizationPVO`
...
- [[hr_all_organization_units_f|HR_ALL_ORGANIZATION_UNITS_F]] — 18 atributos (4 BICC)
- [[hr_organization_units_f_tl|HR_ORGANIZATION_UNITS_F_TL]] — 13 atributos (3 BICC)
- [[hr_org_unit_classifications_f|HR_ORG_UNIT_CLASSIFICATIONS_F]] — 16 atributos (3 PKs, 5 BICC)
