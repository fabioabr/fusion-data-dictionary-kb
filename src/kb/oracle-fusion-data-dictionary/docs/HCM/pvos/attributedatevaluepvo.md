---
id: DOC-HCM-PVO-AttributeDateValuePVO
doc_type: system-doc
title: "AttributeDateValuePVO — PVO Human Capital Management"
...
Extrai valores de atributos do tipo data no repositorio de tempo (Time Repository). Suporta analise de campos customizados de data em time cards.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.AttributeDateValuePVO`
...
- [[hwm_tm_rep_atrb_date_val_v|HWM_TM_REP_ATRB_DATE_VAL_V]] — 28 atributos (1 PKs, 6 BICC)

---

## ⚙️ Atributos

### [[hwm_tm_rep_atrb_date_val_v|HWM_TM_REP_ATRB_DATE_VAL_V]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | AllowedScope | ALLOWED_SCOPE | — | — |
| 2 | AttributeCategory | ATTRIBUTE_CATEGORY | — | — |
| 3 | AttributeDateValue | ATTRIBUTE_DATE_VALUE | — | ✅ |
| 4 | AttributeGroup | ATTRIBUTE_GROUP | — | — |
| 5 | AttributeName | ATTRIBUTE_NAME | — | ✅ |
