---
id: DOC-HCM-PVO-LocationDetailsTranslationPVO
doc_type: system-doc
title: "LocationDetailsTranslationPVO — PVO Human Capital Management"
...
Extrai traduções de detalhes de localização por idioma e vigência. Suporta exibição multilíngue de nomes e descrições de locais de trabalho.
