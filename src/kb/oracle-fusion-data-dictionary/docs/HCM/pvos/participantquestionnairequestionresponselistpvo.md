---
id: DOC-HCM-PVO-ParticipantQuestionnaireQuestionResponseListPVO
doc_type: system-doc
title: "ParticipantQuestionnaireQuestionResponseListPVO — PVO Human Capital Management"
...
Disponibiliza lista de respostas possíveis para perguntas de questionários com textos traduzidos. Fornece o catálogo de opções para questionários de avaliação e pesquisas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.QuestionnaireAM.ParticipantQuestionnaireQuestionResponseListPVO`
...
- [[hrq_qstn_answers_b|HRQ_QSTN_ANSWERS_B]] — 8 atributos (2 PKs, 3 BICC)
