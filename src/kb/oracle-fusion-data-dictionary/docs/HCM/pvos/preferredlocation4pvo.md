---
id: DOC-HCM-PVO-PreferredLocation4PVO
doc_type: system-doc
title: "PreferredLocation4PVO — PVO Human Capital Management"
...
Extrai a quarta localização preferida do colaborador no perfil de talento. Oferece opções adicionais de mobilidade para alocação de talentos em múltiplas regiões.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PreferredLocation4PVO`
