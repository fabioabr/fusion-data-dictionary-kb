---
id: DOC-HCM-PVO-GoalsCalibRatingPVO_ViewAll
doc_type: system-doc
title: "GoalsCalibRatingPVO_ViewAll — PVO Human Capital Management"
...
Visão completa (sem filtro de segurança) de ratings de metas em calibração. Utilizado por RH para análise global de calibração de objetivos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.GoalsCalibRatingPVO_ViewAll`
