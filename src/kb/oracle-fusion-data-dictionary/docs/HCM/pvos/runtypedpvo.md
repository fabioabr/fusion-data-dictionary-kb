---
id: DOC-HCM-PVO-RunTypeDPVO
doc_type: system-doc
title: "RunTypeDPVO — PVO Human Capital Management"
...
Disponibiliza tipos de execução (run types) da folha de pagamento com vigência e traduções. Define categorias de processamento (regular, suplementar, reversão) no Payroll.
