---
id: DOC-HCM-PVO-ManagerBudgetsPVOViewAll
doc_type: system-doc
title: "ManagerBudgetsPVOViewAll — PVO Human Capital Management"
...
Versão sem restrição de segurança dos orçamentos de compensação por gestor. Permite visão administrativa completa dos budgets do Compensation Workbench para auditoria e consolidação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.CompensationAM.ManagerBudgetsPVOViewAll`
...
- [[cmp_person_budgets_v|CMP_PERSON_BUDGETS_V]] — 47 atributos (1 PKs, 38 BICC)
