---
id: DOC-HCM-PVO-PersonalGoalPVO
doc_type: system-doc
title: "PersonalGoalPVO — PVO Human Capital Management"
...
Extrai metas individuais dos colaboradores, incluindo alinhamento com objetivos organizacionais e métricas de acompanhamento. Suporta gestão de desempenho e OKRs corporativos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmGoalCoreAM.PersonalGoalPVO`
...
- [[hrd_goal_intents|HRD_GOAL_INTENTS]] — 12 atributos
- [[hrd_personal_intents|HRD_PERSONAL_INTENTS]] — 11 atributos
- [[hrg_goals|HRG_GOALS]] — 65 atributos (1 PKs, 20 BICC)
...
- [[hrg_goal_plan_goals|HRG_GOAL_PLAN_GOALS]] — 9 atributos (2 BICC)
- [[hrt_profiles_tl|HRT_PROFILES_TL]] — 12 atributos
