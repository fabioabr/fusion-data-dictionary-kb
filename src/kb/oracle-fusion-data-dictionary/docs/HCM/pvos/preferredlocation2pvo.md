---
id: DOC-HCM-PVO-PreferredLocation2PVO
doc_type: system-doc
title: "PreferredLocation2PVO — PVO Human Capital Management"
...
Extrai a segunda localização preferida do colaborador no perfil de talento, com detalhes e traduções. Complementa a análise de mobilidade geográfica e alocação de talentos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PreferredLocation2PVO`
