---
id: DOC-HCM-PVO-PerformancePotentialBoxSequencePVO_Viewall
doc_type: system-doc
title: "PerformancePotentialBoxSequencePVO_Viewall — PVO Human Capital Management"
...
Versão ViewAll da matriz 9-box (performance x potencial), sem filtros de segurança. Permite extração completa dos dados de posicionamento para analytics de talentos e calibração.
