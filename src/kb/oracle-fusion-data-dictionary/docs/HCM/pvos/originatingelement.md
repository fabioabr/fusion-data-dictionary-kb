---
id: DOC-HCM-PVO-OriginatingElement
doc_type: system-doc
title: "OriginatingElement — PVO Human Capital Management"
...
Extrai tipos de elementos de folha de pagamento (earnings, deductions) com classificação e vigência. Base para configuração e análise de componentes remuneratórios no Payroll.
