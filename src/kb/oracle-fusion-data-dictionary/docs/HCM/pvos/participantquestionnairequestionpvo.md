---
id: DOC-HCM-PVO-ParticipantQuestionnaireQuestionPVO
doc_type: system-doc
title: "ParticipantQuestionnaireQuestionPVO — PVO Human Capital Management"
...
Disponibiliza perguntas de questionários respondidos por participantes, com seções e respostas possíveis. Utilizado em avaliações de desempenho e pesquisas de clima sob visão do respondente.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.QuestionnaireAM.ParticipantQuestionnaireQuestionPVO`
...
- [[hrq_qstnr_participants|HRQ_QSTNR_PARTICIPANTS]] — 11 atributos (2 PKs, 4 BICC)
- [[hrq_qstnr_questions|HRQ_QSTNR_QUESTIONS]] — 17 atributos (2 PKs, 6 BICC)
- [[hrq_qstnr_sections_b|HRQ_QSTNR_SECTIONS_B]] — 17 atributos (2 PKs, 5 BICC)
- [[hrq_qstnr_sections_tl|HRQ_QSTNR_SECTIONS_TL]] — 13 atributos (3 PKs, 5 BICC)
- [[hrq_qstn_answers_b|HRQ_QSTN_ANSWERS_B]] — 3 atributos
- [[hrq_qstn_answers_tl|HRQ_QSTN_ANSWERS_TL]] — 5 atributos
- [[hrq_questionnaires_b|HRQ_QUESTIONNAIRES_B]] — 20 atributos (3 PKs, 5 BICC)
- [[hrq_questionnaires_tl|HRQ_QUESTIONNAIRES_TL]] — 7 atributos (1 BICC)
- [[hrq_questions_b|HRQ_QUESTIONS_B]] — 38 atributos (3 PKs, 10 BICC)
- [[hrq_questions_tl|HRQ_QUESTIONS_TL]] — 18 atributos (4 PKs, 9 BICC)
