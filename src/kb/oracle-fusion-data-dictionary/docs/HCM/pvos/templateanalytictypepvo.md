---
id: DOC-HCM-PVO-TemplateAnalyticTypePVO
doc_type: system-doc
title: "TemplateAnalyticTypePVO — PVO Human Capital Management"
...
Disponibiliza tipos analíticos de templates de calibração com modos de visualização. Configura métricas e dimensões de análise em reuniões de calibração de talentos.
