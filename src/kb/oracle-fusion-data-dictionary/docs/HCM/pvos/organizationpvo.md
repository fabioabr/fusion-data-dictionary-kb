---
id: DOC-HCM-PVO-OrganizationPVO
doc_type: system-doc
title: "OrganizationPVO — PVO Human Capital Management"
...
Consolida unidades organizacionais com classificações, traduções e conjuntos de referência (SetID). Visão central para análise de estrutura organizacional e taxonomia de departamentos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.OrganizationPVO`
...
- [[hr_organization_units_f_tl|HR_ORGANIZATION_UNITS_F_TL]] — 13 atributos (2 BICC)
- [[hr_org_unit_classifications_f|HR_ORG_UNIT_CLASSIFICATIONS_F]] — 16 atributos (1 PKs, 10 BICC)
