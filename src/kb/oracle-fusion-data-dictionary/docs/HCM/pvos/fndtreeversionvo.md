---
id: DOC-HCM-PVO-FndTreeVersionVO
doc_type: system-doc
title: "FndTreeVersionVO — PVO Human Capital Management"
...
Disponibiliza versões de árvore hierárquica Foundation com status de validação. Utilizado para controle de ciclo de vida de hierarquias.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.AnalyticsServiceAM.FndTreeVersionVO`
