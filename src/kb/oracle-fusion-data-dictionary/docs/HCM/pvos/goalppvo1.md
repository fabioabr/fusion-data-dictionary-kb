---
id: DOC-HCM-PVO-GoalPPVO1
doc_type: system-doc
title: "GoalPPVO1 — PVO Human Capital Management"
...
Visão enriquecida de metas com alinhamentos, medições e intenções pessoais de desenvolvimento. Suporta análise integrada de objetivos e aspirações de carreira.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmGoalCoreAM.GoalPPVO1`
...
- [[hrg_goals|HRG_GOALS]] — 65 atributos (1 PKs, 4 BICC)
- [[hrg_goal_alignments|HRG_GOAL_ALIGNMENTS]] — 4 atributos (1 BICC)
- [[hrg_goal_measurements|HRG_GOAL_MEASUREMENTS]] — 27 atributos (8 BICC)
