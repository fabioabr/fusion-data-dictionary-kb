---
id: DOC-HCM-PVO-PerformanceRatingPVOViewAll
doc_type: system-doc
title: "PerformanceRatingPVOViewAll — PVO Human Capital Management"
...
Versão ViewAll das notas de desempenho no ciclo de compensação, sem restrições de segurança. Permite análise consolidada de ratings para planejamento de remuneração variável.
