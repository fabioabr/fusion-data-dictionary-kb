---
id: DOC-HCM-PVO-HNSIncidentActionOwnerPVO
doc_type: system-doc
title: "HNSIncidentActionOwnerPVO — PVO Human Capital Management"
...
Extrai responsáveis (owners) por ações corretivas de incidentes de SST. Utilizado para atribuição e acompanhamento de ações de segurança.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HealthandSafetyAM.HNSIncidentActionOwnerPVO`
