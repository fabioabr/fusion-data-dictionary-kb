---
id: DOC-HCM-PVO-PotentialPVO
doc_type: system-doc
title: "PotentialPVO — PVO Human Capital Management"
...
Extrai avaliações de potencial de carreira dos colaboradores, vinculadas ao perfil de talento e tipos de conteúdo. Suporta análise de talent pool e planos de desenvolvimento.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PotentialPVO`
...
- [[hrt_bi_career_potn_items_v|HRT_BI_CAREER_POTN_ITEMS_V]] — 98 atributos (1 PKs, 92 BICC)
- [[hrt_content_types_b|HRT_CONTENT_TYPES_B]] — 9 atributos (1 PKs, 6 BICC)
- [[hrt_content_types_tl|HRT_CONTENT_TYPES_TL]] — 6 atributos (2 BICC)
- [[hrt_profiles_b|HRT_PROFILES_B]] — 9 atributos (9 BICC)
