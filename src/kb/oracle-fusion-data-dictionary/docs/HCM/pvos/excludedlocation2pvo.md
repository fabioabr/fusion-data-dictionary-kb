---
id: DOC-HCM-PVO-ExcludedLocation2PVO
doc_type: system-doc
title: "ExcludedLocation2PVO — PVO Human Capital Management"
...
Disponibiliza localizações excluídas (nível 2) de perfis de competência, com detalhes e traduções. Utilizado para refinamento de restrições geográficas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.ExcludedLocation2PVO`
