---
id: DOC-HCM-PVO-BoxLabelLookupPVO
doc_type: system-doc
title: "BoxLabelLookupPVO — PVO Human Capital Management"
...
Extrai labels de caixas (box labels) para templates de calibracao de talentos. Suporta configuracao de matrizes 9-box em sessoes de talent review.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.BoxLabelLookupPVO`
