---
id: DOC-HCM-PVO-LocationDetailsTranslationPVOViewAll
doc_type: system-doc
title: "LocationDetailsTranslationPVOViewAll — PVO Human Capital Management"
...
Extrai traduções multilíngues dos detalhes de localização (endereço, características) com vigência temporal. Essencial para relatórios de localidades em múltiplos idiomas no HCM global.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.LocationAM.LocationDetailsTranslationPVOViewAll`
...
- [[per_location_details_f_tl|PER_LOCATION_DETAILS_F_TL]] — 15 atributos (4 PKs, 7 BICC)
- [[per_location_details_f_vl|PER_LOCATION_DETAILS_F_VL]] — 39 atributos (2 BICC)
