---
id: DOC-HCM-PVO-PersonAddressPVO
doc_type: system-doc
title: "PersonAddressPVO — PVO Human Capital Management"
...
Extrai endereços dos colaboradores com vigência temporal (date-effective), tipo de uso e atributos adicionais. Fundamental para compliance trabalhista e comunicações corporativas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.PersonAddressPVO`
...
- [[per_addresses_f|PER_ADDRESSES_F]] — 30 atributos (3 PKs, 27 BICC)
