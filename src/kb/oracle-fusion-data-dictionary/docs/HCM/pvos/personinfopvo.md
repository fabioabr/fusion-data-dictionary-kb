---
id: DOC-HCM-PVO-PersonInfoPVO
doc_type: system-doc
title: "PersonInfoPVO — PVO Human Capital Management"
...
Extrai informações consolidadas do colaborador no contexto de compensação (Compensation Workbench), incluindo salário atual e valores ajustados. Central para o ciclo de revisão salarial.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.CompensationAM.PersonInfoPVO`
