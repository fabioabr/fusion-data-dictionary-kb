---
id: DOC-HCM-PVO-ProfileTypePVO
doc_type: system-doc
title: "ProfileTypePVO — PVO Human Capital Management"
...
Disponibiliza tipos de perfil configurados no Talent Profile, com traduções. Utilizado para categorizar perfis (cargo, pessoa, posição) no framework de competências.
