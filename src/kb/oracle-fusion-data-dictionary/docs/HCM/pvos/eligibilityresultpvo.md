---
id: DOC-HCM-PVO-EligibilityResultPVO
doc_type: system-doc
title: "EligibilityResultPVO — PVO Human Capital Management"
...
Consolida resultados de elegibilidade de performance, cruzando objetos, templates e períodos de avaliação. Utilizado para determinar participação em ciclos de desempenho.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmPerformanceSetupAM.EligibilityResultPVO`
...
- [[ben_elig_obj_f|BEN_ELIG_OBJ_F]] — 14 atributos (3 PKs, 4 BICC)
- [[ben_elig_rslt_f|BEN_ELIG_RSLT_F]] — 20 atributos (4 PKs, 5 BICC)
