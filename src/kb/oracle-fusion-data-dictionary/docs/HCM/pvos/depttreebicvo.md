---
id: DOC-HCM-PVO-DeptTreeBICVO
doc_type: system-doc
title: "DeptTreeBICVO — PVO Human Capital Management"
...
Extrai arvore hierarquica de departamentos com versao, nos e enterprise ID. Suporta visualizacao e navegacao da hierarquia organizacional completa.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.DeptTreeBICVO`
...
- [[per_dept_tree_node_cf|PER_DEPT_TREE_NODE_CF]] — 235 atributos (5 PKs, 6 BICC)
...
### [[per_dept_tree_node_cf|PER_DEPT_TREE_NODE_CF]]
