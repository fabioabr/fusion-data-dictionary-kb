---
id: DOC-HCM-PVO-ContentLibAttachmentPVO
doc_type: system-doc
title: "ContentLibAttachmentPVO — PVO Human Capital Management"
...
Extrai anexos da biblioteca de conteudo de recrutamento com documentos associados. Suporta gestao documental de templates e materiais de recrutamento.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecruitingCommonAM.ContentLibAttachmentPVO`
...
- [[fnd_attached_documents|FND_ATTACHED_DOCUMENTS]] — 153 atributos (1 PKs, 2 BICC)
- [[fnd_documents_vl|FND_DOCUMENTS_VL]] — 31 atributos (2 BICC)
