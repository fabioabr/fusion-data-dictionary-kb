---
id: DOC-HCM-PVO-ImpactOfLossCalibRatingPVO_ViewAll
doc_type: system-doc
title: "ImpactOfLossCalibRatingPVO_ViewAll — PVO Human Capital Management"
...
Visão completa (sem filtro de segurança) de ratings de impacto de perda em calibração. Utilizado por RH para análise global de risco de retenção.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.ImpactOfLossCalibRatingPVO_ViewAll`
