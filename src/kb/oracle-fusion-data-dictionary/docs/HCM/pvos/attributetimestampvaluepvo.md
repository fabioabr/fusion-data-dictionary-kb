---
id: DOC-HCM-PVO-AttributeTimestampValuePVO
doc_type: system-doc
title: "AttributeTimestampValuePVO — PVO Human Capital Management"
...
Extrai valores de timestamp de atributos no repositorio de tempo. Suporta rastreamento de momentos exatos em registros de ponto e horas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.AttributeTimestampValuePVO`
...
- [[hwm_tm_rep_atrb_ts_val_v|HWM_TM_REP_ATRB_TS_VAL_V]] — 28 atributos (1 PKs, 6 BICC)

---

## ⚙️ Atributos

### [[hwm_tm_rep_atrb_ts_val_v|HWM_TM_REP_ATRB_TS_VAL_V]]
...
| 5 | AttributeTimestampValue | ATTRIBUTE_TIMESTAMP_VALUE | — | ✅ |
