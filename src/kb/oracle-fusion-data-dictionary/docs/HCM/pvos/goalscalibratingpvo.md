---
id: DOC-HCM-PVO-GoalsCalibRatingPVO
doc_type: system-doc
title: "GoalsCalibRatingPVO — PVO Human Capital Management"
...
Consolida ratings de metas em sessões de calibração de talentos. Suporta o processo de calibração de performance baseado em atingimento de objetivos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.GoalsCalibRatingPVO`
