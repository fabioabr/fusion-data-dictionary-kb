---
id: DOC-HCM-PVO-SourceDimensionPVO
doc_type: system-doc
title: "SourceDimensionPVO — PVO Human Capital Management"
...
Extrai dimensões de rastreamento de fonte de recrutamento com traduções. Define critérios de análise para origem de candidatos (canal, campanha, referência).
