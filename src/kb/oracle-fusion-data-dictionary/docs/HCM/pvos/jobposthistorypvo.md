---
id: DOC-HCM-PVO-JobPostHistoryPVO
doc_type: system-doc
title: "JobPostHistoryPVO — PVO Human Capital Management"
...
Consolida histórico de publicações de vagas com parceiros, resultados e requisições. Suporta análise de efetividade de canais de recrutamento.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecJobDistributionAM.JobPostHistoryPVO`
...
- [[irc_jd_req_post_results|IRC_JD_REQ_POST_RESULTS]] — 15 atributos (12 BICC)
