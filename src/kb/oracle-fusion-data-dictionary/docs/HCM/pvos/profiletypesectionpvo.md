---
id: DOC-HCM-PVO-ProfileTypeSectionPVO
doc_type: system-doc
title: "ProfileTypeSectionPVO — PVO Human Capital Management"
...
Extrai seções configuradas por tipo de perfil, com nomes traduzidos. Define a estrutura de dados (competências, educação, certificações) dentro de cada tipo de perfil.
