---
id: DOC-HCM-PVO-PreferredLocation1PVO_Viewall
doc_type: system-doc
title: "PreferredLocation1PVO_Viewall — PVO Human Capital Management"
...
Versão ViewAll da primeira localização preferida, sem filtros de segurança. Permite extração completa de preferências de localidade para analytics de mobilidade.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PreferredLocation1PVO_Viewall`
