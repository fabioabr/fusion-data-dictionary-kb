---
id: DOC-HCM-PVO-PersonNationalIdentifierPVO
doc_type: system-doc
title: "PersonNationalIdentifierPVO — PVO Human Capital Management"
...
Extrai documentos de identificação nacional dos colaboradores (CPF, RG, passaporte, etc.). Essencial para compliance trabalhista, eSocial e validações cadastrais.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.PersonNationalIdentifierPVO`
...
- [[per_national_identifiers|PER_NATIONAL_IDENTIFIERS]] — 15 atributos (1 PKs, 15 BICC)
...
| 4 | PersonDetailsPEOPrimaryNidId | PRIMARY_NID_ID | — | — |
