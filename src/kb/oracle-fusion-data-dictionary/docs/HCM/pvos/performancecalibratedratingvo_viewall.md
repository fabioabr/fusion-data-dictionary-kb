---
id: DOC-HCM-PVO-PerformanceCalibratedRatingVO_ViewAll
doc_type: system-doc
title: "PerformanceCalibratedRatingVO_ViewAll — PVO Human Capital Management"
...
Versão sem restrição de segurança dos ratings calibrados de desempenho. Permite visão administrativa completa para auditoria e consolidação de resultados de calibração de talentos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.PerformanceCalibratedRatingVO_ViewAll`
