---
id: DOC-HCM-PVO-PartnerProvisionPVO
doc_type: system-doc
title: "PartnerProvisionPVO — PVO Human Capital Management"
...
Disponibiliza provisionamentos de parceiros de recrutamento com categorias e status de integração. Permite controle de ativação e configuração de canais de publicação de vagas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecJobDistributionAM.PartnerProvisionPVO`
...
- [[irc_tp_partner_provisngs|IRC_TP_PARTNER_PROVISNGS]] — 11 atributos (1 PKs, 9 BICC)
