---
id: DOC-HCM-PVO-RatingLevelFirstLangPVO
doc_type: system-doc
title: "RatingLevelFirstLangPVO — PVO Human Capital Management"
...
Extrai níveis de avaliação (rating levels) com códigos e valores numéricos. Define a escala de proficiência utilizada em competências e avaliações de desempenho.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileContentLibraryAM.RatingLevelFirstLangPVO`
...
- [[hrt_rating_levels_tl|HRT_RATING_LEVELS_TL]] — 8 atributos (3 BICC)
