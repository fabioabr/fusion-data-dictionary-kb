---
id: DOC-HCM-PVO-PerformanceRatingPVO
doc_type: system-doc
title: "PerformanceRatingPVO — PVO Human Capital Management"
...
Extrai as notas de desempenho dos colaboradores no ciclo de compensação (Compensation Workbench). Vincula ratings a assignments para suportar decisões de mérito e bônus.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.CompensationAM.PerformanceRatingPVO`
