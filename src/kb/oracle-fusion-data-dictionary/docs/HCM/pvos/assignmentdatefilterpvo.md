---
id: DOC-HCM-PVO-AssignmentDateFilterPVO
doc_type: system-doc
title: "AssignmentDateFilterPVO — PVO Human Capital Management"
...
Disponibiliza assignments com filtro por data efetiva e steps de grade. Utilizado para consultas temporais de alocacoes e progressao salarial.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.AssignmentAM.AssignmentDateFilterPVO`
...
- [[per_all_assignments_m|PER_ALL_ASSIGNMENTS_M]] — 122 atributos (5 PKs, 6 BICC)
