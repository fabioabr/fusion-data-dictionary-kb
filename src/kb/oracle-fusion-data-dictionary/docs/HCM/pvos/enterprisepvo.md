---
id: DOC-HCM-PVO-EnterprisePVO
doc_type: system-doc
title: "EnterprisePVO — PVO Human Capital Management"
...
Disponibiliza dados da empresa (enterprise) com unidades organizacionais, classificações e set IDs. Fundamental para estrutura corporativa e segmentação multi-empresa.

**Caminho:** `FscmTopModelAM.OrganizationAM.EnterprisePVO`
...
- [[hr_organization_units_f_tl|HR_ORGANIZATION_UNITS_F_TL]] — 13 atributos (1 PKs, 8 BICC)
