---
id: DOC-HCM-PVO-RatingLevelThirdPVO
doc_type: system-doc
title: "RatingLevelThirdPVO — PVO Human Capital Management"
...
Disponibiliza terceiro conjunto de níveis de avaliação com traduções. Suporta configurações com múltiplas dimensões de proficiência no Talent Profile.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileContentLibraryAM.RatingLevelThirdPVO`
