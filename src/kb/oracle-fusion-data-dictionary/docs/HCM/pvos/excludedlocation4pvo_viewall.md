---
id: DOC-HCM-PVO-ExcludedLocation4PVO_Viewall
doc_type: system-doc
title: "ExcludedLocation4PVO_Viewall — PVO Human Capital Management"
...
Visão completa (sem filtro de segurança) de localizações excluídas nível 4 de perfis. Utilizado em relatórios analíticos de restrições geográficas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.ExcludedLocation4PVO_Viewall`
