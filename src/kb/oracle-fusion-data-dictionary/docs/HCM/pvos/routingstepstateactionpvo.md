---
id: DOC-HCM-PVO-RoutingStepStateActionPVO
doc_type: system-doc
title: "RoutingStepStateActionPVO — PVO Human Capital Management"
...
Extrai ações vinculadas a estados de etapas de roteamento no recrutamento. Define gatilhos automáticos por mudança de estado no ciclo de contratação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecProcessLifecycleAM.RoutingStepStateActionPVO`
