---
id: DOC-HCM-PVO-TalentScoreCalibRatingPVO
doc_type: system-doc
title: "TalentScoreCalibRatingPVO — PVO Human Capital Management"
...
Extrai avaliações de talent score em reuniões de calibração. Suporta ajuste coletivo de classificações de desempenho e potencial por gestores.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.TalentScoreCalibRatingPVO`
