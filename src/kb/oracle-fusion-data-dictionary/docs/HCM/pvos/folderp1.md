---
id: DOC-HCM-PVO-FolderP1
doc_type: system-doc
title: "FolderP1 — PVO Human Capital Management"
...
Extrai pastas/categorias da biblioteca de questionários HCM. Utilizado para organização e classificação de questionários de RH.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.QuestionnaireLibraryAM.FolderP1`
...
- [[hrq_categories_b|HRQ_CATEGORIES_B]] — 4 atributos (2 PKs, 4 BICC)
- [[hrq_categories_tl|HRQ_CATEGORIES_TL]] — 5 atributos (2 BICC)
