---
id: DOC-HCM-PVO-ParticipantQuestionnaireQuestionResponsePVO
doc_type: system-doc
title: "ParticipantQuestionnaireQuestionResponsePVO — PVO Human Capital Management"
...
Extrai respostas efetivas de participantes a perguntas de questionários com scores e textos CLOB. Permite análise quantitativa e qualitativa de avaliações e pesquisas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.QuestionnaireAM.ParticipantQuestionnaireQuestionResponsePVO`
...
- [[hrq_all_qstn_responses_v|HRQ_ALL_QSTN_RESPONSES_V]] — 8 atributos (4 PKs, 8 BICC)
- [[hrq_qstnr_participants|HRQ_QSTNR_PARTICIPANTS]] — 16 atributos (2 PKs, 4 BICC)
- [[hrq_qstnr_responses|HRQ_QSTNR_RESPONSES]] — 15 atributos (2 PKs, 9 BICC)
- [[hrq_qstn_responses|HRQ_QSTN_RESPONSES]] — 17 atributos (3 BICC)
