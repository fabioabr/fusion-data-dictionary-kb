---
id: DOC-HCM-PVO-GoalStatusOverviewPVO
doc_type: system-doc
title: "GoalStatusOverviewPVO — PVO Human Capital Management"
...
Visão consolidada de status de metas com planos, medições e planos set. Suporta dashboards gerenciais de acompanhamento de objetivos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmGoalCoreAM.GoalStatusOverviewPVO`
