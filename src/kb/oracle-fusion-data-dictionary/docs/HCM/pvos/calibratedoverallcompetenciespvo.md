---
id: DOC-HCM-PVO-CalibratedOverallCompetenciesPVO
doc_type: system-doc
title: "CalibratedOverallCompetenciesPVO — PVO Human Capital Management"
...
Extrai competencias calibradas agregadas por perfil de talento. Suporta analise pos-calibracao de competencias em processos de talent review.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.CalibratedOverallCompetenciesPVO`
...
- [[hrt_content_types_b|HRT_CONTENT_TYPES_B]] — 14 atributos (2 PKs, 3 BICC)
...
|---|----------|--------|----|------|
| 1 | CTypeBPEO1BusinessGroupId | BUSINESS_GROUP_ID | — | — |
| 2 | CTypeBPEO1ContentTypeId | CONTENT_TYPE_ID | — | — |
| 3 | CTypeBPEO1ContextName | CONTEXT_NAME | — | — |
| 4 | CTypeBPEOBusinessGroupId | BUSINESS_GROUP_ID | 🔑 | ✅ |
| 5 | CTypeBPEOContentTypeId | CONTENT_TYPE_ID | 🔑 | ✅ |
| 6 | CTypeBPEOContextName | CONTEXT_NAME | — | — |
| 7 | CTypeBPEOCreatedBy | CREATED_BY | — | — |
| 8 | CTypeBPEOCreationDate | CREATION_DATE | — | — |
| 9 | CTypeBPEOFreeFormFlag | FREE_FORM_FLAG | — | — |
| 10 | CTypeBPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 11 | CTypeBPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 12 | CTypeBPEOLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 13 | CTypeBPEOModuleId | MODULE_ID | — | — |
| 14 | CTypeBPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
