---
id: DOC-HCM-PVO-AttributeVarcharValuePVO
doc_type: system-doc
title: "AttributeVarcharValuePVO — PVO Human Capital Management"
...
Extrai valores texto (varchar) de atributos no repositorio de tempo. Permite analise de campos descritivos customizados em time cards.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.AttributeVarcharValuePVO`
...
- [[hwm_tm_rep_atrb_varchar_val_v|HWM_TM_REP_ATRB_VARCHAR_VAL_V]] — 28 atributos (1 PKs, 6 BICC)

---

## ⚙️ Atributos

### [[hwm_tm_rep_atrb_varchar_val_v|HWM_TM_REP_ATRB_VARCHAR_VAL_V]]
