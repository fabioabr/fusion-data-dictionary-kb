---
id: DOC-HCM-PVO-RptAbsTimeEntryPVO
doc_type: system-doc
title: "RptAbsTimeEntryPVO — PVO Human Capital Management"
...
Extrai entradas de tempo e ausências reportadas com múltiplos status de aprovação. Visão consolidada para análise de horas trabalhadas e absenteísmo.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.RptAbsTimeEntryPVO`
