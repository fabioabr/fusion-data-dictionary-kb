---
id: DOC-HCM-PVO-PotentialRatingLevelPVO
doc_type: system-doc
title: "PotentialRatingLevelPVO — PVO Human Capital Management"
...
Extrai os níveis de rating de potencial configurados por tipo de conteúdo e seção de perfil. Dimensão de referência para padronização das escalas de avaliação de potencial.
