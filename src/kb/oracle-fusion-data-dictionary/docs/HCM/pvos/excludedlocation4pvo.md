---
id: DOC-HCM-PVO-ExcludedLocation4PVO
doc_type: system-doc
title: "ExcludedLocation4PVO — PVO Human Capital Management"
...
Disponibiliza localizações excluídas (nível 4) de perfis de competência. Nível mais granular de restrição geográfica para perfis de talento.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.ExcludedLocation4PVO`
