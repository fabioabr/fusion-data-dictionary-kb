---
id: DOC-HCM-PVO-PersonLegislativeInfoPVOViewAll
doc_type: system-doc
title: "PersonLegislativeInfoPVOViewAll — PVO Human Capital Management"
...
Versão ViewAll das informações legislativas da pessoa, sem filtros de segurança. Inclui nível educacional e dados regulatórios para extração completa em analytics.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.PersonLegislativeInfoPVOViewAll`
...
- [[per_people_legislative_f|PER_PEOPLE_LEGISLATIVE_F]] — 148 atributos (3 PKs, 13 BICC)
