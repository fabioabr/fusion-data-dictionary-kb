---
id: DOC-HCM-PVO-RiskPVO
doc_type: system-doc
title: "RiskPVO — PVO Human Capital Management"
...
Disponibiliza itens de risco em perfis de talento com tipos de conteúdo e seções. Suporta avaliação de riscos associados a competências e perfis de colaboradores.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.RiskPVO`
