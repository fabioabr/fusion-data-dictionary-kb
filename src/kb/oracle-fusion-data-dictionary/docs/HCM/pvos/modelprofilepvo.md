---
id: DOC-HCM-PVO-ModelProfilePVO
doc_type: system-doc
title: "ModelProfilePVO — PVO Human Capital Management"
...
Disponibiliza perfis de modelo com tipos, relações e traduções para planejamento de talentos. Utilizado na definição de requisitos de competências para cenários de workforce modeling.
