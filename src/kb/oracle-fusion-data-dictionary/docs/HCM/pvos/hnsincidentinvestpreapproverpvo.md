---
id: DOC-HCM-PVO-HNSIncidentInvestPreApproverPVO
doc_type: system-doc
title: "HNSIncidentInvestPreApproverPVO — PVO Human Capital Management"
...
Extrai pré-aprovadores de investigações de incidentes de SST. Utilizado para workflow de pré-aprovação de investigações de segurança.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HealthandSafetyAM.HNSIncidentInvestPreApproverPVO`
