---
id: DOC-HCM-PVO-MembershipContentItemPVO
doc_type: system-doc
title: "MembershipContentItemPVO — PVO Human Capital Management"
...
Disponibiliza itens de conteúdo da biblioteca de perfis (competências, habilidades, qualificações) com traduções. Utilizado como catálogo de referência para composição de perfis de cargo e pessoa.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileContentLibraryAM.MembershipContentItemPVO`
