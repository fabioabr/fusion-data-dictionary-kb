---
id: DOC-HCM-PVO-JobPostHistoryViewAllPVO
doc_type: system-doc
title: "JobPostHistoryViewAllPVO — PVO Human Capital Management"
...
Visão completa (sem filtro de segurança) do histórico de publicações de vagas. Utilizado em relatórios analíticos de distribuição de vagas.
