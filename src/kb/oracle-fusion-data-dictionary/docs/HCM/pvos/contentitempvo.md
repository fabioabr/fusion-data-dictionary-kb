---
id: DOC-HCM-PVO-ContentItemPVO
doc_type: system-doc
title: "ContentItemPVO — PVO Human Capital Management"
...
Cataloga itens de conteudo da biblioteca de perfis (competencias, certificacoes, etc.). Referencia central para o modelo de conteudo de talent management.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileContentLibraryAM.ContentItemPVO`
...
- [[hrt_content_items_b|HRT_CONTENT_ITEMS_B]] — 65 atributos (2 PKs, 15 BICC)
- [[hrt_content_items_tl|HRT_CONTENT_ITEMS_TL]] — 23 atributos (1 PKs, 7 BICC)
