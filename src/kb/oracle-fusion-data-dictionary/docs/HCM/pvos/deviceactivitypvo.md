---
id: DOC-HCM-PVO-DeviceActivityPVO
doc_type: system-doc
title: "DeviceActivityPVO — PVO Human Capital Management"
...
Consolida registros de atividade de dispositivos de ponto eletrônico, incluindo dados do colaborador. Suporta gestão de frequência e controle de jornada de trabalho.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.DeviceActivityPVO`
...
- [[hwm_tm_rec|HWM_TM_REC]] — 33 atributos (2 PKs, 10 BICC)
