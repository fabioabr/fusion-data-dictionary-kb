---
id: DOC-HCM-PVO-RequisitionHiringManagerPVO
doc_type: system-doc
title: "RequisitionHiringManagerPVO — PVO Human Capital Management"
...
Disponibiliza gerentes de contratação vinculados a requisições de recrutamento. Fundamental para governança e aprovações no fluxo de contratação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecruitingCommonAM.RequisitionHiringManagerPVO`
