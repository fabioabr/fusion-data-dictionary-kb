---
id: DOC-HCM-PVO-GenericProfilePVO
doc_type: system-doc
title: "GenericProfilePVO — PVO Human Capital Management"
...
Consolida perfis genéricos de talento com itens de perfil e tipos de conteúdo. Fundamental para gestão de competências, habilidades e qualificações.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.GenericProfilePVO`
...
- [[hrt_content_types_b|HRT_CONTENT_TYPES_B]] — 8 atributos
- [[hrt_content_types_tl|HRT_CONTENT_TYPES_TL]] — 6 atributos
- [[hrt_profiles_b|HRT_PROFILES_B]] — 14 atributos (1 PKs, 2 BICC)
- [[hrt_profiles_tl|HRT_PROFILES_TL]] — 7 atributos
- [[hrt_profile_items|HRT_PROFILE_ITEMS]] — 95 atributos (1 PKs, 2 BICC)
- [[hrt_profile_typ_sections_vl|HRT_PROFILE_TYP_SECTIONS_VL]] — 7 atributos
