---
id: DOC-HCM-PVO-PerformanceDocumentsPVO
doc_type: system-doc
title: "PerformanceDocumentsPVO — PVO Human Capital Management"
...
Extrai documentos de avaliação de desempenho com templates e períodos de avaliação. Visão central para monitoramento de status e cobertura do processo de performance management.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmPerformanceDocsAM.PerformanceDocumentsPVO`
...
- [[hra_tmpl_defns_b|HRA_TMPL_DEFNS_B]] — 16 atributos
- [[hra_tmpl_periods_b|HRA_TMPL_PERIODS_B]] — 12 atributos
