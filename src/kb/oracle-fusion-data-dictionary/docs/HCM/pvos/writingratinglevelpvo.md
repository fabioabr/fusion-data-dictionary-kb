---
id: DOC-HCM-PVO-WritingRatingLevelPVO
doc_type: system-doc
title: "WritingRatingLevelPVO — PVO Human Capital Management"
...
Extrai níveis de avaliação de escrita (idiomas) vinculados a conteúdos e perfis. Suporta avaliação de proficiência linguística escrita no Talent Profile.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileSetupAM.WritingRatingLevelPVO`
