---
id: DOC-HCM-PVO-OptionPVO
doc_type: system-doc
title: "OptionPVO — PVO Human Capital Management"
...
Extrai opções de planos de benefícios com vigência temporal, incluindo nome da operadora e motivo do componente. Base para configuração e análise de coberturas no módulo Benefits.
