---
id: DOC-HCM-PVO-PersonNamePVO
doc_type: system-doc
title: "PersonNamePVO — PVO Human Capital Management"
...
Extrai nomes dos colaboradores vinculados a detalhes de pessoa e usuário do sistema, com número funcional. Serve como view consolidada de identificação do colaborador.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.PersonNamePVO`
...
- [[per_all_people_f|PER_ALL_PEOPLE_F]] — 5 atributos (3 BICC)
- [[per_persons|PER_PERSONS]] — 2 atributos (2 BICC)
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 58 atributos (3 PKs, 57 BICC)
