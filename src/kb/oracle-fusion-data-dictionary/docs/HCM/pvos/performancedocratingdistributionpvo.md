---
id: DOC-HCM-PVO-PerformanceDocRatingDistributionPVO
doc_type: system-doc
title: "PerformanceDocRatingDistributionPVO — PVO Human Capital Management"
...
Extrai distribuição de ratings por seção de documentos de desempenho com períodos de avaliação. Suporta análise de curva forçada e distribuição estatística de notas de performance.
