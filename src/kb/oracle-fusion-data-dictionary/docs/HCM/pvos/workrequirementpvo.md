---
id: DOC-HCM-PVO-WorkRequirementPVO
doc_type: system-doc
title: "WorkRequirementPVO — PVO Human Capital Management"
...
Extrai requisitos de trabalho em perfis de talento com importância e tipos de conteúdo. Mapeia preferências e exigências profissionais para matching de posições.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.WorkRequirementPVO`
...
- [[hrt_profile_typ_sections_vl|HRT_PROFILE_TYP_SECTIONS_VL]] — 5 atributos (3 BICC)
