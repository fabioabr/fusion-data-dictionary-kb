---
id: DOC-HCM-PVO-ExcludedLocation2PVO_Viewall
doc_type: system-doc
title: "ExcludedLocation2PVO_Viewall — PVO Human Capital Management"
...
Visão completa (sem filtro de segurança) de localizações excluídas nível 2 de perfis. Utilizado em relatórios analíticos de restrições geográficas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.ExcludedLocation2PVO_Viewall`
