---
id: DOC-HCM-PVO-PhonesPVO
doc_type: system-doc
title: "PhonesPVO — PVO Human Capital Management"
...
Extrai números de telefone dos colaboradores com código de área e país, vinculados ao cadastro de pessoa. Utilizado para diretórios corporativos e canais de comunicação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.PhonesPVO`
...
- [[per_phones|PER_PHONES]] — 20 atributos (1 PKs, 17 BICC)
