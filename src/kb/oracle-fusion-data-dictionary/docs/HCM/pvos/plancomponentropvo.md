---
id: DOC-HCM-PVO-PlanComponentROPVO
doc_type: system-doc
title: "PlanComponentROPVO — PVO Human Capital Management"
...
Extrai visão somente-leitura dos componentes de plano de incentivos, com expressões, fórmulas e tipos de intervalo. Suporta consultas analíticas sobre a estrutura de compensação variável.

**Caminho:** `FscmTopModelAM.CompensationPlanAM.PlanComponentROPVO`
