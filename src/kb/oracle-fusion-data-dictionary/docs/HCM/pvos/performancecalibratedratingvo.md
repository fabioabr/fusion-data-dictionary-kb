---
id: DOC-HCM-PVO-PerformanceCalibratedRatingVO
doc_type: system-doc
title: "PerformanceCalibratedRatingVO — PVO Human Capital Management"
...
Extrai ratings calibrados de desempenho a partir de reuniões de Talent Review com dashboards e métricas. Suporta análise de ajustes pós-calibração nas avaliações de performance.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.PerformanceCalibratedRatingVO`
