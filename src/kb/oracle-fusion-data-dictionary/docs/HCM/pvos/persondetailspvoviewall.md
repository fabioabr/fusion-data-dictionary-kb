---
id: DOC-HCM-PVO-PersonDetailsPVOViewAll
doc_type: system-doc
title: "PersonDetailsPVOViewAll — PVO Human Capital Management"
...
Versão ViewAll dos detalhes cadastrais da pessoa, sem restrições de segurança. Permite extração irrestrita de dados pessoais básicos para carga em data warehouse.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.PersonDetailsPVOViewAll`
...
- [[per_all_people_f|PER_ALL_PEOPLE_F]] — 19 atributos (3 PKs, 14 BICC)
