---
id: DOC-HCM-PVO-PassportsPVO
doc_type: system-doc
title: "PassportsPVO — PVO Human Capital Management"
...
Disponibiliza dados de passaportes de colaboradores incluindo data de expiração. Suporta gestão de documentos de viagem e controle de validade para mobilidade internacional.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.PassportsPVO`
