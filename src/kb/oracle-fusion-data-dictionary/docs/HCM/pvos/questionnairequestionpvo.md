---
id: DOC-HCM-PVO-QuestionnaireQuestionPVO
doc_type: system-doc
title: "QuestionnaireQuestionPVO — PVO Human Capital Management"
...
Disponibiliza perguntas de questionários com seções, respostas e tipos de pergunta. Fundamental para configuração e aplicação de avaliações e pesquisas organizacionais.
