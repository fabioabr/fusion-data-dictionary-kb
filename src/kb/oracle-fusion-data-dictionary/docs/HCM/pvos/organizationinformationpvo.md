---
id: DOC-HCM-PVO-OrganizationInformationPVO
doc_type: system-doc
title: "OrganizationInformationPVO — PVO Human Capital Management"
...
Disponibiliza informações complementares de organizações (DFFs, classificações, parâmetros) com vigência temporal. Permite acesso a atributos flexíveis e configurações específicas por unidade organizacional.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.OrganizationInformationPVO`
...
- [[hr_organization_information_f|HR_ORGANIZATION_INFORMATION_F]] — 79 atributos (2 PKs, 75 BICC)
