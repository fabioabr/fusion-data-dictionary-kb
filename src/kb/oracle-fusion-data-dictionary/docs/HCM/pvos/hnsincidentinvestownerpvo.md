---
id: DOC-HCM-PVO-HNSIncidentInvestOwnerPVO
doc_type: system-doc
title: "HNSIncidentInvestOwnerPVO — PVO Human Capital Management"
...
Extrai responsáveis por investigações de incidentes de SST. Utilizado para atribuição e acompanhamento de processos investigativos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HealthandSafetyAM.HNSIncidentInvestOwnerPVO`
