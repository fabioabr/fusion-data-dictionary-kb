---
id: DOC-HCM-PVO-AssignmentPVOEffectiveLatestChange
doc_type: system-doc
title: "AssignmentPVOEffectiveLatestChange — PVO Human Capital Management"
...
Filtra assignments pela ultima alteracao efetiva com status e tipo. Otimizado para identificar mudancas mais recentes em alocacoes de workforce.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.AssignmentAM.AssignmentPVOEffectiveLatestChange`
...
- [[per_all_assignments_m|PER_ALL_ASSIGNMENTS_M]] — 122 atributos (5 PKs, 13 BICC)
