---
id: DOC-HCM-PVO-GlobalPersonPVOViewAll
doc_type: system-doc
title: "GlobalPersonPVOViewAll — PVO Human Capital Management"
...
Visão completa (sem filtro de segurança) do colaborador global com dados consolidados. Utilizado para relatórios administrativos e integrações de workforce.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.GlobalPersonPVOViewAll`
...
- [[hr_all_organization_units_f|HR_ALL_ORGANIZATION_UNITS_F]] — 22 atributos (5 BICC)
- [[hr_all_positions_f|HR_ALL_POSITIONS_F]] — 149 atributos (9 BICC)
- [[hr_all_positions_f_tl|HR_ALL_POSITIONS_F_TL]] — 12 atributos (3 BICC)
- [[hr_organization_information_f|HR_ORGANIZATION_INFORMATION_F]] — 18 atributos (12 BICC)
- [[hr_organization_units_f_tl|HR_ORGANIZATION_UNITS_F_TL]] — 6 atributos (3 BICC)
- [[per_addresses_f|PER_ADDRESSES_F]] — 24 atributos (16 BICC)
- [[per_all_assignments_m|PER_ALL_ASSIGNMENTS_M]] — 128 atributos (70 BICC)
- [[per_all_people_f|PER_ALL_PEOPLE_F]] — 24 atributos (9 BICC)
...
- [[per_assignment_supervisors_f|PER_ASSIGNMENT_SUPERVISORS_F]] — 19 atributos (6 BICC)
- [[per_email_addresses|PER_EMAIL_ADDRESSES]] — 21 atributos (6 BICC)
- [[per_grade_ladders_f|PER_GRADE_LADDERS_F]] — 4 atributos (2 BICC)
- [[per_grade_ladders_f_tl|PER_GRADE_LADDERS_F_TL]] — 6 atributos (3 BICC)
- [[per_jobs_f|PER_JOBS_F]] — 29 atributos (5 BICC)
- [[per_jobs_f_tl|PER_JOBS_F_TL]] — 6 atributos (3 BICC)
- [[per_location_details_f|PER_LOCATION_DETAILS_F]] — 5 atributos
- [[per_location_details_f_vl|PER_LOCATION_DETAILS_F_VL]] — 5 atributos (3 BICC)
- [[per_national_identifiers|PER_NATIONAL_IDENTIFIERS]] — 3 atributos (2 BICC)
- [[per_periods_of_service|PER_PERIODS_OF_SERVICE]] — 9 atributos (7 BICC)
- [[per_persons|PER_PERSONS]] — 18 atributos (1 PKs, 15 BICC)
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 53 atributos (32 BICC)
- [[per_person_types_tl|PER_PERSON_TYPES_TL]] — 4 atributos (2 BICC)
- [[per_phones|PER_PHONES]] — 26 atributos (8 BICC)
- [[per_users|PER_USERS]] — 42 atributos (6 BICC)
- [[per_working_hour_patterns_f|PER_WORKING_HOUR_PATTERNS_F]] — 82 atributos (28 BICC)
