---
id: DOC-OTHER-PVO-SubledgerApplicationPVO
doc_type: system-doc
title: "SubledgerApplicationPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Subledger Application. Acessa as tabelas: XLA_SUBLEDGERS, XLA_SUBLEDGERS_TL.

**Caminho:** `FscmTopModelAM.FinXlaAmsEventModelsAM.SubledgerApplicationPVO`
...
- [[xla_subledgers|XLA_SUBLEDGERS]] — 19 atributos (1 PKs, 3 BICC)
- [[xla_subledgers_tl|XLA_SUBLEDGERS_TL]] — 11 atributos (1 BICC)
