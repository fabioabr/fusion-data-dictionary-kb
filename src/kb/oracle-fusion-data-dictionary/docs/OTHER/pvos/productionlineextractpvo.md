---
id: DOC-OTHER-PVO-ProductionLineExtractPVO
doc_type: system-doc
title: "ProductionLineExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Production Line Extract. Acessa as tabelas: WIS_PRODUCTION_LINES_VL.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.ProductionLineExtractPVO`
...
- [[wis_production_lines_vl|WIS_PRODUCTION_LINES_VL]] — 54 atributos (54 BICC)

---

## ⚙️ Atributos

### [[wis_production_lines_vl|WIS_PRODUCTION_LINES_VL]]
...
| 48 | LineRate | LINE_RATE | — | ✅ |
| 49 | ObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 50 | OrganizationId | ORGANIZATION_ID | — | ✅ |
| 51 | ProductionLineCode | PRODUCTION_LINE_CODE | — | ✅ |
| 52 | ProductionLineDescription | PRODUCTION_LINE_DESCRIPTION | — | ✅ |
| 53 | ProductionLineId | PRODUCTION_LINE_ID | — | ✅ |
| 54 | ProductionLineName | PRODUCTION_LINE_NAME | — | ✅ |
