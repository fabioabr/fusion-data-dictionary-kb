---
id: DOC-OTHER-PVO-Project
doc_type: system-doc
title: "Project — PVO Cross-Module"
...
View Object para extração BICC de dados de Project. Acessa as tabelas: FND_CURRENCIES_VL, FND_SETID_SETS_VL, GL_DAILY_CONVERSION_TYPES (+21).

**Caminho:** `FscmTopModelAM.PjfProjectAM.Project`
...
- [[hr_organization_information_f|HR_ORGANIZATION_INFORMATION_F]] — 4 atributos (2 BICC)
...
- [[pjf_latestprojectmanager_v|PJF_LATESTPROJECTMANAGER_V]] — 4 atributos (2 BICC)
- [[pjf_projects_all_b|PJF_PROJECTS_ALL_B]] — 92 atributos (1 PKs, 40 BICC)
