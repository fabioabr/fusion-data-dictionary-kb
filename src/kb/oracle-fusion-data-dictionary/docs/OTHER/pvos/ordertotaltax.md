---
id: DOC-OTHER-PVO-OrderTotalTax
doc_type: system-doc
title: "OrderTotalTax — PVO Cross-Module"
...
View Object para extração BICC de dados de Order Total Tax. Acessa as tabelas: DOO_HEADERS_ALL, DOO_ORDER_TOTALS, FUN_ALL_BUSINESS_UNITS_V (+1).

**Caminho:** `FscmTopModelAM.DooTopAM.OrderTotalTax`
