---
id: DOC-OTHER-PVO-ClassificationRuleHierarchyCF
doc_type: system-doc
title: "ClassificationRuleHierarchyCF — PVO Cross-Module"
...
View Object para extração BICC de dados de Classification Rule Hierarchy CF. Acessa as tabelas: CN_RS_DENORM_RULES_ALL, CN_RS_RULES_ALL_B, CN_RS_RULES_ALL_TL (+2).

**Caminho:** `FscmTopModelAM.RuleAM.ClassificationRuleHierarchyCF`
...
- [[cn_rs_rules_all_b|CN_RS_RULES_ALL_B]] — 199 atributos (1 PKs, 199 BICC)
- [[cn_rs_rules_all_tl|CN_RS_RULES_ALL_TL]] — 72 atributos (36 BICC)
- [[cn_rs_rules_hierarchy_cf_all|CN_RS_RULES_HIERARCHY_CF_ALL]] — 26 atributos (26 BICC)
- [[cn_rs_usages_all_tl|CN_RS_USAGES_ALL_TL]] — 5 atributos (1 PKs, 5 BICC)
