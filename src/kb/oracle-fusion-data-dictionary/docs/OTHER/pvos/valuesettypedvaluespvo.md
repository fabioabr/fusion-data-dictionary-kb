---
id: DOC-OTHER-PVO-ValueSetTypedValuesPVO
doc_type: system-doc
title: "ValueSetTypedValuesPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Value Set Typed Values. Acessa as tabelas: FND_VS_VALUES_B, FND_VS_VALUE_SETS.

**Caminho:** `FscmTopModelAM.FinExtractAM.AnalyticsExtractServiceAM.ValueSetTypedValuesPVO`
