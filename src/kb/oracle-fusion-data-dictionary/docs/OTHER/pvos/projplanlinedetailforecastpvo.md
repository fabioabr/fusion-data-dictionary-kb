---
id: DOC-OTHER-PVO-ProjPlanLineDetailForecastPVO
doc_type: system-doc
title: "ProjPlanLineDetailForecastPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Proj Plan Line Detail Forecast. Acessa as tabelas: CST_COST_BOOKS_B, EGP_CATEGORIES_VL, EGP_SYSTEM_ITEMS_VL (+39).

**Caminho:** `FscmTopModelAM.PjoBudgetsAndForecastsAnalyticsAM.ProjPlanLineDetailForecastPVO`
...
- [[per_person_types_vl|PER_PERSON_TYPES_VL]] — 2 atributos (1 BICC)
...
- [[pjf_exp_types_vl|PJF_EXP_TYPES_VL]] — 5 atributos (1 BICC)
...
- [[pjf_rate_schedules_vl|PJF_RATE_SCHEDULES_VL]] — 30 atributos
- [[pjf_rbs_elements_vl|PJF_RBS_ELEMENTS_VL]] — 49 atributos (12 BICC)
...
- [[pjo_planning_elements|PJO_PLANNING_ELEMENTS]] — 55 atributos (8 BICC)
- [[pjo_planning_options|PJO_PLANNING_OPTIONS]] — 91 atributos (1 BICC)
- [[pjo_plan_lines|PJO_PLAN_LINES]] — 83 atributos (1 BICC)
- [[pjo_plan_line_details|PJO_PLAN_LINE_DETAILS]] — 100 atributos (1 PKs, 51 BICC)
...
- [[pjo_plan_versions_b|PJO_PLAN_VERSIONS_B]] — 48 atributos (4 BICC)
- [[pjo_plan_versions_tl|PJO_PLAN_VERSIONS_TL]] — 11 atributos (1 BICC)
- [[pjo_plan_versions_vl|PJO_PLAN_VERSIONS_VL]] — 6 atributos
- [[pjo_spread_curves_vl|PJO_SPREAD_CURVES_VL]] — 3 atributos (1 BICC)
...
| 2 | ItemCategoryPEOCategoryName | CATEGORY_NAME | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | OrganizaionForRbsElementClassificationCode | CLASSIFICATION_CODE | — | — |
| 2 | OrganizaionForRbsElementEffectiveEndDate | EFFECTIVE_END_DATE | — | — |
| 3 | OrganizaionForRbsElementEffectiveStartDate | EFFECTIVE_START_DATE | — | ✅ |
| 4 | OrganizaionForRbsElementOrganizationId | ORGANIZATION_ID | — | — |
| 5 | OrganizationForRbsElementName | NAME | — | ✅ |
...
| 2 | PersonTypeForRbsElementUserPersonType | USER_PERSON_TYPE | — | ✅ |
...
| 2 | TaskStructForPlanElementName | NAME | — | — |
| 3 | TaskStructForPlanElementProjElementId | PROJ_ELEMENT_ID | — | — |
| 4 | TaskStructForPlanElementType | ELEMENT_TYPE | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | BillRateSchForPlanLineDetailRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 2 | BillRateSchForPlanLineDetailRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 3 | BillRateSchForPlanLineRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 4 | BillRateSchForPlanLineRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 5 | CostBrdnRateSchForPlanOptionRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 6 | CostBrdnRateSchForPlanOptionRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 7 | CostEmpRateSchForPlanOptionRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 8 | CostEmpRateSchForPlanOptionRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 9 | CostJobRateSchForPlanOptionRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 10 | CostJobRateSchForPlanOptionRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 11 | CostNonLbrRateSchForPlanOptiRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 12 | CostNonLbrRateSchForPlanOptiRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 13 | CostRateSchForPlanLineDetailRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 14 | CostRateSchForPlanLineDetailRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 15 | CostRateSchForPlanLineRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 16 | CostRateSchForPlanLineRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 17 | IndRateSchForPlanLineDetailRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 18 | IndRateSchForPlanLineDetailRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 19 | IndRateSchForPlanLineRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 20 | IndRateSchForPlanLineRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 21 | ResClsBillRateSchForPlanOptnRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 22 | ResClsBillRateSchForPlanOptnRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 23 | ResClsRawCostSchForPlanOptnRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 24 | ResClsRawCostSchForPlanOptnRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 25 | RevEmpRateSchForPlanOptionRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 26 | RevEmpRateSchForPlanOptionRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 27 | RevJobRateSchForPlanOptionRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 28 | RevJobRateSchForPlanOptionRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 29 | RevNonLbrRateSchForPlanOptnRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 30 | RevNonLbrRateSchForPlanOptnRateScheduleName | RATE_SCHEDULE_NAME | — | — |

### [[pjf_rbs_elements_vl|PJF_RBS_ELEMENTS_VL]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ParentElementForRbsElementMarkedFor | MARKED_FOR | — | — |
...
| 20 | RbsElementPEOMfcCostTypeId | MFC_COST_TYPE_ID | — | — |
| 21 | RbsElementPEONonLaborResourceId | NON_LABOR_RESOURCE_ID | — | ✅ |
| 22 | RbsElementPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 23 | RbsElementPEOOrderNumber | ORDER_NUMBER | — | — |
| 24 | RbsElementPEOOrganizationId | ORGANIZATION_ID | — | — |
| 25 | RbsElementPEOOutlineNumber | OUTLINE_NUMBER | — | — |
| 26 | RbsElementPEOParentElementId | PARENT_ELEMENT_ID | — | — |
| 27 | RbsElementPEOPersonId | PERSON_ID | — | ✅ |
| 28 | RbsElementPEOPersonTypeId | PERSON_TYPE_ID | — | — |
| 29 | RbsElementPEORbsElementId | RBS_ELEMENT_ID | — | — |
| 30 | RbsElementPEORbsElementNameId | RBS_ELEMENT_NAME_ID | — | — |
| 31 | RbsElementPEORbsLevel | RBS_LEVEL | — | — |
| 32 | RbsElementPEORbsVersionId | RBS_VERSION_ID | — | — |
| 33 | RbsElementPEOResFormatId | RES_FORMAT_ID | — | — |
| 34 | RbsElementPEOResourceClassCode | RESOURCE_CLASS_CODE | — | ✅ |
| 35 | RbsElementPEOResourceClassId | RESOURCE_CLASS_ID | — | — |
| 36 | RbsElementPEOResourceSourceId | RESOURCE_SOURCE_ID | — | — |
| 37 | RbsElementPEOResourceTypeId | RESOURCE_TYPE_ID | — | — |
| 38 | RbsElementPEORevenueCategoryId | REVENUE_CATEGORY_ID | — | — |
| 39 | RbsElementPEORoleId | ROLE_ID | — | — |
| 40 | RbsElementPEORuleFlag | RULE_FLAG | — | — |
| 41 | RbsElementPEOSpreadCurveId | SPREAD_CURVE_ID | — | — |
| 42 | RbsElementPEOUnitOfMeasure | UNIT_OF_MEASURE | — | ✅ |
| 43 | RbsElementPEOUserCreatedFlag | USER_CREATED_FLAG | — | — |
| 44 | RbsElementPEOUserDefinedCustom1Id | USER_DEFINED_CUSTOM1_ID | — | — |
| 45 | RbsElementPEOUserDefinedCustom2Id | USER_DEFINED_CUSTOM2_ID | — | — |
| 46 | RbsElementPEOUserDefinedCustom3Id | USER_DEFINED_CUSTOM3_ID | — | — |
| 47 | RbsElementPEOUserDefinedCustom4Id | USER_DEFINED_CUSTOM4_ID | — | — |
| 48 | RbsElementPEOUserDefinedCustom5Id | USER_DEFINED_CUSTOM5_ID | — | — |
| 49 | RbsElementPEOVendorId | VENDOR_ID | — | ✅ |
...
| 3 | PlanLineDetailPEOBillRateScheduleId | BILL_RATE_SCHEDULE_ID | — | — |
| 4 | PlanLineDetailPEOCostIndCompiledSetId | COST_IND_COMPILED_SET_ID | — | — |
| 5 | PlanLineDetailPEOCostRateScheduleId | COST_RATE_SCHEDULE_ID | — | — |
| 6 | PlanLineDetailPEOCreatedBy | CREATED_BY | — | ✅ |
| 7 | PlanLineDetailPEOCreationDate | CREATION_DATE | — | ✅ |
| 8 | PlanLineDetailPEOEndDate | END_DATE | — | ✅ |
| 9 | PlanLineDetailPEOExtQuantity | EXT_QUANTITY | — | — |
| 10 | PlanLineDetailPEOIndRateScheduleId | IND_RATE_SCHEDULE_ID | — | — |
| 11 | PlanLineDetailPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 12 | PlanLineDetailPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 13 | PlanLineDetailPEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 14 | PlanLineDetailPEOMultiErrorFlag | MULTI_ERROR_FLAG | — | — |
| 15 | PlanLineDetailPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 16 | PlanLineDetailPEOPcActBrdndCost | PC_ACT_BRDND_COST | — | ✅ |
| 17 | PlanLineDetailPEOPcActRawCost | PC_ACT_RAW_COST | — | ✅ |
| 18 | PlanLineDetailPEOPcActRevenue | PC_ACT_REVENUE | — | ✅ |
| 19 | PlanLineDetailPEOPcBrdndCost | PC_BRDND_COST | — | ✅ |
| 20 | PlanLineDetailPEOPcCode | PC_CODE | — | ✅ |
| 21 | PlanLineDetailPEOPcCostExchangeRate | PC_COST_EXCHANGE_RATE | — | ✅ |
| 22 | PlanLineDetailPEOPcCostRateDate | PC_COST_RATE_DATE | — | ✅ |
| 23 | PlanLineDetailPEOPcCostRateDateType | PC_COST_RATE_DATE_TYPE | — | — |
| 24 | PlanLineDetailPEOPcCostRateType | PC_COST_RATE_TYPE | — | ✅ |
| 25 | PlanLineDetailPEOPcExtBrdndCost | PC_EXT_BRDND_COST | — | — |
| 26 | PlanLineDetailPEOPcExtRawCost | PC_EXT_RAW_COST | — | — |
| 27 | PlanLineDetailPEOPcPoBrdndCost | PC_PO_BRDND_COST | — | — |
| 28 | PlanLineDetailPEOPcPoRawCost | PC_PO_RAW_COST | — | — |
| 29 | PlanLineDetailPEOPcRawCost | PC_RAW_COST | — | ✅ |
| 30 | PlanLineDetailPEOPcReqBrdndCost | PC_REQ_BRDND_COST | — | — |
| 31 | PlanLineDetailPEOPcReqRawCost | PC_REQ_RAW_COST | — | — |
| 32 | PlanLineDetailPEOPcRevExchangeRate | PC_REV_EXCHANGE_RATE | — | ✅ |
| 33 | PlanLineDetailPEOPcRevRateDate | PC_REV_RATE_DATE | — | ✅ |
| 34 | PlanLineDetailPEOPcRevRateDateType | PC_REV_RATE_DATE_TYPE | — | — |
| 35 | PlanLineDetailPEOPcRevRateType | PC_REV_RATE_TYPE | — | ✅ |
| 36 | PlanLineDetailPEOPcRevenue | PC_REVENUE | — | ✅ |
| 37 | PlanLineDetailPEOPcSiBrdndCost | PC_SI_BRDND_COST | — | — |
| 38 | PlanLineDetailPEOPcSiRawCost | PC_SI_RAW_COST | — | — |
| 39 | PlanLineDetailPEOPcToBrdndCost | PC_TO_BRDND_COST | — | — |
| 40 | PlanLineDetailPEOPcToRawCost | PC_TO_RAW_COST | — | — |
| 41 | PlanLineDetailPEOPeriodName | PERIOD_NAME | — | — |
| 42 | PlanLineDetailPEOPfcActBrdndCost | PFC_ACT_BRDND_COST | — | ✅ |
| 43 | PlanLineDetailPEOPfcActRawCost | PFC_ACT_RAW_COST | — | ✅ |
| 44 | PlanLineDetailPEOPfcActRevenue | PFC_ACT_REVENUE | — | ✅ |
| 45 | PlanLineDetailPEOPfcBrdndCost | PFC_BRDND_COST | — | ✅ |
| 46 | PlanLineDetailPEOPfcCode | PFC_CODE | — | ✅ |
| 47 | PlanLineDetailPEOPfcCostExchangeRate | PFC_COST_EXCHANGE_RATE | — | ✅ |
| 48 | PlanLineDetailPEOPfcCostRateDate | PFC_COST_RATE_DATE | — | ✅ |
| 49 | PlanLineDetailPEOPfcCostRateDateType | PFC_COST_RATE_DATE_TYPE | — | — |
| 50 | PlanLineDetailPEOPfcCostRateType | PFC_COST_RATE_TYPE | — | ✅ |
| 51 | PlanLineDetailPEOPfcExtBrdndCost | PFC_EXT_BRDND_COST | — | — |
| 52 | PlanLineDetailPEOPfcExtRawCost | PFC_EXT_RAW_COST | — | — |
| 53 | PlanLineDetailPEOPfcPoBrdndCost | PFC_PO_BRDND_COST | — | — |
| 54 | PlanLineDetailPEOPfcPoRawCost | PFC_PO_RAW_COST | — | — |
| 55 | PlanLineDetailPEOPfcRawCost | PFC_RAW_COST | — | ✅ |
| 56 | PlanLineDetailPEOPfcReqBrdndCost | PFC_REQ_BRDND_COST | — | — |
| 57 | PlanLineDetailPEOPfcReqRawCost | PFC_REQ_RAW_COST | — | — |
| 58 | PlanLineDetailPEOPfcRevExchangeRate | PFC_REV_EXCHANGE_RATE | — | ✅ |
| 59 | PlanLineDetailPEOPfcRevRateDate | PFC_REV_RATE_DATE | — | ✅ |
| 60 | PlanLineDetailPEOPfcRevRateDateType | PFC_REV_RATE_DATE_TYPE | — | — |
| 61 | PlanLineDetailPEOPfcRevRateType | PFC_REV_RATE_TYPE | — | ✅ |
| 62 | PlanLineDetailPEOPfcRevenue | PFC_REVENUE | — | ✅ |
| 63 | PlanLineDetailPEOPfcSiBrdndCost | PFC_SI_BRDND_COST | — | — |
| 64 | PlanLineDetailPEOPfcSiRawCost | PFC_SI_RAW_COST | — | — |
| 65 | PlanLineDetailPEOPfcToBrdndCost | PFC_TO_BRDND_COST | — | — |
| 66 | PlanLineDetailPEOPfcToRawCost | PFC_TO_RAW_COST | — | — |
| 67 | PlanLineDetailPEOPlanVersionId | PLAN_VERSION_ID | — | ✅ |
| 68 | PlanLineDetailPEOPlanningElementId | PLANNING_ELEMENT_ID | — | — |
| 69 | PlanLineDetailPEOPoQuantity | PO_QUANTITY | — | — |
| 70 | PlanLineDetailPEOQuantity | QUANTITY | — | ✅ |
| 71 | PlanLineDetailPEOReqQuantity | REQ_QUANTITY | — | — |
| 72 | PlanLineDetailPEOSiQuantity | SI_QUANTITY | — | — |
| 73 | PlanLineDetailPEOStartDate | START_DATE | — | ✅ |
| 74 | PlanLineDetailPEOTcActBrdndCost | TC_ACT_BRDND_COST | — | ✅ |
| 75 | PlanLineDetailPEOTcActRawCost | TC_ACT_RAW_COST | — | ✅ |
| 76 | PlanLineDetailPEOTcActRevenue | TC_ACT_REVENUE | — | ✅ |
| 77 | PlanLineDetailPEOTcBillRateOverride | TC_BILL_RATE_OVERRIDE | — | ✅ |
| 78 | PlanLineDetailPEOTcBrdndCost | TC_BRDND_COST | — | ✅ |
| 79 | PlanLineDetailPEOTcBrdndCostRateOverride | TC_BRDND_COST_RATE_OVERRIDE | — | ✅ |
| 80 | PlanLineDetailPEOTcExtBrdndCost | TC_EXT_BRDND_COST | — | — |
| 81 | PlanLineDetailPEOTcExtRawCost | TC_EXT_RAW_COST | — | — |
| 82 | PlanLineDetailPEOTcMarkupPercent | TC_MARKUP_PERCENT | — | ✅ |
| 83 | PlanLineDetailPEOTcMarkupPercentOverride | TC_MARKUP_PERCENT_OVERRIDE | — | ✅ |
| 84 | PlanLineDetailPEOTcPoBrdndCost | TC_PO_BRDND_COST | — | — |
| 85 | PlanLineDetailPEOTcPoRawCost | TC_PO_RAW_COST | — | — |
| 86 | PlanLineDetailPEOTcRawCost | TC_RAW_COST | — | ✅ |
| 87 | PlanLineDetailPEOTcRawCostRateOverride | TC_RAW_COST_RATE_OVERRIDE | — | ✅ |
| 88 | PlanLineDetailPEOTcReqBrdndCost | TC_REQ_BRDND_COST | — | — |
| 89 | PlanLineDetailPEOTcReqRawCost | TC_REQ_RAW_COST | — | — |
| 90 | PlanLineDetailPEOTcRevenue | TC_REVENUE | — | ✅ |
| 91 | PlanLineDetailPEOTcSiBrdndCost | TC_SI_BRDND_COST | — | — |
| 92 | PlanLineDetailPEOTcSiRawCost | TC_SI_RAW_COST | — | — |
| 93 | PlanLineDetailPEOTcStdBillRate | TC_STD_BILL_RATE | — | ✅ |
| 94 | PlanLineDetailPEOTcStdBrdndCostRate | TC_STD_BRDND_COST_RATE | — | ✅ |
| 95 | PlanLineDetailPEOTcStdBrdndMultiplier | TC_STD_BRDND_MULTIPLIER | — | — |
| 96 | PlanLineDetailPEOTcStdRawCostRate | TC_STD_RAW_COST_RATE | — | ✅ |
| 97 | PlanLineDetailPEOTcToBrdndCost | TC_TO_BRDND_COST | — | — |
| 98 | PlanLineDetailPEOTcToRawCost | TC_TO_RAW_COST | — | — |
| 99 | PlanLineDetailPEOToQuantity | TO_QUANTITY | — | — |
| 100 | PlanLineDetailPEOTxnCurrencyCode | TXN_CURRENCY_CODE | — | ✅ |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | SpreadCurveForPlanElementName | NAME | — | ✅ |
| 2 | SpreadCurveForPlanElementSpreadCurveId | SPREAD_CURVE_ID | — | — |
| 3 | SpreadCurveForRbsElementSpreadCurveId | SPREAD_CURVE_ID | — | — |
