---
id: DOC-OTHER-PVO-ItemRelationship
doc_type: system-doc
title: "ItemRelationship — PVO Cross-Module"
...
View Object para extração BICC de dados de Item Relationship. Acessa as tabelas: EGO_ITEM_ASSOCIATIONS, EGP_ITEM_RELATIONSHIPS_B_V, EGP_ITEM_RELATIONSHIPS_TL (+3).

**Caminho:** `FscmTopModelAM.EgpItemsPublicModelAM.ItemRelationship`
...
- [[egp_item_relationships_b_v|EGP_ITEM_RELATIONSHIPS_B_V]] — 45 atributos (1 PKs, 26 BICC)
- [[egp_item_relationships_tl|EGP_ITEM_RELATIONSHIPS_TL]] — 10 atributos (3 BICC)
- [[egp_item_revisions_vl|EGP_ITEM_REVISIONS_VL]] — 3 atributos (1 BICC)
