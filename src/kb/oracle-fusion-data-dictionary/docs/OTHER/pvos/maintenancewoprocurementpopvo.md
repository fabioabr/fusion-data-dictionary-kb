---
id: DOC-OTHER-PVO-MaintenanceWOProcurementPOPVO
doc_type: system-doc
title: "MaintenanceWOProcurementPOPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Maintenance WOProcurement PO. Acessa as tabelas: EGP_CATEGORIES_VL, EGP_SYSTEM_ITEMS_B_V, POR_REQUISITION_HEADERS_ALL (+11).

**Caminho:** `FscmTopModelAM.WorkOrderAM.MaintenanceWOProcurementPOPVO`
...
- [[por_requisition_lines_all|POR_REQUISITION_LINES_ALL]] — 177 atributos (21 BICC)
- [[por_req_distributions_all|POR_REQ_DISTRIBUTIONS_ALL]] — 38 atributos (1 BICC)
- [[po_distributions_all|PO_DISTRIBUTIONS_ALL]] — 110 atributos (1 PKs, 10 BICC)
- [[po_headers_all|PO_HEADERS_ALL]] — 137 atributos (8 BICC)
- [[po_lines_all|PO_LINES_ALL]] — 117 atributos (10 BICC)
