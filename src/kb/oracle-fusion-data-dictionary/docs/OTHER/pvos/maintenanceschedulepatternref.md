---
id: DOC-OTHER-PVO-MaintenanceSchedulePatternRef
doc_type: system-doc
title: "MaintenanceSchedulePatternRef — PVO Cross-Module"
...
View Object para extração BICC de dados de Maintenance Schedule Pattern Ref. Acessa as tabelas: MNT_SCHEDULE_PATTERNS_B, MNT_SCHEDULE_PATTERNS_TL.

**Caminho:** `FscmTopModelAM.MaintProgramAM.MaintenanceSchedulePatternRef`
...
- [[mnt_schedule_patterns_b|MNT_SCHEDULE_PATTERNS_B]] — 71 atributos (1 PKs, 5 BICC)
- [[mnt_schedule_patterns_tl|MNT_SCHEDULE_PATTERNS_TL]] — 4 atributos (1 BICC)
