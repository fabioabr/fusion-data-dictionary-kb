---
id: DOC-OTHER-PVO-TransactionRectHeaderPVO
doc_type: system-doc
title: "TransactionRectHeaderPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Transaction Rect Header. Acessa as tabelas: FUN_INTERCO_ORGANIZATIONS, FUN_LOOKUPS, FUN_TRX_BATCHES (+4).

**Caminho:** `FscmTopModelAM.FinFunIntercoTransactionsAM.TransactionRectHeaderPVO`
...
- [[fun_trx_headers|FUN_TRX_HEADERS]] — 96 atributos (1 PKs, 17 BICC)
