---
id: DOC-OTHER-PVO-ItemPendingPVO
doc_type: system-doc
title: "ItemPendingPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Item Pending. Acessa as tabelas: EGO_CHANGE_LINES_B, EGP_ITEM_CLASSES_B_V, EGP_ITEM_CLASSES_TL (+5).

**Caminho:** `FscmTopModelAM.ChangeObjectsAM.ItemPendingPVO`
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ItemClassBasePEOItemClassCode2_1 | ITEM_CLASS_CODE | — | — |
...
| 3 | OrganizationUnitPEOOrganizationId2_1 | ORGANIZATION_ID | — | — |
...
| 4 | OrgUnitTransPEOOrganizationId3_1 | ORGANIZATION_ID | — | — |
