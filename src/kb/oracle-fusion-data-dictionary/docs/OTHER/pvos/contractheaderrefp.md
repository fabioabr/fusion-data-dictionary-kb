---
id: DOC-OTHER-PVO-ContractHeaderRefP
doc_type: system-doc
title: "ContractHeaderRefP — PVO Cross-Module"
...
View Object para extração BICC de dados de Contract Header Ref P. Acessa as tabelas: FND_SETID_ASSIGNMENTS, FUN_ALL_BUSINESS_UNITS_V, GL_DAILY_CONVERSION_TYPES (+14).

**Caminho:** `FscmTopModelAM.ContractsCoreAM.ContractHeaderRefP`
...
- [[hz_parties|HZ_PARTIES]] — 137 atributos
- [[hz_party_sites|HZ_PARTY_SITES]] — 86 atributos
...
- [[okc_k_headers_all_b|OKC_K_HEADERS_ALL_B]] — 104 atributos (2 PKs, 28 BICC)
