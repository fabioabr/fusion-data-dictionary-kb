---
id: DOC-OTHER-PVO-ItemRelShipRelatedItemPendRev
doc_type: system-doc
title: "ItemRelShipRelatedItemPendRev — PVO Cross-Module"
...
View Object para extração BICC de dados de Item Rel Ship Related Item Pend Rev. Acessa as tabelas: EGO_ITEM_ASSOCIATIONS, EGP_ITEM_RELATIONSHIPS_B_V, EGP_ITEM_RELATIONSHIPS_TL (+3).

**Caminho:** `FscmTopModelAM.EgpItemsPublicModelAM.ItemRelShipRelatedItemPendRev`
