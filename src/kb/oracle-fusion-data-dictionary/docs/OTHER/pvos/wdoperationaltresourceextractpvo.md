---
id: DOC-OTHER-PVO-WDOperationAltResourceExtractPVO
doc_type: system-doc
title: "WDOperationAltResourceExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WDOperation Alt Resource Extract. Acessa as tabelas: WIS_WD_OP_ALT_RESOURCES.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.WDOperationAltResourceExtractPVO`
...
- [[wis_wd_op_alt_resources|WIS_WD_OP_ALT_RESOURCES]] — 59 atributos (1 PKs, 59 BICC)

---

## ⚙️ Atributos

### [[wis_wd_op_alt_resources|WIS_WD_OP_ALT_RESOURCES]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | AssignedUnits | ASSIGNED_UNITS | — | ✅ |
...
| 45 | DocumentItemId | DOCUMENT_ITEM_ID | — | ✅ |
| 46 | InverseUsageRate | INVERSE_USAGE_RATE | — | ✅ |
...
| 53 | PriorityRanking | PRIORITY_RANKING | — | ✅ |
| 54 | RequestId | REQUEST_ID | — | ✅ |
| 55 | ResourceId | RESOURCE_ID | — | ✅ |
| 56 | UomCode | UOM_CODE | — | ✅ |
| 57 | UsageRate | USAGE_RATE | — | ✅ |
| 58 | WdOpAltResourceId | WD_OP_ALT_RESOURCE_ID | 🔑 | ✅ |
| 59 | WdOperationResourceId | WD_OPERATION_RESOURCE_ID | — | ✅ |
