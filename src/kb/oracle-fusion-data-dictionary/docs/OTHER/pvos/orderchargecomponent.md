---
id: DOC-OTHER-PVO-OrderChargeComponent
doc_type: system-doc
title: "OrderChargeComponent — PVO Cross-Module"
...
View Object para extração BICC de dados de Order Charge Component. Acessa as tabelas: DOO_COVERAGE_FLINES_DETAILS_V, DOO_COVERED_FLINES_DETAILS_V, DOO_CVRD_FLINE_UNREF_RETRN_V (+18).

**Caminho:** `FscmTopModelAM.DooTopAM.OrderChargeComponent`
...
- [[doo_covered_flines_details_v|DOO_COVERED_FLINES_DETAILS_V]] — 20 atributos (19 BICC)
...
- [[doo_doc_references_dropship_v|DOO_DOC_REFERENCES_DROPSHIP_V]] — 4 atributos (1 PKs, 4 BICC)
- [[doo_doc_references_supply_v|DOO_DOC_REFERENCES_SUPPLY_V]] — 4 atributos (4 BICC)
- [[doo_fulfill_lines_all|DOO_FULFILL_LINES_ALL]] — 172 atributos (149 BICC)
- [[doo_headers_all|DOO_HEADERS_ALL]] — 46 atributos (39 BICC)
- [[doo_lines_all|DOO_LINES_ALL]] — 49 atributos (41 BICC)
- [[doo_order_charges|DOO_ORDER_CHARGES]] — 33 atributos (22 BICC)
- [[doo_order_charge_components|DOO_ORDER_CHARGE_COMPONENTS]] — 33 atributos (1 PKs, 29 BICC)
...
- [[dos_supply_make_order_dtls|DOS_SUPPLY_MAKE_ORDER_DTLS]] — 7 atributos (1 PKs, 5 BICC)
- [[dos_supply_tracking_lines|DOS_SUPPLY_TRACKING_LINES]] — 3 atributos (1 PKs, 2 BICC)
...
- [[hz_cust_accounts|HZ_CUST_ACCOUNTS]] — 31 atributos (27 BICC)
...
| 3 | DocReferencesDropShipDocSystemRefId | DOC_SYSTEM_REF_ID | 🔑 | ✅ |
| 4 | DocReferencesDropshipDocUserKey | DOC_USER_KEY | — | ✅ |
...
| 57 | FulfillLineInventoryInterfacedFlag | INVENTORY_INTERFACED_FLAG | — | ✅ |
| 58 | FulfillLineInventoryItemId | INVENTORY_ITEM_ID | — | ✅ |
| 59 | FulfillLineInventoryOrganizationId | INVENTORY_ORGANIZATION_ID | — | — |
| 60 | FulfillLineInventoryTransactionFlag | INVENTORY_TRANSACTION_FLAG | — | ✅ |
| 61 | FulfillLineInvoiceEnabledFlag | INVOICE_ENABLED_FLAG | — | ✅ |
| 62 | FulfillLineInvoiceInterfacedFlag | INVOICE_INTERFACED_FLAG | — | ✅ |
| 63 | FulfillLineInvoiceableItemFlag | INVOICEABLE_ITEM_FLAG | — | ✅ |
| 64 | FulfillLineInvoicingRuleId | INVOICING_RULE_ID | — | ✅ |
| 65 | FulfillLineItemSubTypeCode | ITEM_SUB_TYPE_CODE | — | ✅ |
| 66 | FulfillLineItemTypeCode | ITEM_TYPE_CODE | — | ✅ |
| 67 | FulfillLineLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 68 | FulfillLineLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 69 | FulfillLineLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 70 | FulfillLineLatestAcceptableArrivalDate | LATEST_ACCEPTABLE_ARRIVAL_DATE | — | ✅ |
| 71 | FulfillLineLatestAcceptableShipDate | LATEST_ACCEPTABLE_SHIP_DATE | — | ✅ |
| 72 | FulfillLineLineId | LINE_ID | — | ✅ |
| 73 | FulfillLineLineTypeCode | LINE_TYPE_CODE | — | ✅ |
| 74 | FulfillLineNumber | FULFILL_LINE_NUMBER | — | ✅ |
...
| 8 | OrderChargeChargeSubtypeCode | CHARGE_SUBTYPE_CODE | — | ✅ |
| 9 | OrderChargeChargeTypeCode | CHARGE_TYPE_CODE | — | ✅ |
| 10 | OrderChargeCreatedBy | CREATED_BY | — | — |
| 11 | OrderChargeCreationDate | CREATION_DATE | — | — |
| 12 | OrderChargeDeltaType | DELTA_TYPE | — | — |
| 13 | OrderChargeGsaUnitPrice | GSA_UNIT_PRICE | — | ✅ |
| 14 | OrderChargeLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 15 | OrderChargeLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 16 | OrderChargeLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 17 | OrderChargeModifiedFlag | MODIFIED_FLAG | — | ✅ |
| 18 | OrderChargeObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 19 | OrderChargeOrderChargeId | ORDER_CHARGE_ID | — | ✅ |
| 20 | OrderChargeParentEntityCode | PARENT_ENTITY_CODE | — | ✅ |
| 21 | OrderChargeParentEntityId | PARENT_ENTITY_ID | — | ✅ |
| 22 | OrderChargePricePeriodicityCode | PRICE_PERIODICITY_CODE | — | ✅ |
| 23 | OrderChargePriceTypeCode | PRICE_TYPE_CODE | — | ✅ |
| 24 | OrderChargePricedQuantity | PRICED_QUANTITY | — | ✅ |
| 25 | OrderChargePricedQuantityUomCode | PRICED_QUANTITY_UOM_CODE | — | ✅ |
| 26 | OrderChargePrimaryFlag | PRIMARY_FLAG | — | ✅ |
| 27 | OrderChargeReferenceOrderChargeId | REFERENCE_ORDER_CHARGE_ID | — | ✅ |
| 28 | OrderChargeRollupFlag | ROLLUP_FLAG | — | ✅ |
| 29 | OrderChargeSequenceNumber | SEQUENCE_NUMBER | — | ✅ |
| 30 | OrderChargeSourceChargeId | SOURCE_CHARGE_ID | — | ✅ |
| 31 | OrderChargeTierAppliesTo | TIER_APPLIES_TO | — | — |
| 32 | OrderChargeTieredFlag | TIERED_FLAG | — | — |
| 33 | OrderChargeUsagePriceLockFlag | USAGE_PRICE_LOCK_FLAG | — | — |

### [[doo_order_charge_components|DOO_ORDER_CHARGE_COMPONENTS]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | OrderChargeComponentChargeCurrencyCode | CHARGE_CURRENCY_CODE | — | ✅ |
| 2 | OrderChargeComponentChargeCurrencyExtAmount | CHARGE_CURRENCY_EXT_AMOUNT | — | ✅ |
| 3 | OrderChargeComponentChargeCurrencyUnitPrice | CHARGE_CURRENCY_UNIT_PRICE | — | ✅ |
| 4 | OrderChargeComponentCreatedBy | CREATED_BY | — | — |
| 5 | OrderChargeComponentCreationDate | CREATION_DATE | — | — |
| 6 | OrderChargeComponentDeltaType | DELTA_TYPE | — | — |
| 7 | OrderChargeComponentExplanation | EXPLANATION | — | ✅ |
| 8 | OrderChargeComponentExplanationMessageName | EXPLANATION_MESSAGE_NAME | — | ✅ |
| 9 | OrderChargeComponentHeaderCurrDurationExtAmt | HEADER_CURR_DURATION_EXT_AMT | — | ✅ |
| 10 | OrderChargeComponentHeaderCurrencyCode | HEADER_CURRENCY_CODE | — | ✅ |
| 11 | OrderChargeComponentHeaderCurrencyExtAmount | HEADER_CURRENCY_EXT_AMOUNT | — | ✅ |
| 12 | OrderChargeComponentHeaderCurrencyUnitPrice | HEADER_CURRENCY_UNIT_PRICE | — | ✅ |
| 13 | OrderChargeComponentId | ORDER_CHARGE_COMPONENT_ID | 🔑 | ✅ |
| 14 | OrderChargeComponentLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 15 | OrderChargeComponentLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 16 | OrderChargeComponentLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 17 | OrderChargeComponentModifiedFlag | MODIFIED_FLAG | — | ✅ |
| 18 | OrderChargeComponentObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 19 | OrderChargeComponentOrderChargeId | ORDER_CHARGE_ID | — | ✅ |
| 20 | OrderChargeComponentParentChargeComponentId | PARENT_CHARGE_COMPONENT_ID | — | ✅ |
| 21 | OrderChargeComponentPercentOfComparisonElement | PERCENT_OF_COMPARISON_ELEMENT | — | ✅ |
| 22 | OrderChargeComponentPriceElementCode | PRICE_ELEMENT_CODE | — | ✅ |
| 23 | OrderChargeComponentPriceElementUsageCode | PRICE_ELEMENT_USAGE_CODE | — | ✅ |
| 24 | OrderChargeComponentPricingSourceId | PRICING_SOURCE_ID | — | ✅ |
| 25 | OrderChargeComponentPricingSourceTypeCode | PRICING_SOURCE_TYPE_CODE | — | ✅ |
| 26 | OrderChargeComponentReferenceOrderChargeCompId | REFERENCE_ORDER_CHARGE_COMP_ID | — | ✅ |
| 27 | OrderChargeComponentRollupFlag | ROLLUP_FLAG | — | ✅ |
| 28 | OrderChargeComponentSequenceNumber | SEQUENCE_NUMBER | — | ✅ |
| 29 | OrderChargeComponentSourceChargeComponentId | SOURCE_CHARGE_COMPONENT_ID | — | ✅ |
| 30 | OrderChargeComponentSourceChargeId | SOURCE_CHARGE_ID | — | ✅ |
| 31 | OrderChargeComponentSourceMpaId | SOURCE_MPA_ID | — | ✅ |
| 32 | OrderChargeComponentSourceParentChargeCompId | SOURCE_PARENT_CHARGE_COMP_ID | — | ✅ |
| 33 | OrderChargeComponentTaxIncludedFlag | TAX_INCLUDED_FLAG | — | ✅ |
...
| 24 | ProjectRefDooOrderPrjId | REF_DOO_ORDER_PRJ_ID | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | DosSupplyMakeOrderDtlsEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 2 | DosSupplyMakeOrderDtlsObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 3 | DosSupplyMakeOrderDtlsSupplyMakeDetailsId | SUPPLY_MAKE_DETAILS_ID | 🔑 | ✅ |
| 4 | DosSupplyMakeOrderDtlsTrackingLineId | TRACKING_LINE_ID | — | ✅ |
| 5 | DosSupplyMakeOrderDtlsWorkOrderId | WORK_ORDER_ID | — | ✅ |
| 6 | DosSupplyMakeOrderDtlsWorkOrderNumber | WORK_ORDER_NUMBER | — | ✅ |
| 7 | DosSupplyMakeOrderDtlsWorkOrderStatusId | WORK_ORDER_STATUS_ID | — | ✅ |
