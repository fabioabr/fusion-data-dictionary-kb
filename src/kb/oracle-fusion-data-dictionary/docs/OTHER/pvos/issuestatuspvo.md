---
id: DOC-OTHER-PVO-IssueStatusPVO
doc_type: system-doc
title: "IssueStatusPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Issue Status. Acessa as tabelas: PJE_LOOKUPS.

**Caminho:** `FscmTopModelAM.PjeCommonAM.IssueStatusPVO`
