---
id: DOC-OTHER-PVO-WOOperationsResourceInstancesPVO
doc_type: system-doc
title: "WOOperationsResourceInstancesPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WOOperations Resource Instances. Acessa as tabelas: WIE_WORK_ORDERS_B, WIE_WO_OPERATIONS_B, WIE_WO_OPERATION_RESOURCES (+4).

**Caminho:** `FscmTopModelAM.WorkOrderAM.WOOperationsResourceInstancesPVO`
...
- [[wie_work_orders_b|WIE_WORK_ORDERS_B]] — 70 atributos (6 BICC)
- [[wie_wo_operations_b|WIE_WO_OPERATIONS_B]] — 43 atributos (1 BICC)
- [[wie_wo_operation_resources|WIE_WO_OPERATION_RESOURCES]] — 32 atributos (15 BICC)
