---
id: DOC-OTHER-PVO-CompetencyContentItemRatingPVO
doc_type: system-doc
title: "CompetencyContentItemRatingPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Competency Content Item Rating. Acessa as tabelas: HRT_CONTENT_ITEMS_B, HRT_CONTENT_ITEMS_TL, HRT_CONTENT_TYPES_B (+3).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileSetupAM.CompetencyContentItemRatingPVO`
...
- [[hrt_content_items_b|HRT_CONTENT_ITEMS_B]] — 60 atributos (1 PKs, 3 BICC)
- [[hrt_content_items_tl|HRT_CONTENT_ITEMS_TL]] — 23 atributos (3 BICC)
- [[hrt_content_types_b|HRT_CONTENT_TYPES_B]] — 4 atributos (1 BICC)
- [[hrt_profile_tp_sc_prp_b|HRT_PROFILE_TP_SC_PRP_B]] — 14 atributos (1 PKs, 2 BICC)
- [[hrt_profile_typ_sections_vl|HRT_PROFILE_TYP_SECTIONS_VL]] — 13 atributos (1 PKs, 2 BICC)
...
| 2 | ContentTypeBPEOForProfileTpSLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
...
| 9 | RatingLevelBPEOBusinessGroupId | BUSINESS_GROUP_ID | 🔑 | ✅ |
| 10 | RatingLevelBPEODateFrom | DATE_FROM | — | — |
| 11 | RatingLevelBPEODateTo | DATE_TO | — | — |
