---
id: DOC-OTHER-PVO-GenericProfilePVO
doc_type: system-doc
title: "GenericProfilePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Generic Profile. Acessa as tabelas: HRT_CONTENT_TYPES_B, HRT_CONTENT_TYPES_TL, HRT_PROFILES_B (+3).
