---
id: DOC-OTHER-PVO-MaintenanceWorkDefinitionsPVO
doc_type: system-doc
title: "MaintenanceWorkDefinitionsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Maintenance Work Definitions. Acessa as tabelas: WIS_WD_VERSIONS, WIS_WORK_DEFINITIONS, WIS_WORK_DEFINITION_NAMES_VL (+1).

**Caminho:** `FscmTopModelAM.WorkOrderAM.MaintenanceWorkDefinitionsPVO`
...
- [[wis_wd_versions|WIS_WD_VERSIONS]] — 57 atributos
- [[wis_work_definitions|WIS_WORK_DEFINITIONS]] — 65 atributos (1 PKs, 18 BICC)
- [[wis_work_definition_names_vl|WIS_WORK_DEFINITION_NAMES_VL]] — 54 atributos (8 BICC)
- [[wis_work_methods_vl|WIS_WORK_METHODS_VL]] — 50 atributos (4 BICC)
