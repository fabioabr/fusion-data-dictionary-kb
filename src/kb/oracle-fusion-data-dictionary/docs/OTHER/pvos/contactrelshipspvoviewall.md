---
id: DOC-OTHER-PVO-ContactRelshipsPVOViewAll
doc_type: system-doc
title: "ContactRelshipsPVOViewAll — PVO Cross-Module"
...
View Object para extração BICC de dados de Contact Relships View All. Acessa as tabelas: PER_ALL_PEOPLE_F, PER_CONTACT_RELSHIPS_F, PER_PERSONS (+1).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.ContactRelshipsPVOViewAll`
...
- [[per_all_people_f|PER_ALL_PEOPLE_F]] — 105 atributos (11 BICC)
- [[per_contact_relships_f|PER_CONTACT_RELSHIPS_F]] — 27 atributos (3 PKs, 24 BICC)
- [[per_persons|PER_PERSONS]] — 2 atributos (2 BICC)
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 57 atributos (50 BICC)
