---
id: DOC-OTHER-PVO-RepeatingTimePeriod
doc_type: system-doc
title: "RepeatingTimePeriod — PVO Cross-Module"
...
View Object para extração BICC de dados de Repeating Time Period. Acessa as tabelas: HWM_RP_TM_PERIODS_B, HWM_RP_TM_PERIODS_TL.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimePeriodsAM.RepeatingTimePeriod`
...
- [[hwm_rp_tm_periods_b|HWM_RP_TM_PERIODS_B]] — 25 atributos (1 PKs, 25 BICC)
- [[hwm_rp_tm_periods_tl|HWM_RP_TM_PERIODS_TL]] — 11 atributos (1 PKs, 11 BICC)
