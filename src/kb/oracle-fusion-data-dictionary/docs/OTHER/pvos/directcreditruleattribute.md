---
id: DOC-OTHER-PVO-DirectCreditRuleAttribute
doc_type: system-doc
title: "DirectCreditRuleAttribute — PVO Cross-Module"
...
View Object para extração BICC de dados de Direct Credit Rule Attribute. Acessa as tabelas: CN_RS_ATTRIBUTES_ALL_VL, CN_RS_ATTR_USAGES_ALL, CN_RS_RULE_ATTRIBUTES_ALL (+1).

**Caminho:** `FscmTopModelAM.RuleAM.DirectCreditRuleAttribute`
...
- [[cn_rs_attributes_all_vl|CN_RS_ATTRIBUTES_ALL_VL]] — 14 atributos (3 BICC)
- [[cn_rs_attr_usages_all|CN_RS_ATTR_USAGES_ALL]] — 47 atributos (5 BICC)
