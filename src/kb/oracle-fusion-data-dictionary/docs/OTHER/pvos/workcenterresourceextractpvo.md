---
id: DOC-OTHER-PVO-WorkCenterResourceExtractPVO
doc_type: system-doc
title: "WorkCenterResourceExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Work Center Resource Extract. Acessa as tabelas: WIS_WC_RESOURCES.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.WorkCenterResourceExtractPVO`
...
- [[wis_wc_resources|WIS_WC_RESOURCES]] — 54 atributos (2 PKs, 54 BICC)

---

## ⚙️ Atributos

### [[wis_wc_resources|WIS_WC_RESOURCES]]
...
| 42 | Available24HoursFlag | AVAILABLE_24_HOURS_FLAG | — | ✅ |
| 43 | CheckCtpFlag | CHECK_CTP_FLAG | — | ✅ |
| 44 | CreatedBy | CREATED_BY | — | ✅ |
| 45 | CreationDate | CREATION_DATE | — | ✅ |
| 46 | EfficiencyPercentage | EFFICIENCY_PERCENTAGE | — | ✅ |
...
| 51 | ResourceId | RESOURCE_ID | 🔑 | ✅ |
| 52 | ResourceQuantity | RESOURCE_QUANTITY | — | ✅ |
| 53 | UtilizationPercentage | UTILIZATION_PERCENTAGE | — | ✅ |
| 54 | WorkCenterId | WORK_CENTER_ID | 🔑 | ✅ |
