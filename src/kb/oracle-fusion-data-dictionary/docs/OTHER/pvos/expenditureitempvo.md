---
id: DOC-OTHER-PVO-ExpenditureItemPVO
doc_type: system-doc
title: "ExpenditureItemPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Expenditure Item. Acessa as tabelas: CST_ALL_TXN_TYPES_V, FUN_ALL_BUSINESS_UNITS_V, HR_ORGANIZATION_INFORMATION_F (+23).

**Caminho:** `FscmTopModelAM.PjcTransactionsAM.ExpenditureItemPVO`
...
- [[hr_organization_v|HR_ORGANIZATION_V]] — 17 atributos (7 BICC)
...
- [[pjc_exp_items_all|PJC_EXP_ITEMS_ALL]] — 227 atributos (1 PKs, 122 BICC)
