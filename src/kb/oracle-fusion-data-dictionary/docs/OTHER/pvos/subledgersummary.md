---
id: DOC-OTHER-PVO-SubLedgerSummary
doc_type: system-doc
title: "SubLedgerSummary — PVO Cross-Module"
...
View Object para extração BICC de dados de Sub Ledger Summary. Acessa as tabelas: CN_REPOSITORIES_ALL_B, CN_REPOSITORIES_ALL_TL, CN_SRP_PARTICIPANTS_ALL (+2).

**Caminho:** `FscmTopModelAM.SrpCompPlanAM.SubLedgerSummary`
...
- [[cn_repositories_all_b|CN_REPOSITORIES_ALL_B]] — 48 atributos (27 BICC)
- [[cn_repositories_all_tl|CN_REPOSITORIES_ALL_TL]] — 12 atributos (4 BICC)
- [[cn_srp_participants_all|CN_SRP_PARTICIPANTS_ALL]] — 42 atributos (8 BICC)
- [[cn_srp_subledger_all|CN_SRP_SUBLEDGER_ALL]] — 76 atributos (1 PKs, 59 BICC)
- [[hz_parties|HZ_PARTIES]] — 6 atributos (3 BICC)
