---
id: DOC-OTHER-PVO-EvalItemExtractPVO
doc_type: system-doc
title: "EvalItemExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Eval Item Extract. Acessa as tabelas: HRA_EVAL_ITEMS.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HCMExtractAM.PerformanceBiccExtractAM.EvalItemExtractPVO`
...
- [[hra_eval_items|HRA_EVAL_ITEMS]] — 97 atributos (1 PKs, 97 BICC)
...
|---|----------|--------|----|------|
| 1 | AchievementDate | ACHIEVEMENT_DATE | — | ✅ |
...
| 71 | CriticalFlag | CRITICAL_FLAG | — | ✅ |
| 72 | Description | DESCRIPTION | — | ✅ |
| 73 | DueDate | DUE_DATE | — | ✅ |
| 74 | EvalItemId | EVAL_ITEM_ID | 🔑 | ✅ |
| 75 | EvalSectionId | EVAL_SECTION_ID | — | ✅ |
| 76 | EvaluationId | EVALUATION_ID | — | ✅ |
| 77 | ItemName | ITEM_NAME | — | ✅ |
| 78 | LastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 79 | LastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 80 | LastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 81 | MandatoryFlag | MANDATORY_FLAG | — | ✅ |
| 82 | Measurement | MEASUREMENT | — | ✅ |
| 83 | MinWeight | MIN_WEIGHT | — | ✅ |
| 84 | ObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 85 | OwnedBy | OWNED_BY | — | ✅ |
| 86 | ParentItemId | PARENT_ITEM_ID | — | ✅ |
| 87 | PercentCompleted | PERCENT_COMPLETED | — | ✅ |
| 88 | PerfRatingModelId | PERF_RATING_MODEL_ID | — | ✅ |
| 89 | ProfRatingModelId | PROF_RATING_MODEL_ID | — | ✅ |
| 90 | RatingOverideFlag | RATING_OVERIDE_FLAG | — | ✅ |
| 91 | ReferenceItemId | REFERENCE_ITEM_ID | — | ✅ |
| 92 | ReminderDate | REMINDER_DATE | — | ✅ |
| 93 | StartDate | START_DATE | — | ✅ |
| 94 | TargetDate | TARGET_DATE | — | ✅ |
| 95 | TargetPerfRevRatingId | TARGET_PERF_REV_RATING_ID | — | ✅ |
| 96 | TargetProfRevRatingId | TARGET_PROF_REV_RATING_ID | — | ✅ |
| 97 | Weight | WEIGHT | — | ✅ |
