---
id: DOC-OTHER-PVO-LegalEmployerPVO
doc_type: system-doc
title: "LegalEmployerPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Legal Employer. Acessa as tabelas: FND_SETID_SETS_VL, HR_ALL_ORGANIZATION_UNITS_F, HR_ORGANIZATION_UNITS_F_TL (+4).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.LegalEmployerPVO`
...
- [[fnd_setid_sets_vl|FND_SETID_SETS_VL]] — 5 atributos (3 BICC)
- [[hr_all_organization_units_f|HR_ALL_ORGANIZATION_UNITS_F]] — 18 atributos (16 BICC)
