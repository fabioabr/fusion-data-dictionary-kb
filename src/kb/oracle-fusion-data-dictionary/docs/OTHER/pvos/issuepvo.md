---
id: DOC-OTHER-PVO-IssuePVO
doc_type: system-doc
title: "IssuePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Issue. Acessa as tabelas: GRC_COMMENT, GRC_ISSU_ISSUE_B, GRC_ISSU_ISSUE_TL (+8).

**Caminho:** `FscmTopModelAM.GRCTOPBIAM.IssuePVO`
...
- [[grc_issu_issue_b|GRC_ISSU_ISSUE_B]] — 119 atributos (1 PKs, 28 BICC)
- [[grc_issu_issue_tl|GRC_ISSU_ISSUE_TL]] — 11 atributos (2 BICC)
