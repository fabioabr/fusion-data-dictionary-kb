---
id: DOC-OTHER-PVO-CostOrgBookRefPVO
doc_type: system-doc
title: "CostOrgBookRefPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Cost Org Book Ref. Acessa as tabelas: CST_COST_BOOKS_B, CST_COST_BOOKS_TL, CST_COST_ORGS_V (+2).
