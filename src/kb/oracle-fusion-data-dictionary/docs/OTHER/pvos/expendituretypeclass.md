---
id: DOC-OTHER-PVO-ExpenditureTypeClass
doc_type: system-doc
title: "ExpenditureTypeClass — PVO Cross-Module"
...
View Object para extração BICC de dados de Expenditure Type Class. Acessa as tabelas: PJF_SYSTEM_LINKAGES_B, PJF_SYSTEM_LINKAGES_TL.

**Caminho:** `FscmTopModelAM.PjfSetupSystemAM.ExpenditureTypeClass`
...
- [[pjf_system_linkages_b|PJF_SYSTEM_LINKAGES_B]] — 12 atributos (1 PKs, 5 BICC)
- [[pjf_system_linkages_tl|PJF_SYSTEM_LINKAGES_TL]] — 11 atributos (1 BICC)
...
| 6 | ExpenditureTypeClassBasePEOLaborNonLaborFlag | LABOR_NON_LABOR_FLAG | — | — |
| 7 | ExpenditureTypeClassBasePEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 8 | ExpenditureTypeClassBasePEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 9 | ExpenditureTypeClassBasePEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 10 | ExpenditureTypeClassBasePEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 11 | ExpenditureTypeClassBasePEOProjectManufacturingFlag | PROJECT_MANUFACTURING_FLAG | — | — |
| 12 | Function1 | FUNCTION | 🔑 | ✅ |
