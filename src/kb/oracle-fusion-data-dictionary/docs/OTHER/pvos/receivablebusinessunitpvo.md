---
id: DOC-OTHER-PVO-ReceivableBusinessUnitPVO
doc_type: system-doc
title: "ReceivableBusinessUnitPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Receivable Business Unit. Acessa as tabelas: FND_SETID_SETS_VL, GL_LEDGERS, HR_ALL_ORGANIZATION_UNITS_F (+8).

**Caminho:** `FscmTopModelAM.FinFunBusinessUnitsAM.ReceivableBusinessUnitPVO`
