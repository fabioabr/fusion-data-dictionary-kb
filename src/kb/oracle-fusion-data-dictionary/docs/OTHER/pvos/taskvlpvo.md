---
id: DOC-OTHER-PVO-TaskVLPVO
doc_type: system-doc
title: "TaskVLPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Task VL. Acessa as tabelas: HR_ORGANIZATION_V, PER_PERSON_NAMES_F_V, PJF_PROJECTS_ALL_B (+4).

**Caminho:** `FscmTopModelAM.PjfProjectDefinitionAM.TaskVLPVO`
...
- [[pjf_proj_elements_vl|PJF_PROJ_ELEMENTS_VL]] — 147 atributos (1 PKs, 113 BICC)
- [[pjf_work_types_vl|PJF_WORK_TYPES_VL]] — 3 atributos (1 BICC)
- [[pjo_project_progress|PJO_PROJECT_PROGRESS]] — 9 atributos (4 BICC)
