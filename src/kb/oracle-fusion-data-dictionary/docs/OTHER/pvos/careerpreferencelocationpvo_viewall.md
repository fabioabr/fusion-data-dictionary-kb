---
id: DOC-OTHER-PVO-CareerPreferenceLocationPVO_Viewall
doc_type: system-doc
title: "CareerPreferenceLocationPVO_Viewall — PVO Cross-Module"
...
View Object para extração BICC de dados de Career Preference Location_Viewall. Acessa as tabelas: PER_LOCATIONS, PER_LOCATION_DETAILS_F_TL, PER_LOCATION_DETAILS_F_VL.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.CareerPreferenceLocationPVO_Viewall`
...
- [[per_location_details_f_tl|PER_LOCATION_DETAILS_F_TL]] — 10 atributos (4 BICC)
- [[per_location_details_f_vl|PER_LOCATION_DETAILS_F_VL]] — 34 atributos (2 BICC)
