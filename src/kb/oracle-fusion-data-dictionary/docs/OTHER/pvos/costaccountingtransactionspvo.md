---
id: DOC-OTHER-PVO-CostAccountingTransactionsPVO
doc_type: system-doc
title: "CostAccountingTransactionsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Cost Accounting Transactions. Acessa as tabelas: AP_INVOICES_ALL, AP_INVOICE_DISTRIBUTIONS_ALL, AP_INVOICE_LINES_ALL (+30).

**Caminho:** `FscmTopModelAM.CostTransactionAM.CostAccountingTransactionsPVO`
...
- [[cmr_ap_invoice_dtls|CMR_AP_INVOICE_DTLS]] — 66 atributos (66 BICC)
- [[cmr_purchase_order_dtls|CMR_PURCHASE_ORDER_DTLS]] — 84 atributos
- [[cmr_rcv_transactions|CMR_RCV_TRANSACTIONS]] — 91 atributos (91 BICC)
- [[cmr_r_active_purchase_orddtl_v|CMR_R_ACTIVE_PURCHASE_ORDDTL_V]] — 2 atributos (2 BICC)
- [[cst_all_cost_transactions_v|CST_ALL_COST_TRANSACTIONS_V]] — 94 atributos (1 PKs, 64 BICC)
- [[cst_all_expense_pool_txns_v|CST_ALL_EXPENSE_POOL_TXNS_V]] — 16 atributos (9 BICC)
- [[cst_cost_distributions|CST_COST_DISTRIBUTIONS]] — 31 atributos (29 BICC)
- [[cst_cost_distribution_lines|CST_COST_DISTRIBUTION_LINES]] — 28 atributos (1 PKs, 25 BICC)
- [[cst_cost_orgs_v|CST_COST_ORGS_V]] — 4 atributos
- [[cst_cost_org_books|CST_COST_ORG_BOOKS]] — 6 atributos
- [[cst_inv_transactions|CST_INV_TRANSACTIONS]] — 53 atributos (40 BICC)
- [[cst_trade_events|CST_TRADE_EVENTS]] — 4 atributos
- [[cst_txn_invoice_asc_v|CST_TXN_INVOICE_ASC_V]] — 3 atributos (3 BICC)
- [[cst_work_orders|CST_WORK_ORDERS]] — 3 atributos
- [[doo_document_references|DOO_DOCUMENT_REFERENCES]] — 23 atributos (1 PKs, 23 BICC)
- [[doo_fulfill_lines_all|DOO_FULFILL_LINES_ALL]] — 115 atributos
- [[doo_headers_all|DOO_HEADERS_ALL]] — 31 atributos (1 BICC)
...
- [[xla_cst_distribution_lines_vl|XLA_CST_DISTRIBUTION_LINES_VL]] — 9 atributos (5 BICC)
- [[xla_event_classes_tl|XLA_EVENT_CLASSES_TL]] — 6 atributos (1 PKs, 6 BICC)
