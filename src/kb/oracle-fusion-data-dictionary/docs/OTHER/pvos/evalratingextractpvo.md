---
id: DOC-OTHER-PVO-EvalRatingExtractPVO
doc_type: system-doc
title: "EvalRatingExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Eval Rating Extract. Acessa as tabelas: HRA_EVAL_RATINGS.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HCMExtractAM.PerformanceBiccExtractAM.EvalRatingExtractPVO`
...
- [[hra_eval_ratings|HRA_EVAL_RATINGS]] — 85 atributos (1 PKs, 85 BICC)
...
| 68 | CalculatedRating | CALCULATED_RATING | — | ✅ |
| 69 | CommentText | COMMENT_TEXT | — | ✅ |
| 70 | Comments | COMMENTS | — | ✅ |
| 71 | CreatedBy | CREATED_BY | — | ✅ |
| 72 | CreationDate | CREATION_DATE | — | ✅ |
| 73 | EvalParticipantId | EVAL_PARTICIPANT_ID | — | ✅ |
| 74 | EvalRatingId | EVAL_RATING_ID | 🔑 | ✅ |
| 75 | EvaluationId | EVALUATION_ID | — | ✅ |
...
| 80 | PerformanceRatingId | PERFORMANCE_RATING_ID | — | ✅ |
| 81 | ProficiencyRatingId | PROFICIENCY_RATING_ID | — | ✅ |
| 82 | ReferenceId | REFERENCE_ID | — | ✅ |
| 83 | ReferenceType | REFERENCE_TYPE | — | ✅ |
| 84 | ReviewPoints | REVIEW_POINTS | — | ✅ |
| 85 | RoleTypeCode | ROLE_TYPE_CODE | — | ✅ |
