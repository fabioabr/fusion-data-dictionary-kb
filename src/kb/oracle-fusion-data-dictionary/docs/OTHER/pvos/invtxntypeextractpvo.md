---
id: DOC-OTHER-PVO-InvTxnTypeExtractPVO
doc_type: system-doc
title: "InvTxnTypeExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Inv Txn Type Extract. Acessa as tabelas: INV_TRANSACTION_TYPES_B, INV_TRANSACTION_TYPES_TL.

**Caminho:** `FscmTopModelAM.ScmExtractAM.InvBiccExtractAM.InvTxnTypeExtractPVO`
...
- [[inv_transaction_types_b|INV_TRANSACTION_TYPES_B]] — 17 atributos (1 PKs, 17 BICC)
- [[inv_transaction_types_tl|INV_TRANSACTION_TYPES_TL]] — 11 atributos (11 BICC)
