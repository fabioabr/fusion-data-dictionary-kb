---
id: DOC-OTHER-PVO-AdvancedTransactionControlDetailsRefPVO
doc_type: system-doc
title: "AdvancedTransactionControlDetailsRefPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Advanced Transaction Control Details Ref. Acessa as tabelas: GRC_COMMENT, GRC_CTRL_CCM_CONTROL_TL, GRC_JOB (+11).

**Caminho:** `FscmTopModelAM.GRCTOPBIAM.AdvancedTransactionControlDetailsRefPVO`
...
- [[grc_otbi_ctrl_ccm_b|GRC_OTBI_CTRL_CCM_B]] — 52 atributos (3 PKs, 42 BICC)
- [[gtg_ca_ctrl_bo|GTG_CA_CTRL_BO]] — 9 atributos
...
### [[gtg_ca_ctrl_bo|GTG_CA_CTRL_BO]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ControlJobBOPEOBoCount | BO_COUNT | — | — |
| 2 | ControlJobBOPEOControlId | CONTROL_ID | — | — |
| 3 | ControlJobBOPEOCreatedBy | CREATED_BY | — | — |
| 4 | ControlJobBOPEOCreationDate | CREATION_DATE | — | — |
| 5 | ControlJobBOPEOJobId | JOB_ID | — | — |
| 6 | ControlJobBOPEOLastUpdateDate | LAST_UPDATE_DATE | — | — |
| 7 | ControlJobBOPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 8 | ControlJobBOPEOLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 9 | ControlJobBOPEOOntClassUrl | ONT_CLASS_URL | — | — |
