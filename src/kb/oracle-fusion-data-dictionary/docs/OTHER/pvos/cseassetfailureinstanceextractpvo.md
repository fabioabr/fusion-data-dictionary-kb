---
id: DOC-OTHER-PVO-CseAssetFailureInstanceExtractPVO
doc_type: system-doc
title: "CseAssetFailureInstanceExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Cse Asset Failure Instance Extract. Acessa as tabelas: CSE_FAILURE_INSTANCES.

**Caminho:** `FscmTopModelAM.ScmExtractAM.CseBiccExtractAM.CseAssetFailureInstanceExtractPVO`
...
- [[cse_failure_instances|CSE_FAILURE_INSTANCES]] — 59 atributos (1 PKs, 59 BICC)

---

## ⚙️ Atributos

### [[cse_failure_instances|CSE_FAILURE_INSTANCES]]
...
| 42 | CauseCodeId | CAUSE_CODE_ID | — | ✅ |
| 43 | CreatedBy | CREATED_BY | — | ✅ |
| 44 | CreationDate | CREATION_DATE | — | ✅ |
| 45 | FailedAssetId | FAILED_ASSET_ID | — | ✅ |
| 46 | FailedItemId | FAILED_ITEM_ID | — | ✅ |
| 47 | FailedSerialNumber | FAILED_SERIAL_NUMBER | — | ✅ |
| 48 | FailureCodeId | FAILURE_CODE_ID | — | ✅ |
| 49 | FailureComments | FAILURE_COMMENTS | — | ✅ |
| 50 | FailureEventId | FAILURE_EVENT_ID | — | ✅ |
| 51 | FailureFlag | FAILURE_FLAG | — | ✅ |
| 52 | FailureInstanceId | FAILURE_INSTANCE_ID | 🔑 | ✅ |
| 53 | LastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 54 | LastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 55 | LastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 56 | ObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 57 | ResolutionCodeId | RESOLUTION_CODE_ID | — | ✅ |
| 58 | SeverityCode | SEVERITY_CODE | — | ✅ |
| 59 | StatusCode | STATUS_CODE | — | ✅ |
