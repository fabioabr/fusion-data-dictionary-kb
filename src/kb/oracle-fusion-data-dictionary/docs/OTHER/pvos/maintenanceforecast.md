---
id: DOC-OTHER-PVO-MaintenanceForecast
doc_type: system-doc
title: "MaintenanceForecast — PVO Cross-Module"
...
View Object para extração BICC de dados de Maintenance Forecast. Acessa as tabelas: INV_ORG_PARAMETERS, MNT_FORECASTS.

**Caminho:** `FscmTopModelAM.MaintProgramAM.MaintenanceForecast`
...
- [[mnt_forecasts|MNT_FORECASTS]] — 59 atributos (1 PKs, 5 BICC)
...
| 58 | MaintenanceForecastPEORequestedSkipDueDateFlag | REQUESTED_SKIP_DUE_DATE_FLAG | — | — |
| 59 | MaintenanceForecastPEORequestedWoStartDate | REQUESTED_WO_START_DATE | — | — |
