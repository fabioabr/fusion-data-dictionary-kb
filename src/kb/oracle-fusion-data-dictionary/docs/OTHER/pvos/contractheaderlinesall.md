---
id: DOC-OTHER-PVO-ContractHeaderLinesAll
doc_type: system-doc
title: "ContractHeaderLinesAll — PVO Cross-Module"
...
View Object para extração BICC de dados de Contract Header Lines All. Acessa as tabelas: EGP_CATEGORIES_B, EGP_CATEGORIES_TL, EGP_SYSTEM_ITEMS_B_V (+33).

**Caminho:** `FscmTopModelAM.ContractsCoreAM.ContractHeaderLinesAll`
...
- [[fnd_setid_assignments|FND_SETID_ASSIGNMENTS]] — 16 atributos (3 BICC)
...
- [[hr_organization_units_f_tl|HR_ORGANIZATION_UNITS_F_TL]] — 17 atributos
- [[hr_organization_v|HR_ORGANIZATION_V]] — 6 atributos
- [[hz_cust_accounts|HZ_CUST_ACCOUNTS]] — 17 atributos
- [[hz_cust_site_uses_all|HZ_CUST_SITE_USES_ALL]] — 14 atributos
- [[hz_locations|HZ_LOCATIONS]] — 25 atributos
- [[hz_parties|HZ_PARTIES]] — 274 atributos (28 BICC)
- [[hz_party_sites|HZ_PARTY_SITES]] — 172 atributos (12 BICC)
- [[inv_organization_definitions_v|INV_ORGANIZATION_DEFINITIONS_V]] — 5 atributos
- [[inv_units_of_measure_vl|INV_UNITS_OF_MEASURE_VL]] — 3 atributos (1 BICC)
- [[okc_contract_types_vl|OKC_CONTRACT_TYPES_VL]] — 38 atributos (1 BICC)
- [[okc_k_headers_all_b|OKC_K_HEADERS_ALL_B]] — 105 atributos (15 BICC)
- [[okc_k_headers_tl|OKC_K_HEADERS_TL]] — 15 atributos (4 BICC)
- [[okc_k_inv_rev_summary_v|OKC_K_INV_REV_SUMMARY_V]] — 4 atributos (2 BICC)
- [[okc_k_lines_b|OKC_K_LINES_B]] — 96 atributos (2 PKs, 20 BICC)
- [[okc_k_lines_tl|OKC_K_LINES_TL]] — 18 atributos (4 BICC)
- [[okc_line_types_vl|OKC_LINE_TYPES_VL]] — 3 atributos
- [[pjb_bill_plans_vl|PJB_BILL_PLANS_VL]] — 19 atributos
- [[pjb_clin_internal_attributes|PJB_CLIN_INTERNAL_ATTRIBUTES]] — 12 atributos
- [[pjf_exp_types_tl|PJF_EXP_TYPES_TL]] — 3 atributos
- [[pjf_projects_all_b|PJF_PROJECTS_ALL_B]] — 2 atributos
- [[pjf_projects_all_tl|PJF_PROJECTS_ALL_TL]] — 3 atributos
- [[pjf_proj_elements_b|PJF_PROJ_ELEMENTS_B]] — 2 atributos
- [[pjf_proj_elements_tl|PJF_PROJ_ELEMENTS_TL]] — 3 atributos
- [[qsc_pricebook_headers_vl|QSC_PRICEBOOK_HEADERS_VL]] — 6 atributos (4 BICC)
- [[xle_entity_profiles|XLE_ENTITY_PROFILES]] — 6 atributos
