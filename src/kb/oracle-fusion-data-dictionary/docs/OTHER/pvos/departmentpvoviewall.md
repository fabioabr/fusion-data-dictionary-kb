---
id: DOC-OTHER-PVO-DepartmentPVOViewAll
doc_type: system-doc
title: "DepartmentPVOViewAll — PVO Cross-Module"
...
View Object para extração BICC de dados de Department View All. Acessa as tabelas: FND_SETID_SETS_VL, HR_ALL_ORGANIZATION_UNITS_F, HR_ORGANIZATION_UNITS_F_TL (+4).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.DepartmentPVOViewAll`
...
- [[hr_all_organization_units_f|HR_ALL_ORGANIZATION_UNITS_F]] — 18 atributos (17 BICC)
- [[hr_organization_units_f_tl|HR_ORGANIZATION_UNITS_F_TL]] — 13 atributos (5 BICC)
