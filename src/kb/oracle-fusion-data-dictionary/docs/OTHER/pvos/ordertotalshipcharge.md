---
id: DOC-OTHER-PVO-OrderTotalShipCharge
doc_type: system-doc
title: "OrderTotalShipCharge — PVO Cross-Module"
...
View Object para extração BICC de dados de Order Total Ship Charge. Acessa as tabelas: DOO_HEADERS_ALL, DOO_ORDER_TOTALS, FUN_ALL_BUSINESS_UNITS_V (+1).

**Caminho:** `FscmTopModelAM.DooTopAM.OrderTotalShipCharge`
