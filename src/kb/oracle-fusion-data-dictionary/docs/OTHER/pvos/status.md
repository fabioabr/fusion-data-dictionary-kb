---
id: DOC-OTHER-PVO-Status
doc_type: system-doc
title: "Status — PVO Cross-Module"
...
View Object para extração BICC de dados de Status. Acessa as tabelas: DOO_STATUSES_B, DOO_STATUSES_TL.

**Caminho:** `FscmTopModelAM.DooTopAM.Status`
...
- [[doo_statuses_b|DOO_STATUSES_B]] — 10 atributos (1 PKs, 7 BICC)
