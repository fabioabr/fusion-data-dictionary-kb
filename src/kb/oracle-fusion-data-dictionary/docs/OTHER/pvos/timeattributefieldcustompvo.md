---
id: DOC-OTHER-PVO-TimeAttributeFieldCustomPVO
doc_type: system-doc
title: "TimeAttributeFieldCustomPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Time Attribute Field Custom. Acessa as tabelas: FND_VS_VALUE_SETS, HWM_DATA_SOURCE_USAGES_V, HWM_TCSMRS_VL (+3).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.DataDictionaryAM.TimeAttributeFieldCustomPVO`
...
- [[hwm_data_source_usages_v|HWM_DATA_SOURCE_USAGES_V]] — 22 atributos (8 BICC)
- [[hwm_tcsmrs_vl|HWM_TCSMRS_VL]] — 3 atributos (2 BICC)
- [[hwm_tm_atrb_flds_b|HWM_TM_ATRB_FLDS_B]] — 23 atributos (1 PKs, 15 BICC)
