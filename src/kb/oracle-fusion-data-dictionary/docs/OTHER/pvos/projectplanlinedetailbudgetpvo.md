---
id: DOC-OTHER-PVO-ProjectPlanLineDetailBudgetPVO
doc_type: system-doc
title: "ProjectPlanLineDetailBudgetPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Project Plan Line Detail Budget. Acessa as tabelas: CST_COST_BOOKS_B, EGP_CATEGORIES_VL, EGP_SYSTEM_ITEMS_VL (+39).

**Caminho:** `FscmTopModelAM.PjoBudgetsAndForecastsAnalyticsAM.ProjectPlanLineDetailBudgetPVO`
...
- [[egp_system_items_vl|EGP_SYSTEM_ITEMS_VL]] — 4 atributos (1 BICC)
...
- [[pjf_event_types_vl|PJF_EVENT_TYPES_VL]] — 3 atributos (1 BICC)
- [[pjf_exp_categories_vl|PJF_EXP_CATEGORIES_VL]] — 3 atributos (1 BICC)
...
- [[pjf_proj_elements_vl|PJF_PROJ_ELEMENTS_VL]] — 5 atributos
- [[pjf_proj_role_types_vl|PJF_PROJ_ROLE_TYPES_VL]] — 3 atributos
- [[pjf_rate_schedules_vl|PJF_RATE_SCHEDULES_VL]] — 33 atributos (3 BICC)
- [[pjf_rbs_elements_vl|PJF_RBS_ELEMENTS_VL]] — 50 atributos (12 BICC)
- [[pjf_rbs_element_map|PJF_RBS_ELEMENT_MAP]] — 4 atributos (1 BICC)
...
- [[pjo_fin_plan_amt_sets|PJO_FIN_PLAN_AMT_SETS]] — 11 atributos
- [[pjo_period_profiles_vl|PJO_PERIOD_PROFILES_VL]] — 2 atributos
- [[pjo_planning_elements|PJO_PLANNING_ELEMENTS]] — 56 atributos (12 BICC)
- [[pjo_planning_options|PJO_PLANNING_OPTIONS]] — 91 atributos (1 BICC)
- [[pjo_plan_lines|PJO_PLAN_LINES]] — 83 atributos (5 BICC)
- [[pjo_plan_line_details|PJO_PLAN_LINE_DETAILS]] — 101 atributos (1 PKs, 43 BICC)
...
- [[pjo_plan_versions_b|PJO_PLAN_VERSIONS_B]] — 48 atributos (6 BICC)
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | OrganizationForRbsElementClassificationCode | CLASSIFICATION_CODE | — | — |
| 2 | OrganizationForRbsElementEffectiveEndDate | EFFECTIVE_END_DATE | — | — |
| 3 | OrganizationForRbsElementEffectiveStartDate | EFFECTIVE_START_DATE | — | ✅ |
| 4 | OrganizationForRbsElementName | NAME | — | ✅ |
| 5 | OrganizationForRbsElementOrganizationId | ORGANIZATION_ID | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | EventTypeForRbsElementEventTypeId | EVENT_TYPE_ID | — | — |
| 2 | EventTypeForRbsElementEventTypeName | EVENT_TYPE_NAME | — | ✅ |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ExpCategoryForRbsElementExpenditureCategoryId | EXPENDITURE_CATEGORY_ID | — | — |
| 2 | ExpCategoryForRbsElementExpenditureCategoryName | EXPENDITURE_CATEGORY_NAME | — | ✅ |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ExpenditureTypeForRbsElementExpenditureTypeId | EXPENDITURE_TYPE_ID | — | — |
| 2 | ExpenditureTypeForRbsElementExpenditureTypeName | EXPENDITURE_TYPE_NAME | — | ✅ |
...
| 2 | TaskStructForPlanElementDescription | DESCRIPTION | — | — |
| 3 | TaskStructForPlanElementName | NAME | — | — |
| 4 | TaskStructForPlanElementProjElementId | PROJ_ELEMENT_ID | — | — |
| 5 | TaskStructForPlanElementType | ELEMENT_TYPE | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | BillRateSchForPlanLineDescription | DESCRIPTION | — | — |
| 2 | BillRateSchForPlanLineDetailRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 3 | BillRateSchForPlanLineDetailRateScheduleName | RATE_SCHEDULE_NAME | — | ✅ |
| 4 | BillRateSchForPlanLineRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 5 | BillRateSchForPlanLineRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 6 | CostBrdnRateSchForPlanOptionRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 7 | CostBrdnRateSchForPlanOptionRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 8 | CostEmpRateSchForPlanOptionRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 9 | CostEmpRateSchForPlanOptionRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 10 | CostJobRateSchForPlanOptionRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 11 | CostJobRateSchForPlanOptionRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 12 | CostNonLbrRateSchForPlanOptnRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 13 | CostNonLbrRateSchForPlanOptnRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 14 | CostRateSchForPlanLineDescription | DESCRIPTION | — | — |
| 15 | CostRateSchForPlanLineDetailRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 16 | CostRateSchForPlanLineDetailRateScheduleName | RATE_SCHEDULE_NAME | — | ✅ |
| 17 | CostRateSchForPlanLineRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 18 | CostRateSchForPlanLineRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 19 | IndRateSchForPlanLineDescription | DESCRIPTION | — | — |
| 20 | IndRateSchForPlanLineDetailRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 21 | IndRateSchForPlanLineDetailRateScheduleName | RATE_SCHEDULE_NAME | — | ✅ |
| 22 | IndRateSchForPlanLineRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 23 | IndRateSchForPlanLineRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 24 | ResClsBillRateSchForPlanOptnRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 25 | ResClsBillRateSchForPlanOptnRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 26 | ResClsRawCostRateSchForPlanORateScheduleId | RATE_SCHEDULE_ID | — | — |
| 27 | ResClsRawCostRateSchForPlanORateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 28 | RevEmpRateSchForPlanOptionRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 29 | RevEmpRateSchForPlanOptionRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 30 | RevJobRateSchForPlanOptionRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 31 | RevJobRateSchForPlanOptionRateScheduleName | RATE_SCHEDULE_NAME | — | — |
| 32 | RevNonLbrRateSchForPlanOptioRateScheduleId | RATE_SCHEDULE_ID | — | — |
| 33 | RevNonLbrRateSchForPlanOptioRateScheduleName | RATE_SCHEDULE_NAME | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ProjectRbsElementMapPEOResourceId | RESOURCE_ID | — | — |
| 2 | ProjectRbsElementMapPEOResourceName | RESOURCE_NAME | — | — |
| 3 | RevCategoryForRbsElementResourceId | RESOURCE_ID | — | — |
| 4 | RevCategoryForRbsElementResourceName | RESOURCE_NAME | — | ✅ |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | RbsFormaForRbsElementName | NAME | — | — |
| 2 | RbsFormaForRbsElementResFormatId | RES_FORMAT_ID | — | — |
...
| 2 | AmountSetForPlanOptionAmountSetTypeCode | AMOUNT_SET_TYPE_CODE | — | — |
| 3 | AmountSetForPlanOptionBillRateFlag | BILL_RATE_FLAG | — | — |
| 4 | AmountSetForPlanOptionBrdndCostFlag | BRDND_COST_FLAG | — | — |
| 5 | AmountSetForPlanOptionBrdndRateFlag | BRDND_RATE_FLAG | — | — |
| 6 | AmountSetForPlanOptionCostQtyFlag | COST_QTY_FLAG | — | — |
| 7 | AmountSetForPlanOptionCostRateFlag | COST_RATE_FLAG | — | — |
| 8 | AmountSetForPlanOptionFinPlanAmtSetId | FIN_PLAN_AMT_SET_ID | — | — |
| 9 | AmountSetForPlanOptionRawCostFlag | RAW_COST_FLAG | — | — |
| 10 | AmountSetForPlanOptionRevenueFlag | REVENUE_FLAG | — | — |
| 11 | AmountSetForPlanOptionRevenueQtyFlag | REVENUE_QTY_FLAG | — | — |
...
| 9 | PlanningElementPEOFundingSourceId | FUNDING_SOURCE_ID | — | — |
| 10 | PlanningElementPEOInventoryItemId | INVENTORY_ITEM_ID | — | — |
| 11 | PlanningElementPEOItemCategoryId | ITEM_CATEGORY_ID | — | — |
| 12 | PlanningElementPEOJobId | JOB_ID | — | — |
| 13 | PlanningElementPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 14 | PlanningElementPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 15 | PlanningElementPEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 16 | PlanningElementPEOMfcCostTypeId | MFC_COST_TYPE_ID | — | — |
| 17 | PlanningElementPEONonLaborResourceId | NON_LABOR_RESOURCE_ID | — | — |
| 18 | PlanningElementPEOObjectChildId1 | OBJECT_CHILD_ID1 | — | — |
| 19 | PlanningElementPEOObjectChildId2 | OBJECT_CHILD_ID2 | — | — |
| 20 | PlanningElementPEOObjectChildId3 | OBJECT_CHILD_ID3 | — | — |
| 21 | PlanningElementPEOObjectId1 | OBJECT_ID1 | — | — |
| 22 | PlanningElementPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 23 | PlanningElementPEOOrganizationId | ORGANIZATION_ID | — | — |
| 24 | PlanningElementPEOParentElementId | PARENT_ELEMENT_ID | — | — |
| 25 | PlanningElementPEOPersonId | PERSON_ID | — | — |
| 26 | PlanningElementPEOPersonTypeId | PERSON_TYPE_ID | — | — |
| 27 | PlanningElementPEOPlanVersionId | PLAN_VERSION_ID | — | — |
| 28 | PlanningElementPEOPlanningElementId | PLANNING_ELEMENT_ID | — | — |
| 29 | PlanningElementPEOPlanningEndDate | PLANNING_END_DATE | — | ✅ |
| 30 | PlanningElementPEOPlanningStartDate | PLANNING_START_DATE | — | ✅ |
| 31 | PlanningElementPEOPmProductCode | PM_PRODUCT_CODE | — | — |
| 32 | PlanningElementPEOPmResAsgnReference | PM_RES_ASGN_REFERENCE | — | — |
| 33 | PlanningElementPEOProcureResourceFlag | PROCURE_RESOURCE_FLAG | — | — |
| 34 | PlanningElementPEOProgressEtcMethodCode | PROGRESS_ETC_METHOD_CODE | — | — |
| 35 | PlanningElementPEOProjElementVersionId | PROJ_ELEMENT_VERSION_ID | — | — |
| 36 | PlanningElementPEOProjectId | PROJECT_ID | — | ✅ |
| 37 | PlanningElementPEOProjectRoleId | PROJECT_ROLE_ID | — | — |
| 38 | PlanningElementPEORaTaskDatesSame | RA_TASK_DATES_SAME | — | — |
| 39 | PlanningElementPEORateBasedFlag | RATE_BASED_FLAG | — | ✅ |
| 40 | PlanningElementPEORateExpFuncCurrCode | RATE_EXP_FUNC_CURR_CODE | — | — |
| 41 | PlanningElementPEORateExpenditureOrgId | RATE_EXPENDITURE_ORG_ID | — | ✅ |
| 42 | PlanningElementPEORateExpenditureTypeId | RATE_EXPENDITURE_TYPE_ID | — | — |
| 43 | PlanningElementPEORbsElementId | RBS_ELEMENT_ID | — | — |
| 44 | PlanningElementPEOResTypeCode | RES_TYPE_CODE | — | — |
| 45 | PlanningElementPEOResourceClassCode | RESOURCE_CLASS_CODE | — | — |
| 46 | PlanningElementPEOResourceClassFlag | RESOURCE_CLASS_FLAG | — | — |
| 47 | PlanningElementPEORevenueCategoryId | REVENUE_CATEGORY_ID | — | — |
| 48 | PlanningElementPEOScheduledDelay | SCHEDULED_DELAY | — | — |
| 49 | PlanningElementPEOSpFixedDate | SP_FIXED_DATE | — | — |
| 50 | PlanningElementPEOSpreadCurveId | SPREAD_CURVE_ID | — | — |
| 51 | PlanningElementPEOSupplierId | SUPPLIER_ID | — | — |
| 52 | PlanningElementPEOTaskId | TASK_ID | — | ✅ |
| 53 | PlanningElementPEOTransactionSourceCode | TRANSACTION_SOURCE_CODE | — | — |
| 54 | PlanningElementPEOTxnAccumHeaderId | TXN_ACCUM_HEADER_ID | — | — |
| 55 | PlanningElementPEOUnitOfMeasure | UNIT_OF_MEASURE | — | ✅ |
| 56 | PlanningElementPEOUnplannedFlag | UNPLANNED_FLAG | — | — |
...
| 78 | PlanningOptionPEORetOverRatesFrmSrcFlag | RET_OVER_RATES_FRM_SRC_FLAG | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | PlanLinePEOBillRateScheduleId | BILL_RATE_SCHEDULE_ID | — | — |
| 2 | PlanLinePEOCostRateScheduleId | COST_RATE_SCHEDULE_ID | — | — |
| 3 | PlanLinePEOCreatedBy | CREATED_BY | — | ✅ |
| 4 | PlanLinePEOCreationDate | CREATION_DATE | — | ✅ |
| 5 | PlanLinePEOIndRateScheduleId | IND_RATE_SCHEDULE_ID | — | — |
| 6 | PlanLinePEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 7 | PlanLinePEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 8 | PlanLinePEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 9 | PlanLinePEOMultiErrorFlag | MULTI_ERROR_FLAG | — | — |
| 10 | PlanLinePEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 11 | PlanLinePEOPlanLineId | PLAN_LINE_ID | — | — |
...
### [[pjo_plan_line_details|PJO_PLAN_LINE_DETAILS]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | PlanLineDetailId | PLAN_LINE_DETAIL_ID | 🔑 | ✅ |
| 2 | PlanLineDetailPEOActQuantity | ACT_QUANTITY | — | — |
| 3 | PlanLineDetailPEOAwardPeriodId | AWARD_PERIOD_ID | — | — |
| 4 | PlanLineDetailPEOBillRateScheduleId | BILL_RATE_SCHEDULE_ID | — | — |
| 5 | PlanLineDetailPEOCostIndCompiledSetId | COST_IND_COMPILED_SET_ID | — | — |
| 6 | PlanLineDetailPEOCostRateScheduleId | COST_RATE_SCHEDULE_ID | — | — |
| 7 | PlanLineDetailPEOCreatedBy | CREATED_BY | — | ✅ |
| 8 | PlanLineDetailPEOCreationDate | CREATION_DATE | — | ✅ |
| 9 | PlanLineDetailPEOEndDate | END_DATE | — | ✅ |
| 10 | PlanLineDetailPEOExtQuantity | EXT_QUANTITY | — | — |
| 11 | PlanLineDetailPEOIndRateScheduleId | IND_RATE_SCHEDULE_ID | — | — |
| 12 | PlanLineDetailPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 13 | PlanLineDetailPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 14 | PlanLineDetailPEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 15 | PlanLineDetailPEOMultiErrorFlag | MULTI_ERROR_FLAG | — | — |
| 16 | PlanLineDetailPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 17 | PlanLineDetailPEOPcActBrdndCost | PC_ACT_BRDND_COST | — | — |
| 18 | PlanLineDetailPEOPcActRawCost | PC_ACT_RAW_COST | — | — |
| 19 | PlanLineDetailPEOPcActRevenue | PC_ACT_REVENUE | — | — |
| 20 | PlanLineDetailPEOPcBrdndCost | PC_BRDND_COST | — | ✅ |
| 21 | PlanLineDetailPEOPcCode | PC_CODE | — | ✅ |
| 22 | PlanLineDetailPEOPcCostExchangeRate | PC_COST_EXCHANGE_RATE | — | ✅ |
| 23 | PlanLineDetailPEOPcCostRateDate | PC_COST_RATE_DATE | — | ✅ |
| 24 | PlanLineDetailPEOPcCostRateDateType | PC_COST_RATE_DATE_TYPE | — | — |
| 25 | PlanLineDetailPEOPcCostRateType | PC_COST_RATE_TYPE | — | ✅ |
| 26 | PlanLineDetailPEOPcExtBrdndCost | PC_EXT_BRDND_COST | — | — |
| 27 | PlanLineDetailPEOPcExtRawCost | PC_EXT_RAW_COST | — | — |
| 28 | PlanLineDetailPEOPcPoBrdndCost | PC_PO_BRDND_COST | — | — |
| 29 | PlanLineDetailPEOPcPoRawCost | PC_PO_RAW_COST | — | — |
| 30 | PlanLineDetailPEOPcRawCost | PC_RAW_COST | — | ✅ |
| 31 | PlanLineDetailPEOPcReqBrdndCost | PC_REQ_BRDND_COST | — | — |
| 32 | PlanLineDetailPEOPcReqRawCost | PC_REQ_RAW_COST | — | — |
| 33 | PlanLineDetailPEOPcRevExchangeRate | PC_REV_EXCHANGE_RATE | — | ✅ |
| 34 | PlanLineDetailPEOPcRevRateDate | PC_REV_RATE_DATE | — | ✅ |
| 35 | PlanLineDetailPEOPcRevRateDateType | PC_REV_RATE_DATE_TYPE | — | ✅ |
| 36 | PlanLineDetailPEOPcRevRateType | PC_REV_RATE_TYPE | — | ✅ |
| 37 | PlanLineDetailPEOPcRevenue | PC_REVENUE | — | ✅ |
| 38 | PlanLineDetailPEOPcSiBrdndCost | PC_SI_BRDND_COST | — | — |
| 39 | PlanLineDetailPEOPcSiRawCost | PC_SI_RAW_COST | — | — |
| 40 | PlanLineDetailPEOPcToBrdndCost | PC_TO_BRDND_COST | — | — |
| 41 | PlanLineDetailPEOPcToRawCost | PC_TO_RAW_COST | — | — |
| 42 | PlanLineDetailPEOPeriodName | PERIOD_NAME | — | — |
| 43 | PlanLineDetailPEOPfcActBrdndCost | PFC_ACT_BRDND_COST | — | — |
| 44 | PlanLineDetailPEOPfcActRawCost | PFC_ACT_RAW_COST | — | — |
| 45 | PlanLineDetailPEOPfcActRevenue | PFC_ACT_REVENUE | — | — |
| 46 | PlanLineDetailPEOPfcBrdndCost | PFC_BRDND_COST | — | ✅ |
| 47 | PlanLineDetailPEOPfcCode | PFC_CODE | — | ✅ |
| 48 | PlanLineDetailPEOPfcCostExchangeRate | PFC_COST_EXCHANGE_RATE | — | ✅ |
| 49 | PlanLineDetailPEOPfcCostRateDate | PFC_COST_RATE_DATE | — | ✅ |
| 50 | PlanLineDetailPEOPfcCostRateDateType | PFC_COST_RATE_DATE_TYPE | — | — |
| 51 | PlanLineDetailPEOPfcCostRateType | PFC_COST_RATE_TYPE | — | ✅ |
| 52 | PlanLineDetailPEOPfcExtBrdndCost | PFC_EXT_BRDND_COST | — | — |
| 53 | PlanLineDetailPEOPfcExtRawCost | PFC_EXT_RAW_COST | — | — |
| 54 | PlanLineDetailPEOPfcPoBrdndCost | PFC_PO_BRDND_COST | — | — |
| 55 | PlanLineDetailPEOPfcPoRawCost | PFC_PO_RAW_COST | — | — |
| 56 | PlanLineDetailPEOPfcRawCost | PFC_RAW_COST | — | ✅ |
| 57 | PlanLineDetailPEOPfcReqBrdndCost | PFC_REQ_BRDND_COST | — | — |
| 58 | PlanLineDetailPEOPfcReqRawCost | PFC_REQ_RAW_COST | — | — |
| 59 | PlanLineDetailPEOPfcRevExchangeRate | PFC_REV_EXCHANGE_RATE | — | ✅ |
| 60 | PlanLineDetailPEOPfcRevRateDate | PFC_REV_RATE_DATE | — | ✅ |
| 61 | PlanLineDetailPEOPfcRevRateDateType | PFC_REV_RATE_DATE_TYPE | — | — |
| 62 | PlanLineDetailPEOPfcRevRateType | PFC_REV_RATE_TYPE | — | ✅ |
| 63 | PlanLineDetailPEOPfcRevenue | PFC_REVENUE | — | ✅ |
| 64 | PlanLineDetailPEOPfcSiBrdndCost | PFC_SI_BRDND_COST | — | — |
| 65 | PlanLineDetailPEOPfcSiRawCost | PFC_SI_RAW_COST | — | — |
| 66 | PlanLineDetailPEOPfcToBrdndCost | PFC_TO_BRDND_COST | — | — |
| 67 | PlanLineDetailPEOPfcToRawCost | PFC_TO_RAW_COST | — | — |
| 68 | PlanLineDetailPEOPlanVersionId | PLAN_VERSION_ID | — | ✅ |
| 69 | PlanLineDetailPEOPlanningElementId | PLANNING_ELEMENT_ID | — | — |
| 70 | PlanLineDetailPEOPoQuantity | PO_QUANTITY | — | — |
| 71 | PlanLineDetailPEOQuantity | QUANTITY | — | ✅ |
| 72 | PlanLineDetailPEOReqQuantity | REQ_QUANTITY | — | — |
| 73 | PlanLineDetailPEOSiQuantity | SI_QUANTITY | — | — |
| 74 | PlanLineDetailPEOStartDate | START_DATE | — | ✅ |
| 75 | PlanLineDetailPEOTcActBrdndCost | TC_ACT_BRDND_COST | — | — |
| 76 | PlanLineDetailPEOTcActRawCost | TC_ACT_RAW_COST | — | — |
| 77 | PlanLineDetailPEOTcActRevenue | TC_ACT_REVENUE | — | — |
| 78 | PlanLineDetailPEOTcBillRateOverride | TC_BILL_RATE_OVERRIDE | — | ✅ |
| 79 | PlanLineDetailPEOTcBrdndCost | TC_BRDND_COST | — | ✅ |
| 80 | PlanLineDetailPEOTcBrdndCostRateOverride | TC_BRDND_COST_RATE_OVERRIDE | — | ✅ |
| 81 | PlanLineDetailPEOTcExtBrdndCost | TC_EXT_BRDND_COST | — | — |
| 82 | PlanLineDetailPEOTcExtRawCost | TC_EXT_RAW_COST | — | — |
| 83 | PlanLineDetailPEOTcMarkupPercent | TC_MARKUP_PERCENT | — | ✅ |
| 84 | PlanLineDetailPEOTcMarkupPercentOverride | TC_MARKUP_PERCENT_OVERRIDE | — | ✅ |
| 85 | PlanLineDetailPEOTcPoBrdndCost | TC_PO_BRDND_COST | — | — |
| 86 | PlanLineDetailPEOTcPoRawCost | TC_PO_RAW_COST | — | — |
| 87 | PlanLineDetailPEOTcRawCost | TC_RAW_COST | — | ✅ |
| 88 | PlanLineDetailPEOTcRawCostRateOverride | TC_RAW_COST_RATE_OVERRIDE | — | ✅ |
| 89 | PlanLineDetailPEOTcReqBrdndCost | TC_REQ_BRDND_COST | — | — |
| 90 | PlanLineDetailPEOTcReqRawCost | TC_REQ_RAW_COST | — | — |
| 91 | PlanLineDetailPEOTcRevenue | TC_REVENUE | — | ✅ |
| 92 | PlanLineDetailPEOTcSiBrdndCost | TC_SI_BRDND_COST | — | — |
| 93 | PlanLineDetailPEOTcSiRawCost | TC_SI_RAW_COST | — | — |
| 94 | PlanLineDetailPEOTcStdBillRate | TC_STD_BILL_RATE | — | ✅ |
| 95 | PlanLineDetailPEOTcStdBrdndCostRate | TC_STD_BRDND_COST_RATE | — | ✅ |
| 96 | PlanLineDetailPEOTcStdBrdndMultiplier | TC_STD_BRDND_MULTIPLIER | — | — |
| 97 | PlanLineDetailPEOTcStdRawCostRate | TC_STD_RAW_COST_RATE | — | ✅ |
| 98 | PlanLineDetailPEOTcToBrdndCost | TC_TO_BRDND_COST | — | — |
| 99 | PlanLineDetailPEOTcToRawCost | TC_TO_RAW_COST | — | — |
| 100 | PlanLineDetailPEOToQuantity | TO_QUANTITY | — | — |
| 101 | PlanLineDetailPEOTxnCurrencyCode | TXN_CURRENCY_CODE | — | ✅ |
