---
id: DOC-OTHER-PVO-ResourceShiftExceptionExtractPVO
doc_type: system-doc
title: "ResourceShiftExceptionExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Resource Shift Exception Extract. Acessa as tabelas: WIS_WC_RESOURCE_SHIFT_EXCPS.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.ResourceShiftExceptionExtractPVO`
...
- [[wis_wc_resource_shift_excps|WIS_WC_RESOURCE_SHIFT_EXCPS]] — 58 atributos (1 PKs, 58 BICC)

---

## ⚙️ Atributos

### [[wis_wc_resource_shift_excps|WIS_WC_RESOURCE_SHIFT_EXCPS]]
...
| 44 | ExceptionType | EXCEPTION_TYPE | — | ✅ |
| 45 | FromDate | FROM_DATE | — | ✅ |
| 46 | FromTime | FROM_TIME | — | ✅ |
...
| 51 | ReasonCode | REASON_CODE | — | ✅ |
| 52 | ResourceId | RESOURCE_ID | — | ✅ |
| 53 | ResourceQuantity | RESOURCE_QUANTITY | — | ✅ |
| 54 | ResourceShiftExceptionId | RESOURCE_SHIFT_EXCEPTION_ID | 🔑 | ✅ |
| 55 | ScheduleDetailId | SCHEDULE_DETAIL_ID | — | ✅ |
| 56 | ToDate | TO_DATE | — | ✅ |
| 57 | ToTime | TO_TIME | — | ✅ |
| 58 | WorkCenterId | WORK_CENTER_ID | — | ✅ |
