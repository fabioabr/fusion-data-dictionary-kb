---
id: DOC-OTHER-PVO-XccCmrReceiptTransactionPVO
doc_type: system-doc
title: "XccCmrReceiptTransactionPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Xcc Cmr Receipt Transaction. Acessa as tabelas: CMR_PURCHASE_ORDER_DTLS, CMR_RCV_DISTRIBUTIONS, CMR_RCV_EVENTS (+6).

**Caminho:** `FscmTopModelAM.FinCcControlEnginePublicModelAM.XccCmrReceiptTransactionPVO`
