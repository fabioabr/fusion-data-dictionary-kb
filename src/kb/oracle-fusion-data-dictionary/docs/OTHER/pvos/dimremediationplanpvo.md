---
id: DOC-OTHER-PVO-DimRemediationPlanPVO
doc_type: system-doc
title: "DimRemediationPlanPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Dim Remediation Plan. Acessa as tabelas: GRC_COMMENT, GRC_ISSU_RMPLAN_B, GRC_ISSU_RMPLAN_TL (+7).

**Caminho:** `FscmTopModelAM.GRCTOPBIAM.DimRemediationPlanPVO`
...
- [[grc_issu_rmplan_tl|GRC_ISSU_RMPLAN_TL]] — 11 atributos (3 BICC)
