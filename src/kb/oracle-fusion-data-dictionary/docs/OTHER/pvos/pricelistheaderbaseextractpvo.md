---
id: DOC-OTHER-PVO-PriceListHeaderBaseExtractPVO
doc_type: system-doc
title: "PriceListHeaderBaseExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Price List Header Base Extract. Acessa as tabelas: QP_PRICE_LISTS_ALL_B.

**Caminho:** `FscmTopModelAM.ScmExtractAM.QpBiccExtractAM.PriceListHeaderBaseExtractPVO`
...
- [[qp_price_lists_all_b|QP_PRICE_LISTS_ALL_B]] — 58 atributos (1 PKs, 21 BICC)

---

## ⚙️ Atributos

### [[qp_price_lists_all_b|QP_PRICE_LISTS_ALL_B]]
...
| 42 | CalculationMethodCode | CALCULATION_METHOD_CODE | — | ✅ |
| 43 | CatalogId | CATALOG_ID | — | ✅ |
| 44 | ChargeDefinitionId | CHARGE_DEFINITION_ID | — | ✅ |
| 45 | CreatedBy | CREATED_BY | — | ✅ |
| 46 | CreationDate | CREATION_DATE | — | ✅ |
| 47 | CurrencyCode | CURRENCY_CODE | — | ✅ |
| 48 | EndDate | END_DATE | — | ✅ |
| 49 | LastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 50 | LastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 51 | LastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 52 | LineTypeCode | LINE_TYPE_CODE | — | ✅ |
| 53 | ObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 54 | OrgId | ORG_ID | — | ✅ |
| 55 | PriceListId | PRICE_LIST_ID | 🔑 | ✅ |
| 56 | PriceListTypeCode | PRICE_LIST_TYPE_CODE | — | ✅ |
