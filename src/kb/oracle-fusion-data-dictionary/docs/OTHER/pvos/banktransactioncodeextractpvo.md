---
id: DOC-OTHER-PVO-BankTransactionCodeExtractPVO
doc_type: system-doc
title: "BankTransactionCodeExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Bank Transaction Code Extract. Acessa as tabelas: CE_TRANSACTION_CODES.

**Caminho:** `FscmTopModelAM.FinExtractAM.CeBiccExtractAM.BankTransactionCodeExtractPVO`
...
- [[ce_transaction_codes|CE_TRANSACTION_CODES]] — 14 atributos (1 PKs, 14 BICC)
