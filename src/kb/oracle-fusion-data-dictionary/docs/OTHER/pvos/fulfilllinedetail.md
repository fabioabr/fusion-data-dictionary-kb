---
id: DOC-OTHER-PVO-FulfillLineDetail
doc_type: system-doc
title: "FulfillLineDetail — PVO Cross-Module"
...
View Object para extração BICC de dados de Fulfill Line Detail. Acessa as tabelas: DOO_FULFILL_LINES_ALL, DOO_FULFILL_LINE_DETAILS, DOO_HEADERS_ALL (+2).

**Caminho:** `FscmTopModelAM.DooTopAM.FulfillLineDetail`
...
- [[doo_fulfill_lines_all|DOO_FULFILL_LINES_ALL]] — 117 atributos (5 BICC)
- [[doo_fulfill_line_details|DOO_FULFILL_LINE_DETAILS]] — 26 atributos (1 PKs, 19 BICC)
