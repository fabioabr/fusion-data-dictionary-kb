---
id: DOC-OTHER-PVO-InvMaterialStatusesPVO
doc_type: system-doc
title: "InvMaterialStatusesPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Inv Material Statuses. Acessa as tabelas: INV_MATERIAL_STATUSES_B, INV_MATERIAL_STATUSES_TL.

**Caminho:** `FscmTopModelAM.InventoryAM.InvMaterialStatusesPVO`
...
- [[inv_material_statuses_b|INV_MATERIAL_STATUSES_B]] — 19 atributos (1 BICC)
- [[inv_material_statuses_tl|INV_MATERIAL_STATUSES_TL]] — 11 atributos (2 PKs, 5 BICC)
