---
id: DOC-OTHER-PVO-HoldCodeExtractPVO
doc_type: system-doc
title: "HoldCodeExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Hold Code Extract. Acessa as tabelas: DOO_HOLD_CODES_B, DOO_HOLD_CODES_TL.

**Caminho:** `FscmTopModelAM.ScmExtractAM.DooBiccExtractAM.HoldCodeExtractPVO`
...
- [[doo_hold_codes_b|DOO_HOLD_CODES_B]] — 14 atributos (1 PKs, 14 BICC)
