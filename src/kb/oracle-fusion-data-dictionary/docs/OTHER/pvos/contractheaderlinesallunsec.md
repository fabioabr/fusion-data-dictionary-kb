---
id: DOC-OTHER-PVO-ContractHeaderLinesAllUnsec
doc_type: system-doc
title: "ContractHeaderLinesAllUnsec — PVO Cross-Module"
...
View Object para extração BICC de dados de Contract Header Lines All Unsec. Acessa as tabelas: EGP_CATEGORIES_B, EGP_CATEGORIES_TL, EGP_SYSTEM_ITEMS_B_V (+33).

**Caminho:** `FscmTopModelAM.ContractsCoreAM.ContractHeaderLinesAllUnsec`
...
- [[fnd_setid_assignments|FND_SETID_ASSIGNMENTS]] — 16 atributos
...
- [[okc_k_headers_all_b|OKC_K_HEADERS_ALL_B]] — 105 atributos (5 BICC)
- [[okc_k_headers_tl|OKC_K_HEADERS_TL]] — 15 atributos (3 BICC)
- [[okc_k_inv_rev_summary_v|OKC_K_INV_REV_SUMMARY_V]] — 4 atributos
- [[okc_k_lines_b|OKC_K_LINES_B]] — 96 atributos (2 PKs, 4 BICC)
- [[okc_k_lines_tl|OKC_K_LINES_TL]] — 18 atributos (1 BICC)
