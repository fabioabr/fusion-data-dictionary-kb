---
id: DOC-OTHER-PVO-TransferOrderDistributionPVO
doc_type: system-doc
title: "TransferOrderDistributionPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Transfer Order Distribution. Acessa as tabelas: INV_ORG_PARAMETERS_V, INV_TRANSFER_ORDER_DISTRIBS, INV_TRANSFER_ORDER_HEADERS (+2).

**Caminho:** `FscmTopModelAM.InventoryAM.TransferOrderDistributionPVO`
...
- [[inv_transfer_order_distribs|INV_TRANSFER_ORDER_DISTRIBS]] — 31 atributos (1 PKs, 9 BICC)
- [[inv_transfer_order_headers|INV_TRANSFER_ORDER_HEADERS]] — 28 atributos (6 BICC)
- [[inv_transfer_order_lines|INV_TRANSFER_ORDER_LINES]] — 191 atributos (1 PKs, 30 BICC)
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | TransferOrderDistributionPEOBudgetDate | BUDGET_DATE | — | ✅ |
| 2 | TransferOrderDistributionPEOCodeCombinationId | CODE_COMBINATION_ID | — | — |
| 3 | TransferOrderDistributionPEOCreatedBy | CREATED_BY | — | — |
| 4 | TransferOrderDistributionPEOCreationDate | CREATION_DATE | — | — |
| 5 | TransferOrderDistributionPEODeliveredQty | DELIVERED_QTY | — | ✅ |
| 6 | TransferOrderDistributionPEODistributionAmount | DISTRIBUTION_AMOUNT | — | ✅ |
| 7 | TransferOrderDistributionPEODistributionId | DISTRIBUTION_ID | 🔑 | ✅ |
| 8 | TransferOrderDistributionPEODistributionNumber | DISTRIBUTION_NUMBER | — | ✅ |
| 9 | TransferOrderDistributionPEODistributionQty | DISTRIBUTION_QTY | — | ✅ |
| 10 | TransferOrderDistributionPEOFundsStatus | FUNDS_STATUS | — | ✅ |
| 11 | TransferOrderDistributionPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 12 | TransferOrderDistributionPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 13 | TransferOrderDistributionPEOLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 14 | TransferOrderDistributionPEOLineId | LINE_ID | — | — |
| 15 | TransferOrderDistributionPEONonrecoverableTax | NONRECOVERABLE_TAX | — | — |
| 16 | TransferOrderDistributionPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 17 | TransferOrderDistributionPEOPercent | PERCENT | — | ✅ |
| 18 | TransferOrderDistributionPEOPjcBillableFlag | PJC_BILLABLE_FLAG | — | — |
| 19 | TransferOrderDistributionPEOPjcCapitalizableFlag | PJC_CAPITALIZABLE_FLAG | — | — |
| 20 | TransferOrderDistributionPEOPjcContractId | PJC_CONTRACT_ID | — | — |
| 21 | TransferOrderDistributionPEOPjcExpenditureItemDate | PJC_EXPENDITURE_ITEM_DATE | — | — |
| 22 | TransferOrderDistributionPEOPjcExpenditureTypeId | PJC_EXPENDITURE_TYPE_ID | — | — |
| 23 | TransferOrderDistributionPEOPjcOrganizationId | PJC_ORGANIZATION_ID | — | — |
| 24 | TransferOrderDistributionPEOPjcProjectId | PJC_PROJECT_ID | — | — |
| 25 | TransferOrderDistributionPEOPjcReservedAttribute1 | PJC_RESERVED_ATTRIBUTE1 | — | — |
| 26 | TransferOrderDistributionPEOPjcTaskId | PJC_TASK_ID | — | — |
| 27 | TransferOrderDistributionPEOPjcWorkTypeId | PJC_WORK_TYPE_ID | — | — |
| 28 | TransferOrderDistributionPEOPrimaryLedgerId | PRIMARY_LEDGER_ID | — | — |
| 29 | TransferOrderDistributionPEORecoverableTax | RECOVERABLE_TAX | — | — |
| 30 | TransferOrderDistributionPEOReqBuId | REQ_BU_ID | — | — |
| 31 | TransferOrderDistributionPEOReqDistributionId | REQ_DISTRIBUTION_ID | — | — |
