---
id: DOC-OTHER-PVO-CompetitorProduct
doc_type: system-doc
title: "CompetitorProduct — PVO Cross-Module"
...
View Object para extração BICC de dados de Competitor Product. Acessa as tabelas: EGO_ITEM_ASSOCIATIONS, EGP_ITEM_RELATIONSHIPS_B_V, EGP_TRADING_PARTNER_ITEMS.

**Caminho:** `FscmTopModelAM.EgpItemsPublicModelAM.CompetitorProduct`
...
- [[egp_trading_partner_items|EGP_TRADING_PARTNER_ITEMS]] — 25 atributos (1 PKs, 11 BICC)
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | CompetitorProductPEOAverageRatingNumber | AVERAGE_RATING_NUMBER | — | ✅ |
| 2 | CompetitorProductPEOCreatedBy | CREATED_BY | — | — |
| 3 | CompetitorProductPEOCreatedFromTpiId | CREATED_FROM_TPI_ID | — | — |
| 4 | CompetitorProductPEOCreationDate | CREATION_DATE | — | — |
| 5 | CompetitorProductPEOEndDate | END_DATE | — | ✅ |
| 6 | CompetitorProductPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 7 | CompetitorProductPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 8 | CompetitorProductPEOLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 9 | CompetitorProductPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 10 | CompetitorProductPEOProgramAppName | PROGRAM_APP_NAME | — | — |
| 11 | CompetitorProductPEOProgramName | PROGRAM_NAME | — | — |
| 12 | CompetitorProductPEORequestId | REQUEST_ID | — | — |
| 13 | CompetitorProductPEOStartDate | START_DATE | — | ✅ |
| 14 | CompetitorProductPEOTpItemDesc | TP_ITEM_DESC | — | ✅ |
| 15 | CompetitorProductPEOTpItemNumber | TP_ITEM_NUMBER | — | ✅ |
| 16 | CompetitorProductPEOTpItemUomCode | TP_ITEM_UOM_CODE | — | ✅ |
| 17 | CompetitorProductPEOTpType | TP_TYPE | — | ✅ |
| 18 | CompetitorProductPEOTradingPartnerId | TRADING_PARTNER_ID | — | — |
| 19 | CompetitorProductPEOUnitPriceAmt | UNIT_PRICE_AMT | — | ✅ |
| 20 | CompetitorProductPEOUnitPriceCurrencyCode | UNIT_PRICE_CURRENCY_CODE | — | ✅ |
| 21 | CreatedFromTpItemPEOTpItem | TP_ITEM_ID | — | — |
| 22 | CreatedFromTpItemPEOTpItemDesc | TP_ITEM_DESC | — | — |
| 23 | CreatedFromTpItemPEOTpItemNumber | TP_ITEM_NUMBER | — | — |
| 24 | CreatedFromTpItemPEOTpType | TP_TYPE | — | — |
| 25 | TpItemId | TP_ITEM_ID | 🔑 | ✅ |
