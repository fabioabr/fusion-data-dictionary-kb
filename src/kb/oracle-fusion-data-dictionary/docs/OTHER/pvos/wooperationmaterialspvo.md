---
id: DOC-OTHER-PVO-WOOperationMaterialsPVO
doc_type: system-doc
title: "WOOperationMaterialsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WOOperation Materials. Acessa as tabelas: INV_RESERVATIONS, WIE_WORK_ORDERS_B, WIE_WO_OPERATIONS_B (+2).

**Caminho:** `FscmTopModelAM.WorkOrderAM.WOOperationMaterialsPVO`
...
- [[wie_work_orders_b|WIE_WORK_ORDERS_B]] — 94 atributos (29 BICC)
- [[wie_wo_operations_b|WIE_WO_OPERATIONS_B]] — 84 atributos (1 BICC)
- [[wie_wo_operation_materials|WIE_WO_OPERATION_MATERIALS]] — 33 atributos (1 PKs, 23 BICC)
