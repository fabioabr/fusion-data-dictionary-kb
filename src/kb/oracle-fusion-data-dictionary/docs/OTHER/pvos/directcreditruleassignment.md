---
id: DOC-OTHER-PVO-DirectCreditRuleAssignment
doc_type: system-doc
title: "DirectCreditRuleAssignment — PVO Cross-Module"
...
View Object para extração BICC de dados de Direct Credit Rule Assignment. Acessa as tabelas: CN_RS_RULES_ALL_B, CN_RS_RULES_HIERARCHY_CF_ALL, CN_RS_RULE_ASSIGNMENTS_ALL (+2).

**Caminho:** `FscmTopModelAM.RuleAM.DirectCreditRuleAssignment`
