---
id: DOC-OTHER-PVO-CostOrgBookPVO
doc_type: system-doc
title: "CostOrgBookPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Cost Org Book. Acessa as tabelas: CST_COST_BOOKS_B, CST_COST_BOOKS_TL, CST_COST_ORGS_V (+2).
