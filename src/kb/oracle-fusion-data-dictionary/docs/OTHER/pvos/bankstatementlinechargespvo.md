---
id: DOC-OTHER-PVO-BankStatementLineChargesPVO
doc_type: system-doc
title: "BankStatementLineChargesPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Bank Statement Line Charges. Acessa as tabelas: CE_INTERNAL_BANK_ACCTS_V, CE_STATEMENT_HEADERS, CE_STATEMENT_LINES (+3).

**Caminho:** `FscmTopModelAM.FinCeBankStatementsAM.BankStatementLineChargesPVO`
...
- [[ce_statement_headers|CE_STATEMENT_HEADERS]] — 21 atributos (1 BICC)
- [[ce_statement_lines|CE_STATEMENT_LINES]] — 38 atributos (2 BICC)
- [[ce_stmt_line_charges|CE_STMT_LINE_CHARGES]] — 17 atributos (1 PKs, 14 BICC)
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | StatementLineAccntServicerRef | ACCNT_SERVICER_REF | — | — |
| 2 | StatementLineAddendaTxt | ADDENDA_TXT | — | — |
| 3 | StatementLineAmount | AMOUNT | — | — |
| 4 | StatementLineBookingDate | BOOKING_DATE | — | — |
| 5 | StatementLineCheckNumber | CHECK_NUMBER | — | — |
| 6 | StatementLineClearingSystemRef | CLEARING_SYSTEM_REF | — | — |
| 7 | StatementLineCommWaiverIndFlag | COMM_WAIVER_IND_FLAG | — | — |
| 8 | StatementLineContractIdentification | CONTRACT_IDENTIFICATION | — | — |
| 9 | StatementLineCreatedBy | CREATED_BY | — | — |
| 10 | StatementLineCreationDate | CREATION_DATE | — | ✅ |
| 11 | StatementLineCustomerReference | CUSTOMER_REFERENCE | — | — |
| 12 | StatementLineEndToEndId | END_TO_END_ID | — | — |
| 13 | StatementLineExceptionFlag | EXCEPTION_FLAG | — | — |
| 14 | StatementLineExchangeRate | EXCHANGE_RATE | — | — |
| 15 | StatementLineExchangeRateDate | EXCHANGE_RATE_DATE | — | — |
| 16 | StatementLineExchangeRateType | EXCHANGE_RATE_TYPE | — | — |
| 17 | StatementLineExternalTransactionId | EXTERNAL_TRANSACTION_ID | — | — |
| 18 | StatementLineFlowIndicator | FLOW_INDICATOR | — | — |
| 19 | StatementLineInstructionIdentification | INSTRUCTION_IDENTIFICATION | — | — |
| 20 | StatementLineLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 21 | StatementLineLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 22 | StatementLineLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 23 | StatementLineLineNumber | LINE_NUMBER | — | — |
| 24 | StatementLineObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 25 | StatementLineOrigBankAccountId | ORIG_BANK_ACCOUNT_ID | — | — |
| 26 | StatementLineReconHistoryId | RECON_HISTORY_ID | — | — |
| 27 | StatementLineReconReference | RECON_REFERENCE | — | — |
| 28 | StatementLineReconStatus | RECON_STATUS | — | — |
| 29 | StatementLineReversalIndFlag | REVERSAL_IND_FLAG | — | — |
| 30 | StatementLineServicerStatus | SERVICER_STATUS | — | — |
| 31 | StatementLineStatementHeaderId | STATEMENT_HEADER_ID | — | — |
| 32 | StatementLineStatementLineId | STATEMENT_LINE_ID | — | — |
| 33 | StatementLineTransactionId | TRANSACTION_ID | — | — |
| 34 | StatementLineTrxAmount | TRX_AMOUNT | — | — |
| 35 | StatementLineTrxCodeId | TRX_CODE_ID | — | — |
| 36 | StatementLineTrxCurrCode | TRX_CURR_CODE | — | — |
| 37 | StatementLineTrxType | TRX_TYPE | — | — |
| 38 | StatementLineValueDate | VALUE_DATE | — | — |

### [[ce_stmt_line_charges|CE_STMT_LINE_CHARGES]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | StLineChargesChargePercentRate | CHARGE_PERCENT_RATE | — | ✅ |
| 2 | StLineChargesChargeServiceCode | CHARGE_SERVICE_CODE | — | ✅ |
| 3 | StLineChargesChargesAmt | CHARGES_AMT | — | ✅ |
| 4 | StLineChargesChargesCurr | CHARGES_CURR | — | ✅ |
| 5 | StLineChargesCreatedBy | CREATED_BY | — | ✅ |
| 6 | StLineChargesCreationDate | CREATION_DATE | — | ✅ |
| 7 | StLineChargesLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 8 | StLineChargesLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 9 | StLineChargesLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 10 | StLineChargesObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 11 | StLineChargesStatementLineId | STATEMENT_LINE_ID | — | — |
| 12 | StLineChargesTaxAmount | TAX_AMOUNT | — | ✅ |
| 13 | StLineChargesTaxCurr | TAX_CURR | — | ✅ |
| 14 | StLineChargesTaxId | TAX_ID | — | ✅ |
| 15 | StLineChargesTaxRate | TAX_RATE | — | ✅ |
| 16 | StLineChargesTrxChargeBearerCode | TRX_CHARGE_BEARER_CODE | — | ✅ |
| 17 | StmtLineChargesId | STMT_LINE_CHARGES_ID | 🔑 | ✅ |
