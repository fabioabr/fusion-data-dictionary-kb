---
id: DOC-OTHER-PVO-WorkOrderPVO
doc_type: system-doc
title: "WorkOrderPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Work Order. Acessa as tabelas: CSE_ASSETS_B, CSE_CONDITION_EVENT_CODES_B, CSE_W_CONTRACTS (+14).

**Caminho:** `FscmTopModelAM.WorkOrderAM.WorkOrderPVO`
...
- [[hz_parties|HZ_PARTIES]] — 77 atributos (11 BICC)
...
- [[wie_work_orders_b|WIE_WORK_ORDERS_B]] — 78 atributos (1 PKs, 55 BICC)
- [[wie_work_orders_tl|WIE_WORK_ORDERS_TL]] — 10 atributos (7 BICC)
