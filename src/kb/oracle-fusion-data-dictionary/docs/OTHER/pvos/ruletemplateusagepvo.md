---
id: DOC-OTHER-PVO-RuleTemplateUsagePVO
doc_type: system-doc
title: "RuleTemplateUsagePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Rule Template Usage. Acessa as tabelas: FF_FORMULAS_VL, FND_VS_VALUE_SETS, HWM_ALLOCATIONS_HDR_VL (+4).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.RulesTemplatesAM.RuleTemplateUsagePVO`
...
- [[hwm_rule_tmplt_usages|HWM_RULE_TMPLT_USAGES]] — 24 atributos (1 PKs, 17 BICC)
- [[hwm_rule_tmplt_usages_tl|HWM_RULE_TMPLT_USAGES_TL]] — 4 atributos (2 BICC)
...
### [[hwm_rule_tmplt_usages|HWM_RULE_TMPLT_USAGES]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | RuleTemplateUsageBPEOAtrbFldName | ATRB_FLD_NAME | — | ✅ |
| 2 | RuleTemplateUsageBPEOAtrbFldSetId | ATRB_FLD_SET_ID | — | — |
| 3 | RuleTemplateUsageBPEOCreatedBy | CREATED_BY | — | ✅ |
| 4 | RuleTemplateUsageBPEOCreationDate | CREATION_DATE | — | ✅ |
| 5 | RuleTemplateUsageBPEODisplaySequence | DISPLAY_SEQUENCE | — | ✅ |
| 6 | RuleTemplateUsageBPEOEnterpriseId | ENTERPRISE_ID | — | — |
| 7 | RuleTemplateUsageBPEOHideFlag | HIDE_FLAG | — | ✅ |
| 8 | RuleTemplateUsageBPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 9 | RuleTemplateUsageBPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 10 | RuleTemplateUsageBPEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 11 | RuleTemplateUsageBPEOMsgSeverity | MSG_SEVERITY | — | ✅ |
| 12 | RuleTemplateUsageBPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 13 | RuleTemplateUsageBPEOOutputName | OUTPUT_NAME | — | ✅ |
| 14 | RuleTemplateUsageBPEOOutputSource | OUTPUT_SOURCE | — | ✅ |
| 15 | RuleTemplateUsageBPEOOutputValueType | OUTPUT_VALUE_TYPE | — | ✅ |
| 16 | RuleTemplateUsageBPEORecursive | RECURSIVE | — | — |
| 17 | RuleTemplateUsageBPEORelatedInputName | RELATED_INPUT_NAME | — | — |
| 18 | RuleTemplateUsageBPEORuleTmpltUsagesId | RULE_TMPLT_USAGES_ID | 🔑 | ✅ |
| 19 | RuleTemplateUsageBPEORuleTmpltsId | RULE_TMPLTS_ID | — | ✅ |
| 20 | RuleTemplateUsageBPEOSeedDataSource | SEED_DATA_SOURCE | — | — |
| 21 | RuleTemplateUsageBPEOSguid | SGUID | — | — |
| 22 | RuleTemplateUsageBPEOTbbGroupNumber | TBB_GROUP_NUMBER | — | ✅ |
| 23 | RuleTemplateUsageBPEOTmAtrbFldId | TM_ATRB_FLD_ID | — | ✅ |
| 24 | RuleTemplateUsageBPEOValueSetId | VALUE_SET_ID | — | ✅ |

### [[hwm_rule_tmplt_usages_tl|HWM_RULE_TMPLT_USAGES_TL]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | RuleTemplateUsageTLPEOLanguage | LANGUAGE | — | — |
| 2 | RuleTemplateUsageTLPEOOutNameDescription | OUT_NAME_DESCRIPTION | — | ✅ |
| 3 | RuleTemplateUsageTLPEORuleTmpltUsagesId | RULE_TMPLT_USAGES_ID | — | — |
| 4 | RuleTemplateUsageTLPEOUserDefinedOutName | USER_DEFINED_OUT_NAME | — | ✅ |
