---
id: DOC-OTHER-PVO-ResourceRequestWeekPVO
doc_type: system-doc
title: "ResourceRequestWeekPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Resource Request Week. Acessa as tabelas: FND_CAL_WEEK, PJF_PROJECTS_ALL_VL, PJR_RESOURCE_REQUESTS (+1).

**Caminho:** `FscmTopModelAM.PjrResourceRequestAM.ResourceRequestWeekPVO`
...
- [[fnd_cal_week|FND_CAL_WEEK]] — 3 atributos (1 PKs, 1 BICC)
- [[pjf_projects_all_vl|PJF_PROJECTS_ALL_VL]] — 3 atributos
- [[pjr_resource_requests|PJR_RESOURCE_REQUESTS]] — 48 atributos (1 PKs, 33 BICC)
- [[pjr_resource_request_schedules|PJR_RESOURCE_REQUEST_SCHEDULES]] — 8 atributos
...
|---|----------|--------|----|------|
| 1 | CalWeek | CAL_WEEK | 🔑 | ✅ |
| 2 | CalWeekEndDate | CAL_WEEK_END_DATE | — | — |
| 3 | CalWeekStartDate | CAL_WEEK_START_DATE | — | — |
...
| 2 | RequestSchedulesPEOIntervalName | INTERVAL_NAME | — | — |
| 3 | RequestSchedulesPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 4 | RequestSchedulesPEOLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 5 | RequestSchedulesPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 6 | RequestSchedulesPEOResourceRequestId | RESOURCE_REQUEST_ID | — | — |
| 7 | RequestSchedulesPEOResourceRequestScheduleId | RESOURCE_REQUEST_SCHEDULE_ID | — | — |
| 8 | RequestSchedulesPEOUseProjCalendarHourFlag | USE_PROJ_CALENDAR_HOUR_FLAG | — | — |
