---
id: DOC-OTHER-PVO-WOMaintenanceAssetDimPVO
doc_type: system-doc
title: "WOMaintenanceAssetDimPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WOMaintenance Asset Dim. Acessa as tabelas: CSE_ASSETS_VL, HR_ALL_ORGANIZATION_UNITS_F_VL, HZ_PARTIES (+4).

**Caminho:** `FscmTopModelAM.WorkOrderAM.WOMaintenanceAssetDimPVO`
...
- [[cse_assets_vl|CSE_ASSETS_VL]] — 97 atributos (1 PKs, 35 BICC)
...
- [[wis_work_areas_vl|WIS_WORK_AREAS_VL]] — 12 atributos (3 BICC)
- [[wis_work_centers_vl|WIS_WORK_CENTERS_VL]] — 13 atributos (2 BICC)
