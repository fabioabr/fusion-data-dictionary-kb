---
id: DOC-OTHER-PVO-AdvancementReadinessPVO
doc_type: system-doc
title: "AdvancementReadinessPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Advancement Readiness. Acessa as tabelas: HRT_BI_ADV_READINESS_ITEMS_V, HRT_CONTENT_TYPES_B, HRT_CONTENT_TYPES_TL (+4).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.AdvancementReadinessPVO`
