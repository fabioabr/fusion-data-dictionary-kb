---
id: DOC-OTHER-PVO-Task
doc_type: system-doc
title: "Task — PVO Cross-Module"
...
View Object para extração BICC de dados de Task. Acessa as tabelas: DOO_SERVICE_DEFINITIONS_B, DOO_SERVICE_DEFINITIONS_TL, DOO_STATUSES_B (+6).

**Caminho:** `FscmTopModelAM.DooTopAM.Task`
...
- [[doo_task_definitions_b|DOO_TASK_DEFINITIONS_B]] — 9 atributos (1 PKs, 3 BICC)
- [[doo_task_definitions_tl|DOO_TASK_DEFINITIONS_TL]] — 11 atributos (3 BICC)
- [[doo_task_statuses|DOO_TASK_STATUSES]] — 12 atributos
- [[doo_task_types_b|DOO_TASK_TYPES_B]] — 10 atributos (2 BICC)
