---
id: DOC-OTHER-PVO-TimeAttributeFieldComponentPVO
doc_type: system-doc
title: "TimeAttributeFieldComponentPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Time Attribute Field Component. Acessa as tabelas: FND_VS_VALUE_SETS, HWM_DATA_SOURCE_USAGES_V, HWM_TCSMRS_VL (+3).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.DataDictionaryAM.TimeAttributeFieldComponentPVO`
...
- [[hwm_tm_atrb_flds_tl|HWM_TM_ATRB_FLDS_TL]] — 4 atributos (1 BICC)
