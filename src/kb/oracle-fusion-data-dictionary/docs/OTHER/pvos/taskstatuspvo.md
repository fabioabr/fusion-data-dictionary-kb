---
id: DOC-OTHER-PVO-TaskStatusPVO
doc_type: system-doc
title: "TaskStatusPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Task Status. Acessa as tabelas: HRA_EVAL_STEPS, HRA_PF_TASK_ROLES_B, HRA_PF_TASK_ROLES_TL.
