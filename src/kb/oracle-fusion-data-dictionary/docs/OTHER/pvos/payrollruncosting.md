---
id: DOC-OTHER-PVO-PayrollRunCosting
doc_type: system-doc
title: "PayrollRunCosting — PVO Cross-Module"
...
View Object para extração BICC de dados de Payroll Run Costing. Acessa as tabelas: PAY_COSTS, PAY_PAYROLL_ACTIONS, PAY_PAYROLL_REL_ACTIONS (+4).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.CostResultsAM.PayrollRunCosting`
...
- [[pay_costs|PAY_COSTS]] — 18 atributos (1 PKs, 11 BICC)
- [[pay_payroll_actions|PAY_PAYROLL_ACTIONS]] — 41 atributos (18 BICC)
- [[pay_payroll_rel_actions|PAY_PAYROLL_REL_ACTIONS]] — 14 atributos (5 BICC)
- [[pay_pay_relationships_dn|PAY_PAY_RELATIONSHIPS_DN]] — 14 atributos (2 BICC)
- [[pay_requests|PAY_REQUESTS]] — 12 atributos (2 BICC)
- [[pay_run_results|PAY_RUN_RESULTS]] — 3 atributos
- [[per_legislative_data_groups|PER_LEGISLATIVE_DATA_GROUPS]] — 3 atributos
...
|---|----------|--------|----|------|
| 1 | CostId | COST_ID | 🔑 | ✅ |
| 2 | PayCostBalanceOrCost | BALANCE_OR_COST | — | ✅ |
| 3 | PayCostCostAllocationKeyflexId | COST_ALLOCATION_KEYFLEX_ID | — | — |
| 4 | PayCostCostedValue | COSTED_VALUE | — | ✅ |
| 5 | PayCostDebitOrCredit | DEBIT_OR_CREDIT | — | ✅ |
| 6 | PayCostDistributedInputValueId | DISTRIBUTED_INPUT_VALUE_ID | — | — |
| 7 | PayCostDistributedRunResultId | DISTRIBUTED_RUN_RESULT_ID | — | — |
| 8 | PayCostEndDate | END_DATE | — | — |
| 9 | PayCostIdFlexNum | ID_FLEX_NUM | — | ✅ |
| 10 | PayCostInputValueId | INPUT_VALUE_ID | — | — |
| 11 | PayCostPayrollRelationshipActionId | PAYROLL_REL_ACTION_ID | — | — |
| 12 | PayCostRunResultId | RUN_RESULT_ID | — | ✅ |
| 13 | PayCostSecondaryStatus | SECONDARY_STATUS | — | ✅ |
| 14 | PayCostSequence | SEQUENCE | — | ✅ |
| 15 | PayCostSourceId | SOURCE_ID | — | ✅ |
| 16 | PayCostStartDate | START_DATE | — | — |
| 17 | PayCostStatus | STATUS | — | ✅ |
| 18 | PayCostTransferToGlFlag | TRANSFER_TO_GL_FLAG | — | ✅ |
...
| 40 | PayrollActionPEODednTimePeriodId | DEDN_TIME_PERIOD_ID | — | — |
| 41 | PayrollActionPEOEarnTimePeriodId | EARN_TIME_PERIOD_ID | — | — |
...
| 11 | PayReqPayRequestId | PAY_REQUEST_ID | — | — |
| 12 | PayReqPayTaskActionId | PAY_TASK_ACTION_ID | — | — |

### [[pay_run_results|PAY_RUN_RESULTS]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | RunResultPEOCalcBreakdownId | CALC_BREAKDOWN_ID | — | — |
| 2 | RunResultPEORunResultId | RUN_RESULT_ID | — | — |
| 3 | RunResultPEOTaxUnitId | TAX_UNIT_ID | — | — |
