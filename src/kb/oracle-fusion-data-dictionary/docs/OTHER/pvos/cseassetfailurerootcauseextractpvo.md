---
id: DOC-OTHER-PVO-CseAssetFailureRootCauseExtractPVO
doc_type: system-doc
title: "CseAssetFailureRootCauseExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Cse Asset Failure Root Cause Extract. Acessa as tabelas: CSE_FAILURE_ROOT_CAUSES.

**Caminho:** `FscmTopModelAM.ScmExtractAM.CseBiccExtractAM.CseAssetFailureRootCauseExtractPVO`
...
- [[cse_failure_root_causes|CSE_FAILURE_ROOT_CAUSES]] — 51 atributos (1 PKs, 51 BICC)

---

## ⚙️ Atributos

### [[cse_failure_root_causes|CSE_FAILURE_ROOT_CAUSES]]
...
| 46 | FailureInstanceId | FAILURE_INSTANCE_ID | — | ✅ |
