---
id: DOC-OTHER-PVO-LegalEntityPVO
doc_type: system-doc
title: "LegalEntityPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Legal Entity. Acessa as tabelas: GL_LEDGERS, GL_LEDGER_CONFIGURATIONS, GL_LEDGER_CONFIG_DETAILS (+6).

**Caminho:** `FscmTopModelAM.FinLeLegalEntitiesAM.LegalEntityPVO`
...
- [[hz_locations|HZ_LOCATIONS]] — 48 atributos (14 BICC)
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 10 atributos (2 BICC)
- [[per_users|PER_USERS]] — 10 atributos
- [[xle_entity_profiles|XLE_ENTITY_PROFILES]] — 42 atributos (1 PKs, 12 BICC)
