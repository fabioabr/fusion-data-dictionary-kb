---
id: DOC-OTHER-PVO-BankAccountBalancePVO
doc_type: system-doc
title: "BankAccountBalancePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Bank Account Balance. Acessa as tabelas: CE_INTERNAL_BANK_ACCTS_V, CE_STATEMENT_HEADERS, CE_STMT_BALANCES (+3).

**Caminho:** `FscmTopModelAM.FinCeBankStatementsAM.BankAccountBalancePVO`
...
- [[ce_stmt_balances|CE_STMT_BALANCES]] — 13 atributos (1 PKs, 9 BICC)
...
| 13 | StmtBalanceId | STMT_BALANCE_ID | 🔑 | ✅ |
