---
id: DOC-OTHER-PVO-CustomerAssetSoldStructurePVO
doc_type: system-doc
title: "CustomerAssetSoldStructurePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Customer Asset Sold Structure. Acessa as tabelas: CSE_AS_SOLD_STRUCTURES_V.

**Caminho:** `FscmTopModelAM.CustomerAssetAM.CustomerAssetSoldStructurePVO`
...
- [[cse_as_sold_structures_v|CSE_AS_SOLD_STRUCTURES_V]] — 38 atributos (3 PKs, 4 BICC)

---

## ⚙️ Atributos

### [[cse_as_sold_structures_v|CSE_AS_SOLD_STRUCTURES_V]]
