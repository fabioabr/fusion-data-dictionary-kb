---
id: DOC-OTHER-PVO-GoalVersionStatusOverviewPVO
doc_type: system-doc
title: "GoalVersionStatusOverviewPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Goal Version Status Overview. Acessa as tabelas: HRG_GOALS, HRG_GOAL_MEASUREMENTS, HRG_GOAL_PLANS_B (+4).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmGoalCoreAM.GoalVersionStatusOverviewPVO`
...
- [[hrg_goals|HRG_GOALS]] — 63 atributos (1 PKs, 33 BICC)
- [[hrg_goal_measurements|HRG_GOAL_MEASUREMENTS]] — 25 atributos (8 BICC)
...
- [[hrg_goal_pln_assignments|HRG_GOAL_PLN_ASSIGNMENTS]] — 20 atributos (2 BICC)
...
| 16 | GoalPlanGoalPEORevPeriodId | REVIEW_PERIOD_ID | — | — |
...
| 16 | GoalPlanAssgPEORevPeriodId | REVIEW_PERIOD_ID | — | — |
| 17 | GoalPlanAssgPEOStatus | STATUS | — | — |
| 18 | GoalPlanAssgPEOWeighting | WEIGHTING | — | — |
| 19 | GoalPlanAssgnPEOBusinessGroupId | BUSINESS_GROUP_ID | — | — |
