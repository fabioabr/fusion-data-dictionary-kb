---
id: DOC-AR-PVO-SiteContactPoint
doc_type: system-doc
title: "SiteContactPoint — PVO Accounts Receivable"
...
Extrai os pontos de contato (telefone, e-mail) associados a sites de clientes. Complementa os dados de contato para comunicações operacionais de cobrança e envio de documentos fiscais por localidade.

**Caminho:** `FscmTopModelAM.FinArCustomersPublicModelAM.SiteContactPoint`
