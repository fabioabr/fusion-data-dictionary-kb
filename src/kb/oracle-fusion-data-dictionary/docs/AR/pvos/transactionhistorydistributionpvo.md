---
id: DOC-AR-PVO-TransactionHistoryDistributionPVO
doc_type: system-doc
title: "TransactionHistoryDistributionPVO — PVO Accounts Receivable"
...
Extrai as distribuições contábeis do histórico de transações, rastreando cada mudança de estado e seu impacto nas contas do GL. Essencial para auditoria contábil completa, reconstrução de lançamentos e análise de discrepâncias.

**Caminho:** `FscmTopModelAM.FinArTopPublicModelAM.TransactionHistoryDistributionPVO`
...
- [[ar_distributions_all|AR_DISTRIBUTIONS_ALL]] — 41 atributos (1 PKs, 7 BICC)
...
- [[ar_transaction_history_all|AR_TRANSACTION_HISTORY_ALL]] — 33 atributos (15 BICC)
...
- [[ra_customer_trx_all|RA_CUSTOMER_TRX_ALL]] — 298 atributos (16 BICC)
- [[ra_customer_trx_lines_all|RA_CUSTOMER_TRX_LINES_ALL]] — 318 atributos (4 BICC)
...
| 7 | CashDistributionCurrencyCode | CURRENCY_CODE | — | ✅ |
| 8 | CashDistributionCurrencyConversionDate | CURRENCY_CONVERSION_DATE | — | — |
| 9 | CashDistributionCurrencyConversionRate | CURRENCY_CONVERSION_RATE | — | — |
| 10 | CashDistributionCurrencyConversionType | CURRENCY_CONVERSION_TYPE | — | — |
| 11 | CashDistributionFromAcctdAmountCr | FROM_ACCTD_AMOUNT_CR | — | — |
| 12 | CashDistributionFromAcctdAmountDr | FROM_ACCTD_AMOUNT_DR | — | — |
| 13 | CashDistributionFromAmountCr | FROM_AMOUNT_CR | — | — |
| 14 | CashDistributionFromAmountDr | FROM_AMOUNT_DR | — | — |
| 15 | CashDistributionLocationSegmentId | LOCATION_SEGMENT_ID | — | — |
| 16 | CashDistributionObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 17 | CashDistributionRefAccountClass | REF_ACCOUNT_CLASS | — | — |
| 18 | CashDistributionRefCustTrxLineGlDistId | REF_CUST_TRX_LINE_GL_DIST_ID | — | — |
| 19 | CashDistributionRefCustomerTrxLineId | REF_CUSTOMER_TRX_LINE_ID | — | — |
| 20 | CashDistributionRefDistCcid | REF_DIST_CCID | — | — |
| 21 | CashDistributionRefLineId | REF_LINE_ID | — | — |
| 22 | CashDistributionRefMfDistFlag | REF_MF_DIST_FLAG | — | — |
| 23 | CashDistributionReversalFlag | REVERSAL_FLAG | — | — |
| 24 | CashDistributionReversedSourceId | REVERSED_SOURCE_ID | — | — |
| 25 | CashDistributionSourceId | SOURCE_ID | — | — |
| 26 | CashDistributionSourceIdSecondary | SOURCE_ID_SECONDARY | — | — |
| 27 | CashDistributionSourceTable | SOURCE_TABLE | — | — |
| 28 | CashDistributionSourceTableSecondary | SOURCE_TABLE_SECONDARY | — | — |
| 29 | CashDistributionSourceType | SOURCE_TYPE | — | — |
| 30 | CashDistributionSourceTypeSecondary | SOURCE_TYPE_SECONDARY | — | ✅ |
| 31 | CashDistributionTaxCodeId | TAX_CODE_ID | — | — |
| 32 | CashDistributionTaxGroupCodeId | TAX_GROUP_CODE_ID | — | — |
| 33 | CashDistributionTaxId | TAX_ID | — | — |
| 34 | CashDistributionTaxLinkId | TAX_LINK_ID | — | — |
| 35 | CashDistributionTaxableAccountedCr | TAXABLE_ACCOUNTED_CR | — | — |
| 36 | CashDistributionTaxableAccountedDr | TAXABLE_ACCOUNTED_DR | — | — |
| 37 | CashDistributionTaxableEnteredCr | TAXABLE_ENTERED_CR | — | — |
| 38 | CashDistributionTaxableEnteredDr | TAXABLE_ENTERED_DR | — | — |
| 39 | CashDistributionThirdPartyId | THIRD_PARTY_ID | — | — |
| 40 | CashDistributionThirdPartySubId | THIRD_PARTY_SUB_ID | — | — |
| 41 | LineId | LINE_ID | 🔑 | ✅ |
...
|---|----------|--------|----|------|
| 1 | OrgId | ORG_ID | — | — |
| 2 | TransactionHistoryAttributeCategory | ATTRIBUTE_CATEGORY | — | — |
| 3 | TransactionHistoryBatchId | BATCH_ID | — | — |
| 4 | TransactionHistoryComments | COMMENTS | — | ✅ |
| 5 | TransactionHistoryCreatedBy | CREATED_BY | — | ✅ |
| 6 | TransactionHistoryCreatedFrom | CREATED_FROM | — | — |
| 7 | TransactionHistoryCreationDate | CREATION_DATE | — | ✅ |
| 8 | TransactionHistoryCurrentAccountedFlag | CURRENT_ACCOUNTED_FLAG | — | ✅ |
| 9 | TransactionHistoryCurrentRecordFlag | CURRENT_RECORD_FLAG | — | ✅ |
| 10 | TransactionHistoryCustomerTrxId | CUSTOMER_TRX_ID | — | — |
| 11 | TransactionHistoryEvent | EVENT | — | ✅ |
| 12 | TransactionHistoryEventId | EVENT_ID | — | — |
| 13 | TransactionHistoryFirstPostedRecordFlag | FIRST_POSTED_RECORD_FLAG | — | — |
| 14 | TransactionHistoryGlDate | GL_DATE | — | ✅ |
| 15 | TransactionHistoryGlPostedDate | GL_POSTED_DATE | — | ✅ |
...
| 24 | TransactionHistoryPostableFlag | POSTABLE_FLAG | — | ✅ |
| 25 | TransactionHistoryPostingControlId | POSTING_CONTROL_ID | — | ✅ |
| 26 | TransactionHistoryProgramApplicationId | PROGRAM_APPLICATION_ID | — | — |
| 27 | TransactionHistoryProgramId | PROGRAM_ID | — | — |
| 28 | TransactionHistoryProgramUpdateDate | PROGRAM_UPDATE_DATE | — | — |
| 29 | TransactionHistoryPrvTrxHistoryId | PRV_TRX_HISTORY_ID | — | — |
| 30 | TransactionHistoryRequestId | REQUEST_ID | — | — |
| 31 | TransactionHistoryStatus | STATUS | — | ✅ |
| 32 | TransactionHistoryTransactionHistoryId | TRANSACTION_HISTORY_ID | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ObjectVersionNumber3 | OBJECT_VERSION_NUMBER | — | — |
| 2 | RelCustTrxHdrCustomerTrxId | CUSTOMER_TRX_ID | — | — |
| 3 | RelCustTrxHdrTrxNumber | TRX_NUMBER | — | — |
| 4 | TransactionHeaderBrCustomerTrxId | CUSTOMER_TRX_ID | — | — |
