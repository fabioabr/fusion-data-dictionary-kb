---
id: DOC-AR-PVO-SiteBankAccount
doc_type: system-doc
title: "SiteBankAccount — PVO Accounts Receivable"
...
Extrai as contas bancárias associadas a sites (filiais/endereços) de clientes, incluindo dados bancários e instrumentos de pagamento. Permite gerenciar meios de recebimento diferenciados por localidade do cliente.

**Caminho:** `FscmTopModelAM.FinArCustomersPublicModelAM.SiteBankAccount`
