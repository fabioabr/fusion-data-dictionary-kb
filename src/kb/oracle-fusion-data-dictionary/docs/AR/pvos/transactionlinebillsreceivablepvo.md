---
id: DOC-AR-PVO-TransactionLineBillsReceivablePVO
doc_type: system-doc
title: "TransactionLineBillsReceivablePVO — PVO Accounts Receivable"
...
Extrai as linhas de transações do tipo Títulos a Receber (bills receivable), com detalhamento por item, valor, impostos e classificação fiscal. Permite análise granular de títulos negociáveis e sua composição.

**Caminho:** `FscmTopModelAM.FinArTopPublicModelAM.TransactionLineBillsReceivablePVO`
...
- [[ar_cash_receipts_all|AR_CASH_RECEIPTS_ALL]] — 5 atributos
- [[ar_deferred_lines_all|AR_DEFERRED_LINES_ALL]] — 20 atributos (1 BICC)
- [[ar_interest_headers_all|AR_INTEREST_HEADERS_ALL]] — 35 atributos
- [[ar_interest_lines_all|AR_INTEREST_LINES_ALL]] — 22 atributos
- [[ar_lookups|AR_LOOKUPS]] — 4 atributos
...
- [[hr_organization_units_f_tl|HR_ORGANIZATION_UNITS_F_TL]] — 6 atributos (1 BICC)
- [[hz_cust_accounts|HZ_CUST_ACCOUNTS]] — 71 atributos (2 BICC)
...
- [[hz_locations|HZ_LOCATIONS]] — 26 atributos
- [[hz_parties|HZ_PARTIES]] — 27 atributos
- [[hz_party_sites|HZ_PARTY_SITES]] — 12 atributos
- [[hz_party_site_uses|HZ_PARTY_SITE_USES]] — 3 atributos (1 BICC)
- [[iby_ext_bank_accounts|IBY_EXT_BANK_ACCOUNTS]] — 44 atributos
- [[iby_fndcpt_tx_extensions|IBY_FNDCPT_TX_EXTENSIONS]] — 28 atributos
...
- [[ra_customer_trx_all|RA_CUSTOMER_TRX_ALL]] — 587 atributos (18 BICC)
- [[ra_customer_trx_lines_all|RA_CUSTOMER_TRX_LINES_ALL]] — 600 atributos (1 PKs, 7 BICC)
...
- [[zx_registrations|ZX_REGISTRATIONS]] — 6 atributos
