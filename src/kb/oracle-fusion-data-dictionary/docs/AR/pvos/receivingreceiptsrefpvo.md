---
id: DOC-AR-PVO-ReceivingReceiptsRefPVO
doc_type: system-doc
title: "ReceivingReceiptsRefPVO — PVO Accounts Receivable"
...
Extrai referências dos recebimentos de materiais/serviços, com mesmo escopo do ReceivingReceiptsPVO. Fornece visão complementar com referências cruzadas para rastreamento e reconciliação de recebimentos físicos.

**Caminho:** `FscmTopModelAM.RcvReceiptsAM.ReceivingReceiptsRefPVO`
...
- [[po_lines_all|PO_LINES_ALL]] — 104 atributos
- [[po_line_locations_all|PO_LINE_LOCATIONS_ALL]] — 141 atributos
- [[rcv_shipment_headers|RCV_SHIPMENT_HEADERS]] — 81 atributos (11 BICC)
- [[rcv_shipment_lines|RCV_SHIPMENT_LINES]] — 135 atributos (19 BICC)
...
| 54 | PoLinesAllPEOMarketPrice | MARKET_PRICE | — | — |
| 55 | PoLinesAllPEOMatchingBasis | MATCHING_BASIS | — | — |
| 56 | PoLinesAllPEOMaxRetainageAmount | MAX_RETAINAGE_AMOUNT | — | — |
| 57 | PoLinesAllPEOMinReleaseAmount | MIN_RELEASE_AMOUNT | — | — |
| 58 | PoLinesAllPEONegotiatedByPreparerFlag | NEGOTIATED_BY_PREPARER_FLAG | — | — |
| 59 | PoLinesAllPEONotToExceedPrice | NOT_TO_EXCEED_PRICE | — | — |
| 60 | PoLinesAllPEONoteToVendor | NOTE_TO_VENDOR | — | — |
| 61 | PoLinesAllPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 62 | PoLinesAllPEOOkeContractHeaderId | OKE_CONTRACT_HEADER_ID | — | — |
| 63 | PoLinesAllPEOOkeContractVersionId | OKE_CONTRACT_VERSION_ID | — | — |
| 64 | PoLinesAllPEOOrderTypeLookupCode | ORDER_TYPE_LOOKUP_CODE | — | — |
| 65 | PoLinesAllPEOOverToleranceErrorFlag | OVER_TOLERANCE_ERROR_FLAG | — | — |
| 66 | PoLinesAllPEOPJC_CONTEXT_CATEGORY | PJC_CONTEXT_CATEGORY | — | — |
| 67 | PoLinesAllPEOPoHeaderId | PO_HEADER_ID | — | — |
| 68 | PoLinesAllPEOPoLineId | PO_LINE_ID | — | — |
| 69 | PoLinesAllPEOPrcBuId | PRC_BU_ID | — | — |
| 70 | PoLinesAllPEOPreferredGrade | PREFERRED_GRADE | — | — |
| 71 | PoLinesAllPEOPriceBreakLookupCode | PRICE_BREAK_LOOKUP_CODE | — | — |
| 72 | PoLinesAllPEOPriceTypeLookupCode | PRICE_TYPE_LOOKUP_CODE | — | — |
| 73 | PoLinesAllPEOProgramAppName | PROGRAM_APP_NAME | — | — |
| 74 | PoLinesAllPEOProgramName | PROGRAM_NAME | — | — |
| 75 | PoLinesAllPEOProgressPaymentRate | PROGRESS_PAYMENT_RATE | — | — |
| 76 | PoLinesAllPEOPurchaseBasis | PURCHASE_BASIS | — | — |
| 77 | PoLinesAllPEOQcGrade | QC_GRADE | — | — |
| 78 | PoLinesAllPEOQtyRcvTolerance | QTY_RCV_TOLERANCE | — | — |
| 79 | PoLinesAllPEOQuantity | QUANTITY | — | — |
| 80 | PoLinesAllPEOQuantityCommitted | QUANTITY_COMMITTED | — | — |
| 81 | PoLinesAllPEORecoupmentRate | RECOUPMENT_RATE | — | — |
| 82 | PoLinesAllPEOReferenceNum | REFERENCE_NUM | — | — |
| 83 | PoLinesAllPEOReqBuId | REQ_BU_ID | — | — |
| 84 | PoLinesAllPEORequestId | REQUEST_ID | — | — |
| 85 | PoLinesAllPEORetainageRate | RETAINAGE_RATE | — | — |
| 86 | PoLinesAllPEORetroactiveDate | RETROACTIVE_DATE | — | — |
| 87 | PoLinesAllPEOSecondaryQuantity | SECONDARY_QUANTITY | — | — |
| 88 | PoLinesAllPEOSecondaryUomCode | SECONDARY_UOM_CODE | — | — |
| 89 | PoLinesAllPEOSourceDocRevNum | SOURCE_DOC_REV_NUM | — | — |
| 90 | PoLinesAllPEOStartDate | START_DATE | — | — |
| 91 | PoLinesAllPEOSupplierPartAuxid | SUPPLIER_PART_AUXID | — | — |
| 92 | PoLinesAllPEOSupplierRefNumber | SUPPLIER_REF_NUMBER | — | — |
| 93 | PoLinesAllPEOSvcAmountNotifSent | SVC_AMOUNT_NOTIF_SENT | — | — |
| 94 | PoLinesAllPEOSvcCompletionNotifSent | SVC_COMPLETION_NOTIF_SENT | — | — |
| 95 | PoLinesAllPEOTaxAttributeUpdateCode | TAX_ATTRIBUTE_UPDATE_CODE | — | — |
| 96 | PoLinesAllPEOTaxCodeId | TAX_CODE_ID | — | — |
| 97 | PoLinesAllPEOTaxName | TAX_NAME | — | — |
| 98 | PoLinesAllPEOTaxableFlag | TAXABLE_FLAG | — | — |
| 99 | PoLinesAllPEOType1099 | TYPE_1099 | — | — |
| 100 | PoLinesAllPEOUnNumberId | UN_NUMBER_ID | — | — |
| 101 | PoLinesAllPEOUnitPrice | UNIT_PRICE | — | — |
| 102 | PoLinesAllPEOUnorderedFlag | UNORDERED_FLAG | — | — |
| 103 | PoLinesAllPEOUomCode | UOM_CODE | — | — |
| 104 | PoLinesAllPEOVendorProductNum | VENDOR_PRODUCT_NUM | — | — |
...
| 124 | PoLineLocationsAllPEOSourceShipmentId | SOURCE_SHIPMENT_ID | — | — |
| 125 | PoLineLocationsAllPEOStartDate | START_DATE | — | — |
| 126 | PoLineLocationsAllPEOSupplierOrderLineNumber | SUPPLIER_ORDER_LINE_NUMBER | — | — |
| 127 | PoLineLocationsAllPEOTaxAttributeUpdateCode | TAX_ATTRIBUTE_UPDATE_CODE | — | — |
| 128 | PoLineLocationsAllPEOTaxCodeId | TAX_CODE_ID | — | — |
| 129 | PoLineLocationsAllPEOTaxName | TAX_NAME | — | — |
| 130 | PoLineLocationsAllPEOTaxUserOverrideFlag | TAX_USER_OVERRIDE_FLAG | — | — |
| 131 | PoLineLocationsAllPEOTaxableFlag | TAXABLE_FLAG | — | — |
| 132 | PoLineLocationsAllPEOTermsId | TERMS_ID | — | — |
| 133 | PoLineLocationsAllPEOTransactionFlowHeaderId | TRANSACTION_FLOW_HEADER_ID | — | — |
| 134 | PoLineLocationsAllPEOTrxBusinessCategory | TRX_BUSINESS_CATEGORY | — | — |
| 135 | PoLineLocationsAllPEOUnencumberedQuantity | UNENCUMBERED_QUANTITY | — | — |
| 136 | PoLineLocationsAllPEOUnitOfMeasureClass | UNIT_OF_MEASURE_CLASS | — | — |
| 137 | PoLineLocationsAllPEOUomCode | UOM_CODE | — | — |
| 138 | PoLineLocationsAllPEOUserDefinedFiscClass | USER_DEFINED_FISC_CLASS | — | — |
| 139 | PoLineLocationsAllPEOValueBasis | VALUE_BASIS | — | — |
| 140 | PoLineLocationsAllPEOVmiFlag | VMI_FLAG | — | — |
| 141 | PoLineLocationsAllPEOWorkApproverId | WORK_APPROVER_ID | — | — |
...
| 104 | RcvShipmentLinesPEOSecondaryQuantityReceived | SECONDARY_QUANTITY_RECEIVED | — | — |
| 105 | RcvShipmentLinesPEOSecondaryQuantityShipped | SECONDARY_QUANTITY_SHIPPED | — | — |
| 106 | RcvShipmentLinesPEOSecondaryUomCode | SECONDARY_UOM_CODE | — | — |
| 107 | RcvShipmentLinesPEOShipFromLocationId | SHIP_FROM_LOCATION_ID | — | — |
| 108 | RcvShipmentLinesPEOShipToLocationId | SHIP_TO_LOCATION_ID | — | — |
| 109 | RcvShipmentLinesPEOShipmentHeaderId | SHIPMENT_HEADER_ID | — | — |
| 110 | RcvShipmentLinesPEOShipmentLineStatusCode | SHIPMENT_LINE_STATUS_CODE | — | — |
| 111 | RcvShipmentLinesPEOShipmentUnitPrice | SHIPMENT_UNIT_PRICE | — | — |
| 112 | RcvShipmentLinesPEOSourceDocumentCode | SOURCE_DOCUMENT_CODE | — | — |
| 113 | RcvShipmentLinesPEOSpGroupId | SP_GROUP_ID | — | — |
| 114 | RcvShipmentLinesPEOSpQuantity | SP_QUANTITY | — | — |
| 115 | RcvShipmentLinesPEOSpUomCode | SP_UOM_CODE | — | — |
| 116 | RcvShipmentLinesPEOTaxAmount | TAX_AMOUNT | — | — |
| 117 | RcvShipmentLinesPEOTaxClassificationCode | TAX_CLASSIFICATION_CODE | — | — |
| 118 | RcvShipmentLinesPEOTaxName | TAX_NAME | — | — |
| 119 | RcvShipmentLinesPEOThirdPtyRegId | THIRD_PTY_REG_ID | — | — |
| 120 | RcvShipmentLinesPEOTimecardId | TIMECARD_ID | — | — |
| 121 | RcvShipmentLinesPEOTimecardOvn | TIMECARD_OVN | — | — |
| 122 | RcvShipmentLinesPEOToOrganizationId | TO_ORGANIZATION_ID | — | — |
| 123 | RcvShipmentLinesPEOToSubinventory | TO_SUBINVENTORY | — | — |
| 124 | RcvShipmentLinesPEOTransferCost | TRANSFER_COST | — | — |
| 125 | RcvShipmentLinesPEOTransferPercentage | TRANSFER_PERCENTAGE | — | — |
| 126 | RcvShipmentLinesPEOTransportationCost | TRANSPORTATION_COST | — | — |
| 127 | RcvShipmentLinesPEOTruckNum | TRUCK_NUM | — | — |
| 128 | RcvShipmentLinesPEOTrxBusinessCategory | TRX_BUSINESS_CATEGORY | — | — |
| 129 | RcvShipmentLinesPEOUomCode | UOM_CODE | — | ✅ |
| 130 | RcvShipmentLinesPEOUomConversionRate | UOM_CONVERSION_RATE | — | — |
| 131 | RcvShipmentLinesPEOUserDefinedFiscClass | USER_DEFINED_FISC_CLASS | — | — |
| 132 | RcvShipmentLinesPEOVendorCumShippedQuantity | VENDOR_CUM_SHIPPED_QUANTITY | — | — |
| 133 | RcvShipmentLinesPEOVendorItemNum | VENDOR_ITEM_NUM | — | — |
| 134 | RcvShipmentLinesPEOVendorLotNum | VENDOR_LOT_NUM | — | — |
| 135 | ShipmentLineId | SHIPMENT_LINE_ID | — | ✅ |
