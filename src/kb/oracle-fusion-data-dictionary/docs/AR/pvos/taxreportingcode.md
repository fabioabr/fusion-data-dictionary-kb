---
id: DOC-AR-PVO-TaxReportingCode
doc_type: system-doc
title: "TaxReportingCode — PVO Accounts Receivable"
...
Extrai os códigos de reporte fiscal atribuídos a contas de clientes, classificando obrigações de declaração. Suporta o cumprimento de obrigações acessórias e a geração de relatórios fiscais exigidos pelas autoridades.

**Caminho:** `FscmTopModelAM.FinArCustomersPublicModelAM.TaxReportingCode`
