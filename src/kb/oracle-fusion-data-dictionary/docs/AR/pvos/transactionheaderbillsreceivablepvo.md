---
id: DOC-AR-PVO-TransactionHeaderBillsReceivablePVO
doc_type: system-doc
title: "TransactionHeaderBillsReceivablePVO — PVO Accounts Receivable"
...
Extrai os cabeçalhos de transações do tipo Títulos a Receber (bills receivable/letras de câmbio), com dados de cliente, endereço, condições e impostos. Permite gerenciar o ciclo de vida de títulos negociáveis, protestos e descontos bancários.

**Caminho:** `FscmTopModelAM.FinArTopPublicModelAM.TransactionHeaderBillsReceivablePVO`
...
- [[ar_payment_schedules_all|AR_PAYMENT_SCHEDULES_ALL]] — 93 atributos (3 BICC)
...
- [[iby_fndcpt_tx_extensions|IBY_FNDCPT_TX_EXTENSIONS]] — 14 atributos
...
- [[ra_batch_sources_all|RA_BATCH_SOURCES_ALL]] — 114 atributos
- [[ra_customer_trx_all|RA_CUSTOMER_TRX_ALL]] — 306 atributos (1 PKs, 17 BICC)
