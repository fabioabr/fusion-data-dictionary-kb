---
id: DOC-PO-PVO-SharesPVO
doc_type: system-doc
title: "SharesPVO — PVO Purchasing"
...
Extrai os compartilhamentos de requisições de contratação e vagas entre funcionários, com detalhes de quem compartilhou e canal utilizado. Permite análise de colaboração e alcance na divulgação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecSourcingReferralsAM.SharesPVO`
...
- [[irc_rf_shares|IRC_RF_SHARES]] — 10 atributos (1 PKs, 10 BICC)
...
| 7 | ReferrerPersonId | REFERRER_PERSON_ID | — | ✅ |
| 8 | RequisitionId | REQUISITION_ID | — | ✅ |
| 9 | ShareId | SHARE_ID | 🔑 | ✅ |
| 10 | TargetChannelCode | TARGET_CHANNEL_CODE | — | ✅ |
