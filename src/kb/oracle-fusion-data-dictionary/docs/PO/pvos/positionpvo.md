---
id: DOC-PO-PVO-PositionPVO
doc_type: system-doc
title: "PositionPVO — PVO Purchasing"
...
Extrai dados completos de posições organizacionais (cargos), incluindo departamento, nível hierárquico, incumbente e localização. Suporta análise de estrutura organizacional e delegação de autoridade em compras.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PositionAM.PositionPVO`
...
- [[hr_all_positions_f|HR_ALL_POSITIONS_F]] — 70 atributos (2 PKs, 56 BICC)
