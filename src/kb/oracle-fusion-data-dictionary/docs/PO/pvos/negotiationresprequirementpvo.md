---
id: DOC-PO-PVO-NegotiationRespRequirementPVO
doc_type: system-doc
title: "NegotiationRespRequirementPVO — PVO Purchasing"
...
Disponibiliza requisitos de respostas de negociação para consulta, com seções, scores e status. Facilita a avaliação operacional de aderência de cada proposta.

**Caminho:** `FscmTopModelAM.PrcPonPublicViewAM.NegotiationRespRequirementPVO`
...
- [[pon_auction_headers_all|PON_AUCTION_HEADERS_ALL]] — 332 atributos (30 BICC)
- [[pon_bid_headers|PON_BID_HEADERS]] — 83 atributos (17 BICC)
- [[pon_bid_requirements|PON_BID_REQUIREMENTS]] — 20 atributos (2 PKs, 10 BICC)
- [[pon_bid_sections|PON_BID_SECTIONS]] — 10 atributos (2 PKs, 3 BICC)
...
| 41 | NegotiationHeaderAttributeLineNumber1 | ATTRIBUTE_LINE_NUMBER | — | — |
...
| 90 | NegotiationHeaderAwardDate1 | AWARD_DATE | — | ✅ |
| 91 | NegotiationHeaderAwardMode | AWARD_MODE | — | — |
| 92 | NegotiationHeaderAwardStatus1 | AWARD_STATUS | — | — |
...
| 126 | NegotiationHeaderDraftLocked1 | DRAFT_LOCKED | — | — |
| 127 | NegotiationHeaderDraftLockedByPersonId | DRAFT_LOCKED_BY_PERSON_ID | — | — |
| 128 | NegotiationHeaderDraftLockedDate1 | DRAFT_LOCKED_DATE | — | — |
| 129 | NegotiationHeaderDraftUnlockedByPersonId | DRAFT_UNLOCKED_BY_PERSON_ID | — | — |
| 130 | NegotiationHeaderDraftUnlockedDate1 | DRAFT_UNLOCKED_DATE | — | — |
...
| 201 | NegotiationHeaderImportFileName1 | IMPORT_FILE_NAME | — | — |
...
| 233 | NegotiationHeaderMaxInternalLineNum1 | MAX_INTERNAL_LINE_NUM | — | — |
...
| 247 | NegotiationHeaderNumberPriceDecimals1 | NUMBER_PRICE_DECIMALS | — | ✅ |
...
| 257 | NegotiationHeaderPoAgreedAmount1 | PO_AGREED_AMOUNT | — | ✅ |
...
| 268 | NegotiationHeaderProgramAppName1 | PROGRAM_APP_NAME | — | — |
| 269 | NegotiationHeaderProgramName1 | PROGRAM_NAME | — | — |
...
| 276 | NegotiationHeaderPublishDate1 | PUBLISH_DATE | — | ✅ |
...
| 281 | NegotiationHeaderRateDate1 | RATE_DATE | — | — |
| 282 | NegotiationHeaderRateType1 | RATE_TYPE | — | — |
...
| 286 | NegotiationHeaderRequestDate1 | REQUEST_DATE | — | — |
| 287 | NegotiationHeaderRequestId1 | REQUEST_ID | — | — |
| 288 | NegotiationHeaderRequestedBy1 | REQUESTED_BY | — | — |
...
| 2 | ResponseHeaderAuctionHeaderId3 | AUCTION_HEADER_ID | — | — |
...
| 8 | ResponseHeaderBidNumber2 | BID_NUMBER | — | ✅ |
...
| 15 | ResponseHeaderCreatedBy3 | CREATED_BY | — | — |
...
| 33 | ResponseHeaderLastUpdateDate3 | LAST_UPDATE_DATE | — | ✅ |
| 34 | ResponseHeaderLastUpdateLogin3 | LAST_UPDATE_LOGIN | — | — |
| 35 | ResponseHeaderLastUpdatedBy3 | LAST_UPDATED_BY | — | — |
| 36 | ResponseHeaderMaxInternalLineNum | MAX_INTERNAL_LINE_NUM | — | — |
...
| 40 | ResponseHeaderNumberPriceDecimals | NUMBER_PRICE_DECIMALS | — | ✅ |
| 41 | ResponseHeaderObjectVersionNumber3 | OBJECT_VERSION_NUMBER | — | — |
...
| 52 | ResponseHeaderPoAgreedAmount | PO_AGREED_AMOUNT | — | — |
| 53 | ResponseHeaderPoqTransferStatus | POQ_TRANSFER_STATUS | — | — |
| 54 | ResponseHeaderProgramAppName | PROGRAM_APP_NAME | — | — |
| 55 | ResponseHeaderProgramName | PROGRAM_NAME | — | — |
| 56 | ResponseHeaderProxyBidFlag | PROXY_BID_FLAG | — | — |
| 57 | ResponseHeaderPublishDate | PUBLISH_DATE | — | ✅ |
| 58 | ResponseHeaderRate | RATE | — | — |
| 59 | ResponseHeaderRateDate | RATE_DATE | — | — |
| 60 | ResponseHeaderRateDsp | RATE_DSP | — | — |
| 61 | ResponseHeaderRateType | RATE_TYPE | — | — |
| 62 | ResponseHeaderRequestDate | REQUEST_DATE | — | — |
| 63 | ResponseHeaderRequestId | REQUEST_ID | — | — |
| 64 | ResponseHeaderRequestedBy | REQUESTED_BY | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | NegRespRequirementsAuctionHeaderId | AUCTION_HEADER_ID | — | — |
| 2 | NegRespRequirementsBidNumber | BID_NUMBER | 🔑 | ✅ |
| 3 | NegRespRequirementsComments | COMMENTS | — | ✅ |
| 4 | NegRespRequirementsCreatedBy | CREATED_BY | — | ✅ |
| 5 | NegRespRequirementsCreationDate | CREATION_DATE | — | ✅ |
...
| 9 | NegRespRequirementsLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 10 | NegRespRequirementsLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 11 | NegRespRequirementsLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 12 | NegRespRequirementsObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 13 | NegRespRequirementsOldComments | OLD_COMMENTS | — | — |
| 14 | NegRespRequirementsRequirementId | REQUIREMENT_ID | 🔑 | ✅ |
| 15 | NegRespRequirementsScore | SCORE | — | ✅ |
| 16 | NegRespRequirementsSectionId | SECTION_ID | — | ✅ |
| 17 | NegRespRequirementsSequenceNumber | SEQUENCE_NUMBER | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | NegRespSectionsAuctionHeaderId1 | AUCTION_HEADER_ID | — | — |
| 2 | NegRespSectionsBidNumber1 | BID_NUMBER | 🔑 | ✅ |
| 3 | NegRespSectionsCreatedBy1 | CREATED_BY | — | — |
| 4 | NegRespSectionsCreationDate1 | CREATION_DATE | — | — |
| 5 | NegRespSectionsLastUpdateDate1 | LAST_UPDATE_DATE | — | ✅ |
| 6 | NegRespSectionsLastUpdateLogin1 | LAST_UPDATE_LOGIN | — | — |
| 7 | NegRespSectionsLastUpdatedBy1 | LAST_UPDATED_BY | — | — |
| 8 | NegRespSectionsObjectVersionNumber1 | OBJECT_VERSION_NUMBER | — | — |
| 9 | NegRespSectionsSectionId1 | SECTION_ID | 🔑 | ✅ |
...
| 4 | NegotiationRequirementAuctionHeaderId5 | AUCTION_HEADER_ID | — | — |
| 5 | NegotiationRequirementCategoryCode | CATEGORY_CODE | — | — |
| 6 | NegotiationRequirementCreatedBy5 | CREATED_BY | — | — |
| 7 | NegotiationRequirementCreationDate5 | CREATION_DATE | — | — |
...
| 17 | NegotiationRequirementLastUpdateDate5 | LAST_UPDATE_DATE | — | ✅ |
| 18 | NegotiationRequirementLastUpdateLogin5 | LAST_UPDATE_LOGIN | — | — |
| 19 | NegotiationRequirementLastUpdatedBy5 | LAST_UPDATED_BY | — | — |
...
| 24 | NegotiationRequirementObjectVersionNumber5 | OBJECT_VERSION_NUMBER | — | — |
...
| 38 | NegotiationRequirementScoreId | SCORE_ID | — | — |
| 39 | NegotiationRequirementScoringMethod | SCORING_METHOD | — | ✅ |
| 40 | NegotiationRequirementScoringType | SCORING_TYPE | — | — |
| 41 | NegotiationRequirementSectionId3 | SECTION_ID | — | — |
| 42 | NegotiationRequirementSequenceNumber1 | SEQUENCE_NUMBER | — | — |
| 43 | NegotiationRequirementSupplierLevel | SUPPLIER_LEVEL | — | ✅ |
| 44 | NegotiationRequirementTextValue | TEXT_VALUE | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | NegotiationSectionsAuctionHeaderId2 | AUCTION_HEADER_ID | — | — |
| 2 | NegotiationSectionsCreatedBy2 | CREATED_BY | — | — |
| 3 | NegotiationSectionsCreationDate2 | CREATION_DATE | — | — |
...
| 7 | NegotiationSectionsLastUpdateDate2 | LAST_UPDATE_DATE | — | ✅ |
| 8 | NegotiationSectionsLastUpdateLogin2 | LAST_UPDATE_LOGIN | — | — |
| 9 | NegotiationSectionsLastUpdatedBy2 | LAST_UPDATED_BY | — | — |
| 10 | NegotiationSectionsModifiedFlag | MODIFIED_FLAG | — | — |
| 11 | NegotiationSectionsObjectVersionNumber2 | OBJECT_VERSION_NUMBER | — | — |
...
| 14 | NegotiationSectionsSectionId2 | SECTION_ID | — | ✅ |
