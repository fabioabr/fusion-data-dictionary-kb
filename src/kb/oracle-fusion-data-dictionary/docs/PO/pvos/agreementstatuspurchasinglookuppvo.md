---
id: DOC-PO-PVO-AgreementStatusPurchasingLookupPVO
doc_type: system-doc
title: "AgreementStatusPurchasingLookupPVO — PVO Purchasing"
...
Extrai os valores de lookup para status de contratos de compra (ativo, expirado, congelado, cancelado). Padroniza relatórios e dashboards de gestão contratual, garantindo consistência na classificação de acordos.

**Caminho:** `FscmTopModelAM.PrcPoPublicViewAM.AgreementStatusPurchasingLookupPVO`
