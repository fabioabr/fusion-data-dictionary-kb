---
id: DOC-PO-PVO-JobRequisitionViewAllPVO
doc_type: system-doc
title: "JobRequisitionViewAllPVO — PVO Purchasing"
...
Extrai visão completa e irrestrita de todas as requisições de contratação, sem filtros de segurança. Suporta relatórios gerenciais de headcount e planejamento estratégico de workforce.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecHiringRequisitionAM.JobRequisitionViewAllPVO`
...
- [[irc_requisitions_b|IRC_REQUISITIONS_B]] — 167 atributos (1 PKs, 81 BICC)
- [[irc_requisitions_tl|IRC_REQUISITIONS_TL]] — 26 atributos (11 BICC)
