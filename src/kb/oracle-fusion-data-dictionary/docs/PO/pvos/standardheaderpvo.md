---
id: DOC-PO-PVO-StandardHeaderPVO
doc_type: system-doc
title: "StandardHeaderPVO — PVO Purchasing"
...
Extrai os cabeçalhos de ordens de compra padrão (Standard PO), incluindo número, fornecedor, valor total, moeda, termos de pagamento, status e fluxo de aprovação. Principal entidade transacional de compras, base para toda análise de procurement.

**Caminho:** `FscmTopModelAM.PrcPoPublicViewAM.StandardHeaderPVO`
...
- [[po_headers_all|PO_HEADERS_ALL]] — 260 atributos (1 PKs, 39 BICC)
- [[po_system_parameters_all|PO_SYSTEM_PARAMETERS_ALL]] — 71 atributos (1 BICC)
- [[po_versions_init_sequence_v|PO_VERSIONS_INIT_SEQUENCE_V]] — 42 atributos (5 BICC)
