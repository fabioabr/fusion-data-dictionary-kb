---
id: DOC-PO-PVO-SupplierBankAccountPVO
doc_type: system-doc
title: "SupplierBankAccountPVO — PVO Purchasing"
...
Extrai as contas bancárias dos fornecedores, com dados de instituição financeira, tipo de conta, moeda e status de validação. Fundamental para automação de pagamentos e prevenção de fraudes bancárias.

**Caminho:** `FscmTopModelAM.PrcPozPublicViewAM.SupplierBankAccountPVO`
...
- [[iby_external_payees_all|IBY_EXTERNAL_PAYEES_ALL]] — 36 atributos (1 PKs, 19 BICC)
