---
id: DOC-PO-PVO-PoolMembersPVO
doc_type: system-doc
title: "PoolMembersPVO — PVO Purchasing"
...
Disponibiliza membros de pools de candidatos para consulta operacional, facilitando busca e seleção de talentos para novas requisições de contratação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfilePoolsAM.PoolMembersPVO`
...
- [[hrt_pool_members|HRT_POOL_MEMBERS]] — 79 atributos (3 PKs, 9 BICC)
...
| 72 | MemberSince | MEMBER_SINCE | — | — |
| 73 | ObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 74 | PoolMemberType | POOL_MEMBER_TYPE | — | — |
| 75 | PoolMembersPEOEnterpriseId | ENTERPRISE_ID | 🔑 | ✅ |
| 76 | PoolMembersPEOMemberId | MEMBER_ID | 🔑 | ✅ |
| 77 | PoolMembersPEOPoolId | POOL_ID | — | ✅ |
| 78 | PoolMembersPEOPoolMemberId | POOL_MEMBER_ID | 🔑 | ✅ |
| 79 | PoolMembersPEOStatus | STATUS | — | ✅ |
