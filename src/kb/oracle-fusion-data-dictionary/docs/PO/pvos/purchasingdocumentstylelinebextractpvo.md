---
id: DOC-PO-PVO-PurchasingDocumentStyleLineBExtractPVO
doc_type: system-doc
title: "PurchasingDocumentStyleLineBExtractPVO — PVO Purchasing"
...
Extrai a configuração de estilos de documento de compra no nível de linha para carga BICC, determinando quais campos são visíveis, obrigatórios ou editáveis por tipo de pedido.

**Caminho:** `FscmTopModelAM.PrcExtractAM.PoBiccExtractAM.PurchasingDocumentStyleLineBExtractPVO`
...
- [[po_doc_style_headers|PO_DOC_STYLE_HEADERS]] — 15 atributos (15 BICC)
- [[po_doc_style_lines_b|PO_DOC_STYLE_LINES_B]] — 9 atributos (2 PKs, 9 BICC)
- [[po_doc_style_lines_tl|PO_DOC_STYLE_LINES_TL]] — 5 atributos (5 BICC)
