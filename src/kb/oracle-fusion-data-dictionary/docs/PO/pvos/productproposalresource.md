---
id: DOC-PO-PVO-ProductProposalResource
doc_type: system-doc
title: "ProductProposalResource — PVO Purchasing"
...
Extrai recursos alocados a propostas de produto, incluindo tipo, capacidade e período. Permite análise de viabilidade operacional e planejamento de capacidade produtiva.

**Caminho:** `FscmTopModelAM.PortfolioAnalyticsAM.ProductProposalResource`
...
- [[acd_resource|ACD_RESOURCE]] — 15 atributos (1 PKs, 15 BICC)
...
| 2 | PrdProposalCreatedBy4 | CREATED_BY | — | ✅ |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | PrdProposalResourceCreatedBy | CREATED_BY | — | ✅ |
| 2 | PrdProposalResourceCreationDate | CREATION_DATE | — | ✅ |
| 3 | PrdProposalResourceEndDate | END_DATE | — | ✅ |
| 4 | PrdProposalResourceLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 5 | PrdProposalResourceLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 6 | PrdProposalResourceLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 7 | PrdProposalResourceObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 8 | PrdProposalResourceProductProposalId | PRODUCT_PROPOSAL_ID | — | ✅ |
| 9 | PrdProposalResourceResourceCategory | RESOURCE_CATEGORY | — | ✅ |
| 10 | PrdProposalResourceResourceHeadcount | RESOURCE_HEADCOUNT | — | ✅ |
| 11 | PrdProposalResourceResourceId | RESOURCE_ID | 🔑 | ✅ |
| 12 | PrdProposalResourceResourcePool | RESOURCE_POOL | — | ✅ |
| 13 | PrdProposalResourceResourceStatus | RESOURCE_STATUS | — | ✅ |
| 14 | PrdProposalResourceResourceTrend | RESOURCE_TREND | — | ✅ |
| 15 | PrdProposalResourceStartDate | START_DATE | — | ✅ |

### [[ace_pf_scenario_b|ACE_PF_SCENARIO_B]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ProjDevLaborCost | PROJ_DEV_LABOR_COST | — | ✅ |
