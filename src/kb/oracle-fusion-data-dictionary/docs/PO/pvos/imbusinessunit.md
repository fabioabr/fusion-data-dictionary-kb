---
id: DOC-PO-PVO-IMBusinessUnit
doc_type: system-doc
title: "IMBusinessUnit — PVO Purchasing"
...
Extrai dados de unidades de negócio configuradas no módulo de procurement, com nomes e códigos padronizados. Fundamental para segmentação de compras por entidade e análise cross-BU.

**Caminho:** `FscmTopModelAM.PortfolioAnalyticsAM.IMBusinessUnit`
