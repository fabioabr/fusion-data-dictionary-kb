---
id: DOC-PO-PVO-NegotiationResponseCostFactorPVO
doc_type: system-doc
title: "NegotiationResponseCostFactorPVO — PVO Purchasing"
...
Disponibiliza fatores de custo de respostas para consulta, suportando análise comparativa de custos indiretos (frete, seguro, impostos) entre propostas concorrentes.

**Caminho:** `FscmTopModelAM.PrcExtractAM.PonBiccExtractAM.NegotiationResponseCostFactorPVO`
...
- [[gl_daily_conversion_types|GL_DAILY_CONVERSION_TYPES]] — 36 atributos (36 BICC)
...
- [[pon_bid_price_elements|PON_BID_PRICE_ELEMENTS]] — 22 atributos (3 PKs, 22 BICC)
- [[pon_price_elements|PON_PRICE_ELEMENTS]] — 7 atributos (7 BICC)
- [[pon_price_element_types_vl|PON_PRICE_ELEMENT_TYPES_VL]] — 6 atributos (6 BICC)
...
| 2 | DailyConversionTypeNegoHdrCreatedBy | CREATED_BY | — | ✅ |
| 3 | DailyConversionTypeNegoHdrCreationDate | CREATION_DATE | — | ✅ |
| 4 | DailyConversionTypeNegoHdrDescription | DESCRIPTION | — | ✅ |
| 5 | DailyConversionTypeNegoHdrEnableCrossRateFlag | ENABLE_CROSS_RATE_FLAG | — | ✅ |
| 6 | DailyConversionTypeNegoHdrEnforceInverseRateFlag | ENFORCE_INVERSE_RATE_FLAG | — | ✅ |
| 7 | DailyConversionTypeNegoHdrFemEnabledFlag | FEM_ENABLED_FLAG | — | ✅ |
| 8 | DailyConversionTypeNegoHdrFemRateTypeCode | FEM_RATE_TYPE_CODE | — | ✅ |
| 9 | DailyConversionTypeNegoHdrFemScenario | FEM_SCENARIO | — | ✅ |
| 10 | DailyConversionTypeNegoHdrFemTimeframe | FEM_TIMEFRAME | — | ✅ |
| 11 | DailyConversionTypeNegoHdrLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 12 | DailyConversionTypeNegoHdrLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 13 | DailyConversionTypeNegoHdrLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 14 | DailyConversionTypeNegoHdrObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 15 | DailyConversionTypeNegoHdrPivotCurrencyCode | PIVOT_CURRENCY_CODE | — | ✅ |
| 16 | DailyConversionTypeNegoHdrSecurityFlag | SECURITY_FLAG | — | ✅ |
| 17 | DailyConversionTypeNegoHdrUserConversionType | USER_CONVERSION_TYPE | — | ✅ |
| 18 | DailyConversionTypeNegoHdrUserOverrideCrossRateFlag | USER_OVERRIDE_CROSS_RATE_FLAG | — | ✅ |
| 19 | DailyConversionTypeResHdrConversionType | CONVERSION_TYPE | — | ✅ |
| 20 | DailyConversionTypeResHdrCreatedBy | CREATED_BY | — | ✅ |
| 21 | DailyConversionTypeResHdrCreationDate | CREATION_DATE | — | ✅ |
| 22 | DailyConversionTypeResHdrDescription | DESCRIPTION | — | ✅ |
| 23 | DailyConversionTypeResHdrEnableCrossRateFlag | ENABLE_CROSS_RATE_FLAG | — | ✅ |
| 24 | DailyConversionTypeResHdrEnforceInverseRateFlag | ENFORCE_INVERSE_RATE_FLAG | — | ✅ |
| 25 | DailyConversionTypeResHdrFemEnabledFlag | FEM_ENABLED_FLAG | — | ✅ |
| 26 | DailyConversionTypeResHdrFemRateTypeCode | FEM_RATE_TYPE_CODE | — | ✅ |
| 27 | DailyConversionTypeResHdrFemScenario | FEM_SCENARIO | — | ✅ |
| 28 | DailyConversionTypeResHdrFemTimeframe | FEM_TIMEFRAME | — | ✅ |
| 29 | DailyConversionTypeResHdrLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 30 | DailyConversionTypeResHdrLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 31 | DailyConversionTypeResHdrLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 32 | DailyConversionTypeResHdrObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 33 | DailyConversionTypeResHdrPivotCurrencyCode | PIVOT_CURRENCY_CODE | — | ✅ |
| 34 | DailyConversionTypeResHdrSecurityFlag | SECURITY_FLAG | — | ✅ |
| 35 | DailyConversionTypeResHdrUserConversionType | USER_CONVERSION_TYPE | — | ✅ |
| 36 | DailyConversionTypeResHdrUserOverrideCrossRateFlag | USER_OVERRIDE_CROSS_RATE_FLAG | — | ✅ |
...
| 3 | ResponseCostFactorAuctionCurrencyValue | AUCTION_CURRENCY_VALUE | — | ✅ |
| 4 | ResponseCostFactorAuctionHeaderId | AUCTION_HEADER_ID | — | ✅ |
| 5 | ResponseCostFactorBatchId | BATCH_ID | — | ✅ |
| 6 | ResponseCostFactorBidCurrencyValue | BID_CURRENCY_VALUE | — | ✅ |
| 7 | ResponseCostFactorCreatedBy | CREATED_BY | — | ✅ |
| 8 | ResponseCostFactorCreationDate | CREATION_DATE | — | ✅ |
| 9 | ResponseCostFactorInterfaceLineId | INTERFACE_LINE_ID | — | ✅ |
| 10 | ResponseCostFactorLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 11 | ResponseCostFactorLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 12 | ResponseCostFactorLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 13 | ResponseCostFactorObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 14 | ResponseCostFactorOldBidCurrencyValue | OLD_BID_CURRENCY_VALUE | — | ✅ |
| 15 | ResponseCostFactorPfType | PF_TYPE | — | ✅ |
| 16 | ResponseCostFactorPriceElementTypeId | PRICE_ELEMENT_TYPE_ID | — | ✅ |
| 17 | ResponseCostFactorPricingBasis | PRICING_BASIS | — | ✅ |
| 18 | ResponseCostFactorProgramAppName | PROGRAM_APP_NAME | — | ✅ |
| 19 | ResponseCostFactorProgramName | PROGRAM_NAME | — | ✅ |
| 20 | ResponseCostFactorProgramUpdateDate | PROGRAM_UPDATE_DATE | — | ✅ |
| 21 | ResponseCostFactorRequestId | REQUEST_ID | — | ✅ |
| 22 | SequenceNumber | SEQUENCE_NUMBER | 🔑 | ✅ |

### [[pon_price_elements|PON_PRICE_ELEMENTS]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | SourcingCostFactorAuctionHeaderId | AUCTION_HEADER_ID | — | ✅ |
| 2 | SourcingCostFactorLineNumber1 | LINE_NUMBER | — | ✅ |
| 3 | SourcingCostFactorObjectVersionNumber1 | OBJECT_VERSION_NUMBER | — | ✅ |
| 4 | SourcingCostFactorSequenceNumber1 | SEQUENCE_NUMBER | — | ✅ |
| 5 | SourcingCostFactorTypesPfType | PF_TYPE | — | ✅ |
| 6 | SourcingCostFactorTypesPricingBasis | PRICING_BASIS | — | ✅ |
| 7 | SourcingCostFactorValue | VALUE | — | ✅ |

### [[pon_price_element_types_vl|PON_PRICE_ELEMENT_TYPES_VL]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | SourcingCostFactorTypesDescription | DESCRIPTION | — | ✅ |
| 2 | SourcingCostFactorTypesEnabledFlag | ENABLED_FLAG | — | ✅ |
| 3 | SourcingCostFactorTypesName | NAME | — | ✅ |
| 4 | SourcingCostFactorTypesObjectVersionNumber2 | OBJECT_VERSION_NUMBER | — | ✅ |
| 5 | SourcingCostFactorTypesPriceElementCode | PRICE_ELEMENT_CODE | — | ✅ |
| 6 | SourcingCostFactorTypesPriceElementTypeId | PRICE_ELEMENT_TYPE_ID | — | ✅ |
