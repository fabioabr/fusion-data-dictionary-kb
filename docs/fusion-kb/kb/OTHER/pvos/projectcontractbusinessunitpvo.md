---
id: DOC-OTHER-PVO-ProjectContractBusinessUnitPVO
doc_type: system-doc
title: "ProjectContractBusinessUnitPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Project Contract Business Unit. Acessa as tabelas: FND_SETID_SETS_VL, GL_LEDGERS, HR_ALL_ORGANIZATION_UNITS_F (+8).

**Caminho:** `FscmTopModelAM.FinFunBusinessUnitsAM.ProjectContractBusinessUnitPVO`
