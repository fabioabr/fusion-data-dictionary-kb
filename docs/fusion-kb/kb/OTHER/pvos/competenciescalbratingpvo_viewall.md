---
id: DOC-OTHER-PVO-CompetenciesCalbRatingPVO_ViewAll
doc_type: system-doc
title: "CompetenciesCalbRatingPVO_ViewAll — PVO Cross-Module"
...
View Object para extração BICC de dados de Competencies Calb Rating_View All. Acessa as tabelas: HRR_DASHBOARDS, HRR_MEETINGS, HRR_TMPL_METRIC_CONFIG (+1).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.CompetenciesCalbRatingPVO_ViewAll`
