---
id: DOC-OTHER-PVO-GoalItemPVO
doc_type: system-doc
title: "GoalItemPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Goal Item. Acessa as tabelas: HRA_EVAL_ITEMS, HRA_EVAL_SECTIONS, HRG_GOALS (+1).
