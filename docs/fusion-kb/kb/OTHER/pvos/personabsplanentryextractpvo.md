---
id: DOC-OTHER-PVO-PersonAbsPlanEntryExtractPVO
doc_type: system-doc
title: "PersonAbsPlanEntryExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Person Abs Plan Entry Extract. Acessa as tabelas: ANC_PER_ABS_PLAN_ENTRIES.
