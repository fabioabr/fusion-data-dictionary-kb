---
id: DOC-OTHER-PVO-JobPVO
doc_type: system-doc
title: "JobPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Job. Acessa as tabelas: FND_SETID_SETS_VL, PER_JOBS_F, PER_JOBS_F_TL (+1).
