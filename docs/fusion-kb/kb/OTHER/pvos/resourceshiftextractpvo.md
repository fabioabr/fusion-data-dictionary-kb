---
id: DOC-OTHER-PVO-ResourceShiftExtractPVO
doc_type: system-doc
title: "ResourceShiftExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Resource Shift Extract. Acessa as tabelas: WIS_WC_RESOURCE_SHIFTS.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.ResourceShiftExtractPVO`
...
- [[wis_wc_resource_shifts|WIS_WC_RESOURCE_SHIFTS]] — 52 atributos (3 PKs, 52 BICC)

---

## ⚙️ Atributos

### [[wis_wc_resource_shifts|WIS_WC_RESOURCE_SHIFTS]]
...
| 49 | ResourceId | RESOURCE_ID | 🔑 | ✅ |
| 50 | ShiftId | SHIFT_ID | 🔑 | ✅ |
| 51 | WcProdCalendarId | WC_PROD_CALENDAR_ID | — | ✅ |
| 52 | WorkCenterId | WORK_CENTER_ID | 🔑 | ✅ |
