---
id: DOC-OTHER-PVO-ProjectAccountingBUUsagePVO
doc_type: system-doc
title: "ProjectAccountingBUUsagePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Project Accounting BUUsage. Acessa as tabelas: FUN_ALL_BUSINESS_UNITS_V, FUN_BUSINESS_FUNCTIONS_B, FUN_BUSINESS_FUNCTIONS_TL (+1).

**Caminho:** `FscmTopModelAM.FinFunBusinessUnitsAM.ProjectAccountingBUUsagePVO`
