---
id: DOC-OTHER-PVO-CalibratedRiskPVO
doc_type: system-doc
title: "CalibratedRiskPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Calibrated Risk. Acessa as tabelas: HRT_CONTENT_TYPES_B, HRT_PROFILES_B, HRT_PROFILE_ITEMS.
