---
id: DOC-OTHER-PVO-WDOperationOutputExtractPVO
doc_type: system-doc
title: "WDOperationOutputExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WDOperation Output Extract. Acessa as tabelas: WIS_WD_OPERATION_OUTPUTS.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.WDOperationOutputExtractPVO`
...
- [[wis_wd_operation_outputs|WIS_WD_OPERATION_OUTPUTS]] — 65 atributos (1 PKs, 65 BICC)

---

## ⚙️ Atributos

### [[wis_wd_operation_outputs|WIS_WD_OPERATION_OUTPUTS]]
...
| 42 | ComplLocatorId | COMPL_LOCATOR_ID | — | ✅ |
| 43 | ComplSubinventoryCode | COMPL_SUBINVENTORY_CODE | — | ✅ |
| 44 | CompletionType | COMPLETION_TYPE | — | ✅ |
| 45 | CostAllocationPercentage | COST_ALLOCATION_PERCENTAGE | — | ✅ |
| 46 | CostingPriority | COSTING_PRIORITY | — | ✅ |
| 47 | CreatedBy | CREATED_BY | — | ✅ |
| 48 | CreationDate | CREATION_DATE | — | ✅ |
| 49 | InventoryItemId | INVENTORY_ITEM_ID | — | ✅ |
...
| 57 | OutputQuantity | OUTPUT_QUANTITY | — | ✅ |
| 58 | OutputSeqNumber | OUTPUT_SEQ_NUMBER | — | ✅ |
| 59 | OutputType | OUTPUT_TYPE | — | ✅ |
| 60 | PrimaryFlag | PRIMARY_FLAG | — | ✅ |
| 61 | RequestId | REQUEST_ID | — | ✅ |
| 62 | UomCode | UOM_CODE | — | ✅ |
| 63 | WdOperationId | WD_OPERATION_ID | — | ✅ |
| 64 | WdOperationOutputId | WD_OPERATION_OUTPUT_ID | 🔑 | ✅ |
| 65 | WorkDefinitionId | WORK_DEFINITION_ID | — | ✅ |
