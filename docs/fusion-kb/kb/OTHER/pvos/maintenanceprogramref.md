---
id: DOC-OTHER-PVO-MaintenanceProgramRef
doc_type: system-doc
title: "MaintenanceProgramRef — PVO Cross-Module"
...
View Object para extração BICC de dados de Maintenance Program Ref. Acessa as tabelas: MNT_PROGRAMS_B, MNT_PROGRAMS_TL.

**Caminho:** `FscmTopModelAM.MaintProgramAM.MaintenanceProgramRef`
...
- [[mnt_programs_b|MNT_PROGRAMS_B]] — 72 atributos (1 PKs, 11 BICC)
- [[mnt_programs_tl|MNT_PROGRAMS_TL]] — 5 atributos (2 BICC)
