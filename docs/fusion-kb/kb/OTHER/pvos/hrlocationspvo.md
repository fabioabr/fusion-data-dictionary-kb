---
id: DOC-OTHER-PVO-HRLocationsPVO
doc_type: system-doc
title: "HRLocationsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de HRLocations. Acessa as tabelas: FND_SETID_SETS_VL, INV_ORGANIZATION_DEFINITIONS_V, PER_ACTION_OCCURRENCES (+6).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.LocationAM.HRLocationsPVO`
...
- [[fnd_setid_sets_vl|FND_SETID_SETS_VL]] — 5 atributos (5 BICC)
- [[inv_organization_definitions_v|INV_ORGANIZATION_DEFINITIONS_V]] — 3 atributos (2 BICC)
- [[per_action_occurrences|PER_ACTION_OCCURRENCES]] — 3 atributos (3 BICC)
- [[per_action_reasons_b|PER_ACTION_REASONS_B]] — 2 atributos (2 BICC)
- [[per_action_reasons_tl|PER_ACTION_REASONS_TL]] — 4 atributos (4 BICC)
- [[per_addresses_f|PER_ADDRESSES_F]] — 27 atributos (26 BICC)
- [[per_locations|PER_LOCATIONS]] — 12 atributos (12 BICC)
- [[per_location_details_f_vl|PER_LOCATION_DETAILS_F_VL]] — 45 atributos (1 PKs, 41 BICC)
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 4 atributos (4 BICC)
