---
id: DOC-OTHER-PVO-MaintenanceWorkCenterPVO
doc_type: system-doc
title: "MaintenanceWorkCenterPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Maintenance Work Center. Acessa as tabelas: WIS_WORK_AREAS_VL, WIS_WORK_CENTERS_B, WIS_WORK_CENTERS_TL.

**Caminho:** `FscmTopModelAM.WorkCenterAM.MaintenanceWorkCenterPVO`
...
- [[wis_work_areas_vl|WIS_WORK_AREAS_VL]] — 4 atributos (3 BICC)
- [[wis_work_centers_b|WIS_WORK_CENTERS_B]] — 11 atributos (1 PKs, 4 BICC)
- [[wis_work_centers_tl|WIS_WORK_CENTERS_TL]] — 11 atributos (3 BICC)
