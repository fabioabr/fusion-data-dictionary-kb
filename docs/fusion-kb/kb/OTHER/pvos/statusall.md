---
id: DOC-OTHER-PVO-StatusAll
doc_type: system-doc
title: "StatusAll — PVO Cross-Module"
...
View Object para extração BICC de dados de Status All. Acessa as tabelas: DOO_STATUSES_B, DOO_STATUSES_TL.

**Caminho:** `FscmTopModelAM.DooTopAM.StatusAll`
...
- [[doo_statuses_b|DOO_STATUSES_B]] — 10 atributos (1 PKs, 4 BICC)
- [[doo_statuses_tl|DOO_STATUSES_TL]] — 10 atributos (1 PKs, 7 BICC)
