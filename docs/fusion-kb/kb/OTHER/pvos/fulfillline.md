---
id: DOC-OTHER-PVO-FulfillLine
doc_type: system-doc
title: "FulfillLine — PVO Cross-Module"
...
View Object para extração BICC de dados de Fulfill Line. Acessa as tabelas: DOO_COVERAGE_FLINES_DETAILS_V, DOO_COVERED_FLINES_DETAILS_V, DOO_CVRD_FLINE_UNREF_RETRN_V (+16).

**Caminho:** `FscmTopModelAM.DooTopAM.FulfillLine`
...
- [[doo_coverage_flines_details_v|DOO_COVERAGE_FLINES_DETAILS_V]] — 19 atributos (1 PKs, 12 BICC)
- [[doo_covered_flines_details_v|DOO_COVERED_FLINES_DETAILS_V]] — 20 atributos (12 BICC)
- [[doo_cvrd_fline_unref_retrn_v|DOO_CVRD_FLINE_UNREF_RETRN_V]] — 17 atributos
- [[doo_document_references|DOO_DOCUMENT_REFERENCES]] — 14 atributos (1 PKs, 12 BICC)
- [[doo_doc_references_dropship_v|DOO_DOC_REFERENCES_DROPSHIP_V]] — 5 atributos (1 PKs, 3 BICC)
- [[doo_doc_references_supply_v|DOO_DOC_REFERENCES_SUPPLY_V]] — 4 atributos (1 BICC)
- [[doo_fulfill_lines_all|DOO_FULFILL_LINES_ALL]] — 172 atributos (1 PKs, 97 BICC)
- [[doo_headers_all|DOO_HEADERS_ALL]] — 46 atributos (34 BICC)
- [[doo_lines_all|DOO_LINES_ALL]] — 49 atributos (29 BICC)
- [[doo_order_terms|DOO_ORDER_TERMS]] — 6 atributos
- [[doo_projects|DOO_PROJECTS]] — 24 atributos
- [[dos_supply_buy_order_dtls|DOS_SUPPLY_BUY_ORDER_DTLS]] — 8 atributos (1 PKs, 3 BICC)
- [[dos_supply_make_order_dtls|DOS_SUPPLY_MAKE_ORDER_DTLS]] — 6 atributos
- [[dos_supply_tracking_lines|DOS_SUPPLY_TRACKING_LINES]] — 3 atributos (1 PKs, 1 BICC)
- [[egp_trading_partner_items|EGP_TRADING_PARTNER_ITEMS]] — 28 atributos (8 BICC)
- [[fun_all_business_units_v|FUN_ALL_BUSINESS_UNITS_V]] — 3 atributos
- [[gl_ledgers|GL_LEDGERS]] — 3 atributos
- [[hz_cust_accounts|HZ_CUST_ACCOUNTS]] — 31 atributos (2 BICC)
...
| 99 | FulfillLinePromiseArrivalDate | PROMISE_ARRIVAL_DATE | — | ✅ |
| 100 | FulfillLinePromiseShipDate | PROMISE_SHIP_DATE | — | ✅ |
| 101 | FulfillLineReferenceFlineId | REFERENCE_FLINE_ID | — | — |
| 102 | FulfillLineRemnantFlag | REMNANT_FLAG | — | — |
| 103 | FulfillLineRequestArrivalDate | REQUEST_ARRIVAL_DATE | — | ✅ |
| 104 | FulfillLineRequestCancelDate | REQUEST_CANCEL_DATE | — | ✅ |
| 105 | FulfillLineRequestShipDate | REQUEST_SHIP_DATE | — | ✅ |
| 106 | FulfillLineRequestType | REQUEST_TYPE | — | — |
| 107 | FulfillLineReservableFlag | RESERVABLE_FLAG | — | ✅ |
| 108 | FulfillLineReservationId | RESERVATION_ID | — | — |
| 109 | FulfillLineReservedQty | RESERVED_QTY | — | ✅ |
| 110 | FulfillLineReturnReasonCode | RETURN_REASON_CODE | — | ✅ |
| 111 | FulfillLineReturnableFlag | RETURNABLE_FLAG | — | — |
| 112 | FulfillLineRmaDeliveredQty | RMA_DELIVERED_QTY | — | ✅ |
...
| 172 | PrjRecIndicator | PRJ_REC_INDICATOR | — | — |
