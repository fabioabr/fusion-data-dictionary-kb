---
id: DOC-OTHER-PVO-CareerDevPVO
doc_type: system-doc
title: "CareerDevPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Career Dev. Acessa as tabelas: HRG_GOALS, HRG_GOAL_MEASUREMENTS, HRG_GOAL_PLANS_B (+4).
