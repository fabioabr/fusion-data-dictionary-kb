---
id: DOC-OTHER-PVO-PersonNamePVO
doc_type: system-doc
title: "PersonNamePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Person Name. Acessa as tabelas: PER_ALL_PEOPLE_F, PER_PERSONS, PER_PERSON_NAMES_F_V (+1).
