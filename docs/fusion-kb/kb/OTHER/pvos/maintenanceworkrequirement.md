---
id: DOC-OTHER-PVO-MaintenanceWorkRequirement
doc_type: system-doc
title: "MaintenanceWorkRequirement — PVO Cross-Module"
...
View Object para extração BICC de dados de Maintenance Work Requirement. Acessa as tabelas: MNT_WORK_REQUIREMENTS_B, MNT_WORK_REQUIREMENTS_TL, WIE_WO_STATUSES_TL.

**Caminho:** `FscmTopModelAM.MaintProgramAM.MaintenanceWorkRequirement`
...
- [[mnt_work_requirements_b|MNT_WORK_REQUIREMENTS_B]] — 42 atributos (1 PKs, 15 BICC)
- [[mnt_work_requirements_tl|MNT_WORK_REQUIREMENTS_TL]] — 10 atributos (2 PKs, 4 BICC)
