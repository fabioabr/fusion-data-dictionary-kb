---
id: DOC-OTHER-PVO-RequisitionAttachmentPVO
doc_type: system-doc
title: "RequisitionAttachmentPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Requisition Attachment. Acessa as tabelas: FND_ATTACHED_DOCUMENTS, FND_DOCUMENTS_VL.
