---
id: DOC-OTHER-PVO-ContentLibAttachmentPVO
doc_type: system-doc
title: "ContentLibAttachmentPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Content Lib Attachment. Acessa as tabelas: FND_ATTACHED_DOCUMENTS, FND_DOCUMENTS_VL.
