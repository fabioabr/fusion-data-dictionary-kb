---
id: DOC-OTHER-PVO-ResourceRequestMonthPVO
doc_type: system-doc
title: "ResourceRequestMonthPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Resource Request Month. Acessa as tabelas: FND_CAL_MONTH, PJF_PROJECTS_ALL_VL, PJR_RESOURCE_REQUESTS (+1).

**Caminho:** `FscmTopModelAM.PjrResourceRequestAM.ResourceRequestMonthPVO`
...
- [[fnd_cal_month|FND_CAL_MONTH]] — 3 atributos
...
| 2 | CalMonthEndDate | CAL_MONTH_END_DATE | — | — |
| 3 | CalMonthStartDate | CAL_MONTH_START_DATE | — | — |
