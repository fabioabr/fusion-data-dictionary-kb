---
id: DOC-OTHER-PVO-WOOperationOutputDetailDimRefPVO
doc_type: system-doc
title: "WOOperationOutputDetailDimRefPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WOOperation Output Detail Dim Ref. Acessa as tabelas: INV_ITEM_LOCATIONS, WIE_WO_OPERATIONS_B, WIE_WO_OPERATION_OUTPUTS.

**Caminho:** `FscmTopModelAM.WorkOrderAM.WOOperationOutputDetailDimRefPVO`
