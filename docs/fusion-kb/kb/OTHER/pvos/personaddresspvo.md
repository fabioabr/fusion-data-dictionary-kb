---
id: DOC-OTHER-PVO-PersonAddressPVO
doc_type: system-doc
title: "PersonAddressPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Person Address. Acessa as tabelas: PER_ADDRESSES_F, PER_ALL_PEOPLE_F, PER_PERSON_ADDR_USAGES_F.
