---
id: DOC-OTHER-PVO-FulfillLineRef
doc_type: system-doc
title: "FulfillLineRef — PVO Cross-Module"
...
View Object para extração BICC de dados de Fulfill Line Ref. Acessa as tabelas: DOO_COVERAGE_FLINES_DETAILS_V, DOO_COVERED_FLINES_DETAILS_V, DOO_CVRD_FLINE_UNREF_RETRN_V (+16).

**Caminho:** `FscmTopModelAM.DooTopAM.FulfillLineRef`
...
- [[doo_coverage_flines_details_v|DOO_COVERAGE_FLINES_DETAILS_V]] — 19 atributos (12 BICC)
...
- [[doo_document_references|DOO_DOCUMENT_REFERENCES]] — 14 atributos (13 BICC)
- [[doo_doc_references_dropship_v|DOO_DOC_REFERENCES_DROPSHIP_V]] — 5 atributos (3 BICC)
- [[doo_doc_references_supply_v|DOO_DOC_REFERENCES_SUPPLY_V]] — 4 atributos (1 BICC)
- [[doo_fulfill_lines_all|DOO_FULFILL_LINES_ALL]] — 172 atributos (1 PKs, 95 BICC)
...
- [[dos_supply_buy_order_dtls|DOS_SUPPLY_BUY_ORDER_DTLS]] — 8 atributos (3 BICC)
- [[dos_supply_make_order_dtls|DOS_SUPPLY_MAKE_ORDER_DTLS]] — 6 atributos
- [[dos_supply_tracking_lines|DOS_SUPPLY_TRACKING_LINES]] — 3 atributos (1 BICC)
