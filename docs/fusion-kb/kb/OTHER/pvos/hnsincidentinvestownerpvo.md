---
id: DOC-OTHER-PVO-HNSIncidentInvestOwnerPVO
doc_type: system-doc
title: "HNSIncidentInvestOwnerPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de HNSIncident Invest Owner. Acessa as tabelas: HNS_PERSONS.
