---
id: DOC-OTHER-PVO-EmployeeExpenseBusinessUnitPVO
doc_type: system-doc
title: "EmployeeExpenseBusinessUnitPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Employee Expense Business Unit. Acessa as tabelas: FND_SETID_SETS_VL, GL_LEDGERS, HR_ALL_ORGANIZATION_UNITS_F (+8).

**Caminho:** `FscmTopModelAM.FinFunBusinessUnitsAM.EmployeeExpenseBusinessUnitPVO`
