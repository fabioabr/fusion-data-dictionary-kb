---
id: DOC-OTHER-PVO-InventoryReservationsExtractPVO
doc_type: system-doc
title: "InventoryReservationsExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Inventory Reservations Extract. Acessa as tabelas: INV_RESERVATIONS.

**Caminho:** `FscmTopModelAM.ScmExtractAM.InvBiccExtractAM.InventoryReservationsExtractPVO`
...
- [[inv_reservations|INV_RESERVATIONS]] — 64 atributos (1 PKs, 64 BICC)
