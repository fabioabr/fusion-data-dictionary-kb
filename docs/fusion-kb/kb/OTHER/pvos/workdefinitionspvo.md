---
id: DOC-OTHER-PVO-WorkDefinitionsPVO
doc_type: system-doc
title: "WorkDefinitionsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Work Definitions. Acessa as tabelas: WIS_WD_VERSIONS, WIS_WORK_DEFINITIONS, WIS_WORK_DEFINITION_NAMES_VL (+1).

**Caminho:** `FscmTopModelAM.WorkOrderAM.WorkDefinitionsPVO`
...
- [[wis_work_methods_vl|WIS_WORK_METHODS_VL]] — 50 atributos (3 BICC)
