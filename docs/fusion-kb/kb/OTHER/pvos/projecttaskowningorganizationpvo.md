---
id: DOC-OTHER-PVO-ProjectTaskOwningOrganizationPVO
doc_type: system-doc
title: "ProjectTaskOwningOrganizationPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Project Task Owning Organization. Acessa as tabelas: FND_SETID_SETS_VL, HR_ALL_ORGANIZATION_UNITS_F, HR_ORGANIZATION_UNITS_F_TL (+4).

**Caminho:** `FscmTopModelAM.OrganizationAM.ProjectTaskOwningOrganizationPVO`
