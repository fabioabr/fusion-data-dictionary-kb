---
id: DOC-OTHER-PVO-HNSFireEventPVO
doc_type: system-doc
title: "HNSFireEventPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de HNSFire Event. Acessa as tabelas: HNS_FIRE_INC_EVENT_DETAIL.
