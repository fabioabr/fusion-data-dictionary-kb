---
id: DOC-OTHER-PVO-OvertimeTimePeriod
doc_type: system-doc
title: "OvertimeTimePeriod — PVO Cross-Module"
...
View Object para extração BICC de dados de Overtime Time Period. Acessa as tabelas: HWM_RP_TM_PERIODS_B, HWM_RP_TM_PERIODS_TL.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimePeriodsAM.OvertimeTimePeriod`
