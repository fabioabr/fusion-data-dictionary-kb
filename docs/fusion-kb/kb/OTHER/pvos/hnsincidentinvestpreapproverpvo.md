---
id: DOC-OTHER-PVO-HNSIncidentInvestPreApproverPVO
doc_type: system-doc
title: "HNSIncidentInvestPreApproverPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de HNSIncident Invest Pre Approver. Acessa as tabelas: HNS_PERSONS.
