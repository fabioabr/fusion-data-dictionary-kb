---
id: DOC-OTHER-PVO-HNSIncidentActionApproverPVO
doc_type: system-doc
title: "HNSIncidentActionApproverPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de HNSIncident Action Approver. Acessa as tabelas: HNS_PERSONS.
