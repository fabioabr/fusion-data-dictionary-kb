---
id: DOC-OTHER-PVO-JobPVOViewAll
doc_type: system-doc
title: "JobPVOViewAll — PVO Cross-Module"
...
View Object para extração BICC de dados de Job View All. Acessa as tabelas: FND_SETID_SETS_VL, PER_JOBS_F, PER_JOBS_F_TL (+1).
