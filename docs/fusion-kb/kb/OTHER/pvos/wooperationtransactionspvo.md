---
id: DOC-OTHER-PVO-WOOperationTransactionsPVO
doc_type: system-doc
title: "WOOperationTransactionsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WOOperation Transactions. Acessa as tabelas: WIE_OPERATION_TRANSACTIONS, WIE_TRANSACTION_SERIALS, WIE_WORK_ORDERS_B (+4).

**Caminho:** `FscmTopModelAM.WOOperationTransactionsAM.WOOperationTransactionsPVO`
...
- [[wie_operation_transactions|WIE_OPERATION_TRANSACTIONS]] — 40 atributos (1 PKs, 29 BICC)
- [[wie_transaction_serials|WIE_TRANSACTION_SERIALS]] — 16 atributos (10 BICC)
- [[wie_work_orders_b|WIE_WORK_ORDERS_B]] — 142 atributos (35 BICC)
