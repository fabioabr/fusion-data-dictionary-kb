---
id: DOC-OTHER-PVO-CareerDevGoalPVO
doc_type: system-doc
title: "CareerDevGoalPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Career Dev Goal. Acessa as tabelas: HRD_GOAL_INTENTS, HRD_PERSONAL_INTENTS, HRG_GOALS (+5).
