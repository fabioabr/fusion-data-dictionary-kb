---
id: DOC-OTHER-PVO-PaymentStatus
doc_type: system-doc
title: "PaymentStatus — PVO Cross-Module"
...
View Object para extração BICC de dados de Payment Status. Acessa as tabelas: CN_LOOKUPS.

**Caminho:** `FscmTopModelAM.CnLookupAM.PaymentStatus`
