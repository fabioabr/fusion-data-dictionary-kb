---
id: DOC-OTHER-PVO-CollectionBUUsagePVO
doc_type: system-doc
title: "CollectionBUUsagePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Collection BUUsage. Acessa as tabelas: FUN_ALL_BUSINESS_UNITS_V, FUN_BUSINESS_FUNCTIONS_B, FUN_BUSINESS_FUNCTIONS_TL (+1).

**Caminho:** `FscmTopModelAM.FinFunBusinessUnitsAM.CollectionBUUsagePVO`
