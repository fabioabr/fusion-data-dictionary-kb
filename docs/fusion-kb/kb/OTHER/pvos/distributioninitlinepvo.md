---
id: DOC-OTHER-PVO-DistributionInitLinePVO
doc_type: system-doc
title: "DistributionInitLinePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Distribution Init Line. Acessa as tabelas: FUN_BATCH_DISTS, FUN_DIST_LINES, FUN_INTERCO_ORGANIZATIONS (+7).

**Caminho:** `FscmTopModelAM.FinFunIntercoTransactionsAM.DistributionInitLinePVO`
