---
id: DOC-OTHER-PVO-ItemRelationshipPendingRev
doc_type: system-doc
title: "ItemRelationshipPendingRev — PVO Cross-Module"
...
View Object para extração BICC de dados de Item Relationship Pending Rev. Acessa as tabelas: EGO_ITEM_ASSOCIATIONS, EGP_ITEM_RELATIONSHIPS_B_V, EGP_ITEM_RELATIONSHIPS_TL (+3).

**Caminho:** `FscmTopModelAM.EgpItemsPublicModelAM.ItemRelationshipPendingRev`
...
- [[egp_item_relationships_b_v|EGP_ITEM_RELATIONSHIPS_B_V]] — 45 atributos (1 PKs, 16 BICC)
- [[egp_item_relationships_tl|EGP_ITEM_RELATIONSHIPS_TL]] — 10 atributos (3 BICC)
