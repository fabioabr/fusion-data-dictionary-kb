---
id: DOC-OTHER-PVO-ParticipantQuestionnaireQuestionPVOForPotentialAssessement
doc_type: system-doc
title: "ParticipantQuestionnaireQuestionPVOForPotentialAssessement — PVO Cross-Module"
...
View Object para extração BICC de dados de Participant Questionnaire Question For Potential Assessement. Acessa as tabelas: HRQ_QSTNR_PARTICIPANTS, HRQ_QSTNR_QUESTIONS, HRQ_QSTNR_SECTIONS_B (+7).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.QuestionnaireAM.ParticipantQuestionnaireQuestionPVOForPotentialAssessement`
...
- [[hrq_qstnr_questions|HRQ_QSTNR_QUESTIONS]] — 17 atributos (3 BICC)
- [[hrq_qstnr_sections_b|HRQ_QSTNR_SECTIONS_B]] — 17 atributos (2 PKs, 3 BICC)
- [[hrq_qstnr_sections_tl|HRQ_QSTNR_SECTIONS_TL]] — 13 atributos (3 BICC)
...
- [[hrq_questions_b|HRQ_QUESTIONS_B]] — 38 atributos (2 BICC)
