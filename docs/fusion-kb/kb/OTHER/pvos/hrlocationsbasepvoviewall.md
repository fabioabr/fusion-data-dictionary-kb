---
id: DOC-OTHER-PVO-HRLocationsBasePVOViewAll
doc_type: system-doc
title: "HRLocationsBasePVOViewAll — PVO Cross-Module"
...
View Object para extração BICC de dados de HRLocations Base View All. Acessa as tabelas: FND_SETID_SETS_VL, INV_ORGANIZATION_DEFINITIONS_V, PER_ACTION_OCCURRENCES (+7).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.LocationAM.HRLocationsBasePVOViewAll`
...
- [[per_location_details_f|PER_LOCATION_DETAILS_F]] — 43 atributos (3 PKs, 22 BICC)
