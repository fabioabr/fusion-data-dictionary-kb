---
id: DOC-OTHER-PVO-FulfillLineDetailTransportationPlanning
doc_type: system-doc
title: "FulfillLineDetailTransportationPlanning — PVO Cross-Module"
...
View Object para extração BICC de dados de Fulfill Line Detail Transportation Planning. Acessa as tabelas: DOO_FULFILL_LINES_ALL, DOO_FULFILL_LINE_DETAILS, DOO_HEADERS_ALL (+2).

**Caminho:** `FscmTopModelAM.DooTopAM.FulfillLineDetailTransportationPlanning`
