---
id: DOC-OTHER-PVO-CustomContentProfilePVO_Viewall
doc_type: system-doc
title: "CustomContentProfilePVO_Viewall — PVO Cross-Module"
...
View Object para extração BICC de dados de Custom Content Profile_Viewall. Acessa as tabelas: HRT_CONTENT_TYPES_B, HRT_CONTENT_TYPES_TL, HRT_PROFILES_B (+3).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.CustomContentProfilePVO_Viewall`
...
- [[hrt_content_types_b|HRT_CONTENT_TYPES_B]] — 8 atributos (3 BICC)
...
- [[hrt_profile_items|HRT_PROFILE_ITEMS]] — 95 atributos (1 PKs, 85 BICC)
