---
id: DOC-OTHER-PVO-WOOperationStartStopRefPVO
doc_type: system-doc
title: "WOOperationStartStopRefPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WOOperation Start Stop Ref. Acessa as tabelas: WIE_WORK_ORDERS_B, WIE_WO_OPERATIONS_B, WIE_WO_OPERATION_START_STOP (+1).

**Caminho:** `FscmTopModelAM.WorkOrderAM.WOOperationStartStopRefPVO`
...
- [[wie_work_orders_b|WIE_WORK_ORDERS_B]] — 103 atributos (1 BICC)
- [[wie_wo_operations_b|WIE_WO_OPERATIONS_B]] — 70 atributos (1 BICC)
- [[wie_wo_operation_start_stop|WIE_WO_OPERATION_START_STOP]] — 15 atributos (3 PKs, 13 BICC)
- [[wie_wo_product_serials|WIE_WO_PRODUCT_SERIALS]] — 59 atributos (2 BICC)
