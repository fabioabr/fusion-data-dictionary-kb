---
id: DOC-OTHER-PVO-HNSIncidentActionPreApproverPVO
doc_type: system-doc
title: "HNSIncidentActionPreApproverPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de HNSIncident Action Pre Approver. Acessa as tabelas: HNS_PERSONS.
