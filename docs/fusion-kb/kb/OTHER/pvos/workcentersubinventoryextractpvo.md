---
id: DOC-OTHER-PVO-WorkCenterSubInventoryExtractPVO
doc_type: system-doc
title: "WorkCenterSubInventoryExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Work Center Sub Inventory Extract. Acessa as tabelas: WIS_WC_SUB_INVENTORIES.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.WorkCenterSubInventoryExtractPVO`
...
- [[wis_wc_sub_inventories|WIS_WC_SUB_INVENTORIES]] — 53 atributos (1 PKs, 53 BICC)

---

## ⚙️ Atributos

### [[wis_wc_sub_inventories|WIS_WC_SUB_INVENTORIES]]
...
| 47 | LocatorId | LOCATOR_ID | — | ✅ |
| 48 | ObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 49 | OrganizationId | ORGANIZATION_ID | — | ✅ |
| 50 | SubinventoryName | SUBINVENTORY_NAME | — | ✅ |
| 51 | WorkCenterId | WORK_CENTER_ID | — | ✅ |
| 52 | WorkCenterSubInvType | WORK_CENTER_SUB_INV_TYPE | — | ✅ |
| 53 | WorkCenterSubinventoryId | WORK_CENTER_SUBINVENTORY_ID | 🔑 | ✅ |
