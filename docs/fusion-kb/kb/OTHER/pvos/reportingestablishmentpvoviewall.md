---
id: DOC-OTHER-PVO-ReportingEstablishmentPVOViewAll
doc_type: system-doc
title: "ReportingEstablishmentPVOViewAll — PVO Cross-Module"
...
View Object para extração BICC de dados de Reporting Establishment View All. Acessa as tabelas: FND_SETID_SETS_VL, HR_ALL_ORGANIZATION_UNITS_F, HR_ORGANIZATION_UNITS_F_TL (+4).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.ReportingEstablishmentPVOViewAll`
...
- [[hr_all_organization_units_f|HR_ALL_ORGANIZATION_UNITS_F]] — 18 atributos (7 BICC)
- [[hr_organization_units_f_tl|HR_ORGANIZATION_UNITS_F_TL]] — 13 atributos (3 BICC)
- [[hr_org_unit_classifications_f|HR_ORG_UNIT_CLASSIFICATIONS_F]] — 16 atributos (3 PKs, 8 BICC)
