---
id: DOC-OTHER-PVO-LocationRefPVO
doc_type: system-doc
title: "LocationRefPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Location Ref. Acessa as tabelas: PER_ADDRESSES_F, PER_LOCATIONS, PER_LOCATION_DETAILS_F_TL (+1).
