---
id: DOC-OTHER-PVO-WDOperationSubstituteMaterialExtractPVO
doc_type: system-doc
title: "WDOperationSubstituteMaterialExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WDOperation Substitute Material Extract. Acessa as tabelas: WIS_WD_OP_SUB_MATERIALS.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.WDOperationSubstituteMaterialExtractPVO`
...
- [[wis_wd_op_sub_materials|WIS_WD_OP_SUB_MATERIALS]] — 57 atributos (1 PKs, 57 BICC)

---

## ⚙️ Atributos

### [[wis_wd_op_sub_materials|WIS_WD_OP_SUB_MATERIALS]]
...
| 42 | ComponentSequenceId | COMPONENT_SEQUENCE_ID | — | ✅ |
...
| 51 | PriorityRanking | PRIORITY_RANKING | — | ✅ |
| 52 | RequestId | REQUEST_ID | — | ✅ |
| 53 | SubstituteComponentId | SUBSTITUTE_COMPONENT_ID | — | ✅ |
| 54 | SubstituteInverseQuantity | SUBSTITUTE_INVERSE_QUANTITY | — | ✅ |
| 55 | SubstituteItemQuantity | SUBSTITUTE_ITEM_QUANTITY | — | ✅ |
| 56 | WdOpSubMaterialId | WD_OP_SUB_MATERIAL_ID | 🔑 | ✅ |
| 57 | WdOperationMaterialId | WD_OPERATION_MATERIAL_ID | — | ✅ |
