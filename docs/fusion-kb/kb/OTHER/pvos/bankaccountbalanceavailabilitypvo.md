---
id: DOC-OTHER-PVO-BankAccountBalanceAvailabilityPVO
doc_type: system-doc
title: "BankAccountBalanceAvailabilityPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Bank Account Balance Availability. Acessa as tabelas: CE_INTERNAL_BANK_ACCTS_V, CE_STATEMENT_HEADERS, CE_STMT_BALANCES (+4).

**Caminho:** `FscmTopModelAM.FinCeBankStatementsAM.BankAccountBalanceAvailabilityPVO`
...
- [[ce_stmt_balances|CE_STMT_BALANCES]] — 13 atributos (7 BICC)
- [[ce_stmt_bal_avalbty|CE_STMT_BAL_AVALBTY]] — 12 atributos (1 PKs, 7 BICC)
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | BalanceBalanceAmount | BALANCE_AMOUNT | — | — |
| 2 | BalanceBalanceCode | BALANCE_CODE | — | ✅ |
| 3 | BalanceBalanceCurr | BALANCE_CURR | — | ✅ |
| 4 | BalanceBalanceDate | BALANCE_DATE | — | ✅ |
| 5 | BalanceBankAccountId | BANK_ACCOUNT_ID | — | — |
| 6 | BalanceCreatedBy | CREATED_BY | — | ✅ |
| 7 | BalanceCreationDate | CREATION_DATE | — | — |
| 8 | BalanceLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 9 | BalanceLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 10 | BalanceLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 11 | BalanceObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 12 | BalanceStatementHeaderId | STATEMENT_HEADER_ID | — | — |
| 13 | BalanceStmtBalanceId | STMT_BALANCE_ID | — | ✅ |

### [[ce_stmt_bal_avalbty|CE_STMT_BAL_AVALBTY]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | BalanceAvlActualDate | ACTUAL_DATE | — | ✅ |
| 2 | BalanceAvlAvailableBalanceAmt | AVAILABLE_BALANCE_AMT | — | ✅ |
| 3 | BalanceAvlCreatedBy | CREATED_BY | — | — |
| 4 | BalanceAvlCreationDate | CREATION_DATE | — | ✅ |
| 5 | BalanceAvlCreditDebitInd | CREDIT_DEBIT_IND | — | ✅ |
| 6 | BalanceAvlLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 7 | BalanceAvlLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 8 | BalanceAvlLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 9 | BalanceAvlNumberOfFloatDays | NUMBER_OF_FLOAT_DAYS | — | ✅ |
| 10 | BalanceAvlObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 11 | BalanceAvlStmtBalanceId | STMT_BALANCE_ID | — | — |
| 12 | StmtBalAvalbtyId | STMT_BAL_AVALBTY_ID | 🔑 | ✅ |
