---
id: DOC-OTHER-PVO-OrganizationRelationshipExtractPVO
doc_type: system-doc
title: "OrganizationRelationshipExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Organization Relationship Extract. Acessa as tabelas: CSE_ORG_RELATIONSHIPS.

**Caminho:** `FscmTopModelAM.ScmExtractAM.CseBiccExtractAM.OrganizationRelationshipExtractPVO`
...
- [[cse_org_relationships|CSE_ORG_RELATIONSHIPS]] — 51 atributos (1 PKs, 51 BICC)

---

## ⚙️ Atributos

### [[cse_org_relationships|CSE_ORG_RELATIONSHIPS]]
...
| 48 | OrgRelationshipId | ORG_RELATIONSHIP_ID | 🔑 | ✅ |
| 49 | OrganizationId | ORGANIZATION_ID | — | ✅ |
| 50 | RelatedOrganizationId | RELATED_ORGANIZATION_ID | — | ✅ |
| 51 | RelationshipTypeCode | RELATIONSHIP_TYPE_CODE | — | ✅ |
