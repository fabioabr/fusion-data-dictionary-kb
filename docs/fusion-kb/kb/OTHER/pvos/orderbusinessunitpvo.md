---
id: DOC-OTHER-PVO-OrderBusinessUnitPVO
doc_type: system-doc
title: "OrderBusinessUnitPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Order Business Unit. Acessa as tabelas: FND_SETID_SETS_VL, GL_LEDGERS, HR_ALL_ORGANIZATION_UNITS_F (+8).

**Caminho:** `FscmTopModelAM.FinFunBusinessUnitsAM.OrderBusinessUnitPVO`
...
- [[gl_ledgers|GL_LEDGERS]] — 59 atributos (59 BICC)
- [[hr_all_organization_units_f|HR_ALL_ORGANIZATION_UNITS_F]] — 20 atributos (3 PKs, 10 BICC)
- [[hr_organization_information_f|HR_ORGANIZATION_INFORMATION_F]] — 22 atributos (9 BICC)
- [[hr_organization_units_f_tl|HR_ORGANIZATION_UNITS_F_TL]] — 11 atributos (2 BICC)
- [[hr_org_unit_classifications_f|HR_ORG_UNIT_CLASSIFICATIONS_F]] — 16 atributos (3 BICC)
- [[per_location_details_f|PER_LOCATION_DETAILS_F]] — 4 atributos (4 BICC)
- [[per_location_details_f_tl|PER_LOCATION_DETAILS_F_TL]] — 7 atributos (3 BICC)
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 29 atributos (21 BICC)
- [[per_users|PER_USERS]] — 10 atributos
- [[xle_entity_profiles|XLE_ENTITY_PROFILES]] — 12 atributos (11 BICC)
