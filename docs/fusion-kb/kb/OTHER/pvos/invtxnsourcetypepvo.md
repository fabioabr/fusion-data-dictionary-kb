---
id: DOC-OTHER-PVO-InvTxnSourceTypePVO
doc_type: system-doc
title: "InvTxnSourceTypePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Inv Txn Source Type. Acessa as tabelas: INV_TXN_SOURCE_TYPES_B, INV_TXN_SOURCE_TYPES_TL.

**Caminho:** `FscmTopModelAM.InventoryAM.InvTxnSourceTypePVO`
...
- [[inv_txn_source_types_b|INV_TXN_SOURCE_TYPES_B]] — 17 atributos (1 PKs, 2 BICC)
- [[inv_txn_source_types_tl|INV_TXN_SOURCE_TYPES_TL]] — 11 atributos (1 PKs, 3 BICC)
