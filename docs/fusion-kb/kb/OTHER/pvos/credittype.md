---
id: DOC-OTHER-PVO-CreditType
doc_type: system-doc
title: "CreditType — PVO Cross-Module"
...
View Object para extração BICC de dados de Credit Type. Acessa as tabelas: CN_LOOKUPS.

**Caminho:** `FscmTopModelAM.CnLookupAM.CreditType`
