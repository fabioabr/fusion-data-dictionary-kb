---
id: DOC-OTHER-PVO-CourtOrderPVO
doc_type: system-doc
title: "CourtOrderPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Court Order. Acessa as tabelas: BEN_CRT_ORDR_F, BEN_CRT_ORDR_PL_DPNT, PER_ALL_PEOPLE_F.
