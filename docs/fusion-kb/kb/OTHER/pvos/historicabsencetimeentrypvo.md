---
id: DOC-OTHER-PVO-HistoricAbsenceTimeEntryPVO
doc_type: system-doc
title: "HistoricAbsenceTimeEntryPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Historic Absence Time Entry. Acessa as tabelas: HWM_RP_TM_PERIODS_VL, HWM_TM_ABS_ENTRY_V, HWM_TM_APPROVED_TS_V (+13).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.HistoricAbsenceTimeEntryPVO`
...
- [[hwm_tm_approved_ts_v|HWM_TM_APPROVED_TS_V]] — 2 atributos
- [[hwm_tm_a_anc_app_status_v|HWM_TM_A_ANC_APP_STATUS_V]] — 2 atributos
- [[hwm_tm_a_user_status_v|HWM_TM_A_USER_STATUS_V]] — 2 atributos
- [[hwm_tm_d_tm_ui_status_v|HWM_TM_D_TM_UI_STATUS_V]] — 2 atributos
- [[hwm_tm_rec_grp|HWM_TM_REC_GRP]] — 3 atributos
- [[hwm_tm_rep_m_anc_atrbs_v|HWM_TM_REP_M_ANC_ATRBS_V]] — 2 atributos
- [[hwm_tm_rep_s_abs_hp_atrbs_v|HWM_TM_REP_S_ABS_HP_ATRBS_V]] — 4 atributos
- [[hwm_tm_rep_s_abs_tep_atrbs_v|HWM_TM_REP_S_ABS_TEP_ATRBS_V]] — 2 atributos
...
- [[hwm_tm_submitted_ts_v|HWM_TM_SUBMITTED_TS_V]] — 2 atributos
