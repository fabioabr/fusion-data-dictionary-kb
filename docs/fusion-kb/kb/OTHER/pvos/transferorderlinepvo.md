---
id: DOC-OTHER-PVO-TransferOrderLinePVO
doc_type: system-doc
title: "TransferOrderLinePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Transfer Order Line. Acessa as tabelas: INV_ORG_PARAMETERS_V, INV_TRANSFER_ORDER_HEADERS, INV_TRANSFER_ORDER_LINES (+1).

**Caminho:** `FscmTopModelAM.InventoryAM.TransferOrderLinePVO`
