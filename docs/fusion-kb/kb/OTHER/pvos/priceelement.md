---
id: DOC-OTHER-PVO-PriceElement
doc_type: system-doc
title: "PriceElement — PVO Cross-Module"
...
View Object para extração BICC de dados de Price Element. Acessa as tabelas: QP_PRICE_ELEMENTS_VL.

**Caminho:** `FscmTopModelAM.DooTopAM.PriceElement`
...
- [[qp_price_elements_vl|QP_PRICE_ELEMENTS_VL]] — 54 atributos (1 PKs, 54 BICC)
...
| 45 | ElementCode | ELEMENT_CODE | — | ✅ |
| 46 | ElementTypeCode | ELEMENT_TYPE_CODE | — | ✅ |
...
| 52 | PriceElementId | PRICE_ELEMENT_ID | 🔑 | ✅ |
| 53 | PricingGuidelineEnabledFlag | PRICING_GUIDELINE_ENABLED_FLAG | — | ✅ |
| 54 | SeededFlag | SEEDED_FLAG | — | ✅ |
