---
id: DOC-OTHER-PVO-ProjectPlanLineBudgetPVO
doc_type: system-doc
title: "ProjectPlanLineBudgetPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Project Plan Line Budget. Acessa as tabelas: CST_COST_BOOKS_B, EGP_CATEGORIES_VL, EGP_SYSTEM_ITEMS_VL (+37).

**Caminho:** `FscmTopModelAM.PjoBudgetsAndForecastsAnalyticsAM.ProjectPlanLineBudgetPVO`
...
- [[pjf_rate_schedules_vl|PJF_RATE_SCHEDULES_VL]] — 27 atributos (3 BICC)
...
- [[pjo_planning_elements|PJO_PLANNING_ELEMENTS]] — 56 atributos (9 BICC)
- [[pjo_planning_options|PJO_PLANNING_OPTIONS]] — 90 atributos (1 BICC)
- [[pjo_plan_lines|PJO_PLAN_LINES]] — 83 atributos (1 PKs, 22 BICC)
