---
id: DOC-OTHER-PVO-ProjectInvoicingBusinessUnitPVO
doc_type: system-doc
title: "ProjectInvoicingBusinessUnitPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Project Invoicing Business Unit. Acessa as tabelas: FND_SETID_SETS_VL, GL_LEDGERS, HR_ALL_ORGANIZATION_UNITS_F (+8).

**Caminho:** `FscmTopModelAM.FinFunBusinessUnitsAM.ProjectInvoicingBusinessUnitPVO`
...
- [[hr_all_organization_units_f|HR_ALL_ORGANIZATION_UNITS_F]] — 20 atributos (3 PKs, 4 BICC)
