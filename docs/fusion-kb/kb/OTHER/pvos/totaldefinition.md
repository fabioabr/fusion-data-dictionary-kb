---
id: DOC-OTHER-PVO-TotalDefinition
doc_type: system-doc
title: "TotalDefinition — PVO Cross-Module"
...
View Object para extração BICC de dados de Total Definition. Acessa as tabelas: QP_TOTAL_DEFINITIONS_VL.

**Caminho:** `FscmTopModelAM.DooTopAM.TotalDefinition`
...
- [[qp_total_definitions_vl|QP_TOTAL_DEFINITIONS_VL]] — 56 atributos (1 PKs, 56 BICC)

---

## ⚙️ Atributos

### [[qp_total_definitions_vl|QP_TOTAL_DEFINITIONS_VL]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | AlgorithmName | ALGORITHM_NAME | — | ✅ |
...
| 51 | PricingGuidelineEnabledFlag | PRICING_GUIDELINE_ENABLED_FLAG | — | ✅ |
| 52 | ReturnNullTotalFlag | RETURN_NULL_TOTAL_FLAG | — | ✅ |
| 53 | SeededFlag | SEEDED_FLAG | — | ✅ |
| 54 | TotalCode | TOTAL_CODE | — | ✅ |
| 55 | TotalDefinitionId | TOTAL_DEFINITION_ID | 🔑 | ✅ |
| 56 | TransactionEnabledFlag | TRANSACTION_ENABLED_FLAG | — | ✅ |
