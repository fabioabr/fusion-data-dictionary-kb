---
id: DOC-OTHER-PVO-BoxLabelLookupPVO
doc_type: system-doc
title: "BoxLabelLookupPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Box Label Lookup. Acessa as tabelas: HRR_DASHBOARD_TMPLS_B, HRR_MEETINGS, HRR_TMPL_ANALYTIC_TYPES_B (+2).
