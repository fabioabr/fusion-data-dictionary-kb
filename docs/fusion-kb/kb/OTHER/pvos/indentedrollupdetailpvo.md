---
id: DOC-OTHER-PVO-IndentedRollupDetailPVO
doc_type: system-doc
title: "IndentedRollupDetailPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Indented Rollup Detail. Acessa as tabelas: CST_COSTED_VU_ONHAND_V, CST_COST_ORGS_V, CST_COST_ORG_BOOKS (+8).

**Caminho:** `FscmTopModelAM.ScenariosAM.IndentedRollupDetailPVO`
...
- [[cst_indented_rollup_details_v|CST_INDENTED_ROLLUP_DETAILS_V]] — 76 atributos (1 PKs, 39 BICC)
- [[cst_rollup_det_otbi_v|CST_ROLLUP_DET_OTBI_V]] — 42 atributos (8 BICC)
...
| 8 | CostedVuOnhandPEOValUnitId1 | VAL_UNIT_ID | — | — |
...
### [[cst_indented_rollup_details_v|CST_INDENTED_ROLLUP_DETAILS_V]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | IndentedRollupDetailPEOAllocatedExtendedCost | ALLOCATED_EXTENDED_COST | — | ✅ |
| 2 | IndentedRollupDetailPEOAllocatedUnitCost | ALLOCATED_UNIT_COST | — | ✅ |
| 3 | IndentedRollupDetailPEOAssemblyItemId | ASSEMBLY_ITEM_ID | — | — |
| 4 | IndentedRollupDetailPEOBasisType | BASIS_TYPE | — | ✅ |
| 5 | IndentedRollupDetailPEOBatchPrimaryUomCode | BATCH_PRIMARY_UOM_CODE | — | ✅ |
| 6 | IndentedRollupDetailPEOBatchQuantity | BATCH_QUANTITY | — | ✅ |
| 7 | IndentedRollupDetailPEOBatchUomCode | BATCH_UOM_CODE | — | ✅ |
| 8 | IndentedRollupDetailPEOBomLevel | BOM_LEVEL | — | ✅ |
| 9 | IndentedRollupDetailPEOCompCostUomCode | COMP_COST_UOM_CODE | — | — |
| 10 | IndentedRollupDetailPEOCostAllocationPercentage | COST_ALLOCATION_PERCENTAGE | — | ✅ |
| 11 | IndentedRollupDetailPEOCostBookId | COST_BOOK_ID | — | — |
| 12 | IndentedRollupDetailPEOCostOrgId | COST_ORG_ID | — | — |
| 13 | IndentedRollupDetailPEOCostUomCode | COST_UOM_CODE | — | ✅ |
| 14 | IndentedRollupDetailPEOCostUomConversionFactor | COST_UOM_CONVERSION_FACTOR | — | — |
| 15 | IndentedRollupDetailPEOCostingBatchOutputSize | COSTING_BATCH_OUTPUT_SIZE | — | ✅ |
| 16 | IndentedRollupDetailPEOCostingPriority | COSTING_PRIORITY | — | ✅ |
| 17 | IndentedRollupDetailPEOCumulativeExtendedCost | CUMULATIVE_EXTENDED_COST | — | ✅ |
| 18 | IndentedRollupDetailPEOCumulativeUnitCost | CUMULATIVE_UNIT_COST | — | ✅ |
| 19 | IndentedRollupDetailPEOCurrencyConversionRate | CURRENCY_CONVERSION_RATE | — | — |
| 20 | IndentedRollupDetailPEODetailSourceType | DETAIL_SOURCE_TYPE | — | ✅ |
| 21 | IndentedRollupDetailPEOEffectiveStartDate | EFFECTIVE_START_DATE | — | — |
| 22 | IndentedRollupDetailPEOExtendedCost | EXTENDED_COST | — | ✅ |
| 23 | IndentedRollupDetailPEOInvOrgId | INV_ORG_ID | — | — |
| 24 | IndentedRollupDetailPEOMaterialInventoryItemId | MATERIAL_INVENTORY_ITEM_ID | — | — |
| 25 | IndentedRollupDetailPEOMaterialInventoryOrgId | MATERIAL_INVENTORY_ORG_ID | — | — |
| 26 | IndentedRollupDetailPEOOpRevYieldFactor | OP_REV_YIELD_FACTOR | — | — |
| 27 | IndentedRollupDetailPEOOpYieldFactor | OP_YIELD_FACTOR | — | — |
| 28 | IndentedRollupDetailPEOOperationSeqNumber | OPERATION_SEQ_NUMBER | — | — |
| 29 | IndentedRollupDetailPEOOrganizationId | ORGANIZATION_ID | — | — |
| 30 | IndentedRollupDetailPEOOrigOutputType | ORIG_OUTPUT_TYPE | — | ✅ |
| 31 | IndentedRollupDetailPEOOutputInventoryItemId | OUTPUT_INVENTORY_ITEM_ID | — | — |
| 32 | IndentedRollupDetailPEOOutputSeqNumber | OUTPUT_SEQ_NUMBER | — | — |
| 33 | IndentedRollupDetailPEOOutputType | OUTPUT_TYPE | — | ✅ |
| 34 | IndentedRollupDetailPEOOverheadFlag | OVERHEAD_FLAG | — | ✅ |
| 35 | IndentedRollupDetailPEOOverheadRateId | OVERHEAD_RATE_ID | — | — |
| 36 | IndentedRollupDetailPEOPoLineLocationId | PO_LINE_LOCATION_ID | — | — |
| 37 | IndentedRollupDetailPEOPostedFlag | POSTED_FLAG | — | ✅ |
| 38 | IndentedRollupDetailPEOPrimaryFlag | PRIMARY_FLAG | — | ✅ |
| 39 | IndentedRollupDetailPEOPrimaryUomCode | PRIMARY_UOM_CODE | — | ✅ |
| 40 | IndentedRollupDetailPEOProductionPriority | PRODUCTION_PRIORITY | — | ✅ |
| 41 | IndentedRollupDetailPEOPublishedFlag | PUBLISHED_FLAG | — | ✅ |
| 42 | IndentedRollupDetailPEOQtyUomCode | QTY_UOM_CODE | — | ✅ |
| 43 | IndentedRollupDetailPEOQuantityUsage | QUANTITY_USAGE | — | ✅ |
| 44 | IndentedRollupDetailPEOResourceId | RESOURCE_ID | — | — |
| 45 | IndentedRollupDetailPEOResourceSeqNumber | RESOURCE_SEQ_NUMBER | — | ✅ |
| 46 | IndentedRollupDetailPEORollupHeaderKey | ROLLUP_HEADER_KEY | — | — |
| 47 | IndentedRollupDetailPEORollupHeaderLevel | ROLLUP_HEADER_LEVEL | — | — |
| 48 | IndentedRollupDetailPEORollupHeaderType | ROLLUP_HEADER_TYPE | — | — |
| 49 | IndentedRollupDetailPEORootAssemblyItemId | ROOT_ASSEMBLY_ITEM_ID | — | — |
| 50 | IndentedRollupDetailPEORootRowNum | ROOT_ROW_NUM | — | — |
| 51 | IndentedRollupDetailPEORunningExtendedTotal | RUNNING_EXTENDED_TOTAL | — | ✅ |
| 52 | IndentedRollupDetailPEORunningUnitTotal | RUNNING_UNIT_TOTAL | — | — |
| 53 | IndentedRollupDetailPEOScenarioEventId | SCENARIO_EVENT_ID | — | — |
| 54 | IndentedRollupDetailPEOScenarioId | SCENARIO_ID | — | — |
| 55 | IndentedRollupDetailPEOScenarioRollupHeaderId | SCENARIO_ROLLUP_HEADER_ID | — | — |
| 56 | IndentedRollupDetailPEOSourceId | SOURCE_ID | — | — |
| 57 | IndentedRollupDetailPEOSourceType | SOURCE_TYPE | — | — |
| 58 | IndentedRollupDetailPEOUnallocatedExtendedCost | UNALLOCATED_EXTENDED_COST | — | ✅ |
| 59 | IndentedRollupDetailPEOUnallocatedUnitCost | UNALLOCATED_UNIT_COST | — | — |
| 60 | IndentedRollupDetailPEOUnitCost | UNIT_COST | — | ✅ |
| 61 | IndentedRollupDetailPEOValUnitId | VAL_UNIT_ID | — | — |
| 62 | IndentedRollupDetailPEOVersionNumber | VERSION_NUMBER | — | ✅ |
| 63 | IndentedRollupDetailPEOWdCostingBatchOutputSize | WD_COSTING_BATCH_OUTPUT_SIZE | — | — |
| 64 | IndentedRollupDetailPEOWdOperationId | WD_OPERATION_ID | — | — |
| 65 | IndentedRollupDetailPEOWorkDefinitionId | WORK_DEFINITION_ID | — | — |
| 66 | IndentedRollupDetailPEOWorkDefinitionNameId | WORK_DEFINITION_NAME_ID | — | — |
| 67 | IndentedRollupDetailPEOWorkDefinitionType | WORK_DEFINITION_TYPE | — | ✅ |
| 68 | IndentedRollupDetailPEOWorkMethodCode | WORK_METHOD_CODE | — | ✅ |
| 69 | IndentedRollupDetailPEOWorkMethodId | WORK_METHOD_ID | — | ✅ |
| 70 | IndentedRollupDetailPEOWorkMethodName | WORK_METHOD_NAME | — | ✅ |
| 71 | IndentedRollupDetailPEOWorkOrderId | WORK_ORDER_ID | — | — |
| 72 | IndentedRollupDetailPEOYieldFactor | YIELD_FACTOR | — | ✅ |
| 73 | IndentedRollupDetailPEOtatusCode | STATUS_CODE | — | ✅ |
| 74 | IntendedRollupDetailPEOCostEffectiveEndDate | COST_EFFECTIVE_END_DATE | — | ✅ |
| 75 | IntendedRollupDetailPEOCostEffectiveStartDate | COST_EFFECTIVE_START_DATE | — | ✅ |
| 76 | Rollupkey | ROLLUPKEY | 🔑 | ✅ |
...
| 28 | ScenarioRollupDetailPEOQtyUomCode1 | QTY_UOM_CODE | — | — |
| 29 | ScenarioRollupDetailPEOQuantityUsage1 | QUANTITY_USAGE | — | ✅ |
...
| 12 | OverheadRatesPEOInventoryrgId | INVENTORY_ORG_ID | — | — |
...
| 28 | OverheadRatesPEOStatusCode1 | STATUS_CODE | — | — |
| 29 | OverheadRatesPEOStdOverheadRateId1 | STD_OVERHEAD_RATE_ID | — | — |
...
| 23 | PoHeadersAllAttribute20 | ATTRIBUTE20 | — | — |
| 24 | PoHeadersAllAttribute21 | ATTRIBUTE2 | — | — |
...
| 104 | PoHeadersAllEndDate | END_DATE | — | — |
...
| 151 | PoHeadersAllModeOfTransport | MODE_OF_TRANSPORT | — | — |
...
| 187 | PoHeadersAllShipToLocationId1 | SHIP_TO_LOCATION_ID | — | — |
| 188 | PoHeadersAllShippingControl | SHIPPING_CONTROL | — | — |
| 189 | PoHeadersAllSignatureRequiredFlag | SIGNATURE_REQUIRED_FLAG | — | — |
| 190 | PoHeadersAllSoldtoLeId | SOLDTO_LE_ID | — | — |
| 191 | PoHeadersAllStartDate | START_DATE | — | — |
| 192 | PoHeadersAllStyleId | STYLE_ID | — | — |
| 193 | PoHeadersAllSubmitApprovalAutomatic | SUBMIT_APPROVAL_AUTOMATIC | — | — |
| 194 | PoHeadersAllSubmitDate | SUBMIT_DATE | — | — |
| 195 | PoHeadersAllSummaryFlag | SUMMARY_FLAG | — | — |
| 196 | PoHeadersAllSupplierNotifMethod | SUPPLIER_NOTIF_METHOD | — | — |
| 197 | PoHeadersAllTaxAttributeUpdateCode | TAX_ATTRIBUTE_UPDATE_CODE | — | — |
| 198 | PoHeadersAllTaxDocumentSubtype | TAX_DOCUMENT_SUBTYPE | — | — |
| 199 | PoHeadersAllTermsId | TERMS_ID | — | — |
| 200 | PoHeadersAllThirdPtyRegId | THIRD_PTY_REG_ID | — | — |
| 201 | PoHeadersAllTypeLookupCode | TYPE_LOOKUP_CODE | — | — |
| 202 | PoHeadersAllUpdateSourcingRulesFlag | UPDATE_SOURCING_RULES_FLAG | — | — |
| 203 | PoHeadersAllUseNeedByDate | USE_NEED_BY_DATE | — | — |
| 204 | PoHeadersAllUseSalesOrderNumberFlag | USE_SALES_ORDER_NUMBER_FLAG | — | — |
| 205 | PoHeadersAllUseShipTo | USE_SHIP_TO | — | — |
| 206 | PoHeadersAllVendorContactId | VENDOR_CONTACT_ID | — | — |
| 207 | PoHeadersAllVendorId | VENDOR_ID | — | — |
| 208 | PoHeadersAllVendorOrderNum | VENDOR_ORDER_NUM | — | — |
| 209 | PoHeadersAllVendorSiteId | VENDOR_SITE_ID | — | — |
| 210 | PoHeadersAllXmlChangeSendDate | XML_CHANGE_SEND_DATE | — | — |
| 211 | PoHeadersAllXmlFlag | XML_FLAG | — | — |
| 212 | PoHeadersAllXmlSendDate | XML_SEND_DATE | — | — |
...
| 167 | PoLineLocationsAllPrcBuId | PRC_BU_ID | — | — |
| 168 | PoLineLocationsAllPreferredGrade | PREFERRED_GRADE | — | — |
...
| 175 | PoLineLocationsAllProgramAppName | PROGRAM_APP_NAME | — | — |
| 176 | PoLineLocationsAllProgramName | PROGRAM_NAME | — | — |
...
| 180 | PoLineLocationsAllQtyRcvTolerance | QTY_RCV_TOLERANCE | — | — |
| 181 | PoLineLocationsAllQuantity | QUANTITY | — | — |
...
| 238 | PoLineLocationsAllUomCode1 | UOM_CODE | — | — |
...
| 243 | PoLineLocationsAllWorkOrderId1 | WORK_ORDER_ID | — | — |
