---
id: DOC-OTHER-PVO-Paysheet
doc_type: system-doc
title: "Paysheet — PVO Cross-Module"
...
View Object para extração BICC de dados de Paysheet. Acessa as tabelas: CN_PAY_GROUPS_ALL_B, CN_PAY_GROUPS_ALL_TL, CN_PLAN_COMPONENTS_ALL_B (+5).
