---
id: DOC-OTHER-PVO-MaintenanceMaterialTransactionDetailPVO
doc_type: system-doc
title: "MaintenanceMaterialTransactionDetailPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Maintenance Material Transaction Detail. Acessa as tabelas: INV_RESERVATIONS, INV_TRANSACTION_LOT_NUMBERS, INV_UNIT_TRANSACTIONS (+4).

**Caminho:** `FscmTopModelAM.WOMaterialTransactionsAM.MaintenanceMaterialTransactionDetailPVO`
...
- [[inv_transaction_lot_numbers|INV_TRANSACTION_LOT_NUMBERS]] — 62 atributos
- [[inv_unit_transactions|INV_UNIT_TRANSACTIONS]] — 88 atributos
- [[wie_transaction_serials|WIE_TRANSACTION_SERIALS]] — 17 atributos
- [[wie_wo_operation_materials|WIE_WO_OPERATION_MATERIALS]] — 33 atributos
- [[wie_wo_operation_outputs|WIE_WO_OPERATION_OUTPUTS]] — 25 atributos
