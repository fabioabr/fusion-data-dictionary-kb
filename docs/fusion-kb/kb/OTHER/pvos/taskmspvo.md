---
id: DOC-OTHER-PVO-TaskMSPVO
doc_type: system-doc
title: "TaskMSPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Task MS. Acessa as tabelas: HR_ORGANIZATION_V, PER_PERSON_NAMES_F_V, PJF_PROJECTS_ALL_B (+6).

**Caminho:** `FscmTopModelAM.PjfProjectDefinitionAM.TaskMSPVO`
...
- [[pjf_proj_elements_b|PJF_PROJ_ELEMENTS_B]] — 158 atributos (1 PKs, 6 BICC)
...
- [[pjo_project_progress|PJO_PROJECT_PROGRESS]] — 15 atributos (1 BICC)
