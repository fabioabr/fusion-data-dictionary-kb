---
id: DOC-OTHER-PVO-ProcessRiskXrefPVO
doc_type: system-doc
title: "ProcessRiskXrefPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Process Risk Xref. Acessa as tabelas: GRC_PROC_RISK_XREF, GTG_RISK_CONTROL_XREF.

**Caminho:** `FscmTopModelAM.GRCTOPBIAM.ProcessRiskXrefPVO`
