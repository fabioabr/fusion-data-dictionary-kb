---
id: DOC-OTHER-PVO-OrderTotal
doc_type: system-doc
title: "OrderTotal — PVO Cross-Module"
...
View Object para extração BICC de dados de Order Total. Acessa as tabelas: DOO_HEADERS_ALL, DOO_ORDER_TOTALS, FUN_ALL_BUSINESS_UNITS_V (+1).

**Caminho:** `FscmTopModelAM.DooTopAM.OrderTotal`
...
- [[doo_headers_all|DOO_HEADERS_ALL]] — 46 atributos (1 PKs, 43 BICC)
