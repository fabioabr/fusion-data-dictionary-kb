---
id: DOC-OTHER-PVO-CareerPreferenceLocationPVO
doc_type: system-doc
title: "CareerPreferenceLocationPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Career Preference Location. Acessa as tabelas: PER_LOCATIONS, PER_LOCATION_DETAILS_F_TL, PER_LOCATION_DETAILS_F_VL.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.CareerPreferenceLocationPVO`
