---
id: DOC-OTHER-PVO-JobPostHistoryViewAllPVO
doc_type: system-doc
title: "JobPostHistoryViewAllPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Job Post History View All. Acessa as tabelas: IRC_JD_REQ_POSTINGS, IRC_JD_REQ_POST_HISTORY, IRC_JD_REQ_POST_RESULTS (+4).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecJobDistributionAM.JobPostHistoryViewAllPVO`
...
- [[irc_jd_req_post_history|IRC_JD_REQ_POST_HISTORY]] — 15 atributos (1 PKs, 14 BICC)
- [[irc_jd_req_post_results|IRC_JD_REQ_POST_RESULTS]] — 15 atributos (11 BICC)
...
### [[irc_jd_req_post_history|IRC_JD_REQ_POST_HISTORY]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | PostHistoryPEOCreatedBy | CREATED_BY | — | ✅ |
| 2 | PostHistoryPEOCreationDate | CREATION_DATE | — | ✅ |
| 3 | PostHistoryPEOErrorDesc | ERROR_DESC | — | ✅ |
| 4 | PostHistoryPEOJobBoardId | JOB_BOARD_ID | — | ✅ |
| 5 | PostHistoryPEOJobBoardName | JOB_BOARD_NAME | — | ✅ |
| 6 | PostHistoryPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 7 | PostHistoryPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 8 | PostHistoryPEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 9 | PostHistoryPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 10 | PostHistoryPEOPostingEndDate | POSTING_END_DATE | — | ✅ |
| 11 | PostHistoryPEOPostingId | POSTING_ID | — | ✅ |
| 12 | PostHistoryPEOPostingLang | POSTING_LANG | — | ✅ |
| 13 | PostHistoryPEOPostingStartDate | POSTING_START_DATE | — | ✅ |
| 14 | PostHistoryPEOPostingStatusCode | POSTING_STATUS_CODE | — | ✅ |
...
| 15 | PostResultPEOResultId | RESULT_ID | — | ✅ |
