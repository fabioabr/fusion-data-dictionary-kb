---
id: DOC-OTHER-PVO-ResourceRefPVO
doc_type: system-doc
title: "ResourceRefPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Resource Ref. Acessa as tabelas: WIS_RESOURCES_B, WIS_RESOURCES_TL.

**Caminho:** `FscmTopModelAM.ResourceAM.ResourceRefPVO`
...
- [[wis_resources_b|WIS_RESOURCES_B]] — 15 atributos (1 PKs, 5 BICC)
