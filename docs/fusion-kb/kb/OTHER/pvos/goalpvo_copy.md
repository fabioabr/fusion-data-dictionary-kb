---
id: DOC-OTHER-PVO-GoalPVO_Copy
doc_type: system-doc
title: "GoalPVO_Copy — PVO Cross-Module"
...
View Object para extração BICC de dados de Goal_Copy. Acessa as tabelas: HRD_GOAL_INTENTS, HRD_PERSONAL_INTENTS, HRG_GOALS (+5).
