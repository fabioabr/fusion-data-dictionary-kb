---
id: DOC-OTHER-PVO-FulfillLineDetailInvoice
doc_type: system-doc
title: "FulfillLineDetailInvoice — PVO Cross-Module"
...
View Object para extração BICC de dados de Fulfill Line Detail Invoice. Acessa as tabelas: DOO_FULFILL_LINES_ALL, DOO_FULFILL_LINE_DETAILS, DOO_HEADERS_ALL (+2).

**Caminho:** `FscmTopModelAM.DooTopAM.FulfillLineDetailInvoice`
...
- [[doo_fulfill_line_details|DOO_FULFILL_LINE_DETAILS]] — 26 atributos (1 PKs, 5 BICC)
