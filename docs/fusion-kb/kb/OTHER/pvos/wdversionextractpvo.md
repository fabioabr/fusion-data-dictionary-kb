---
id: DOC-OTHER-PVO-WDVersionExtractPVO
doc_type: system-doc
title: "WDVersionExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WDVersion Extract. Acessa as tabelas: WIS_WD_VERSIONS.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.WDVersionExtractPVO`
...
- [[wis_wd_versions|WIS_WD_VERSIONS]] — 57 atributos (1 PKs, 57 BICC)
...
|---|----------|--------|----|------|
| 1 | ApprovalStatusCode | APPROVAL_STATUS_CODE | — | ✅ |
...
| 43 | CompletionLocatorId | COMPLETION_LOCATOR_ID | — | ✅ |
| 44 | CompletionSubinventoryName | COMPLETION_SUBINVENTORY_NAME | — | ✅ |
| 45 | CostingBatchOutputSize | COSTING_BATCH_OUTPUT_SIZE | — | ✅ |
...
| 55 | VersionNumber | VERSION_NUMBER | — | ✅ |
| 56 | WorkDefinitionId | WORK_DEFINITION_ID | — | ✅ |
| 57 | WorkDefinitionVersionId | WORK_DEFINITION_VERSION_ID | 🔑 | ✅ |
