---
id: DOC-OTHER-PVO-WOOperationsResourcesPVO
doc_type: system-doc
title: "WOOperationsResourcesPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WOOperations Resources. Acessa as tabelas: WIE_WORK_ORDERS_B, WIE_WO_OPERATIONS_B, WIE_WO_OPERATION_RESOURCES (+1).

**Caminho:** `FscmTopModelAM.WorkOrderAM.WOOperationsResourcesPVO`
...
- [[wie_wo_operation_resources|WIE_WO_OPERATION_RESOURCES]] — 32 atributos (1 PKs, 21 BICC)
