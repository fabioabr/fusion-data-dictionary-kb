---
id: DOC-OTHER-PVO-HNSIncidentsPVO
doc_type: system-doc
title: "HNSIncidentsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de HNSIncidents. Acessa as tabelas: HNS_INCIDENTS_SUMMARY.
