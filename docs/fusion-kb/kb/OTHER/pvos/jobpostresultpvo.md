---
id: DOC-OTHER-PVO-JobPostResultPVO
doc_type: system-doc
title: "JobPostResultPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Job Post Result. Acessa as tabelas: IRC_JD_REQ_POSTINGS, IRC_JD_REQ_POST_RESULTS, IRC_REQUISITIONS_B (+3).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecJobDistributionAM.JobPostResultPVO`
