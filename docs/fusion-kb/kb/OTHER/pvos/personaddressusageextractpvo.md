---
id: DOC-OTHER-PVO-PersonAddressUsageExtractPVO
doc_type: system-doc
title: "PersonAddressUsageExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Person Address Usage Extract. Acessa as tabelas: PER_PERSON_ADDR_USAGES_F.
