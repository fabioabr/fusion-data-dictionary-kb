---
id: DOC-OTHER-PVO-StepInstanceDetail
doc_type: system-doc
title: "StepInstanceDetail — PVO Cross-Module"
...
View Object para extração BICC de dados de Step Instance Detail. Acessa as tabelas: DOO_CVRD_FLINE_UNREF_RETRN_V, DOO_FULFILL_LINES_ALL, DOO_HEADERS_ALL (+10).

**Caminho:** `FscmTopModelAM.DooTopAM.StepInstanceDetail`
...
- [[doo_fulfill_lines_all|DOO_FULFILL_LINES_ALL]] — 134 atributos (12 BICC)
...
- [[doo_process_instances|DOO_PROCESS_INSTANCES]] — 23 atributos
- [[doo_process_step_instances|DOO_PROCESS_STEP_INSTANCES]] — 22 atributos
- [[doo_projects|DOO_PROJECTS]] — 23 atributos
- [[doo_step_instance_details|DOO_STEP_INSTANCE_DETAILS]] — 15 atributos (1 PKs, 2 BICC)
- [[doo_task_instances|DOO_TASK_INSTANCES]] — 22 atributos
- [[egp_trading_partner_items|EGP_TRADING_PARTNER_ITEMS]] — 6 atributos (2 BICC)
...
| 17 | ProcessInstanceOrchestrationApplicationId | ORCHESTRATION_APPLICATION_ID | — | — |
| 18 | ProcessInstancePlannedCompletionDate | PLANNED_COMPLETION_DATE | — | — |
| 19 | ProcessInstancePlannedFulfillDate | PLANNED_FULFILL_DATE | — | — |
| 20 | ProcessInstanceProcessActive | PROCESS_ACTIVE | — | — |
