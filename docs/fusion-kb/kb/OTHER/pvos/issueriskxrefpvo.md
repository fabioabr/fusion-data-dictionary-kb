---
id: DOC-OTHER-PVO-IssueRiskXrefPVO
doc_type: system-doc
title: "IssueRiskXrefPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Issue Risk Xref. Acessa as tabelas: GRC_ISSU_RISK_XREF.

**Caminho:** `FscmTopModelAM.GRCTOPBIAM.IssueRiskXrefPVO`
