---
id: DOC-OTHER-PVO-MaintenanceForecastLineRef
doc_type: system-doc
title: "MaintenanceForecastLineRef — PVO Cross-Module"
...
View Object para extração BICC de dados de Maintenance Forecast Line Ref. Acessa as tabelas: MNT_FORECAST_LINES.

**Caminho:** `FscmTopModelAM.MaintProgramAM.MaintenanceForecastLineRef`
...
- [[mnt_forecast_lines|MNT_FORECAST_LINES]] — 28 atributos (1 PKs, 18 BICC)
