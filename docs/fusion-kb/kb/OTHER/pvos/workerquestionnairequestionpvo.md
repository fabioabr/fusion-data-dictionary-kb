---
id: DOC-OTHER-PVO-WorkerQuestionnaireQuestionPVO
doc_type: system-doc
title: "WorkerQuestionnaireQuestionPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Worker Questionnaire Question. Acessa as tabelas: HRQ_QSTNR_PARTICIPANTS, HRQ_QSTNR_QUESTIONS, HRQ_QSTNR_SECTIONS_B (+7).
