---
id: DOC-OTHER-PVO-WOProcurementReqPVO
doc_type: system-doc
title: "WOProcurementReqPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WOProcurement Req. Acessa as tabelas: EGP_CATEGORIES_VL, EGP_SYSTEM_ITEMS_B_V, POR_REQUISITION_HEADERS_ALL (+6).

**Caminho:** `FscmTopModelAM.WorkOrderAM.WOProcurementReqPVO`
...
- [[por_requisition_lines_all|POR_REQUISITION_LINES_ALL]] — 177 atributos (27 BICC)
- [[por_req_distributions_all|POR_REQ_DISTRIBUTIONS_ALL]] — 38 atributos (1 PKs, 5 BICC)
