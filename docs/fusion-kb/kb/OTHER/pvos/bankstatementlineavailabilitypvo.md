---
id: DOC-OTHER-PVO-BankStatementLineAvailabilityPVO
doc_type: system-doc
title: "BankStatementLineAvailabilityPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Bank Statement Line Availability. Acessa as tabelas: CE_INTERNAL_BANK_ACCTS_V, CE_STATEMENT_HEADERS, CE_STATEMENT_LINES (+5).

**Caminho:** `FscmTopModelAM.FinCeBankStatementsAM.BankStatementLineAvailabilityPVO`
...
- [[ce_statement_lines|CE_STATEMENT_LINES]] — 38 atributos (25 BICC)
- [[ce_stmt_line_avalbty|CE_STMT_LINE_AVALBTY]] — 11 atributos (1 PKs, 5 BICC)
...
### [[ce_stmt_line_avalbty|CE_STMT_LINE_AVALBTY]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | StatementAvailabilityAvailabilityDate | AVAILABILITY_DATE | — | ✅ |
| 2 | StatementAvailabilityCreatedBy | CREATED_BY | — | — |
| 3 | StatementAvailabilityCreationDate | CREATION_DATE | — | — |
| 4 | StatementAvailabilityLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 5 | StatementAvailabilityLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 6 | StatementAvailabilityLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 7 | StatementAvailabilityLineAmt | LINE_AMT | — | ✅ |
| 8 | StatementAvailabilityNumberOfDays | NUMBER_OF_DAYS | — | ✅ |
| 9 | StatementAvailabilityObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 10 | StatementAvailabilityStatementLineId | STATEMENT_LINE_ID | — | — |
| 11 | StmtLineAvalbtyId | STMT_LINE_AVALBTY_ID | 🔑 | ✅ |
