---
id: DOC-OTHER-PVO-AlertsPVO
doc_type: system-doc
title: "AlertsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Alerts. Acessa as tabelas: CMP_CALC_ALERTS_VL, CMP_CWB_ALERTS.
