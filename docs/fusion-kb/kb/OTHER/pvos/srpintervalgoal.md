---
id: DOC-OTHER-PVO-SrpIntervalGoal
doc_type: system-doc
title: "SrpIntervalGoal — PVO Cross-Module"
...
View Object para extração BICC de dados de Srp Interval Goal. Acessa as tabelas: CN_INTERVAL_GOALS_ALL, CN_SRP_COMP_PLANS_ALL, CN_SRP_FORM_METRICS_ALL (+4).

**Caminho:** `FscmTopModelAM.SrpCompPlanAM.SrpIntervalGoal`
...
- [[cn_interval_goals_all|CN_INTERVAL_GOALS_ALL]] — 2 atributos (1 BICC)
- [[cn_srp_comp_plans_all|CN_SRP_COMP_PLANS_ALL]] — 34 atributos (7 BICC)
- [[cn_srp_form_metrics_all|CN_SRP_FORM_METRICS_ALL]] — 30 atributos (5 BICC)
- [[cn_srp_goals_all|CN_SRP_GOALS_ALL]] — 17 atributos (7 BICC)
- [[cn_srp_interval_goals_all|CN_SRP_INTERVAL_GOALS_ALL]] — 18 atributos (1 PKs, 10 BICC)
...
### [[cn_interval_goals_all|CN_INTERVAL_GOALS_ALL]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | IntervalGoalId1 | INTERVAL_GOAL_ID | — | — |
| 2 | IntervalNumber1 | INTERVAL_NUMBER | — | ✅ |
...
| 9 | IntervalGoalId | INTERVAL_GOAL_ID | — | — |
| 10 | IntervalNumber | INTERVAL_NUMBER | — | — |
...
| 17 | SrpIntervalGoalId | SRP_INTERVAL_GOAL_ID | 🔑 | ✅ |
| 18 | TargetInt | TARGET_INT | — | ✅ |
