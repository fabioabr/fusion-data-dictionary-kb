---
id: DOC-OTHER-PVO-ImpactOfLossCalibRatingPVO
doc_type: system-doc
title: "ImpactOfLossCalibRatingPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Impact Of Loss Calib Rating. Acessa as tabelas: HRR_DASHBOARDS, HRR_MEETINGS, HRR_TMPL_METRIC_CONFIG (+1).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.ImpactOfLossCalibRatingPVO`
