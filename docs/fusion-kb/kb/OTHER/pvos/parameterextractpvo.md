---
id: DOC-OTHER-PVO-ParameterExtractPVO
doc_type: system-doc
title: "ParameterExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Parameter Extract. Acessa as tabelas: CSE_SYSTEM_OPTIONS.

**Caminho:** `FscmTopModelAM.ScmExtractAM.CseBiccExtractAM.ParameterExtractPVO`
...
- [[cse_system_options|CSE_SYSTEM_OPTIONS]] — 56 atributos (1 PKs, 56 BICC)

---

## ⚙️ Atributos

### [[cse_system_options|CSE_SYSTEM_OPTIONS]]
...
| 42 | CorpCurrencyCode | CORP_CURRENCY_CODE | — | ✅ |
| 43 | CreatedBy | CREATED_BY | — | ✅ |
| 44 | CreationDate | CREATION_DATE | — | ✅ |
| 45 | CurcyConvRateType | CURCY_CONV_RATE_TYPE | — | ✅ |
| 46 | CurrencyCode | CURRENCY_CODE | — | ✅ |
| 47 | IotAssetApi | IOT_ASSET_API | — | ✅ |
| 48 | IotConfidenceThreshold | IOT_CONFIDENCE_THRESHOLD | — | ✅ |
| 49 | IotEventCodeApi | IOT_EVENT_CODE_API | — | ✅ |
| 50 | IotIntegrationFlag | IOT_INTEGRATION_FLAG | — | ✅ |
| 51 | IotLearningDirectorApi | IOT_LEARNING_DIRECTOR_API | — | ✅ |
...
| 56 | SystemOptionId | SYSTEM_OPTION_ID | 🔑 | ✅ |
