---
id: DOC-OTHER-PVO-TaskStructureExtractPVO
doc_type: system-doc
title: "TaskStructureExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Task Structure Extract. Acessa as tabelas: PJF_PROJ_ELEMENTS_B, PJF_PROJ_ELEMENTS_TL.

**Caminho:** `FscmTopModelAM.PrjExtractAM.PjfBiccExtractAM.TaskStructureExtractPVO`
...
- [[pjf_proj_elements_b|PJF_PROJ_ELEMENTS_B]] — 226 atributos (1 PKs, 145 BICC)
- [[pjf_proj_elements_tl|PJF_PROJ_ELEMENTS_TL]] — 12 atributos (12 BICC)
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | TaskStructureTransLangPEOCreatedBy | CREATED_BY | — | ✅ |
| 2 | TaskStructureTransLangPEOCreationDate | CREATION_DATE | — | ✅ |
| 3 | TaskStructureTransLangPEODescription | DESCRIPTION | — | ✅ |
| 4 | TaskStructureTransLangPEOLanguage | LANGUAGE | — | ✅ |
| 5 | TaskStructureTransLangPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 6 | TaskStructureTransLangPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 7 | TaskStructureTransLangPEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 8 | TaskStructureTransLangPEOName | NAME | — | ✅ |
| 9 | TaskStructureTransLangPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 10 | TaskStructureTransLangPEOProjElementId | PROJ_ELEMENT_ID | — | ✅ |
| 11 | TaskStructureTransLangPEOProjectId | PROJECT_ID | — | ✅ |
| 12 | TaskStructureTransLangPEOSourceLang | SOURCE_LANG | — | ✅ |
