---
id: DOC-OTHER-PVO-ContractHeaderCurrentP
doc_type: system-doc
title: "ContractHeaderCurrentP — PVO Cross-Module"
...
View Object para extração BICC de dados de Contract Header Current P. Acessa as tabelas: FND_SETID_ASSIGNMENTS, FUN_ALL_BUSINESS_UNITS_V, GL_DAILY_CONVERSION_TYPES (+14).

**Caminho:** `FscmTopModelAM.ContractsCoreAM.ContractHeaderCurrentP`
...
- [[hz_cust_accounts|HZ_CUST_ACCOUNTS]] — 9 atributos
- [[hz_cust_site_uses_all|HZ_CUST_SITE_USES_ALL]] — 4 atributos
- [[hz_locations|HZ_LOCATIONS]] — 15 atributos
- [[hz_parties|HZ_PARTIES]] — 137 atributos (1 BICC)
- [[hz_party_sites|HZ_PARTY_SITES]] — 86 atributos (1 BICC)
- [[inv_organization_definitions_v|INV_ORGANIZATION_DEFINITIONS_V]] — 2 atributos
- [[okc_contract_types_tl|OKC_CONTRACT_TYPES_TL]] — 11 atributos
- [[okc_contract_types_vl|OKC_CONTRACT_TYPES_VL]] — 38 atributos (2 BICC)
- [[okc_k_headers_all_b|OKC_K_HEADERS_ALL_B]] — 104 atributos (2 PKs, 7 BICC)
- [[okc_k_headers_tl|OKC_K_HEADERS_TL]] — 15 atributos (3 BICC)
- [[okc_k_inv_rev_summary_v|OKC_K_INV_REV_SUMMARY_V]] — 4 atributos
- [[qsc_pricebook_headers_vl|QSC_PRICEBOOK_HEADERS_VL]] — 3 atributos
