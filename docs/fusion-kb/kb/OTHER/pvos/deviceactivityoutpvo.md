---
id: DOC-OTHER-PVO-DeviceActivityOutPVO
doc_type: system-doc
title: "DeviceActivityOutPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Device Activity Out. Acessa as tabelas: HWM_TM_REC, PER_ALL_PEOPLE_F, PER_PERSON_NAMES_F_V.
