---
id: DOC-OTHER-PVO-GroupRuleCriteriaExtractPVO
doc_type: system-doc
title: "GroupRuleCriteriaExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Group Rule Criteria Extract. Acessa as tabelas: CSE_GROUPING_VALUES.

**Caminho:** `FscmTopModelAM.ScmExtractAM.CseBiccExtractAM.GroupRuleCriteriaExtractPVO`
...
- [[cse_grouping_values|CSE_GROUPING_VALUES]] — 66 atributos (1 PKs, 66 BICC)

---

## ⚙️ Atributos

### [[cse_grouping_values|CSE_GROUPING_VALUES]]
...
| 44 | GroupId | GROUP_ID | — | ✅ |
| 45 | GroupValueId | GROUP_VALUE_ID | 🔑 | ✅ |
...
| 52 | PrimaryKeyId | PRIMARY_KEY_ID | — | ✅ |
| 53 | RequestId | REQUEST_ID | — | ✅ |
| 54 | RuleAttributeId | RULE_ATTRIBUTE_ID | — | ✅ |
| 55 | ValueChar | VALUE_CHAR | — | ✅ |
| 56 | ValueCharFrom | VALUE_CHAR_FROM | — | ✅ |
| 57 | ValueCharTo | VALUE_CHAR_TO | — | ✅ |
| 58 | ValueDate | VALUE_DATE | — | ✅ |
| 59 | ValueDateFrom | VALUE_DATE_FROM | — | ✅ |
| 60 | ValueDateTo | VALUE_DATE_TO | — | ✅ |
| 61 | ValueNum | VALUE_NUM | — | ✅ |
| 62 | ValueNumFrom | VALUE_NUM_FROM | — | ✅ |
| 63 | ValueNumTo | VALUE_NUM_TO | — | ✅ |
| 64 | ValueTimestamp | VALUE_TIMESTAMP | — | ✅ |
| 65 | ValueTimestampFrom | VALUE_TIMESTAMP_FROM | — | ✅ |
| 66 | ValueTimestampTo | VALUE_TIMESTAMP_TO | — | ✅ |
