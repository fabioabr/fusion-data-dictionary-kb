---
id: DOC-OTHER-PVO-NBoxLabelPVO
doc_type: system-doc
title: "NBoxLabelPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de NBox Label. Acessa as tabelas: HRR_DASHBOARD_TMPLS_B, HRR_MEETINGS, HRR_TMPL_ANALYTIC_TYPES_B (+2).
