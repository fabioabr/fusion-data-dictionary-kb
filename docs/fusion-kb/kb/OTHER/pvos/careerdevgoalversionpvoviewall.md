---
id: DOC-OTHER-PVO-CareerDevGoalVersionPVOViewAll
doc_type: system-doc
title: "CareerDevGoalVersionPVOViewAll — PVO Cross-Module"
...
View Object para extração BICC de dados de Career Dev Goal Version View All. Acessa as tabelas: HRD_GOAL_INTENTS, HRD_PERSONAL_INTENTS, HRG_GOALS (+5).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmGoalCoreAM.CareerDevGoalVersionPVOViewAll`
...
- [[hrd_goal_intents|HRD_GOAL_INTENTS]] — 12 atributos (2 BICC)
- [[hrd_personal_intents|HRD_PERSONAL_INTENTS]] — 11 atributos (2 BICC)
- [[hrg_goals|HRG_GOALS]] — 65 atributos (1 PKs, 50 BICC)
