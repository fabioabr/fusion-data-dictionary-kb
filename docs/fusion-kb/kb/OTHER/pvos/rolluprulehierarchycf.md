---
id: DOC-OTHER-PVO-RollupRuleHierarchyCF
doc_type: system-doc
title: "RollupRuleHierarchyCF — PVO Cross-Module"
...
View Object para extração BICC de dados de Rollup Rule Hierarchy CF. Acessa as tabelas: CN_RS_DENORM_RULES_ALL, CN_RS_RULES_ALL_B, CN_RS_RULES_ALL_TL (+2).

**Caminho:** `FscmTopModelAM.RuleAM.RollupRuleHierarchyCF`
