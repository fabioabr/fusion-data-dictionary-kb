---
id: DOC-OTHER-PVO-RuleSetDPVO
doc_type: system-doc
title: "RuleSetDPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Rule Set D. Acessa as tabelas: HWM_RULE_SETS_F.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.RulesCoreAM.RuleSetDPVO`
...
- [[hwm_rule_sets_f|HWM_RULE_SETS_F]] — 23 atributos (3 PKs, 12 BICC)
