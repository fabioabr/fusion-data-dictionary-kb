---
id: DOC-OTHER-PVO-PartyPerson
doc_type: system-doc
title: "PartyPerson — PVO Cross-Module"
...
View Object para extração BICC de dados de Party Person. Acessa as tabelas: HZ_LOCATIONS, HZ_PARTIES, HZ_PERSON_PROFILES (+1).
