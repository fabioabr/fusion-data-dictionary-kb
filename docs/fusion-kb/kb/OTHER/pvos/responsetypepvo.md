---
id: DOC-OTHER-PVO-ResponseTypePVO
doc_type: system-doc
title: "ResponseTypePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Response Type. Acessa as tabelas: HRQ_RESPONSE_TYPES_B, HRQ_RESPONSE_TYPES_TL.
