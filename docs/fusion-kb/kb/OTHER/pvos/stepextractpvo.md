---
id: DOC-OTHER-PVO-StepExtractPVO
doc_type: system-doc
title: "StepExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Step Extract. Acessa as tabelas: DOO_PROCESS_STEPS_B, DOO_PROCESS_STEPS_TL.

**Caminho:** `FscmTopModelAM.ScmExtractAM.DooBiccExtractAM.StepExtractPVO`
...
- [[doo_process_steps_b|DOO_PROCESS_STEPS_B]] — 37 atributos (1 PKs, 37 BICC)
- [[doo_process_steps_tl|DOO_PROCESS_STEPS_TL]] — 11 atributos (11 BICC)
