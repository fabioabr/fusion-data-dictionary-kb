---
id: DOC-OTHER-PVO-PersonLifeEventsExtractPVO
doc_type: system-doc
title: "PersonLifeEventsExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Person Life Events Extract. Acessa as tabelas: BEN_PER_IN_LER.
