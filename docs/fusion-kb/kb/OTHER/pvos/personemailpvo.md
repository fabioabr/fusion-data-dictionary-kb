---
id: DOC-OTHER-PVO-PersonEmailPVO
doc_type: system-doc
title: "PersonEmailPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Person Email. Acessa as tabelas: PER_ALL_PEOPLE_F, PER_EMAIL_ADDRESSES.
