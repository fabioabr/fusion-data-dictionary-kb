---
id: DOC-OTHER-PVO-SamplesPVO
doc_type: system-doc
title: "SamplesPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Samples. Acessa as tabelas: PER_PERSON_NAMES_F_V, QA_INSPECTION_PLANS_B, QA_IP_EVENTS (+1).

**Caminho:** `FscmTopModelAM.ResultsAM.SamplesPVO`
...
- [[qa_samples|QA_SAMPLES]] — 14 atributos (1 PKs, 14 BICC)
...
| 48 | InspectionEventsPEOSubinventoryCode | SUBINVENTORY_CODE | — | ✅ |
| 49 | InspectionEventsPEOSupplierId | SUPPLIER_ID | — | ✅ |
| 50 | InspectionEventsPEOSupplierLotNum | SUPPLIER_LOT_NUM | — | ✅ |
| 51 | InspectionEventsPEOSupplierSiteId | SUPPLIER_SITE_ID | — | ✅ |
| 52 | InspectionEventsPEOTotalSampleQuantity | TOTAL_SAMPLE_QUANTITY | — | — |
| 53 | InspectionEventsPEOTransactionType | TRANSACTION_TYPE | — | ✅ |
| 54 | InspectionEventsPEOUomCode | UOM_CODE | — | ✅ |
| 55 | InspectionEventsPEOWoOperationId | WO_OPERATION_ID | — | ✅ |
| 56 | InspectionEventsPEOWorkAreaId | WORK_AREA_ID | — | ✅ |
| 57 | InspectionEventsPEOWorkCenterId | WORK_CENTER_ID | — | ✅ |
| 58 | InspectionEventsPEOWorkOrderId | WORK_ORDER_ID | — | ✅ |
| 59 | InspectionEventsRptPEOAssetId | ASSET_ID | — | — |
| 60 | SInspectionEventsPEOourceOrgId | SOURCE_ORG_ID | — | ✅ |
