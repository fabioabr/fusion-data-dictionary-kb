---
id: DOC-OTHER-PVO-DocumentTypePVO
doc_type: system-doc
title: "DocumentTypePVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Document Type. Acessa as tabelas: HRA_DOC_TYPES_B, HRA_DOC_TYPES_TL.
