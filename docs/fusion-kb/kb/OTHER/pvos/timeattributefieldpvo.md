---
id: DOC-OTHER-PVO-TimeAttributeFieldPVO
doc_type: system-doc
title: "TimeAttributeFieldPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Time Attribute Field. Acessa as tabelas: FND_VS_VALUE_SETS, HWM_DATA_SOURCE_USAGES_V, HWM_TCSMRS_VL (+3).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.DataDictionaryAM.TimeAttributeFieldPVO`
...
- [[hwm_tm_atrb_flds_b|HWM_TM_ATRB_FLDS_B]] — 23 atributos (1 PKs, 20 BICC)
- [[hwm_tm_atrb_flds_tl|HWM_TM_ATRB_FLDS_TL]] — 4 atributos
