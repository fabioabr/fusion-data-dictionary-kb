---
id: DOC-OTHER-PVO-EvalSectionExtractPVO
doc_type: system-doc
title: "EvalSectionExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Eval Section Extract. Acessa as tabelas: HRA_EVAL_SECTIONS.
