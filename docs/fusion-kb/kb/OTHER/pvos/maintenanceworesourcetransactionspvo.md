---
id: DOC-OTHER-PVO-MaintenanceWOResourceTransactionsPVO
doc_type: system-doc
title: "MaintenanceWOResourceTransactionsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Maintenance WOResource Transactions. Acessa as tabelas: WIE_RESOURCE_TRANSACTIONS, WIE_WORK_ORDERS_B, WIE_WO_OPERATION_RESOURCES (+3).

**Caminho:** `FscmTopModelAM.WOResourceTransactionsAM.MaintenanceWOResourceTransactionsPVO`
...
- [[wie_resource_transactions|WIE_RESOURCE_TRANSACTIONS]] — 80 atributos (1 PKs, 26 BICC)
- [[wie_work_orders_b|WIE_WORK_ORDERS_B]] — 96 atributos (31 BICC)
- [[wie_wo_operation_resources|WIE_WO_OPERATION_RESOURCES]] — 73 atributos (11 BICC)
