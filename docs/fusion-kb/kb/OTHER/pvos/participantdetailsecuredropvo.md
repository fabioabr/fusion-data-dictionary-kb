---
id: DOC-OTHER-PVO-ParticipantDetailSecuredROPVO
doc_type: system-doc
title: "ParticipantDetailSecuredROPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Participant Detail Secured RO. Acessa as tabelas: CN_SRP_PARTICIPANTS_ALL, CN_SRP_PARTICIPANT_DETAILS_ALL.

**Caminho:** `FscmTopModelAM.ParticipantSetupAM.ParticipantDetailSecuredROPVO`
