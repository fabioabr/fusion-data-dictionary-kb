---
id: DOC-OTHER-PVO-HNSIncidentInvestApproverPVO
doc_type: system-doc
title: "HNSIncidentInvestApproverPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de HNSIncident Invest Approver. Acessa as tabelas: HNS_PERSONS.
