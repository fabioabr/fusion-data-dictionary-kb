---
id: DOC-OTHER-PVO-WorkAreaExtractPVO
doc_type: system-doc
title: "WorkAreaExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Work Area Extract. Acessa as tabelas: WIS_WORK_AREAS_B, WIS_WORK_AREAS_TL.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.WorkAreaExtractPVO`
...
- [[wis_work_areas_b|WIS_WORK_AREAS_B]] — 51 atributos (1 PKs, 51 BICC)
...
| 50 | WorkAreaCode | WORK_AREA_CODE | — | ✅ |
