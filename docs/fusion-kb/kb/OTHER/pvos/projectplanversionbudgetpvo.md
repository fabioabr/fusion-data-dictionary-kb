---
id: DOC-OTHER-PVO-ProjectPlanVersionBudgetPVO
doc_type: system-doc
title: "ProjectPlanVersionBudgetPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Project Plan Version Budget. Acessa as tabelas: GL_DAILY_CONVERSION_TYPES, PER_PERSONS, PER_PERSON_NAMES_F_V (+13).

**Caminho:** `FscmTopModelAM.PjoBudgetsAndForecastsAnalyticsAM.ProjectPlanVersionBudgetPVO`
...
- [[pjo_planning_options|PJO_PLANNING_OPTIONS]] — 90 atributos (16 BICC)
- [[pjo_plan_types_b|PJO_PLAN_TYPES_B]] — 22 atributos (3 BICC)
- [[pjo_plan_types_tl|PJO_PLAN_TYPES_TL]] — 11 atributos (3 BICC)
- [[pjo_plan_types_vl|PJO_PLAN_TYPES_VL]] — 4 atributos
- [[pjo_plan_versions_b|PJO_PLAN_VERSIONS_B]] — 48 atributos (1 PKs, 22 BICC)
- [[pjo_plan_versions_tl|PJO_PLAN_VERSIONS_TL]] — 11 atributos (3 BICC)
