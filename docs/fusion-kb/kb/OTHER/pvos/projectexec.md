---
id: DOC-OTHER-PVO-ProjectExec
doc_type: system-doc
title: "ProjectExec — PVO Cross-Module"
...
View Object para extração BICC de dados de Project Exec. Acessa as tabelas: FND_CURRENCIES_VL, FND_SETID_SETS_VL, GL_DAILY_CONVERSION_TYPES (+21).

**Caminho:** `FscmTopModelAM.PjfProjectAM.ProjectExec`
...
- [[pjf_projects_all_b|PJF_PROJECTS_ALL_B]] — 92 atributos (1 PKs, 35 BICC)
...
- [[pjf_project_types_b|PJF_PROJECT_TYPES_B]] — 33 atributos (15 BICC)
