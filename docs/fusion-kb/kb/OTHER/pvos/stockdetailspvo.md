---
id: DOC-OTHER-PVO-StockDetailsPVO
doc_type: system-doc
title: "StockDetailsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Stock Details. Acessa as tabelas: CMP_PROFILE_VALUES, CMP_STOCK_DETAILS.
