---
id: DOC-OTHER-PVO-WDMaintenanceNameExtractPVO
doc_type: system-doc
title: "WDMaintenanceNameExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de WDMaintenance Name Extract. Acessa as tabelas: WIS_WD_MAINTENANCE_NAMES_B, WIS_WD_MAINTENANCE_NAMES_TL.

**Caminho:** `FscmTopModelAM.ScmExtractAM.WisBiccExtractAM.WDMaintenanceNameExtractPVO`
...
- [[wis_wd_maintenance_names_b|WIS_WD_MAINTENANCE_NAMES_B]] — 50 atributos (1 PKs, 50 BICC)
...
### [[wis_wd_maintenance_names_b|WIS_WD_MAINTENANCE_NAMES_B]]
...
| 47 | MaintenanceWdCode | MAINTENANCE_WD_CODE | — | ✅ |
| 48 | ObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 49 | OrganizationId | ORGANIZATION_ID | — | ✅ |
| 50 | WdMntNameId | WD_MNT_NAME_ID | 🔑 | ✅ |

### [[wis_wd_maintenance_names_tl|WIS_WD_MAINTENANCE_NAMES_TL]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | WorkDefinitionMaintenanceNameTranslationPEOCreatedBy | CREATED_BY | — | ✅ |
| 2 | WorkDefinitionMaintenanceNameTranslationPEOCreationDate | CREATION_DATE | — | ✅ |
| 3 | WorkDefinitionMaintenanceNameTranslationPEOLanguage | LANGUAGE | 🔑 | ✅ |
| 4 | WorkDefinitionMaintenanceNameTranslationPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 5 | WorkDefinitionMaintenanceNameTranslationPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 6 | WorkDefinitionMaintenanceNameTranslationPEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 7 | WorkDefinitionMaintenanceNameTranslationPEOMaintenanceWdDesc | MAINTENANCE_WD_DESC | — | ✅ |
| 8 | WorkDefinitionMaintenanceNameTranslationPEOMaintenanceWdName | MAINTENANCE_WD_NAME | — | ✅ |
| 9 | WorkDefinitionMaintenanceNameTranslationPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 10 | WorkDefinitionMaintenanceNameTranslationPEOSourceLang | SOURCE_LANG | — | ✅ |
| 11 | WorkDefinitionMaintenanceNameTranslationPEOWdMntNameId | WD_MNT_NAME_ID | 🔑 | ✅ |
