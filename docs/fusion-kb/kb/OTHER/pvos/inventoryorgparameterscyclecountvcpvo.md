---
id: DOC-OTHER-PVO-InventoryOrgParametersCycleCountVCPVO
doc_type: system-doc
title: "InventoryOrgParametersCycleCountVCPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Inventory Org Parameters Cycle Count VC. Acessa as tabelas: FUN_ALL_BUSINESS_UNITS_V, HR_ALL_ORGANIZATION_UNITS_F, HR_ORGANIZATION_UNITS_F_TL (+5).

**Caminho:** `FscmTopModelAM.InvOrgPublicViewAM.InventoryOrgParametersCycleCountVCPVO`
