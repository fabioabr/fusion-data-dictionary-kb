---
id: DOC-OTHER-PVO-BillPaymentsPVO
doc_type: system-doc
title: "BillPaymentsPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Bill Payments. Acessa as tabelas: BEN_BILL_PAYMENTS, BEN_BILL_PER_CREDIT, BEN_PER_BENEFIT_GROUP_F (+1).
