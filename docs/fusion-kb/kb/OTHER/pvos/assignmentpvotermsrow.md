---
id: DOC-OTHER-PVO-AssignmentPVOTermsRow
doc_type: system-doc
title: "AssignmentPVOTermsRow — PVO Cross-Module"
...
View Object para extração BICC de dados de Assignment Terms Row. Acessa as tabelas: PER_ALL_ASSIGNMENTS_M, PER_ASSIGN_GRADE_STEPS_F.
