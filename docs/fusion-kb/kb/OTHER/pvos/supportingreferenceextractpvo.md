---
id: DOC-OTHER-PVO-SupportingReferenceExtractPVO
doc_type: system-doc
title: "SupportingReferenceExtractPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Supporting Reference Extract. Acessa as tabelas: XLA_ANALYTICAL_HDRS_B, XLA_ANALYTICAL_HDRS_TL, XLA_SUBLEDGERS_VL.

**Caminho:** `FscmTopModelAM.FinExtractAM.XlaBiccExtractAM.SupportingReferenceExtractPVO`
...
- [[xla_analytical_hdrs_b|XLA_ANALYTICAL_HDRS_B]] — 17 atributos (3 PKs, 16 BICC)
- [[xla_analytical_hdrs_tl|XLA_ANALYTICAL_HDRS_TL]] — 13 atributos (13 BICC)
