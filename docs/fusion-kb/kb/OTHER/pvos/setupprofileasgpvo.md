---
id: DOC-OTHER-PVO-SetupProfileAsgPVO
doc_type: system-doc
title: "SetupProfileAsgPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Setup Profile Asg. Acessa as tabelas: HTS_LABOR_DEMAND_PRFL_DEFS, HTS_LABOR_DEMAND_PRFL_DEFSETS, HTS_LABOR_DEMAND_PRFL_VALS (+7).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.SetupOptionsAM.SetupProfileAsgPVO`
...
- [[hxt_setup_profiles_b|HXT_SETUP_PROFILES_B]] — 12 atributos (9 BICC)
- [[hxt_setup_profiles_tl|HXT_SETUP_PROFILES_TL]] — 4 atributos (2 BICC)
- [[hxt_setup_profile_asgs|HXT_SETUP_PROFILE_ASGS]] — 17 atributos (1 PKs, 11 BICC)
...
| 180 | HtsPrflValueDPEOValue71 | VALUE71 | — | — |
| 181 | HtsPrflValueDPEOValue72 | VALUE72 | — | — |
| 182 | HtsPrflValueDPEOValue73 | VALUE73 | — | — |
| 183 | HtsPrflValueDPEOValue74 | VALUE74 | — | — |
| 184 | HtsPrflValueDPEOValue75 | VALUE75 | — | — |
| 185 | HtsPrflValueDPEOValue76 | VALUE76 | — | — |
| 186 | HtsPrflValueDPEOValue77 | VALUE77 | — | — |
| 187 | HtsPrflValueDPEOValue78 | VALUE78 | — | — |
| 188 | HtsPrflValueDPEOValue79 | VALUE79 | — | — |
| 189 | HtsPrflValueDPEOValue8 | VALUE8 | — | — |
| 190 | HtsPrflValueDPEOValue9 | VALUE9 | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | SetupProfileAsgPEOAssignTo | ASSIGN_TO | — | ✅ |
| 2 | SetupProfileAsgPEOCreatedBy | CREATED_BY | — | ✅ |
| 3 | SetupProfileAsgPEOCreationDate | CREATION_DATE | — | ✅ |
| 4 | SetupProfileAsgPEODateFrom | DATE_FROM | — | ✅ |
| 5 | SetupProfileAsgPEODateTo | DATE_TO | — | ✅ |
| 6 | SetupProfileAsgPEOEnterpriseId | ENTERPRISE_ID | — | — |
| 7 | SetupProfileAsgPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 8 | SetupProfileAsgPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 9 | SetupProfileAsgPEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 10 | SetupProfileAsgPEOModuleId | MODULE_ID | — | — |
| 11 | SetupProfileAsgPEOObjectId | OBJECT_ID | — | ✅ |
| 12 | SetupProfileAsgPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 13 | SetupProfileAsgPEOSeedDataSource | SEED_DATA_SOURCE | — | — |
| 14 | SetupProfileAsgPEOSetupProfileAsgCd | SETUP_PROFILE_ASG_CD | — | ✅ |
| 15 | SetupProfileAsgPEOSetupProfileAsgId | SETUP_PROFILE_ASG_ID | 🔑 | ✅ |
| 16 | SetupProfileAsgPEOSetupProfileId | SETUP_PROFILE_ID | — | — |
| 17 | SetupProfileAsgPEOSguid | SGUID | — | — |

### [[per_all_people_f|PER_ALL_PEOPLE_F]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | AsgToDetailsPEOEffectiveEndDate | EFFECTIVE_END_DATE | — | — |
| 2 | AsgToDetailsPEOEffectiveStartDate | EFFECTIVE_START_DATE | — | ✅ |
| 3 | AsgToDetailsPEOPersonId | PERSON_ID | — | — |
| 4 | AsgToDetailsPEOPersonNumber | PERSON_NUMBER | — | ✅ |
| 5 | MgrDetailsPEOEffectiveEndDate | EFFECTIVE_END_DATE | — | — |
| 6 | MgrDetailsPEOEffectiveStartDate | EFFECTIVE_START_DATE | — | ✅ |
| 7 | MgrDetailsPEOPersonId | PERSON_ID | — | — |
| 8 | MgrDetailsPEOPersonNumber | PERSON_NUMBER | — | ✅ |

### [[per_person_names_f_v|PER_PERSON_NAMES_F_V]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | AsgToNamePEOEffectiveEndDate | EFFECTIVE_END_DATE | — | — |
| 2 | AsgToNamePEOEffectiveStartDate | EFFECTIVE_START_DATE | — | ✅ |
| 3 | AsgToNamePEOFullName | FULL_NAME | — | ✅ |
| 4 | AsgToNamePEOPersonNameId | PERSON_NAME_ID | — | — |
| 5 | MgrNamePEOEffectiveEndDate | EFFECTIVE_END_DATE | — | — |
| 6 | MgrNamePEOEffectiveStartDate | EFFECTIVE_START_DATE | — | ✅ |
| 7 | MgrNamePEOFullName | FULL_NAME | — | ✅ |
| 8 | MgrNamePEOPersonNameId | PERSON_NAME_ID | — | — |
