---
id: DOC-OTHER-PVO-FulfillLineDetailShipping
doc_type: system-doc
title: "FulfillLineDetailShipping — PVO Cross-Module"
...
View Object para extração BICC de dados de Fulfill Line Detail Shipping. Acessa as tabelas: DOO_FULFILL_LINES_ALL, DOO_FULFILL_LINE_DETAILS, DOO_HEADERS_ALL (+2).

**Caminho:** `FscmTopModelAM.DooTopAM.FulfillLineDetailShipping`
...
- [[doo_headers_all|DOO_HEADERS_ALL]] — 37 atributos (1 BICC)
- [[doo_lines_all|DOO_LINES_ALL]] — 48 atributos (1 BICC)
