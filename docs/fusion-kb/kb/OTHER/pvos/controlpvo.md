---
id: DOC-OTHER-PVO-ControlPVO
doc_type: system-doc
title: "ControlPVO — PVO Cross-Module"
...
View Object para extração BICC de dados de Control. Acessa as tabelas: GRC_CONTROL_B, GRC_CONTROL_TL, GRC_CTRL_ASSERTION_V (+7).

**Caminho:** `FscmTopModelAM.GRCTOPBIAM.ControlPVO`
...
- [[grc_control_b|GRC_CONTROL_B]] — 36 atributos (1 PKs, 22 BICC)
