---
id: DOC-AR-PVO-CustomerSiteProfile
doc_type: system-doc
title: "CustomerSiteProfile — PVO Accounts Receivable"
...
Extrai os perfis de cliente no nível de site (filial/endereço), permitindo configurações diferenciadas de crédito, cobrança e faturamento por localidade. Suporta operações onde cada filial do cliente possui condições comerciais distintas.

**Caminho:** `FscmTopModelAM.FinArTopPublicModelAM.CustomerSiteProfile`
...
- [[hz_customer_profiles_f|HZ_CUSTOMER_PROFILES_F]] — 84 atributos (1 PKs, 54 BICC)
- [[hz_cust_profile_amts_f|HZ_CUST_PROFILE_AMTS_F]] — 46 atributos (28 BICC)
- [[hz_cust_profile_classes|HZ_CUST_PROFILE_CLASSES]] — 60 atributos (7 BICC)
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 4 atributos
