---
id: DOC-AR-PVO-SiteContact
doc_type: system-doc
title: "SiteContact — PVO Accounts Receivable"
...
Extrai os contatos vinculados a sites de clientes, com papéis e dados pessoais. Garante que comunicações de cobrança e faturamento sejam direcionadas ao contato correto em cada filial do cliente.

**Caminho:** `FscmTopModelAM.FinArCustomersPublicModelAM.SiteContact`
