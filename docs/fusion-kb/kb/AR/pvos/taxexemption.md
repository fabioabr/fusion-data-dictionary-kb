---
id: DOC-AR-PVO-TaxExemption
doc_type: system-doc
title: "TaxExemption — PVO Accounts Receivable"
...
Extrai as isenções fiscais concedidas a contas de clientes, com jurisdição, regime, produto e período de validade. Garante a aplicação correta de benefícios e imunidades tributárias nas faturas emitidas.

**Caminho:** `FscmTopModelAM.FinArCustomersPublicModelAM.TaxExemption`
...
- [[zx_exemptions|ZX_EXEMPTIONS]] — 37 atributos (13 BICC)
