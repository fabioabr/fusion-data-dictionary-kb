---
id: DOC-AR-PVO-AccountCreditCard
doc_type: system-doc
title: "AccountCreditCard — PVO Accounts Receivable"
...
Extrai os cartões de crédito registrados nas contas de clientes, com dados de endereço de cobrança e instrumentos de pagamento. Viabiliza cobranças automáticas via cartão e reconciliação de pagamentos recorrentes.

**Caminho:** `FscmTopModelAM.FinArCustomersPublicModelAM.AccountCreditCard`
