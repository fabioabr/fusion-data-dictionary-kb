---
id: DOC-AR-PVO-SiteContactRelationShip
doc_type: system-doc
title: "SiteContactRelationShip — PVO Accounts Receivable"
...
Extrai os relacionamentos entre contatos e sites de clientes, com hierarquias e papéis organizacionais. Mapeia a estrutura de responsáveis por pagamentos e aprovações em cada filial do cliente.

**Caminho:** `FscmTopModelAM.FinArCustomersPublicModelAM.SiteContactRelationShip`
...
- [[hz_cust_account_roles|HZ_CUST_ACCOUNT_ROLES]] — 16 atributos (1 PKs, 10 BICC)
