---
id: DOC-AR-PVO-CustomerAccountReceiptMethod
doc_type: system-doc
title: "CustomerAccountReceiptMethod — PVO Accounts Receivable"
...
Extrai os métodos de recebimento configurados por conta de cliente (boleto, TED, cartão, débito automático). Determina quais canais de pagamento estão disponíveis para cada cliente, impactando cobranças e fluxo de caixa.

**Caminho:** `FscmTopModelAM.FinArTopPublicModelAM.CustomerAccountReceiptMethod`
...
- [[iby_fndcpt_pmt_chnnls_vl|IBY_FNDCPT_PMT_CHNNLS_VL]] — 2 atributos
