---
id: DOC-AR-PVO-AccountPaymentNotification
doc_type: system-doc
title: "AccountPaymentNotification — PVO Accounts Receivable"
...
Extrai as configurações de notificação de pagamento das contas de clientes. Controla como e quando os clientes são notificados sobre cobranças, vencimentos e confirmações de recebimento.

**Caminho:** `FscmTopModelAM.FinArCustomersPublicModelAM.AccountPaymentNotification`
