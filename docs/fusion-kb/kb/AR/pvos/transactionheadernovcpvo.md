---
id: DOC-AR-PVO-TransactionHeaderNoVCPVO
doc_type: system-doc
title: "TransactionHeaderNoVCPVO — PVO Accounts Receivable"
...
Extrai os cabeçalhos de transações de Contas a Receber sem critérios de view (sem filtros adicionais), com dados completos de cliente, endereço, batch e impostos. Fornece a visão mais ampla possível dos cabeçalhos de transações para análises abrangentes.

**Caminho:** `FscmTopModelAM.FinArTopPublicModelAM.TransactionHeaderNoVCPVO`
...
- [[hz_cust_accounts|HZ_CUST_ACCOUNTS]] — 71 atributos (3 BICC)
...
- [[ra_customer_trx_all|RA_CUSTOMER_TRX_ALL]] — 306 atributos (1 PKs, 8 BICC)
