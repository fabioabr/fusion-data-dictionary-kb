---
id: DOC-AR-PVO-TaxClassification
doc_type: system-doc
title: "TaxClassification — PVO Accounts Receivable"
...
Extrai as classificações fiscais atribuídas a contas de clientes no nível de conta (não site). Determina o tratamento tributário padrão aplicável ao cliente para cálculo de impostos nas transações de recebíveis.

**Caminho:** `FscmTopModelAM.FinArCustomersPublicModelAM.TaxClassification`
