---
id: DOC-PO-PVO-NegotiationRequirementAndScoringPVO
doc_type: system-doc
title: "NegotiationRequirementAndScoringPVO — PVO Purchasing"
...
Extrai os requisitos e critérios de pontuação de negociações, incluindo pesos, seções e scores atribuídos. Permite análise da estrutura de avaliação de propostas e transparência na seleção de fornecedores.

**Caminho:** `FscmTopModelAM.PrcPonPublicViewAM.NegotiationRequirementAndScoringPVO`
...
- [[pon_requirements|PON_REQUIREMENTS]] — 45 atributos (26 BICC)
- [[pon_requirement_scores|PON_REQUIREMENT_SCORES]] — 50 atributos (1 PKs, 17 BICC)
...
| 30 | NegotiationRequirementRequirementId | REQUIREMENT_ID | — | ✅ |
...
| 41 | NegotiationRequirementSectionId | SECTION_ID | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | NegotiationRequirementScoreAccResponseId | ACC_RESPONSE_ID | — | — |
| 2 | NegotiationRequirementScoreAllowAttachmentCode | ALLOW_ATTACHMENT_CODE | — | ✅ |
| 3 | NegotiationRequirementScoreAuctionHeaderId | AUCTION_HEADER_ID | — | — |
| 4 | NegotiationRequirementScoreCreatedBy | CREATED_BY | — | — |
| 5 | NegotiationRequirementScoreCreationDate | CREATION_DATE | — | — |
| 6 | NegotiationRequirementScoreDateFromRange | DATE_FROM_RANGE | — | ✅ |
| 7 | NegotiationRequirementScoreDateToRange | DATE_TO_RANGE | — | ✅ |
| 8 | NegotiationRequirementScoreDatetimeFromRange | DATETIME_FROM_RANGE | — | ✅ |
| 9 | NegotiationRequirementScoreDatetimeToRange | DATETIME_TO_RANGE | — | ✅ |
| 10 | NegotiationRequirementScoreDispSeqNumber | DISP_SEQ_NUMBER | — | ✅ |
| 11 | NegotiationRequirementScoreIsDefaultScoreRow | IS_DEFAULT_SCORE_ROW | — | ✅ |
| 12 | NegotiationRequirementScoreLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 13 | NegotiationRequirementScoreLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 14 | NegotiationRequirementScoreLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 15 | NegotiationRequirementScoreNumberFromRange | NUMBER_FROM_RANGE | — | ✅ |
| 16 | NegotiationRequirementScoreNumberToRange | NUMBER_TO_RANGE | — | ✅ |
| 17 | NegotiationRequirementScoreObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 18 | NegotiationRequirementScorePreviousScoreId | PREVIOUS_SCORE_ID | — | — |
| 19 | NegotiationRequirementScoreRequirementId | REQUIREMENT_ID | — | — |
| 20 | NegotiationRequirementScoreScore | SCORE | — | ✅ |
| 21 | NegotiationRequirementScoreScoreDisplayNumber | SCORE_DISPLAY_NUMBER | — | ✅ |
| 22 | NegotiationRequirementScoreScoreLevel | SCORE_LEVEL | — | — |
| 23 | NegotiationRequirementScoreTargetFlag | TARGET_FLAG | — | ✅ |
| 24 | NegotiationRequirementScoreTextValue | TEXT_VALUE | — | ✅ |
| 25 | ParentRequirementScoreAccResponseId | ACC_RESPONSE_ID | — | — |
| 26 | ParentRequirementScoreAllowAttachmentCode | ALLOW_ATTACHMENT_CODE | — | — |
| 27 | ParentRequirementScoreAuctionHeaderId | AUCTION_HEADER_ID | — | — |
| 28 | ParentRequirementScoreCreatedBy | CREATED_BY | — | — |
| 29 | ParentRequirementScoreCreationDate | CREATION_DATE | — | — |
| 30 | ParentRequirementScoreDateFromRange | DATE_FROM_RANGE | — | — |
| 31 | ParentRequirementScoreDateToRange | DATE_TO_RANGE | — | — |
| 32 | ParentRequirementScoreDatetimeFromRange | DATETIME_FROM_RANGE | — | — |
| 33 | ParentRequirementScoreDatetimeToRange | DATETIME_TO_RANGE | — | — |
| 34 | ParentRequirementScoreDispSeqNumber | DISP_SEQ_NUMBER | — | ✅ |
| 35 | ParentRequirementScoreIsDefaultScoreRow | IS_DEFAULT_SCORE_ROW | — | — |
| 36 | ParentRequirementScoreLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 37 | ParentRequirementScoreLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 38 | ParentRequirementScoreLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 39 | ParentRequirementScoreNumberFromRange | NUMBER_FROM_RANGE | — | — |
| 40 | ParentRequirementScoreNumberToRange | NUMBER_TO_RANGE | — | — |
| 41 | ParentRequirementScoreObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 42 | ParentRequirementScorePreviousScoreId | PREVIOUS_SCORE_ID | — | — |
| 43 | ParentRequirementScoreRequirementId | REQUIREMENT_ID | — | — |
| 44 | ParentRequirementScoreScore | SCORE | — | — |
| 45 | ParentRequirementScoreScoreDisplayNumber | SCORE_DISPLAY_NUMBER | — | — |
| 46 | ParentRequirementScoreScoreId | SCORE_ID | — | — |
| 47 | ParentRequirementScoreScoreLevel | SCORE_LEVEL | — | — |
| 48 | ParentRequirementScoreTargetFlag | TARGET_FLAG | — | — |
| 49 | ParentRequirementScoreTextValue | TEXT_VALUE | — | — |
| 50 | ScoreId | SCORE_ID | 🔑 | ✅ |
