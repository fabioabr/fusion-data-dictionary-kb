---
id: DOC-PO-PVO-DestinationTypePurchasingLookupPVO
doc_type: system-doc
title: "DestinationTypePurchasingLookupPVO — PVO Purchasing"
...
Extrai os tipos de destino de compras (estoque, despesa, ativo fixo), determinando a classificação contábil do recebimento. Essencial para correta apropriação de custos e integração com módulos financeiros.

**Caminho:** `FscmTopModelAM.PrcPoPublicViewAM.DestinationTypePurchasingLookupPVO`
...
- [[po_lookup_codes|PO_LOOKUP_CODES]] — 15 atributos (2 PKs, 6 BICC)
