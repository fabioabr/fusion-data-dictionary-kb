---
id: DOC-PO-PVO-SupplierAddressBankAccountPVO
doc_type: system-doc
title: "SupplierAddressBankAccountPVO — PVO Purchasing"
...
Extrai as contas bancárias vinculadas a endereços específicos de fornecedores, incluindo banco, agência, tipo de conta e dados de pagamento. Essencial para processamento correto de pagamentos e conciliação bancária.

**Caminho:** `FscmTopModelAM.PrcPozPublicViewAM.SupplierAddressBankAccountPVO`
...
- [[iby_payment_methods_vl|IBY_PAYMENT_METHODS_VL]] — 31 atributos (2 BICC)
