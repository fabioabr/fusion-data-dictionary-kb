---
id: DOC-PO-PVO-JobRequisitionPVO
doc_type: system-doc
title: "JobRequisitionPVO — PVO Purchasing"
...
Extrai requisições de contratação (vagas), incluindo cargo, departamento, tipo de contrato, fórmulas de elegibilidade e status. Permite análise de demanda por mão de obra e acompanhamento do ciclo de contratação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecHiringRequisitionAM.JobRequisitionPVO`
...
- [[irc_requisitions_b|IRC_REQUISITIONS_B]] — 167 atributos (1 PKs, 85 BICC)
- [[irc_requisitions_tl|IRC_REQUISITIONS_TL]] — 26 atributos (16 BICC)
