---
id: DOC-PO-PVO-ResponseRepositoryValuesPVO
doc_type: system-doc
title: "ResponseRepositoryValuesPVO — PVO Purchasing"
...
Disponibiliza valores do repositório de respostas de qualificação para consulta, incluindo dados por área e pergunta. Permite acesso rápido a informações cadastrais históricas de fornecedores.

**Caminho:** `FscmTopModelAM.PrcPoqPublicViewAM.ResponseRepositoryValuesPVO`
...
- [[poq_all_resp_repos_values_v|POQ_ALL_RESP_REPOS_VALUES_V]] — 15 atributos (1 PKs, 14 BICC)
- [[poq_qual_areas_vl|POQ_QUAL_AREAS_VL]] — 23 atributos (23 BICC)
- [[poq_qual_area_all_questions_v|POQ_QUAL_AREA_ALL_QUESTIONS_V]] — 15 atributos (1 PKs, 15 BICC)
- [[poq_questions_vl|POQ_QUESTIONS_VL]] — 37 atributos (37 BICC)
- [[poq_response_repository|POQ_RESPONSE_REPOSITORY]] — 31 atributos (31 BICC)
- [[poz_supplier_sites_all_m|POZ_SUPPLIER_SITES_ALL_M]] — 215 atributos (205 BICC)
...
### [[poq_all_resp_repos_values_v|POQ_ALL_RESP_REPOS_VALUES_V]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | CriticalResponseFlag | CRITICAL_RESPONSE_FLAG | — | — |
| 2 | RespRepositoryValueAccResponseId | ACC_RESPONSE_ID | — | ✅ |
| 3 | RespRepositoryValueAccResponseText | ACC_RESPONSE_TEXT | — | ✅ |
| 4 | RespRepositoryValueCreatedBy | CREATED_BY | — | ✅ |
| 5 | RespRepositoryValueCreationDate | CREATION_DATE | — | ✅ |
| 6 | RespRepositoryValueId | RESP_REPOSITORY_VALUE_ID | 🔑 | ✅ |
| 7 | RespRepositoryValueLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 8 | RespRepositoryValueLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 9 | RespRepositoryValueLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 10 | RespRepositoryValueObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 11 | RespRepositoryValueResponseRepositoryId | RESPONSE_REPOSITORY_ID | — | ✅ |
| 12 | RespRepositoryValueResponseValueDate | RESPONSE_VALUE_DATE | — | ✅ |
| 13 | RespRepositoryValueResponseValueDatetime | RESPONSE_VALUE_DATETIME | — | ✅ |
| 14 | RespRepositoryValueResponseValueNum | RESPONSE_VALUE_NUM | — | ✅ |
| 15 | RespRepositoryValueResponseValueTxt | RESPONSE_VALUE_TXT | — | ✅ |
...
### [[poq_qual_area_all_questions_v|POQ_QUAL_AREA_ALL_QUESTIONS_V]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | QualAreaQuestionBranchLevel | BRANCH_LEVEL | — | ✅ |
| 2 | QualAreaQuestionChildQuestionId | CHILD_QUESTION_ID | — | ✅ |
| 3 | QualAreaQuestionCreatedBy | CREATED_BY | — | ✅ |
| 4 | QualAreaQuestionCreationDate | CREATION_DATE | — | ✅ |
| 5 | QualAreaQuestionDisplaySequence | DISPLAY_SEQUENCE | — | ✅ |
| 6 | QualAreaQuestionKnockoutScore | KNOCKOUT_SCORE | — | ✅ |
| 7 | QualAreaQuestionLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 8 | QualAreaQuestionLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 9 | QualAreaQuestionLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 10 | QualAreaQuestionObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 11 | QualAreaQuestionQualAreaId | QUAL_AREA_ID | — | ✅ |
| 12 | QualAreaQuestionQualAreaQuestionId | QUAL_AREA_QUESTION_ID | 🔑 | ✅ |
| 13 | QualAreaQuestionQuestionId | QUESTION_ID | — | ✅ |
| 14 | QualAreaQuestionRootQuestionId | ROOT_QUESTION_ID | — | ✅ |
| 15 | QualAreaQuestionWeight | WEIGHT | — | ✅ |
...
| 12 | QuestionMaximumScore | MAXIMUM_SCORE | — | ✅ |
| 13 | QuestionObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 14 | QuestionOriginalQuestionId | ORIGINAL_QUESTION_ID | — | ✅ |
| 15 | QuestionOwnerId | OWNER_ID | — | ✅ |
| 16 | QuestionPreferredResponseDate | PREFERRED_RESPONSE_DATE | — | ✅ |
| 17 | QuestionPreferredResponseDatetime | PREFERRED_RESPONSE_DATETIME | — | ✅ |
| 18 | QuestionPreferredResponseNumber | PREFERRED_RESPONSE_NUMBER | — | ✅ |
| 19 | QuestionPreferredResponseText | PREFERRED_RESPONSE_TEXT | — | ✅ |
| 20 | QuestionQuestionHint | QUESTION_HINT | — | ✅ |
| 21 | QuestionQuestionId | QUESTION_ID | — | ✅ |
| 22 | QuestionQuestionLevel | QUESTION_LEVEL | — | ✅ |
| 23 | QuestionQuestionName | QUESTION_NAME | — | ✅ |
| 24 | QuestionQuestionStatus | QUESTION_STATUS | — | ✅ |
| 25 | QuestionQuestionText | QUESTION_TEXT | — | ✅ |
| 26 | QuestionQuestionType | QUESTION_TYPE | — | ✅ |
| 27 | QuestionResponderType | RESPONDER_TYPE | — | ✅ |
| 28 | QuestionResponseRequiredFlag | RESPONSE_REQUIRED_FLAG | — | ✅ |
| 29 | QuestionResponseType | RESPONSE_TYPE | — | ✅ |
| 30 | QuestionRevisionNumber | REVISION_NUMBER | — | ✅ |
| 31 | QuestionScoreForNoResponse | SCORE_FOR_NO_RESPONSE | — | ✅ |
| 32 | QuestionScoringApproach | SCORING_APPROACH | — | ✅ |
| 33 | QuestionScoringMethod | SCORING_METHOD | — | ✅ |
| 34 | QuestionStdsOrgCode | STDS_ORG_CODE | — | ✅ |
| 35 | QuestionSubjectCode | SUBJECT_CODE | — | ✅ |
| 36 | QuestionSupplierAttributeCode | SUPPLIER_ATTRIBUTE_CODE | — | ✅ |
| 37 | QuestionSupplierAttributeFlag | SUPPLIER_ATTRIBUTE_FLAG | — | ✅ |
...
| 2 | RepResponseAcceptanceDate | ACCEPTANCE_DATE | — | ✅ |
| 3 | RepResponseAcceptanceNote | ACCEPTANCE_NOTE | — | ✅ |
| 4 | RepResponseAcceptedBy | ACCEPTED_BY | — | ✅ |
| 5 | RepResponseBatchId | BATCH_ID | — | ✅ |
| 6 | RepResponseCreatedBy | CREATED_BY | — | ✅ |
| 7 | RepResponseCreationDate | CREATION_DATE | — | ✅ |
| 8 | RepResponseDataSourceId | DATA_SOURCE_ID | — | ✅ |
| 9 | RepResponseDataSourceType | DATA_SOURCE_TYPE | — | ✅ |
| 10 | RepResponseFirstSubmissionDate | FIRST_SUBMISSION_DATE | — | ✅ |
| 11 | RepResponseInternalRespondentId | INTERNAL_RESPONDENT_ID | — | ✅ |
| 12 | RepResponseLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 13 | RepResponseLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 14 | RepResponseLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 15 | RepResponseMergeRequestId | MERGE_REQUEST_ID | — | ✅ |
| 16 | RepResponseObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 17 | RepResponseOriginalQuestionId | ORIGINAL_QUESTION_ID | — | ✅ |
| 18 | RepResponseQuestionId | QUESTION_ID | — | ✅ |
| 19 | RepResponseRequestId | REQUEST_ID | — | ✅ |
| 20 | RepResponseResponderType | RESPONDER_TYPE | — | ✅ |
| 21 | RepResponseResponseArchiveDate | RESPONSE_ARCHIVE_DATE | — | ✅ |
| 22 | RepResponseResponseComments | RESPONSE_COMMENTS | — | ✅ |
| 23 | RepResponseResponseRepositoryId | RESPONSE_REPOSITORY_ID | — | ✅ |
| 24 | RepResponseResponseStatus | RESPONSE_STATUS | — | ✅ |
| 25 | RepResponseResponseSubmissionDate | RESPONSE_SUBMISSION_DATE | — | ✅ |
| 26 | RepResponseSupplierContactPartyId | SUPPLIER_CONTACT_PARTY_ID | — | ✅ |
| 27 | RepResponseSupplierId | SUPPLIER_ID | — | ✅ |
| 28 | RepResponseSupplierSiteId | SUPPLIER_SITE_ID | — | ✅ |
| 29 | RepResponseSurrogEnteredBy | SURROG_ENTERED_BY | — | ✅ |
| 30 | RepResponseSurrogEntryDate | SURROG_ENTRY_DATE | — | ✅ |
| 31 | RepResponseSurrogResponseFlag | SURROG_RESPONSE_FLAG | — | ✅ |
...
| 157 | SuppSiteLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 158 | SuppSiteLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 159 | SuppSiteLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 160 | SuppSiteLocationId | LOCATION_ID | — | ✅ |
| 161 | SuppSiteMatchOption | MATCH_OPTION | — | ✅ |
| 162 | SuppSiteModeOfTransport | MODE_OF_TRANSPORT | — | ✅ |
| 163 | SuppSiteObjectVersionNumber7 | OBJECT_VERSION_NUMBER | — | ✅ |
