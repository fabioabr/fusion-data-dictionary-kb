---
id: DOC-PO-PVO-ProductProposalCostStg
doc_type: system-doc
title: "ProductProposalCostStg — PVO Purchasing"
...
Extrai dados de staging de custos de propostas de produto em fase de processamento. Suporta o pipeline de carga e validação de dados de custo antes da consolidação final.

**Caminho:** `FscmTopModelAM.PortfolioAnalyticsAM.ProductProposalCostStg`
...
- [[ace_costs_staging|ACE_COSTS_STAGING]] — 16 atributos (1 PKs, 16 BICC)
...
### [[ace_costs_staging|ACE_COSTS_STAGING]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | PrdProposalCostStgCostAmount | COST_AMOUNT | — | ✅ |
| 2 | PrdProposalCostStgCostCategory | COST_CATEGORY | — | ✅ |
| 3 | PrdProposalCostStgCostStatus | COST_STATUS | — | ✅ |
| 4 | PrdProposalCostStgCostTrend | COST_TREND | — | ✅ |
| 5 | PrdProposalCostStgCostType | COST_TYPE | — | ✅ |
| 6 | PrdProposalCostStgCostsStagingId | COSTS_STAGING_ID | 🔑 | ✅ |
| 7 | PrdProposalCostStgCreatedBy | CREATED_BY | — | ✅ |
| 8 | PrdProposalCostStgCreationDate | CREATION_DATE | — | ✅ |
| 9 | PrdProposalCostStgEndDate | END_DATE | — | ✅ |
| 10 | PrdProposalCostStgLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 11 | PrdProposalCostStgLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 12 | PrdProposalCostStgLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 13 | PrdProposalCostStgObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 14 | PrdProposalCostStgProductProposalId | PRODUCT_PROPOSAL_ID | — | ✅ |
| 15 | PrdProposalCostStgStartDate | START_DATE | — | ✅ |
| 16 | PrdProposalCostStgUserId | USER_ID | — | ✅ |

### [[ace_pf_scenario_b|ACE_PF_SCENARIO_B]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ProjProdMaterialCost | PROJ_PROD_MATERIAL_COST | — | ✅ |
