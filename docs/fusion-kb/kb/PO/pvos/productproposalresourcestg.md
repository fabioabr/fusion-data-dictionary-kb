---
id: DOC-PO-PVO-ProductProposalResourceStg
doc_type: system-doc
title: "ProductProposalResourceStg — PVO Purchasing"
...
Extrai dados de staging de recursos de propostas de produto em processamento. Suporta o pipeline de carga e validação de dados de alocação de recursos antes da consolidação.

**Caminho:** `FscmTopModelAM.PortfolioAnalyticsAM.ProductProposalResourceStg`
...
- [[ace_resource_staging|ACE_RESOURCE_STAGING]] — 16 atributos (1 PKs, 16 BICC)
...
### [[ace_resource_staging|ACE_RESOURCE_STAGING]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | PrdProposalResourceStgCreatedBy | CREATED_BY | — | ✅ |
| 2 | PrdProposalResourceStgCreationDate | CREATION_DATE | — | ✅ |
| 3 | PrdProposalResourceStgEndDate | END_DATE | — | ✅ |
| 4 | PrdProposalResourceStgLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 5 | PrdProposalResourceStgLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 6 | PrdProposalResourceStgLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 7 | PrdProposalResourceStgObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 8 | PrdProposalResourceStgProductProposalId | PRODUCT_PROPOSAL_ID | — | ✅ |
| 9 | PrdProposalResourceStgResourceCategory | RESOURCE_CATEGORY | — | ✅ |
| 10 | PrdProposalResourceStgResourceHeadcount | RESOURCE_HEADCOUNT | — | ✅ |
| 11 | PrdProposalResourceStgResourcePool | RESOURCE_POOL | — | ✅ |
| 12 | PrdProposalResourceStgResourceStagingId | RESOURCE_STAGING_ID | 🔑 | ✅ |
| 13 | PrdProposalResourceStgResourceStatus | RESOURCE_STATUS | — | ✅ |
| 14 | PrdProposalResourceStgResourceTrend | RESOURCE_TREND | — | ✅ |
| 15 | PrdProposalResourceStgStartDate | START_DATE | — | ✅ |
| 16 | PrdProposalResourceStgUserId | USER_ID | — | ✅ |
...
| 66 | SelProductsStgSupplyChainFit1 | SUPPLY_CHAIN_FIT | — | ✅ |
