---
id: DOC-PO-PVO-RequisitionQstnrInternalViewAllPVO
doc_type: system-doc
title: "RequisitionQstnrInternalViewAllPVO — PVO Purchasing"
...
Extrai questionários internos de requisições de contratação, utilizados para coleta de informações e avaliação dentro da organização. Permite padronização de critérios de seleção.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecHiringRequisitionAM.RequisitionQstnrInternalViewAllPVO`
...
- [[hrq_questionnaires_b|HRQ_QUESTIONNAIRES_B]] — 13 atributos (5 BICC)
- [[hrq_questionnaires_tl|HRQ_QUESTIONNAIRES_TL]] — 7 atributos (2 BICC)
- [[irc_im_req_qstnrs|IRC_IM_REQ_QSTNRS]] — 10 atributos (3 PKs, 5 BICC)
