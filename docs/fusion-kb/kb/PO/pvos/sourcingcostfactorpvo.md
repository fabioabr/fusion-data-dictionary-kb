---
id: DOC-PO-PVO-SourcingCostFactorPVO
doc_type: system-doc
title: "SourcingCostFactorPVO — PVO Purchasing"
...
Disponibiliza fatores de custo de sourcing para consulta operacional, com detalhes de tipo, valor e aplicação por linha de negociação. Suporta composição de preço total em avaliações de propostas.

**Caminho:** `FscmTopModelAM.PrcExtractAM.PonBiccExtractAM.SourcingCostFactorPVO`
...
- [[pon_price_element_types_vl|PON_PRICE_ELEMENT_TYPES_VL]] — 8 atributos (8 BICC)
...
| 3 | SequenceNumber | SEQUENCE_NUMBER | 🔑 | ✅ |
| 4 | SourcingCostFactorCreatedBy | CREATED_BY | — | ✅ |
| 5 | SourcingCostFactorCreationDate | CREATION_DATE | — | ✅ |
| 6 | SourcingCostFactorDisplayTargetFlag | DISPLAY_TARGET_FLAG | — | ✅ |
| 7 | SourcingCostFactorDisplayToSuppliersFlag | DISPLAY_TO_SUPPLIERS_FLAG | — | ✅ |
| 8 | SourcingCostFactorLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 9 | SourcingCostFactorLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 10 | SourcingCostFactorLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 11 | SourcingCostFactorObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 12 | SourcingCostFactorPfType | PF_TYPE | — | ✅ |
| 13 | SourcingCostFactorPriceElementTypeId | PRICE_ELEMENT_TYPE_ID | — | ✅ |
| 14 | SourcingCostFactorPricingBasis | PRICING_BASIS | — | ✅ |
| 15 | SourcingCostFactorProgramAppName | PROGRAM_APP_NAME | — | ✅ |
| 16 | SourcingCostFactorProgramName | PROGRAM_NAME | — | ✅ |
| 17 | SourcingCostFactorRequestId | REQUEST_ID | — | ✅ |
| 18 | SourcingCostFactorValue | VALUE | — | ✅ |

### [[pon_price_element_types_vl|PON_PRICE_ELEMENT_TYPES_VL]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | SourcingCostFactorTypeDescription | DESCRIPTION | — | ✅ |
| 2 | SourcingCostFactorTypeEnabledFlag | ENABLED_FLAG | — | ✅ |
| 3 | SourcingCostFactorTypeName | NAME | — | ✅ |
| 4 | SourcingCostFactorTypePriceElementCode | PRICE_ELEMENT_CODE | — | ✅ |
| 5 | SourcingCostFactorTypePriceElementTypeId | PRICE_ELEMENT_TYPE_ID | — | ✅ |
| 6 | SourcingCostFactorTypePricingBasis | PRICING_BASIS | — | ✅ |
| 7 | SourcingCostFactorTypeRowId1 | ROW_ID | — | ✅ |
| 8 | SourcingCostFactorTypeSystemFlag | SYSTEM_FLAG | — | ✅ |
