---
id: DOC-PO-PVO-RequisitionDistributionP1
doc_type: system-doc
title: "RequisitionDistributionP1 — PVO Purchasing"
...
Disponibiliza distribuições contábeis de requisições para consulta operacional, com detalhes de conta, projeto, fornecedor sugerido e local de entrega. Permite verificação de disponibilidade orçamentária.

**Caminho:** `FscmTopModelAM.PrcPorPublicViewAM.RequisitionDistributionP1`
...
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 20 atributos (8 BICC)
...
- [[por_line_locations_sum_v|POR_LINE_LOCATIONS_SUM_V]] — 10 atributos (6 BICC)
- [[por_requisition_headers_all|POR_REQUISITION_HEADERS_ALL]] — 43 atributos (16 BICC)
- [[por_requisition_lines_all|POR_REQUISITION_LINES_ALL]] — 260 atributos (73 BICC)
- [[por_req_distributions_all|POR_REQ_DISTRIBUTIONS_ALL]] — 58 atributos (1 PKs, 19 BICC)
- [[po_action_history|PO_ACTION_HISTORY]] — 7 atributos (2 BICC)
- [[po_hazard_classes_vl|PO_HAZARD_CLASSES_VL]] — 6 atributos (1 BICC)
- [[po_headers_all|PO_HEADERS_ALL]] — 232 atributos (13 BICC)
- [[po_lines_all|PO_LINES_ALL]] — 204 atributos (6 BICC)
- [[po_un_numbers_vl|PO_UN_NUMBERS_VL]] — 12 atributos (2 BICC)
- [[po_versions_init_sequence_v|PO_VERSIONS_INIT_SEQUENCE_V]] — 41 atributos (5 BICC)
