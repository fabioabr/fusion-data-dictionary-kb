---
id: DOC-PO-PVO-NegStyleDocumentTypeExtractPVO
doc_type: system-doc
title: "NegStyleDocumentTypeExtractPVO — PVO Purchasing"
...
Extrai tipos de documentos por estilo de negociação para carga BICC, mapeando quais documentos de compra resultam de cada configuração de evento de sourcing.

**Caminho:** `FscmTopModelAM.PrcExtractAM.PonBiccExtractAM.NegStyleDocumentTypeExtractPVO`
...
- [[pon_auc_doctypes_b|PON_AUC_DOCTYPES_B]] — 11 atributos (11 BICC)
- [[pon_doctype_styles_b|PON_DOCTYPE_STYLES_B]] — 18 atributos (2 PKs, 18 BICC)
- [[pon_negotiation_styles_b|PON_NEGOTIATION_STYLES_B]] — 32 atributos (32 BICC)
