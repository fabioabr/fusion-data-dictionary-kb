---
id: DOC-PO-PVO-PositionTreeBICVO
doc_type: system-doc
title: "PositionTreeBICVO — PVO Purchasing"
...
Extrai a árvore hierárquica de posições para consumo em BI, com relacionamentos pai-filho e versão da árvore. Fundamental para visualização organizacional e análise de níveis hierárquicos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PositionAM.PositionTreeBICVO`
...
- [[fnd_tree_version_vl|FND_TREE_VERSION_VL]] — 23 atributos (3 BICC)
- [[fnd_tree_vl|FND_TREE_VL]] — 11 atributos (3 BICC)
- [[per_pos_tree_node_cf|PER_POS_TREE_NODE_CF]] — 235 atributos (5 PKs, 6 BICC)
...
### [[per_pos_tree_node_cf|PER_POS_TREE_NODE_CF]]
