---
id: DOC-PO-PVO-PurchaseOrderHistoryPVO
doc_type: system-doc
title: "PurchaseOrderHistoryPVO — PVO Purchasing"
...
Extrai o histórico completo de ações em ordens de compra (aprovação, rejeição, revisão, cancelamento), com datas, responsáveis e vínculos com requisições. Essencial para auditoria do ciclo de vida dos pedidos e análise de gargalos.

**Caminho:** `FscmTopModelAM.PrcPoPublicViewAM.PurchaseOrderHistoryPVO`
