---
id: DOC-PO-PVO-SourcingProgramObjectivePVO
doc_type: system-doc
title: "SourcingProgramObjectivePVO — PVO Purchasing"
...
Extrai os objetivos específicos de programas de sourcing, com metas quantificáveis de economia, eficiência e cobertura. Suporta medição de desempenho e ROI de iniciativas de procurement.

**Caminho:** `FscmTopModelAM.PrcPonPublicViewAM.SourcingProgramObjectivePVO`
...
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 16 atributos (2 BICC)
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ObjectivePersonNamePEODisplayName | DISPLAY_NAME | — | ✅ |
| 2 | ObjectivePersonNamePEOEffectiveEndDate | EFFECTIVE_END_DATE | — | — |
| 3 | ObjectivePersonNamePEOEffectiveStartDate | EFFECTIVE_START_DATE | — | — |
| 4 | ObjectivePersonNamePEOFullName | FULL_NAME | — | — |
| 5 | ObjectivePersonNamePEOListName | LIST_NAME | — | — |
| 6 | ObjectivePersonNamePEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 7 | ObjectivePersonNamePEOPersonId | PERSON_ID | — | — |
| 8 | ObjectivePersonNamePEOPersonNameId | PERSON_NAME_ID | — | — |
| 9 | ProgramPersonNamePEODisplayName | DISPLAY_NAME | — | ✅ |
| 10 | ProgramPersonNamePEOEffectiveEndDate | EFFECTIVE_END_DATE | — | — |
| 11 | ProgramPersonNamePEOEffectiveStartDate | EFFECTIVE_START_DATE | — | — |
| 12 | ProgramPersonNamePEOFullName | FULL_NAME | — | — |
| 13 | ProgramPersonNamePEOListName | LIST_NAME | — | — |
| 14 | ProgramPersonNamePEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 15 | ProgramPersonNamePEOPersonId | PERSON_ID | — | — |
| 16 | ProgramPersonNamePEOPersonNameId | PERSON_NAME_ID | — | — |
