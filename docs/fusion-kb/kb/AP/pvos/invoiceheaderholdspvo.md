---
id: DOC-AP-PVO-InvoiceHeaderHoldsPVO
doc_type: system-doc
title: "InvoiceHeaderHoldsPVO — PVO Accounts Payable"
...
Extrai as retenções (holds) aplicadas nos cabeçalhos de faturas de fornecedores, incluindo motivo do bloqueio, fornecedor, valor da fatura e status. Permite monitorar faturas bloqueadas, analisar causas de retenção e acelerar o ciclo de pagamento.

**Caminho:** `FscmTopModelAM.FinApInvTransactionsAM.InvoiceHeaderHoldsPVO`
