---
id: DOC-AP-PVO-InvoiceHoldPVOActiveHolds
doc_type: system-doc
title: "InvoiceHoldPVOActiveHolds — PVO Accounts Payable"
...
Extrai as retenções ativas (não liberadas) em faturas de fornecedores, filtrando apenas bloqueios pendentes de resolução. Permite priorizar ações de liberação de faturas, reduzir atrasos de pagamento e monitorar o volume de exceções ativas no contas a pagar.

**Caminho:** `FscmTopModelAM.FinApInvTransactionsAM.InvoiceHoldPVOActiveHolds`
...
- [[ap_holds_all|AP_HOLDS_ALL]] — 18 atributos (1 PKs, 4 BICC)
...
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 19 atributos (3 BICC)
