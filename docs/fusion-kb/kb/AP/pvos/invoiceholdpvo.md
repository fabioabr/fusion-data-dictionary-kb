---
id: DOC-AP-PVO-InvoiceHoldPVO
doc_type: system-doc
title: "InvoiceHoldPVO — PVO Accounts Payable"
...
Extrai as retenções (holds) aplicadas a faturas de fornecedores, incluindo tipo de bloqueio, referência a pedido de compra, recebimento e dados do fornecedor. Essencial para gestão de exceções no contas a pagar e resolução de discrepâncias entre pedidos e faturas.

**Caminho:** `FscmTopModelAM.FinApInvTransactionsAM.InvoiceHoldPVO`
...
- [[ap_holds_all|AP_HOLDS_ALL]] — 18 atributos (1 PKs, 16 BICC)
- [[ap_invoices_all|AP_INVOICES_ALL]] — 19 atributos (15 BICC)
- [[ap_payment_schedules_all|AP_PAYMENT_SCHEDULES_ALL]] — 1 atributos (1 BICC)
- [[fun_bu_perf_v|FUN_BU_PERF_V]] — 1 atributos (1 BICC)
...
- [[rcv_shipment_headers|RCV_SHIPMENT_HEADERS]] — 5 atributos (3 BICC)
- [[rcv_transactions|RCV_TRANSACTIONS]] — 2 atributos (1 BICC)
