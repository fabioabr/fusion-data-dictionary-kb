---
id: DOC-AP-PVO-AllocatedChecklistTasksPVO
doc_type: system-doc
title: "AllocatedChecklistTasksPVO — PVO Accounts Payable"
...
Extrai as tarefas individuais dos checklists alocados em processos de RH, incluindo status, notificações, questionários vinculados e dependências entre tarefas. Viabiliza o controle granular de cada etapa dos processos de onboarding, offboarding e movimentações de pessoal.
