---
id: DOC-AP-PVO-ScreeningResultViewAllPVO
doc_type: system-doc
title: "ScreeningResultViewAllPVO — PVO Accounts Payable"
...
Extrai os resultados de screening (verificação de antecedentes) de candidatos, incluindo status, candidatura e oferta vinculada. Permite acompanhar o andamento e resultado das verificações de antecedentes em processos seletivos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecBackgroundCheckAM.ScreeningResultViewAllPVO`
...
- [[irc_bc_cand_results|IRC_BC_CAND_RESULTS]] — 14 atributos (1 PKs, 13 BICC)
