...
id: DOC-HCM-386
doc_type: system-doc
title: "HWM_TM_REP_ATRB_DATE_VAL_V — View de Valores Data de Atributos Reportados"
...
View que apresenta os **valores do tipo Data** (DATE) dos atributos de entradas reportadas de tempo. Facilita a consulta de atributos com valores data sem necessidade de conversão.
...
- **Consulta de atributos data:** acesso direto a valores data de entradas reportadas.
- **Relatórios:** facilita extração de atributos data sem conversão de tipo.
...
| 4 | DATE_VALUE | DATE | NULL | Dados | Valor data do atributo | — | 🟡 60% |
...
- [[hwm_tm_rep_atrbs]] — via `REP_ATRB_ID` (atributo de reporte do valor de data)
...
### Consultar valores data de atributos reportados
```sql
SELECT v.ATTRIBUTE_NAME, v.DATE_VALUE, v.REP_ENTRY_ID
FROM   HWM_TM_REP_ATRB_DATE_VAL_V v
...
- Retorna apenas atributos com valores do tipo data.
...
- [Oracle Docs — HWM_TM_REP_ATRB_DATE_VAL_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwmtmrepatrbdatevalv.html)
...
### [[attributedatevaluepvo|AttributeDateValuePVO]] (HCM · BICC: 6/28)

| Coluna da Tabela | Atributo do PVO | BICC |
|------------------|-----------------|------|
| ALLOWED_SCOPE | AllowedScope | — |
| ATTRIBUTE_CATEGORY | AttributeCategory | — |
| ATTRIBUTE_DATE_VALUE | AttributeDateValue | ✅ |
