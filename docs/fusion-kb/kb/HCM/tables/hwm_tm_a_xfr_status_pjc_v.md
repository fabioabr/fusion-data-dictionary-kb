...
id: DOC-HCM-369
doc_type: system-doc
title: "HWM_TM_A_XFR_STATUS_PJC_V — Status de Transferência para Project Costing — Aprovação (View)"
...
View que monitora o status de transferência de registros de tempo aprovados para o módulo de Project Costing, rastreando o progresso da integração.
...
FROM   HWM_TM_A_XFR_STATUS_PJC_V t
...
|------------------|-----------------|------|
| STATUS_ID | TimeEnryPjcXfrStatusId | — |
| STATUS_VALUE | TimeEnryPjcXfrStatusValue | ✅ |
...
- [Oracle Docs — HWM_TM_A_XFR_STATUS_PJC_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tm_a_xfr_status_pjc_v.html)
