...
id: DOC-HCM-396
doc_type: system-doc
title: "HWM_TM_REP_M_PJC_EXP_ATRBS_V — View de Atributos Despesas de Projeto (PJC) de Medidas Reportadas"
...
View que consolida os **atributos de despesas de projeto (pjc)** das medidas (measures) de entradas reportadas de tempo. Foco em atributos de despesas de projeto (Project Costing Expenditures) associados às medidas reportadas.
...
- **Consulta de atributos despesas de projeto (pjc):** acesso consolidado a dados de despesas de projeto (pjc) nas medidas reportadas.
...
- [[per_all_people_f]] — via `PERSON_ID` (pessoa dos atributos de despesa de projeto)
...
### Consultar atributos despesas de projeto (pjc) de medidas reportadas
```sql
SELECT v.PERSON_ID, v.ENTRY_DATE, v.MEASURE,
       v.ATTRIBUTE_1, v.ATTRIBUTE_2
FROM   HWM_TM_REP_M_PJC_EXP_ATRBS_V v
...
- Específica para atributos de despesas de projeto (pjc) nas medidas reportadas.
...
- [Oracle Docs — HWM_TM_REP_M_PJC_EXP_ATRBS_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwmtmrepmpjcexpatrbsv.html)
...
|------------------|-----------------|------|
| PJC_EXP_TIME_REPOS_ATRB_ID | PjcExpTypeTimeRepositoryAttributeId | — |
| PJC_EXPENDITURE_TYPE | PjcExpenditureType | ✅ |
...
| Coluna da Tabela | Atributo do PVO | BICC |
|------------------|-----------------|------|
| PJC_EXP_TIME_REPOS_ATRB_ID | MasterExpendTypeAttributePEOPjcExpTypeTimeRepositoryAttributeId | — |
| PJC_EXPENDITURE_TYPE | MasterExpendTypeAttributePEOPjcExpenditureType | ✅ |
