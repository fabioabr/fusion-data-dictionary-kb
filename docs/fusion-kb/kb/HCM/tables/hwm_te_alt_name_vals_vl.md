...
id: DOC-HCM-348
doc_type: system-doc
title: "HWM_TE_ALT_NAME_VALS_VL — Valores de Nomes Alternativos de Entrada de Tempo (View Consolidada)"
...
Visão consolidada que combina dados base e traduções dos valores de nomes alternativos de entradas de tempo.
...
FROM   HWM_TE_ALT_NAME_VALS_VL t
...
### [[templatelayoutcompdisplayvaluepvo|TemplateLayoutCompDisplayValuePVO]] (GL · BICC: 1/2)

| Coluna da Tabela | Atributo do PVO | BICC |
|------------------|-----------------|------|
| ALT_NAME_VALUE | DflAltNameValsPEOAltNameValue | ✅ |
| TE_ALT_NAME_VAL_ID | DflAltNameValsPEOTeAltNameValId | — |

### [[templatelayoutcomponentpvo|TemplateLayoutComponentPVO]] (GL · BICC: 1/2)
...
- [Oracle Docs — HWM_TE_ALT_NAME_VALS_VL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_te_alt_name_vals_vl.html)
