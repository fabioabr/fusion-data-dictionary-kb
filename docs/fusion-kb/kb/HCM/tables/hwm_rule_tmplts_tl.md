...
id: DOC-HCM-318
doc_type: system-doc
title: "HWM_RULE_TMPLTS_TL — Templates de Regras (Traduções)"
...
Tabela de traduções dos templates de regras, armazenando nomes e descrições dos modelos em múltiplos idiomas.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | RULE_TMPLTS_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | — | 🟢 95% |
...
- [Oracle Docs — HWM_RULE_TMPLTS_TL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_rule_tmplts_tl.html)
