...
id: DOC-HCM-373
doc_type: system-doc
title: "HWM_TM_D_XFR_STATUS_PJC_V — Status de Transferência para Project Costing — Detalhes (View)"
...
View detalhada do status de transferência de registros de tempo para Project Costing, incluindo informações de erro e reprocessamento.
...
FROM   HWM_TM_D_XFR_STATUS_PJC_V t
...
|------------------|-----------------|------|
| STATUS_ID | TimeEntryReadyXfrPjcStatusId | — |
...
- [Oracle Docs — HWM_TM_D_XFR_STATUS_PJC_V](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tm_d_xfr_status_pjc_v.html)
