...
id: DOC-HCM-337
doc_type: system-doc
title: "HWM_TCSMRS_TL — Resumos de Cartão de Ponto (Traduções)"
...
Tabela de traduções dos resumos de cartão de ponto, contendo nomes e descrições em múltiplos idiomas.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | TCSMRS_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | — | 🟢 95% |
...
### [[timeconsumertranslationpvo|TimeConsumerTranslationPVO]] (GL · BICC: 11/11)
...
- [Oracle Docs — HWM_TCSMRS_TL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tcsmrs_tl.html)
