...
id: DOC-HCM-329
doc_type: system-doc
title: "HWM_TCD_EXP_DATA_DEF_TL — Definição de Dados de Exportação de Time Card (Traduções)"
...
Tabela de traduções das definições de dados de exportação de cartão de ponto em múltiplos idiomas.
...
|---|--------|------|-------|-----------|-----------|-----|----------|
| 1 | TCD_EXP_DATA_DEF_ID | NUMBER(18) | NOT NULL | PK/FK | Identificador do registro base | — | 🟢 95% |
...
FROM   HWM_TCD_EXP_DATA_DEF_TL t
...
- [Oracle Docs — HWM_TCD_EXP_DATA_DEF_TL](https://docs.oracle.com/en/cloud/saas/human-resources/25a/oedmf/hwm_tcd_exp_data_def_tl.html)
