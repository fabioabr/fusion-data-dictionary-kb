---
id: DOC-HCM-PVO-PerformanceFinalFeedbackPVOForWorker
doc_type: system-doc
title: "PerformanceFinalFeedbackPVOForWorker — PVO Human Capital Management"
...
Disponibiliza feedback final do colaborador em avaliações de desempenho com comentários por seção. Registra a autoavaliação e perspectiva do trabalhador no encerramento do ciclo.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmPerformanceDocsAM.PerformanceFinalFeedbackPVOForWorker`
