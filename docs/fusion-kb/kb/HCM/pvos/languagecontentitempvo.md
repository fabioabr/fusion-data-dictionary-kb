---
id: DOC-HCM-PVO-LanguageContentItemPVO
doc_type: system-doc
title: "LanguageContentItemPVO — PVO Human Capital Management"
...
Extrai itens de conteúdo de idiomas da biblioteca de perfis de talento. Utilizado para catalogar proficiências linguísticas disponíveis.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileContentLibraryAM.LanguageContentItemPVO`
...
- [[hrt_content_items_b|HRT_CONTENT_ITEMS_B]] — 65 atributos (2 PKs, 3 BICC)
- [[hrt_content_items_tl|HRT_CONTENT_ITEMS_TL]] — 23 atributos (2 PKs, 4 BICC)
