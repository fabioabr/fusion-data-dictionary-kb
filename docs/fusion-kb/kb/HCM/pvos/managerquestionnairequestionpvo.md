---
id: DOC-HCM-PVO-ManagerQuestionnaireQuestionPVO
doc_type: system-doc
title: "ManagerQuestionnaireQuestionPVO — PVO Human Capital Management"
...
Disponibiliza perguntas de questionários sob a visão do gestor, com seções, respostas possíveis e classificações. Utilizado em avaliações de desempenho e pesquisas conduzidas por gestores.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.QuestionnaireAM.ManagerQuestionnaireQuestionPVO`
