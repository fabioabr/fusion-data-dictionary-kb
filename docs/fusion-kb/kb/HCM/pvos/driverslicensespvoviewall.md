---
id: DOC-HCM-PVO-DriversLicensesPVOViewAll
doc_type: system-doc
title: "DriversLicensesPVOViewAll — PVO Human Capital Management"
...
Visão completa (sem filtro de segurança) das carteiras de habilitação dos colaboradores. Utilizado para relatórios analíticos e auditorias de documentação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.DriversLicensesPVOViewAll`
