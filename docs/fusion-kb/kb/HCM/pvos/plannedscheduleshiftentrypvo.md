---
id: DOC-HCM-PVO-PlannedScheduleShiftEntryPVO
doc_type: system-doc
title: "PlannedScheduleShiftEntryPVO — PVO Human Capital Management"
...
Extrai as entradas de turno em escalas planejadas (Time and Labor), com horários, atributos de setup e gestor. Suporta gestão de escalas, cobertura de turnos e planejamento de workforce.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.PlannedScheduleShiftEntryPVO`
...
- [[hts_schedules_day_shift_view|HTS_SCHEDULES_DAY_SHIFT_VIEW]] — 39 atributos
