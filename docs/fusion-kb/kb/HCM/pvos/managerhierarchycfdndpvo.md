---
id: DOC-HCM-PVO-ManagerHierarchyCFDNDPVO
doc_type: system-doc
title: "ManagerHierarchyCFDNDPVO — PVO Human Capital Management"
...
Disponibiliza a hierarquia gerencial desnormalizada com até 15 níveis de subordinados por atribuição. Fundamental para análise de span of control e estrutura organizacional multinível.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.ManagerHierarchyAM.ManagerHierarchyCFDNDPVO`
...
- [[per_manager_hrchy_reportees_dn|PER_MANAGER_HRCHY_REPORTEES_DN]] — 75 atributos (4 PKs, 36 BICC)
