---
id: DOC-HCM-PVO-RiskRatingLevelPVO
doc_type: system-doc
title: "RiskRatingLevelPVO — PVO Human Capital Management"
...
Disponibiliza níveis de avaliação de risco vinculados a seções e tipos de conteúdo. Define escalas de classificação de risco no framework de Talent Profile.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileSetupAM.RiskRatingLevelPVO`
