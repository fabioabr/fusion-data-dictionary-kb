---
id: DOC-HCM-PVO-RatingModelThirdPVO
doc_type: system-doc
title: "RatingModelThirdPVO — PVO Human Capital Management"
...
Extrai terceiro modelo de avaliação com nomes traduzidos. Utilizado em avaliações multidimensionais de competência no Talent Management.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileContentLibraryAM.RatingModelThirdPVO`
...
- [[hrt_rating_models_tl|HRT_RATING_MODELS_TL]] — 7 atributos (1 PKs, 3 BICC)
