---
id: DOC-HCM-PVO-MeetingNotePVO
doc_type: system-doc
title: "MeetingNotePVO — PVO Human Capital Management"
...
Extrai notas e anotações registradas em reuniões de calibração de talentos via dashboards. Suporta rastreabilidade de decisões e comentários do processo de Talent Review.
