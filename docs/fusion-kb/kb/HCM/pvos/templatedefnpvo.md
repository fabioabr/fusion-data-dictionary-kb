---
id: DOC-HCM-PVO-TemplateDefnPVO
doc_type: system-doc
title: "TemplateDefnPVO — PVO Human Capital Management"
...
Extrai definições de templates de avaliação de desempenho com traduções. Base para configuração de modelos de avaliação no Performance Management.
