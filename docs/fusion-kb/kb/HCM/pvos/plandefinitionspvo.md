---
id: DOC-HCM-PVO-PlanDefinitionsPVO
doc_type: system-doc
title: "PlanDefinitionsPVO — PVO Human Capital Management"
...
Extrai as definições de planos no Compensation Workbench, incluindo período, modo de aprovação e configurações. Estrutura base para os ciclos de revisão de compensação.
