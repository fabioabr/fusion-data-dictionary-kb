---
id: DOC-HCM-PVO-PreSalaryPVO
doc_type: system-doc
title: "PreSalaryPVO — PVO Human Capital Management"
...
Extrai dados de salário pré-existente (anterior ao ciclo de compensação), com fator de anualização e frequência de pagamento. Serve como baseline para cálculos de ajuste salarial.
