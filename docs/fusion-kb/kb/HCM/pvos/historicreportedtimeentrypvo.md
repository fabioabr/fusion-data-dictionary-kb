---
id: DOC-HCM-PVO-HistoricReportedTimeEntryPVO
doc_type: system-doc
title: "HistoricReportedTimeEntryPVO — PVO Human Capital Management"
...
Extrai lançamentos de tempo reportados historicamente com status de aprovação e completude. Suporta análise de produtividade e compliance de timesheets.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.HistoricReportedTimeEntryPVO`
