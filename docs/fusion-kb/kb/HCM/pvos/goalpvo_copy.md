---
id: DOC-HCM-PVO-GoalPVO_Copy
doc_type: system-doc
title: "GoalPVO_Copy — PVO Human Capital Management"
...
Cópia alternativa da visão de metas com alinhamentos, medições e intenções pessoais. Utilizado como visão de contingência ou para propósitos analíticos específicos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmGoalCoreAM.GoalPVO_Copy`
...
- [[hrg_goals|HRG_GOALS]] — 64 atributos (1 PKs, 3 BICC)
- [[hrg_goal_alignments|HRG_GOAL_ALIGNMENTS]] — 4 atributos (1 BICC)
- [[hrg_goal_measurements|HRG_GOAL_MEASUREMENTS]] — 27 atributos (1 BICC)
- [[hrg_goal_plan_goals|HRG_GOAL_PLAN_GOALS]] — 8 atributos (2 BICC)
- [[hrt_profiles_tl|HRT_PROFILES_TL]] — 12 atributos (1 BICC)
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 57 atributos (8 BICC)
...
| 30 | GoalPEOLastModifiedBy | LAST_MODIFIED_BY | — | — |
| 31 | GoalPEOLastModifiedDate | LAST_MODIFIED_DATE | — | — |
| 32 | GoalPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 33 | GoalPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 34 | GoalPEOLastUpdatedBy | LAST_UPDATED_BY | — | — |
| 35 | GoalPEOLevelCode | LEVEL_CODE | — | — |
| 36 | GoalPEOLevelMeaning | LEVEL_MEANING | — | — |
| 37 | GoalPEOLongDescription | LONG_DESCRIPTION | — | — |
| 38 | GoalPEOMassRequestId | MASS_REQUEST_ID | — | — |
| 39 | GoalPEOMeasureCalcRuleCode | MEASURE_CALC_RULE_CODE | — | — |
| 40 | GoalPEOMeasureComments | MEASURE_COMMENTS | — | — |
| 41 | GoalPEOMeasureName | MEASURE_NAME | — | — |
| 42 | GoalPEOMeasureTypeCode | MEASURE_TYPE_CODE | — | — |
| 43 | GoalPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
...
| 8 | GoalPlanGoalPEOWeighting | WEIGHTING | — | — |
