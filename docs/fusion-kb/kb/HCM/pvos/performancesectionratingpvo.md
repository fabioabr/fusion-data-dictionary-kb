---
id: DOC-HCM-PVO-PerformanceSectionRatingPVO
doc_type: system-doc
title: "PerformanceSectionRatingPVO — PVO Human Capital Management"
...
Extrai as avaliações por seção do documento de performance, incluindo ratings de participantes e critérios por template. Suporta análise detalhada de competências e objetivos avaliados.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmPerformanceDocsAM.PerformanceSectionRatingPVO`
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | EvalParticipantEOQuestionnaireId | QUESTIONNAIRE_ID | — | — |
| 2 | EvalParticipantPEOBusinessGroupId | BUSINESS_GROUP_ID | — | — |
| 3 | EvalParticipantPEOEvalParticipantId | EVAL_PARTICIPANT_ID | — | — |
| 4 | EvalParticipantPEOEvalRoleId | EVAL_ROLE_ID | — | — |
| 5 | EvalParticipantPEOEvaluationId | EVALUATION_ID | — | — |
| 6 | EvalParticipantPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 7 | EvalParticipantPEOParticipationStatusCode | PARTICIPATION_STATUS_CODE | — | — |
| 8 | EvalParticipantPEOPersonId | PERSON_ID | — | — |
...
| 8 | EvalRatingPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 9 | EvalRatingPEOPerformanceRatingId | PERFORMANCE_RATING_ID | — | — |
| 10 | EvalRatingPEOProficiencyRatingId | PROFICIENCY_RATING_ID | — | — |
| 11 | EvalRatingPEOReferenceId | REFERENCE_ID | — | — |
| 12 | EvalRatingPEOReferenceType | REFERENCE_TYPE | — | — |
| 13 | EvalRatingPEOReviewPoints | REVIEW_POINTS | — | — |
| 14 | EvalRatingPEORoleTypeCode | ROLE_TYPE_CODE | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | TemplateDefnBPEOBusinessGroupId4 | BUSINESS_GROUP_ID | — | — |
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | RatingLevelBPEOBusinessGroupId5 | BUSINESS_GROUP_ID | — | — |
