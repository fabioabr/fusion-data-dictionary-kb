---
id: DOC-HCM-PVO-DepartmentPVO
doc_type: system-doc
title: "DepartmentPVO — PVO Human Capital Management"
...
Disponibiliza departamentos com classificacao organizacional, set ID e vigencia. Fundamental para estrutura organizacional e hierarquia departamental no HCM.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.DepartmentPVO`
