---
id: DOC-HCM-PVO-JobPVO
doc_type: system-doc
title: "JobPVO — PVO Human Capital Management"
...
Disponibiliza cadastro completo de cargos com avaliação, set ID e job benchmark. Fundamental para arquitetura de cargos e remuneração.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.JobAM.JobPVO`
...
- [[per_jobs_f|PER_JOBS_F]] — 40 atributos (2 PKs, 25 BICC)
- [[per_jobs_f_tl|PER_JOBS_F_TL]] — 24 atributos (10 BICC)
- [[per_job_evaluations|PER_JOB_EVALUATIONS]] — 18 atributos (13 BICC)
