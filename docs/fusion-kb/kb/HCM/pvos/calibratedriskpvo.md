---
id: DOC-HCM-PVO-CalibratedRiskPVO
doc_type: system-doc
title: "CalibratedRiskPVO — PVO Human Capital Management"
...
Extrai avaliacoes de risco de perda (flight risk) calibradas por perfil. Suporta estrategias de retencao baseadas em sessoes de calibracao.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.CalibratedRiskPVO`
