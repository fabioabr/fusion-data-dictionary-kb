---
id: DOC-HCM-PVO-OfferPVO
doc_type: system-doc
title: "OfferPVO — PVO Human Capital Management"
...
Consolida ofertas de emprego do módulo de recrutamento com dados do candidato, status de aceitação e descrição da vaga. Visão central do processo de proposta e contratação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecHiringOffersAM.OfferPVO`
...
- [[irc_descriptions_tl|IRC_DESCRIPTIONS_TL]] — 3 atributos
- [[irc_offers|IRC_OFFERS]] — 44 atributos (1 PKs, 31 BICC)
- [[per_all_people_f|PER_ALL_PEOPLE_F]] — 105 atributos (2 BICC)
...
|---|----------|--------|----|------|
| 1 | DescriptionTranslationPEODescriptionId | DESCRIPTION_ID | — | — |
| 2 | DescriptionTranslationPEOLanguage | LANGUAGE | — | — |
| 3 | DescriptionTranslationPEOName | NAME | — | — |
...
| 2 | AcceptedOnBehalf | ACCEPTED_ON_BEHALF | — | ✅ |
| 3 | AcceptedOnBehalfById | ACCEPTED_ON_BEHALF_BY_ID | — | ✅ |
| 4 | AcceptedOnBehalfDate | ACCEPTED_ON_BEHALF_DATE | — | ✅ |
| 5 | ApprovedDate | APPROVED_DATE | — | ✅ |
| 6 | AssignmentOfferId | ASSIGNMENT_OFFER_ID | — | ✅ |
| 7 | Comments | COMMENTS | — | ✅ |
| 8 | CreatedBy | CREATED_BY | — | ✅ |
| 9 | CreationDate | CREATION_DATE | — | ✅ |
| 10 | Description | DESCRIPTION | — | ✅ |
| 11 | EsignatureInstructions | ESIGNATURE_INSTRUCTIONS | — | ✅ |
| 12 | ExpirationDate | EXPIRATION_DATE | — | ✅ |
| 13 | ExtendedDate | EXTENDED_DATE | — | ✅ |
| 14 | HandoffHrScenarioId | HANDOFF_HR_SCENARIO_ID | — | ✅ |
| 15 | HiringManagerId | HIRING_MANAGER_ID | — | ✅ |
| 16 | LastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 17 | LastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 18 | LastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 19 | ManagerAssignmentId | MANAGER_ASSIGNMENT_ID | — | ✅ |
| 20 | ObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 21 | OfferId | OFFER_ID | 🔑 | ✅ |
| 22 | OfferName | OFFER_NAME | — | ✅ |
| 23 | OffersPEOAdditionaltext1 | ADDITIONALTEXT1 | — | ✅ |
| 24 | OffersPEOAdditionaltext2 | ADDITIONALTEXT2 | — | ✅ |
| 25 | OffersPEOBatchCreationFlag | BATCH_CREATION_FLAG | — | — |
| 26 | OffersPEOBypassOfferLcFlag | BYPASS_OFFER_LC_FLAG | — | — |
| 27 | OffersPEODraftedDate | DRAFTED_DATE | — | — |
| 28 | OffersPEOMergedFlag | MERGED_FLAG | — | — |
| 29 | OffersPEOMoveToHrDate | MOVE_TO_HR_DATE | — | — |
| 30 | OffersPEOObjectStatus | OBJECT_STATUS | — | — |
| 31 | OffersPEOOfferLetterCustomizedFlag | OFFER_LETTER_CUSTOMIZED_FLAG | — | ✅ |
| 32 | OffersPEOOfferLetterLayoutId | OFFER_LETTER_LAYOUT_ID | — | — |
| 33 | OffersPEOParentOfferId | PARENT_OFFER_ID | — | — |
| 34 | OffersPEOStartDateChangedFlag | START_DATE_CHANGED_FLAG | — | — |
| 35 | OffersPEOStatePostProcessStatus | STATE_POST_PROCESS_STATUS | — | — |
| 36 | ParentOffersPEOOfferId | OFFER_ID | — | — |
| 37 | ParentOffersPEOOfferName | OFFER_NAME | — | — |
| 38 | PersonId | PERSON_ID | — | ✅ |
| 39 | PreselectedHrActionId | PRESELECTED_HR_ACTION_ID | — | ✅ |
| 40 | PreselectedHrActiontypeCode | PRESELECTED_HR_ACTIONTYPE_CODE | — | — |
| 41 | RecruiterAssignmentId | RECRUITER_ASSIGNMENT_ID | — | ✅ |
| 42 | RecruiterId | RECRUITER_ID | — | ✅ |
| 43 | SubmissionId | SUBMISSION_ID | — | ✅ |
| 44 | WithdrawnRejectedDate | WITHDRAWN_REJECTED_DATE | — | ✅ |
