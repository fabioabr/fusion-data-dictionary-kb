---
id: DOC-HCM-PVO-InputValuePVO
doc_type: system-doc
title: "InputValuePVO — PVO Human Capital Management"
...
Disponibiliza valores de entrada de elementos de folha para análise, incluindo valor default. Suporta configuração e auditoria de parâmetros de payroll.
