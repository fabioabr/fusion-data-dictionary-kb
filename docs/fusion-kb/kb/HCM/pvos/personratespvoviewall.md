---
id: DOC-HCM-PVO-PersonRatesPVOViewAll
doc_type: system-doc
title: "PersonRatesPVOViewAll — PVO Human Capital Management"
...
Versão ViewAll das taxas de compensação, sem restrições de segurança. Inclui flags de elegibilidade e conversão cambial para análise consolidada de remuneração.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.CompensationAM.PersonRatesPVOViewAll`
...
- [[cmp_cwb_person_rates|CMP_CWB_PERSON_RATES]] — 41 atributos (2 PKs, 28 BICC)
- [[cmp_cwb_xchg|CMP_CWB_XCHG]] — 4 atributos (1 BICC)
