---
id: DOC-HCM-PVO-CalibratedRiskPVO_Viewall
doc_type: system-doc
title: "CalibratedRiskPVO_Viewall — PVO Human Capital Management"
...
Versao sem restricao de seguranca do risco de perda calibrado. Permite analise administrativa de risco de turnover pos-calibracao.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.CalibratedRiskPVO_Viewall`
...
- [[hrt_profile_items|HRT_PROFILE_ITEMS]] — 92 atributos (1 PKs, 6 BICC)
