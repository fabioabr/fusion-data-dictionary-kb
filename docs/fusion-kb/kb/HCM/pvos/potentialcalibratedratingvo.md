---
id: DOC-HCM-PVO-PotentialCalibratedRatingVO
doc_type: system-doc
title: "PotentialCalibratedRatingVO — PVO Human Capital Management"
...
Extrai ratings de potencial calibrados em sessões de talent review, vinculando dashboards, reuniões e perfis. Suporta o processo de calibração de talentos e decisões de desenvolvimento.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.PotentialCalibratedRatingVO`
