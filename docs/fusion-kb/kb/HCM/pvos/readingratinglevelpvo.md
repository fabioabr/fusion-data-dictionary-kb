---
id: DOC-HCM-PVO-ReadingRatingLevelPVO
doc_type: system-doc
title: "ReadingRatingLevelPVO — PVO Human Capital Management"
...
Disponibiliza níveis de avaliação de leitura (idiomas) vinculados a conteúdos e seções de perfil. Suporta avaliação de proficiência linguística em leitura.
