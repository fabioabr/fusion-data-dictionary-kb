---
id: DOC-HCM-PVO-RiskOfLossCalibRatingPVO
doc_type: system-doc
title: "RiskOfLossCalibRatingPVO — PVO Human Capital Management"
...
Extrai avaliações de risco de perda em reuniões de calibração de talentos. Suporta identificação de colaboradores em risco de desligamento para retenção.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.RiskOfLossCalibRatingPVO`
