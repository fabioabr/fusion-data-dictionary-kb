---
id: DOC-HCM-PVO-Person
doc_type: system-doc
title: "Person — PVO Human Capital Management"
...
Extrai dados cadastrais de pessoas (parties) do Oracle Fusion, incluindo perfil pessoal e informações de conversão de moeda. Utilizado como referência cruzada entre módulos HCM e financeiros.
