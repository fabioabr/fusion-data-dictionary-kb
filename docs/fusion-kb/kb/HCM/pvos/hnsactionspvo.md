---
id: DOC-HCM-PVO-HNSActionsPVO
doc_type: system-doc
title: "HNSActionsPVO — PVO Human Capital Management"
...
Disponibiliza ações corretivas de incidentes de saúde e segurança com datas, responsáveis e status. Fundamental para gestão de planos de ação de SST.
