---
id: DOC-HCM-PVO-PayrollStatutoryUnitPVO
doc_type: system-doc
title: "PayrollStatutoryUnitPVO — PVO Human Capital Management"
...
Disponibiliza unidades estatutárias de folha de pagamento (PSU) com classificações e legislação aplicável. Define a entidade legal responsável por obrigações trabalhistas e fiscais.
