---
id: DOC-HCM-PVO-SubmissionViewAllPVO
doc_type: system-doc
title: "SubmissionViewAllPVO — PVO Human Capital Management"
...
Extrai todas as submissões de candidatos sem restrição de segurança. Visão completa para relatórios analíticos do funil de recrutamento e contratação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecSubmissionsAM.SubmissionViewAllPVO`
