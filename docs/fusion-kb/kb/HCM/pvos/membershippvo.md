---
id: DOC-HCM-PVO-MembershipPVO
doc_type: system-doc
title: "MembershipPVO — PVO Human Capital Management"
...
Consolida associações entre perfis e itens de conteúdo (competências, habilidades) com tipos e traduções. Visão completa das qualificações vinculadas a perfis de cargo ou pessoa.
