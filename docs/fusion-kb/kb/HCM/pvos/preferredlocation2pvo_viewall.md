---
id: DOC-HCM-PVO-PreferredLocation2PVO_Viewall
doc_type: system-doc
title: "PreferredLocation2PVO_Viewall — PVO Human Capital Management"
...
Versão ViewAll da segunda localização preferida, sem filtros de segurança. Permite análise consolidada de segundas opções de localidade para planejamento de workforce.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PreferredLocation2PVO_Viewall`
