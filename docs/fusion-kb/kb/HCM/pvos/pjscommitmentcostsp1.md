---
id: DOC-HCM-PVO-PjsCommitmentCostsP1
doc_type: system-doc
title: "PjsCommitmentCostsP1 — PVO Human Capital Management"
...
Extrai custos comprometidos (commitments) de projetos por período, incluindo ordens de compra e contratos pendentes. Suporta projeção de gastos e gestão de fluxo de caixa de projetos.
