---
id: DOC-HCM-PVO-ManagerHrchyBottomUpPVOLineManager
doc_type: system-doc
title: "ManagerHrchyBottomUpPVOLineManager — PVO Human Capital Management"
...
Consolida hierarquia gerencial bottom-up com dados pessoais (nome, e-mail) em até 10 níveis. Permite navegação ascendente na cadeia de comando e identificação de gestores superiores.
