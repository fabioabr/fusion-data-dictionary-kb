---
id: DOC-HCM-PVO-ProposalProjectsPVO
doc_type: system-doc
title: "ProposalProjectsPVO — PVO Human Capital Management"
...
Extrai projetos associados a propostas de produto, com dados de negócio e custos. Vincula iniciativas de inovação a projetos de execução no portfólio.

**Caminho:** `FscmTopModelAM.ConceptsAnalyticsAM.ProposalProjectsPVO`
...
- [[acd_product_proposal|ACD_PRODUCT_PROPOSAL]] — 18 atributos (18 BICC)
- [[acd_prop_proj_v|ACD_PROP_PROJ_V]] — 2 atributos (2 PKs, 2 BICC)
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ConceptranslationConceptId | CONCEPT_ID | — | ✅ |
| 2 | ConceptranslationCreatedBy | CREATED_BY | — | ✅ |
| 3 | ConceptranslationCreationDate | CREATION_DATE | — | ✅ |
| 4 | ConceptranslationDescription | DESCRIPTION | — | — |
| 5 | ConceptranslationLanguage | LANGUAGE | — | ✅ |
| 6 | ConceptranslationLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 7 | ConceptranslationLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 8 | ConceptranslationLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 9 | ConceptranslationName | NAME | — | ✅ |
| 10 | ConceptranslationObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 11 | ConceptranslationSourceLang | SOURCE_LANG | — | ✅ |
...
| 8 | ProposalLastConceptVersion | LAST_CONCEPT_VERSION | — | ✅ |
| 9 | ProposalLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 10 | ProposalLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 11 | ProposalLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 12 | ProposalObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 13 | ProposalProductProposalId | PRODUCT_PROPOSAL_ID | — | ✅ |
| 14 | ProposalProposalStatus | PROPOSAL_STATUS | — | ✅ |
| 15 | ProposalProposalType | PROPOSAL_TYPE | — | ✅ |
| 16 | ProposalPublishedFromPortfolio | PUBLISHED_FROM_PORTFOLIO | — | ✅ |
| 17 | ProposalSrcProductProposalId | SRC_PRODUCT_PROPOSAL_ID | — | ✅ |
| 18 | ProposalVersion | VERSION | — | ✅ |

### [[acd_prop_proj_v|ACD_PROP_PROJ_V]]

| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ProposalProjectsProjectId | PROJECT_ID | 🔑 | ✅ |
| 2 | ProposalProjectsProposalId | PROPOSAL_ID | 🔑 | ✅ |
