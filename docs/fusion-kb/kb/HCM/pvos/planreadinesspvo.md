---
id: DOC-HCM-PVO-PlanReadinessPVO
doc_type: system-doc
title: "PlanReadinessPVO — PVO Human Capital Management"
...
Extrai avaliações de prontidão (readiness) dos candidatos a sucessão, com níveis de rating e seções de perfil. Suporta análise de maturidade dos sucessores para posições-chave.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PlanReadinessPVO`
...
- [[hrt_bi_adv_readiness_items_v|HRT_BI_ADV_READINESS_ITEMS_V]] — 95 atributos (1 PKs, 92 BICC)
- [[hrt_content_types_b|HRT_CONTENT_TYPES_B]] — 9 atributos (1 PKs, 5 BICC)
- [[hrt_content_types_tl|HRT_CONTENT_TYPES_TL]] — 5 atributos
- [[hrt_profiles_b|HRT_PROFILES_B]] — 9 atributos (8 BICC)
- [[hrt_profile_typ_sections_vl|HRT_PROFILE_TYP_SECTIONS_VL]] — 4 atributos
