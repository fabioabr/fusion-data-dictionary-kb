---
id: DOC-HCM-PVO-HNSIncidentActionReviewerPVO
doc_type: system-doc
title: "HNSIncidentActionReviewerPVO — PVO Human Capital Management"
...
Extrai revisores de ações corretivas de incidentes de SST. Utilizado para gestão de revisão e qualidade de medidas corretivas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HealthandSafetyAM.HNSIncidentActionReviewerPVO`
