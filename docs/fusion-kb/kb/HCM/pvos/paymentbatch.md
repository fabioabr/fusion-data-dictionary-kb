---
id: DOC-HCM-PVO-PaymentBatch
doc_type: system-doc
title: "PaymentBatch — PVO Human Capital Management"
...
Extrai lotes de pagamento de incentivos (Incentive Compensation) com grupos, períodos e status. Suporta gestão de ciclos de pagamento de comissões e bonificações variáveis.
