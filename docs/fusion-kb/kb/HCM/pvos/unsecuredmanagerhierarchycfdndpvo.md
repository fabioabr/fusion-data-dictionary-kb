---
id: DOC-HCM-PVO-UnsecuredManagerHierarchyCFDNDPVO
doc_type: system-doc
title: "UnsecuredManagerHierarchyCFDNDPVO — PVO Human Capital Management"
...
Disponibiliza hierarquia gerencial denormalizada com até 15 níveis de subordinação. Visão não segura para análise de span of control e cadeia de reporte.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.ManagerHierarchyAM.UnsecuredManagerHierarchyCFDNDPVO`
...
- [[per_manager_hrchy_reportees_dn|PER_MANAGER_HRCHY_REPORTEES_DN]] — 75 atributos (4 PKs, 35 BICC)
