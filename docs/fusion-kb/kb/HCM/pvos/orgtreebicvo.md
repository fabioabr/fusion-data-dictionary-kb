---
id: DOC-HCM-PVO-OrgTreeBICVO
doc_type: system-doc
title: "OrgTreeBICVO — PVO Human Capital Management"
...
Extrai árvores organizacionais (Organization Trees) com versões e nós hierárquicos para BI. Fundamental para construção de hierarquias dimensionais de departamentos no data warehouse.
