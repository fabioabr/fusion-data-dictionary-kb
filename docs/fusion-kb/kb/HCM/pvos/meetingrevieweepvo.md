---
id: DOC-HCM-PVO-MeetingRevieweePVO
doc_type: system-doc
title: "MeetingRevieweePVO — PVO Human Capital Management"
...
Disponibiliza os colaboradores avaliados (reviewees) em reuniões de calibração de talentos. Permite identificar quem foi discutido em cada sessão de Talent Review.
