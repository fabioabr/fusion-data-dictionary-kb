---
id: DOC-HCM-PVO-TalentScoreBoxSequencePVO_Viewall
doc_type: system-doc
title: "TalentScoreBoxSequencePVO_Viewall — PVO Human Capital Management"
...
Visão completa da sequência de caixas da matriz de talentos, sem restrição de segurança. Utilizada para análise abrangente de posicionamento na grade de talento.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.TalentScoreBoxSequencePVO_Viewall`
...
- [[hrr_tmpl_analytic_types_b|HRR_TMPL_ANALYTIC_TYPES_B]] — 8 atributos (1 PKs, 1 BICC)
- [[hrt_content_items_b|HRT_CONTENT_ITEMS_B]] — 4 atributos (1 PKs, 1 BICC)
- [[hrt_content_types_b|HRT_CONTENT_TYPES_B]] — 5 atributos (1 PKs, 1 BICC)
- [[hrt_profiles_b|HRT_PROFILES_B]] — 14 atributos (3 PKs, 4 BICC)
- [[hrt_profile_items|HRT_PROFILE_ITEMS]] — 6 atributos (2 PKs, 3 BICC)
