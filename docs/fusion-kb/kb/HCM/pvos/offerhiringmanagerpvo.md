---
id: DOC-HCM-PVO-OfferHiringManagerPVO
doc_type: system-doc
title: "OfferHiringManagerPVO — PVO Human Capital Management"
...
Extrai gestores de contratação (hiring managers) vinculados a ofertas de emprego. Identifica o responsável pela decisão de contratação em cada proposta do processo seletivo.
