---
id: DOC-HCM-PVO-CandidateInteractionPVO
doc_type: system-doc
title: "CandidateInteractionPVO — PVO Human Capital Management"
...
Consolida interacoes com candidatos incluindo tipo de contexto, pessoa responsavel e dados de contato. Suporta historico completo de relacionamento com candidatos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecruitingCommonAM.CandidateInteractionPVO`
...
- [[irc_interactions|IRC_INTERACTIONS]] — 15 atributos (1 PKs, 8 BICC)
...
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 124 atributos (8 BICC)
