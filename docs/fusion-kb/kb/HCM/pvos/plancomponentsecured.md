---
id: DOC-HCM-PVO-PlanComponentSecured
doc_type: system-doc
title: "PlanComponentSecured — PVO Human Capital Management"
...
Extrai componentes de plano de incentivos com filtro de segurança por business unit. Versão restrita para acesso controlado a dados de compensação de incentivos.

**Caminho:** `FscmTopModelAM.CompensationPlanAM.PlanComponentSecured`
