---
id: DOC-HCM-PVO-SpeakingRatingLevelPVO
doc_type: system-doc
title: "SpeakingRatingLevelPVO — PVO Human Capital Management"
...
Extrai níveis de avaliação de fala (idiomas) vinculados a conteúdos e perfis. Suporta avaliação de proficiência linguística oral no Talent Profile.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileSetupAM.SpeakingRatingLevelPVO`
