---
id: DOC-HCM-PVO-OriginalSystemReference
doc_type: system-doc
title: "OriginalSystemReference — PVO Human Capital Management"
...
Disponibiliza referências de sistemas de origem (legados) para entidades do TCA. Essencial para rastreabilidade de migração e reconciliação entre sistemas fonte e Oracle Fusion.
