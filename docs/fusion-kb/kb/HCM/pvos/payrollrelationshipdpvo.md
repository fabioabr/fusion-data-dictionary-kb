---
id: DOC-HCM-PVO-PayrollRelationshipDPVO
doc_type: system-doc
title: "PayrollRelationshipDPVO — PVO Human Capital Management"
...
Disponibiliza relacionamentos de folha de pagamento desnormalizados com vigência temporal. Conecta pessoas a payrolls específicos para controle de processamento e histórico de vínculo.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmPayRegsAM.PayrollRelationshipDPVO`
...
- [[pay_pay_relationships_f|PAY_PAY_RELATIONSHIPS_F]] — 76 atributos (4 BICC)
...
| 4 | PayrollRelationshipPEOLastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 5 | PayrollRelationshipPEOLastUpdateLogin | LAST_UPDATE_LOGIN | — | — |
| 6 | PayrollRelationshipPEOLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 7 | PayrollRelationshipPEOLegislativeDataGroupId | LEGISLATIVE_DATA_GROUP_ID | — | ✅ |
| 8 | PayrollRelationshipPEOObjectVersionNumber | OBJECT_VERSION_NUMBER | — | — |
| 9 | PayrollRelationshipPEOPayrollRelationshipId | PAYROLL_RELATIONSHIP_ID | 🔑 | ✅ |
...
| 10 | PayrollRelationshipDPEOPayrollRelationshipId | PAYROLL_RELATIONSHIP_ID | — | — |
