---
id: DOC-HCM-PVO-PreferredLocation4PVO_Viewall
doc_type: system-doc
title: "PreferredLocation4PVO_Viewall — PVO Human Capital Management"
...
Versão ViewAll da quarta localização preferida, sem filtros de segurança. Completa o conjunto de preferências de localidade para analytics de mobilidade global.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PreferredLocation4PVO_Viewall`
