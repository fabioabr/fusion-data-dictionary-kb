---
id: DOC-HCM-PVO-TimeRecordGroupPVO
doc_type: system-doc
title: "TimeRecordGroupPVO — PVO Human Capital Management"
...
Disponibiliza grupos de registros de tempo com versões e status de commit. Organiza entradas de ponto em conjuntos lógicos para processamento de jornada.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.TimeRecordGroupPVO`
