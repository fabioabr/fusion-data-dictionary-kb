---
id: DOC-HCM-PVO-EventAssignmentDestinationPVO
doc_type: system-doc
title: "EventAssignmentDestinationPVO — PVO Human Capital Management"
...
Extrai destinos de atribuições de eventos de aprendizagem, incluindo relatórios BI vinculados. Suporta configuração de notificações e outputs de treinamento.
