---
id: DOC-HCM-PVO-PersonProfileItemPVO
doc_type: system-doc
title: "PersonProfileItemPVO — PVO Human Capital Management"
...
Extrai itens do perfil de talento dos colaboradores (competências, certificações, formações), com tipo de conteúdo e traduções. Central para talent management e gap analysis.
