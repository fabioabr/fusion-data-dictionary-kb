---
id: DOC-HCM-PVO-LocationAddressUsagePVO
doc_type: system-doc
title: "LocationAddressUsagePVO — PVO Human Capital Management"
...
Extrai usos de endereço de localização (principal, correspondência, entrega) com vigência. Suporta gestão multi-endereço de locais de trabalho.
