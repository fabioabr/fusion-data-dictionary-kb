---
id: DOC-HCM-PVO-PerformanceGoalPVOViewAll
doc_type: system-doc
title: "PerformanceGoalPVOViewAll — PVO Human Capital Management"
...
Versão sem restrição de segurança das metas de desempenho com alinhamentos e medições. Permite visão administrativa para auditoria e consolidação de objetivos em toda a organização.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmGoalCoreAM.PerformanceGoalPVOViewAll`
