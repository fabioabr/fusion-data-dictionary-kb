---
id: DOC-HCM-PVO-MeetingPVO
doc_type: system-doc
title: "MeetingPVO — PVO Human Capital Management"
...
Extrai o cadastro de reuniões de calibração de talentos com templates de dashboard associados. Base dimensional para rastreamento de sessões de Talent Review e calibração de performance.
