---
id: DOC-HCM-PVO-RatingLevelSecondPVO
doc_type: system-doc
title: "RatingLevelSecondPVO — PVO Human Capital Management"
...
Extrai segundo conjunto de níveis de avaliação com traduções. Utilizado quando múltiplas escalas de rating são necessárias em perfis de competência.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileContentLibraryAM.RatingLevelSecondPVO`
...
- [[hrt_rating_levels_b|HRT_RATING_LEVELS_B]] — 21 atributos (2 PKs, 21 BICC)
- [[hrt_rating_levels_tl|HRT_RATING_LEVELS_TL]] — 8 atributos (1 PKs, 7 BICC)
