---
id: DOC-HCM-PVO-GoalPlanP1
doc_type: system-doc
title: "GoalPlanP1 — PVO Human Capital Management"
...
Disponibiliza planos de metas com configurações (auto-associação, departamentos, flags). Utilizado para definição e administração de ciclos de objetivos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmGoalCoreAM.GoalPlanP1`
...
- [[hrg_goal_plans_b|HRG_GOAL_PLANS_B]] — 30 atributos (1 PKs, 27 BICC)
- [[hrg_goal_plans_tl|HRG_GOAL_PLANS_TL]] — 12 atributos
