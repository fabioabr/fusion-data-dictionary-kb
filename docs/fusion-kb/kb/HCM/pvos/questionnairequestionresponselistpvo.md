---
id: DOC-HCM-PVO-QuestionnaireQuestionResponseListPVO
doc_type: system-doc
title: "QuestionnaireQuestionResponseListPVO — PVO Human Capital Management"
...
Extrai listas de respostas disponíveis para perguntas de questionários. Define as opções de resposta (texto curto, longo) vinculadas a cada pergunta.
