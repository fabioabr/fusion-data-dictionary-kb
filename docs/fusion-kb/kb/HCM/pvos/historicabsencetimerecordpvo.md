---
id: DOC-HCM-PVO-HistoricAbsenceTimeRecordPVO
doc_type: system-doc
title: "HistoricAbsenceTimeRecordPVO — PVO Human Capital Management"
...
Extrai registros históricos de alterações em ausências no time repository. Utilizado para auditoria de mudanças em registros de absenteísmo.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.HistoricAbsenceTimeRecordPVO`
...
- [[hwm_tm_his_abs_entry_v|HWM_TM_HIS_ABS_ENTRY_V]] — 14 atributos (3 PKs, 14 BICC)

---

## ⚙️ Atributos

### [[hwm_tm_his_abs_entry_v|HWM_TM_HIS_ABS_ENTRY_V]]
