---
id: DOC-HCM-PVO-PerformanceGoalVersionPVO
doc_type: system-doc
title: "PerformanceGoalVersionPVO — PVO Human Capital Management"
...
Extrai versões históricas de metas de desempenho com alinhamentos e medições. Permite rastreabilidade de alterações em objetivos ao longo do ciclo de performance management.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmGoalCoreAM.PerformanceGoalVersionPVO`
