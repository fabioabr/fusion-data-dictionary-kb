---
id: DOC-HCM-PVO-RequisitionAttachmentPVO
doc_type: system-doc
title: "RequisitionAttachmentPVO — PVO Human Capital Management"
...
Disponibiliza anexos vinculados a requisições de recrutamento, com nomes de arquivo. Suporta gestão documental do processo de contratação.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecruitingCommonAM.RequisitionAttachmentPVO`
...
- [[fnd_documents_vl|FND_DOCUMENTS_VL]] — 31 atributos (3 BICC)
