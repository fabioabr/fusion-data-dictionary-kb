---
id: DOC-HCM-PVO-QuestionnaireQuestionResponsePVO
doc_type: system-doc
title: "QuestionnaireQuestionResponsePVO — PVO Human Capital Management"
...
Disponibiliza respostas individuais a perguntas de questionários, com participantes e tentativas. Suporta análise detalhada de resultados de pesquisas e avaliações.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.QuestionnaireAM.QuestionnaireQuestionResponsePVO`
...
- [[hrq_all_qstn_responses_v|HRQ_ALL_QSTN_RESPONSES_V]] — 8 atributos (4 PKs, 6 BICC)
- [[hrq_qstnr_participants|HRQ_QSTNR_PARTICIPANTS]] — 16 atributos (2 PKs, 4 BICC)
- [[hrq_qstnr_responses|HRQ_QSTNR_RESPONSES]] — 15 atributos (2 PKs, 7 BICC)
- [[hrq_qstn_responses|HRQ_QSTN_RESPONSES]] — 17 atributos (1 PKs, 2 BICC)
