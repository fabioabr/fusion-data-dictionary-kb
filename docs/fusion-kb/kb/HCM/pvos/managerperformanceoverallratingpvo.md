---
id: DOC-HCM-PVO-ManagerPerformanceOverallRatingPVO
doc_type: system-doc
title: "ManagerPerformanceOverallRatingPVO — PVO Human Capital Management"
...
Extrai avaliações de desempenho consolidadas sob a visão do gestor, incluindo ratings por seção e participante. Suporta revisão gerencial de performance e calibração de notas.
