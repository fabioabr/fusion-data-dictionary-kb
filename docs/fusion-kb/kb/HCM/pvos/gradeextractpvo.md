---
id: DOC-HCM-PVO-GradeExtractPVO
doc_type: system-doc
title: "GradeExtractPVO — PVO Human Capital Management"
...
Extrai grades salariais com vigência, status e atributos flexíveis. Fundamental para estruturação de tabelas salariais e bandas de remuneração.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HCMExtractAM.GradeBiccExtractAM.GradeExtractPVO`
...
- [[per_grades_f|PER_GRADES_F]] — 83 atributos (3 PKs, 18 BICC)
...
| 69 | CeilingStepId | CEILING_STEP_ID | — | ✅ |
...
| 74 | GradeCode | GRADE_CODE | — | ✅ |
| 75 | GradeId | GRADE_ID | 🔑 | ✅ |
| 76 | GradeType | GRADE_TYPE | — | ✅ |
...
| 81 | PayScaleId | PAY_SCALE_ID | — | ✅ |
| 82 | SetId | SET_ID | — | ✅ |
| 83 | StartingStep | STARTING_STEP | — | ✅ |
