---
id: DOC-HCM-PVO-LineMgrHierarchyCfDnPVO
doc_type: system-doc
title: "LineMgrHierarchyCfDnPVO — PVO Human Capital Management"
...
Disponibiliza hierarquia denormalizada de gestores de linha para compensação. Utilizado para delegação de autoridade e aprovação de remuneração.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.CompensationAM.LineMgrHierarchyCfDnPVO`
...
- [[cmp_cwb_hrchy_cf_dn|CMP_CWB_HRCHY_CF_DN]] — 41 atributos (1 PKs, 32 BICC)
