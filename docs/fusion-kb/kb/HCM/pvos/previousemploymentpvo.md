---
id: DOC-HCM-PVO-PreviousEmploymentPVO
doc_type: system-doc
title: "PreviousEmploymentPVO — PVO Human Capital Management"
...
Extrai itens de emprego anterior vinculados ao perfil de talento, com descrições e traduções de tipo de conteúdo. Complementa a visão de background profissional do colaborador.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PreviousEmploymentPVO`
...
- [[hrt_profile_items|HRT_PROFILE_ITEMS]] — 95 atributos (1 PKs, 34 BICC)
