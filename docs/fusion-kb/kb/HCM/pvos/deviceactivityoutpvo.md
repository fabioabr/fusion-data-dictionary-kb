---
id: DOC-HCM-PVO-DeviceActivityOutPVO
doc_type: system-doc
title: "DeviceActivityOutPVO — PVO Human Capital Management"
...
Extrai registros de saída de atividade via dispositivo de ponto, com dados do colaborador e timestamp. Utilizado para controle de jornada e marcações de saída.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.DeviceActivityOutPVO`
