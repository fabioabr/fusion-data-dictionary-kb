---
id: DOC-HCM-PVO-SrpPayGroup
doc_type: system-doc
title: "SrpPayGroup — PVO Human Capital Management"
...
Disponibiliza grupos de pagamento de participantes de incentivos (Sales Compensation). Vincula representantes a planos de comissão com datas e status de ativação.
