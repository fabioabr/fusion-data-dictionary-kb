---
id: DOC-HCM-PVO-TalentScoreBoxSequencePVO
doc_type: system-doc
title: "TalentScoreBoxSequencePVO — PVO Human Capital Management"
...
Disponibiliza sequência de caixas da matriz de talentos com itens de perfil e conteúdo. Mapeia posicionamento de colaboradores na grade de talento (9-box).

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.TalentScoreBoxSequencePVO`
