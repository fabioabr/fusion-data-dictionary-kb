---
id: DOC-HCM-PVO-GoalVersionStatusOverviewPVO
doc_type: system-doc
title: "GoalVersionStatusOverviewPVO — PVO Human Capital Management"
...
Visão versionada de status de metas com planos e medições. Permite comparação temporal de progresso de objetivos entre versões.
