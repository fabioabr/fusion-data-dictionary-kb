---
id: DOC-HCM-PVO-ManagerBudgetsForTopMgrPVO
doc_type: system-doc
title: "ManagerBudgetsForTopMgrPVO — PVO Human Capital Management"
...
Extrai orçamentos de compensação alocados para gestores de topo no processo de Compensation Workbench. Suporta análise de distribuição orçamentária e governança de remuneração.
