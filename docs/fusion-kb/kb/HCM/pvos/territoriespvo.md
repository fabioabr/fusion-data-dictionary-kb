---
id: DOC-HCM-PVO-TerritoriesPVO
doc_type: system-doc
title: "TerritoriesPVO — PVO Human Capital Management"
...
Extrai territórios (países e regiões) com códigos e traduções. Referência geográfica utilizada em endereços, legislações e configurações regionais do HCM.
