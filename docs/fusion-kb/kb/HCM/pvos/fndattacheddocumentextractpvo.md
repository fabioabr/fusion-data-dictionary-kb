---
id: DOC-HCM-PVO-FndAttachedDocumentExtractPVO
doc_type: system-doc
title: "FndAttachedDocumentExtractPVO — PVO Human Capital Management"
...
Extrai documentos anexados a registros HCM (PDFs, imagens, comprovantes). Suporta gestão documental e compliance de anexos em processos de RH.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HCMExtractAM.CommonBiccExtractAM.FndAttachedDocumentExtractPVO`
...
- [[fnd_attached_documents|FND_ATTACHED_DOCUMENTS]] — 154 atributos (2 PKs, 24 BICC)
...
| 137 | EnterpriseId | ENTERPRISE_ID | 🔑 | ✅ |
| 138 | EntityAttributes | ENTITY_ATTRIBUTES | — | ✅ |
| 139 | EntityName | ENTITY_NAME | — | ✅ |
| 140 | ExpirationDate | EXPIRATION_DATE | — | ✅ |
| 141 | LastUpdateDate | LAST_UPDATE_DATE | — | ✅ |
| 142 | LastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 143 | LastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 144 | Pk1Value | PK1_VALUE | — | ✅ |
| 145 | Pk2Value | PK2_VALUE | — | ✅ |
| 146 | Pk3Value | PK3_VALUE | — | ✅ |
| 147 | Pk4Value | PK4_VALUE | — | ✅ |
| 148 | Pk5Value | PK5_VALUE | — | ✅ |
| 149 | PrimaryCategoryFlag | PRIMARY_CATEGORY_FLAG | — | ✅ |
| 150 | ProgramApplicationId | PROGRAM_APPLICATION_ID | — | ✅ |
| 151 | ProgramId | PROGRAM_ID | — | ✅ |
| 152 | ProgramUpdateDate | PROGRAM_UPDATE_DATE | — | ✅ |
