---
id: DOC-HCM-PVO-ReportingEstablishmentPVO
doc_type: system-doc
title: "ReportingEstablishmentPVO — PVO Human Capital Management"
...
Disponibiliza estabelecimentos de reporte (unidades organizacionais classificadas) com vigência. Suporta estrutura legal e regulatória para declarações trabalhistas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.ReportingEstablishmentPVO`
...
- [[hr_all_organization_units_f|HR_ALL_ORGANIZATION_UNITS_F]] — 18 atributos (8 BICC)
