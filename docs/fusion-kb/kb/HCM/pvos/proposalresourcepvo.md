---
id: DOC-HCM-PVO-ProposalResourcePVO
doc_type: system-doc
title: "ProposalResourcePVO — PVO Human Capital Management"
...
Disponibiliza recursos alocados a propostas de produto com custos e detalhes. Fundamental para planejamento de capacidade e orçamento de projetos de inovação.

**Caminho:** `FscmTopModelAM.ConceptsAnalyticsAM.ProposalResourcePVO`
...
- [[acd_resource|ACD_RESOURCE]] — 16 atributos (1 PKs, 15 BICC)
...
| # | Atributo | Coluna | PK | BICC |
|---|----------|--------|----|------|
| 1 | ResourceCreatedBy | CREATED_BY | — | ✅ |
| 2 | ResourceCreationDate | CREATION_DATE | — | ✅ |
| 3 | ResourceEndDate | END_DATE | — | ✅ |
| 4 | ResourceLastUpdateDate | LAST_UPDATE_DATE | — | — |
| 5 | ResourceLastUpdateLogin | LAST_UPDATE_LOGIN | — | ✅ |
| 6 | ResourceLastUpdatedBy | LAST_UPDATED_BY | — | ✅ |
| 7 | ResourceObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 8 | ResourceProductProposalId | PRODUCT_PROPOSAL_ID | — | ✅ |
| 9 | ResourceResourceCategory | RESOURCE_CATEGORY | — | ✅ |
| 10 | ResourceResourceHeadcount | RESOURCE_HEADCOUNT | — | ✅ |
| 11 | ResourceResourceId | RESOURCE_ID | 🔑 | ✅ |
| 12 | ResourceResourcePool | RESOURCE_POOL | — | ✅ |
| 13 | ResourceResourceStatus | RESOURCE_STATUS | — | ✅ |
| 14 | ResourceResourceTrend | RESOURCE_TREND | — | ✅ |
| 15 | ResourceSource | SOURCE | — | ✅ |
| 16 | ResourceStartDate | START_DATE | — | ✅ |
