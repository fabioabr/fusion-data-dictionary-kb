---
id: DOC-HCM-PVO-PersonNationalIdentifierPVOViewAll
doc_type: system-doc
title: "PersonNationalIdentifierPVOViewAll — PVO Human Capital Management"
...
Versão ViewAll dos documentos de identificação nacional, sem filtros de segurança. Inclui data de expiração para controle de validade de documentos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.PersonNationalIdentifierPVOViewAll`
