---
id: DOC-HCM-PVO-ProcessedTimeEntryPVO
doc_type: system-doc
title: "ProcessedTimeEntryPVO — PVO Human Capital Management"
...
Extrai entradas de tempo processadas (Time and Labor), com status de transferência para payroll e projetos (18 tabelas). Suporta auditoria de horas e integração com folha de pagamento.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.TimeRepositoryAM.ProcessedTimeEntryPVO`
