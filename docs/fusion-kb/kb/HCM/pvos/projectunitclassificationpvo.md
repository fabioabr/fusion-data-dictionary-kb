---
id: DOC-HCM-PVO-ProjectUnitClassificationPVO
doc_type: system-doc
title: "ProjectUnitClassificationPVO — PVO Human Capital Management"
...
Disponibiliza classificações de unidades organizacionais para projetos no HCM. Permite identificar organizações habilitadas para gestão de projetos e alocação de recursos.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.ProjectUnitClassificationPVO`
