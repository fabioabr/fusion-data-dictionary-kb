---
id: DOC-HCM-PVO-PlanComponent
doc_type: system-doc
title: "PlanComponent — PVO Human Capital Management"
...
Extrai componentes de planos de compensação de incentivos (Incentive Compensation), com business unit, contas contábeis e status de aprovação. Base para configuração de comissões e bônus.
