---
id: DOC-HCM-PVO-PerformanceItemRatingPVO
doc_type: system-doc
title: "PerformanceItemRatingPVO — PVO Human Capital Management"
...
Extrai ratings por item individual de avaliação de desempenho (competências, metas) com participantes. Suporta análise granular de notas por critério dentro do documento de performance.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmPerformanceDocsAM.PerformanceItemRatingPVO`
