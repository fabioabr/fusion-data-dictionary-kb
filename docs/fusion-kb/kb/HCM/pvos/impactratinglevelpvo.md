---
id: DOC-HCM-PVO-ImpactRatingLevelPVO
doc_type: system-doc
title: "ImpactRatingLevelPVO — PVO Human Capital Management"
...
Disponibiliza níveis de rating de impacto para perfis de talento, com seções e propriedades. Suporta configuração de escalas de avaliação de potencial.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileSetupAM.ImpactRatingLevelPVO`
