---
id: DOC-HCM-PVO-TaxReportingUnitPVO
doc_type: system-doc
title: "TaxReportingUnitPVO — PVO Human Capital Management"
...
Extrai unidades de reporte fiscal (Tax Reporting Units) com classificações e vigência. Fundamental para conformidade tributária e declarações de folha de pagamento.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.TaxReportingUnitPVO`
