---
id: DOC-HCM-PVO-PreferredLocation3PVO_Viewall
doc_type: system-doc
title: "PreferredLocation3PVO_Viewall — PVO Human Capital Management"
...
Versão ViewAll da terceira localização preferida, sem filtros de segurança. Suporta análise ampla de preferências geográficas para programas de mobilidade global.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PreferredLocation3PVO_Viewall`
