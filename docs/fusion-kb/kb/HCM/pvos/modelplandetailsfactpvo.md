---
id: DOC-HCM-PVO-ModelPlanDetailsFactPVO
doc_type: system-doc
title: "ModelPlanDetailsFactPVO — PVO Human Capital Management"
...
Extrai detalhes de planos de modelagem de workforce incluindo FTE, datas e métricas de atribuição. Suporta simulações de cenários de planejamento de força de trabalho.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.WorkforceModelingAM.ModelPlanDetailsFactPVO`
...
- [[hmo_model_plan_details|HMO_MODEL_PLAN_DETAILS]] — 107 atributos (1 PKs, 71 BICC)
