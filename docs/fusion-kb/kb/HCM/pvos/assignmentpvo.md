---
id: DOC-HCM-PVO-AssignmentPVO
doc_type: system-doc
title: "AssignmentPVO — PVO Human Capital Management"
...
Extrai dados completos de assignment incluindo grade, step, nome e numero. View Object principal para consulta de alocacoes de colaboradores no HCM.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.AssignmentAM.AssignmentPVO`
...
- [[per_all_assignments_m|PER_ALL_ASSIGNMENTS_M]] — 122 atributos (5 PKs, 37 BICC)
