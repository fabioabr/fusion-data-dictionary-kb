---
id: DOC-HCM-PVO-PerformanceGoalVersionPVOViewAll
doc_type: system-doc
title: "PerformanceGoalVersionPVOViewAll — PVO Human Capital Management"
...
Versão sem restrição de segurança das versões históricas de metas de desempenho. Permite auditoria completa da evolução de objetivos e medições em toda a organização.
