---
id: DOC-HCM-PVO-PerformancePotentialBoxSequencePVO
doc_type: system-doc
title: "PerformancePotentialBoxSequencePVO — PVO Human Capital Management"
...
Extrai a sequência de posicionamento na matriz 9-box (performance x potencial) dos colaboradores, vinculando perfis e itens de conteúdo. Suporta análises de talent review e planejamento de sucessão.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PerformancePotentialBoxSequencePVO`
