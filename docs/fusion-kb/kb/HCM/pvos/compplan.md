---
id: DOC-HCM-PVO-CompPlan
doc_type: system-doc
title: "CompPlan — PVO Human Capital Management"
...
Extrai planos de compensacao de incentivos (ICM) com status de aprovacao e unidade de negocio. Suporta gestao de planos de comissao e remuneracao variavel.

**Caminho:** `FscmTopModelAM.CompensationPlanAM.CompPlan`
