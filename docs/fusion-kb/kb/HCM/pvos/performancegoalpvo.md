---
id: DOC-HCM-PVO-PerformanceGoalPVO
doc_type: system-doc
title: "PerformanceGoalPVO — PVO Human Capital Management"
...
Consolida metas de desempenho com alinhamentos, medições e intenções de desenvolvimento. Visão completa de objetivos individuais para análise de progresso e cascateamento de metas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmGoalCoreAM.PerformanceGoalPVO`
...
- [[hrg_goals|HRG_GOALS]] — 65 atributos (1 PKs, 51 BICC)
...
- [[hrg_goal_plan_goals|HRG_GOAL_PLAN_GOALS]] — 9 atributos (4 BICC)
- [[hrt_profiles_tl|HRT_PROFILES_TL]] — 12 atributos
- [[per_person_names_f_v|PER_PERSON_NAMES_F_V]] — 57 atributos (11 BICC)
