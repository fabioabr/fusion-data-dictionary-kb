---
id: DOC-HCM-PVO-PersonTypeUsagesExtractPVO
doc_type: system-doc
title: "PersonTypeUsagesExtractPVO — PVO Human Capital Management"
...
Extrai o histórico de usos de tipo de pessoa para BICC, com vigência, sequência e controle de auditoria. Permite rastreamento completo de mudanças de categoria do trabalhador.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.PersonAM.PersonTypeUsagesExtractPVO`
...
- [[per_person_type_usages_m|PER_PERSON_TYPE_USAGES_M]] — 81 atributos (5 PKs, 15 BICC)
...
| 69 | EffectiveEndDate | EFFECTIVE_END_DATE | 🔑 | ✅ |
| 70 | EffectiveLatestChange | EFFECTIVE_LATEST_CHANGE | 🔑 | ✅ |
| 71 | EffectiveSequence | EFFECTIVE_SEQUENCE | 🔑 | ✅ |
...
| 76 | LegalEntityId | LEGAL_ENTITY_ID | — | ✅ |
| 77 | ObjectVersionNumber | OBJECT_VERSION_NUMBER | — | ✅ |
| 78 | PersonId | PERSON_ID | — | ✅ |
| 79 | PersonTypeId | PERSON_TYPE_ID | — | ✅ |
| 80 | PersonTypeUsageId | PERSON_TYPE_USAGE_ID | 🔑 | ✅ |
| 81 | SystemPersonType | SYSTEM_PERSON_TYPE | — | ✅ |
