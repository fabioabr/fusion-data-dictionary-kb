---
id: DOC-HCM-PVO-HNSIncidentActionPreApproverPVO
doc_type: system-doc
title: "HNSIncidentActionPreApproverPVO — PVO Human Capital Management"
...
Extrai pré-aprovadores de ações corretivas de incidentes de SST. Utilizado para workflow de pré-aprovação de medidas corretivas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HealthandSafetyAM.HNSIncidentActionPreApproverPVO`
