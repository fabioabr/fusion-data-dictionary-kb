---
id: DOC-HCM-PVO-PreferredLocation3PVO
doc_type: system-doc
title: "PreferredLocation3PVO — PVO Human Capital Management"
...
Extrai a terceira localização preferida do colaborador no perfil de talento. Amplia as opções de mobilidade geográfica para matching de oportunidades internas.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.PreferredLocation3PVO`
