---
id: DOC-HCM-PVO-RoutingStepStartActionPVO
doc_type: system-doc
title: "RoutingStepStartActionPVO — PVO Human Capital Management"
...
Disponibiliza ações de início de etapas de roteamento em processos de recrutamento. Define automações disparadas ao iniciar cada fase do fluxo seletivo.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecProcessLifecycleAM.RoutingStepStartActionPVO`
