---
id: DOC-HCM-PVO-PotentialCalibratedRatingVO_ViewAll
doc_type: system-doc
title: "PotentialCalibratedRatingVO_ViewAll — PVO Human Capital Management"
...
Versão ViewAll dos ratings de potencial calibrados, sem filtros de segurança. Permite análise completa das decisões de calibração de talentos em todas as sessões.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmTalentCalibMeetingsAM.PotentialCalibratedRatingVO_ViewAll`
