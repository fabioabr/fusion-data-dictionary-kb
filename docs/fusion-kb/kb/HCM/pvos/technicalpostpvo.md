---
id: DOC-HCM-PVO-TechnicalPostPVO
doc_type: system-doc
title: "TechnicalPostPVO — PVO Human Capital Management"
...
Extrai postos técnicos em perfis de talento com tipos de conteúdo e traduções. Suporta mapeamento de posições técnicas e requisitos de perfil profissional.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.TechnicalPostPVO`
...
- [[hrt_profile_items|HRT_PROFILE_ITEMS]] — 95 atributos (1 PKs, 9 BICC)
- [[hrt_profile_typ_sections_vl|HRT_PROFILE_TYP_SECTIONS_VL]] — 7 atributos (1 BICC)
