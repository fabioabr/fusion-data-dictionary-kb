---
id: DOC-HCM-PVO-HNSIncidentInvestApproverPVO
doc_type: system-doc
title: "HNSIncidentInvestApproverPVO — PVO Human Capital Management"
...
Extrai aprovadores de investigações de incidentes de SST. Utilizado para gestão de workflow de aprovação de investigações.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HealthandSafetyAM.HNSIncidentInvestApproverPVO`
