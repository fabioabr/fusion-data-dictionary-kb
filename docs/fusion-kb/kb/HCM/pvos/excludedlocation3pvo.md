---
id: DOC-HCM-PVO-ExcludedLocation3PVO
doc_type: system-doc
title: "ExcludedLocation3PVO — PVO Human Capital Management"
...
Disponibiliza localizações excluídas (nível 3) de perfis de competência. Permite granularidade adicional na restrição geográfica de perfis de talento.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmProfileCoreAM.ExcludedLocation3PVO`
