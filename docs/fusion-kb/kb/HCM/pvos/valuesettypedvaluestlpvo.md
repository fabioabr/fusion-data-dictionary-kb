---
id: DOC-HCM-PVO-ValueSetTypedValuesTLPVO
doc_type: system-doc
title: "ValueSetTypedValuesTLPVO — PVO Human Capital Management"
...
Extrai traduções de valores tipados de value sets com descrições multilíngues. Suporta localização de listas de valores em interfaces do Oracle Fusion.

**Caminho:** `FscmTopModelAM.AnalyticsServiceAM.ValueSetTypedValuesTLPVO`
...
- [[fnd_vs_values_b|FND_VS_VALUES_B]] — 14 atributos (1 PKs, 6 BICC)
- [[fnd_vs_values_tl|FND_VS_VALUES_TL]] — 10 atributos (1 PKs, 5 BICC)
- [[fnd_vs_value_sets|FND_VS_VALUE_SETS]] — 23 atributos (3 BICC)
