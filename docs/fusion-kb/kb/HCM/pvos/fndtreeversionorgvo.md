---
id: DOC-HCM-PVO-FndTreeVersionOrgVO
doc_type: system-doc
title: "FndTreeVersionOrgVO — PVO Human Capital Management"
...
Disponibiliza versões de árvore hierárquica de organizações com vigência. Utilizado para representação temporal da estrutura organizacional.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.OrganizationAM.FndTreeVersionOrgVO`
