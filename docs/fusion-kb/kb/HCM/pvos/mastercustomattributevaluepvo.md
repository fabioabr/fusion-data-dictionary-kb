---
id: DOC-HCM-PVO-MasterCustomAttributeValuePVO
doc_type: system-doc
title: "MasterCustomAttributeValuePVO — PVO Human Capital Management"
...
Extrai valores de atributos customizados do repositório de tempo (Time Repository). Permite extensão do modelo padrão de controle de horas com campos específicos da organização.
