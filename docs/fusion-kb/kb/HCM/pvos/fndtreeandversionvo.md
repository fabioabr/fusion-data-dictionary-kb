---
id: DOC-HCM-PVO-FndTreeAndVersionVO
doc_type: system-doc
title: "FndTreeAndVersionVO — PVO Human Capital Management"
...
Consolida árvores hierárquicas Foundation com versões e histórico de aplanamento. Fundamental para navegação em hierarquias organizacionais e contábeis.

**Caminho:** `FscmTopModelAM.AnalyticsServiceAM.FndTreeAndVersionVO`
...
- [[fnd_tree_version_vl|FND_TREE_VERSION_VL]] — 13 atributos (1 PKs, 13 BICC)
