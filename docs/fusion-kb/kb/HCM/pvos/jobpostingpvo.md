---
id: DOC-HCM-PVO-JobPostingPVO
doc_type: system-doc
title: "JobPostingPVO — PVO Human Capital Management"
...
Disponibiliza publicações de vagas em parceiros de recrutamento com provisionamento e status. Suporta gestão de distribuição de oportunidades.

**Caminho:** `HcmTopModelAnalyticsGlobalAM.HcmRecJobDistributionAM.JobPostingPVO`
