---
id: DOC-HCM-PVO-PromotionsPVOViewAll
doc_type: system-doc
title: "PromotionsPVOViewAll — PVO Human Capital Management"
...
Visão completa (sem restrição de segurança) das promoções do Compensation Workbench. Utilizada para relatórios analíticos de movimentação de carreira.
